 ...
 *
 *  Purpose.....:
 *      Creating API Package Implementation for igd$act.
 *
 *
 ...
 */
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PROMPT Creating API Package Implementation for igd$act
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
CREATE OR REPLACE PACKAGE BODY igd$act
  -- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  -- Name:        igd$act
...
IS
  ...
  --
  -- Purpose...:
  --   Selects a organization identity into the given parameter
  --   attribute for the row given by the organization name.
  --
  -- Usage.....: -
  --
  -- Remarks...: -
  --
  -- Parameters:
  --    p_name         The name of the organization to fetch form the
  --                   database.
  -- ------------------------------------------------------------------
