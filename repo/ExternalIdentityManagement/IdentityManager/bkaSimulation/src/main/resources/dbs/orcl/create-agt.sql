...
Rem
Rem Purpose.....:
Rem     This script creates the Google Apigee Repository at a glance in an
...
Rem *
define agtschema=igd_agt
define agtpassword=Sophie20061990$
define agtdata=usr_data
define agtindex=usr_data
define agttemp=temp
