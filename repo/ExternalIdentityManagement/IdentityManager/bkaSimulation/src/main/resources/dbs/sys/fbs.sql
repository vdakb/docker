...
Rem     variable 'fbsschema' with the password provided by variable
Rem     'fbspassword'.
Rem
...
Rem *
PROMPT ********************************************************************
PROMPT * Dropping eFBS User Repository Schema &&fbsschema
PROMPT ********************************************************************
DROP USER &&fbsschema cascade
/
...
Rem *
PROMPT ********************************************************************
PROMPT * Creating eFBS User Repository Schema &&fbsschema
PROMPT ********************************************************************
CREATE USER &&fbsschema IDENTIFIED BY &&fbspassword
  DEFAULT   TABLESPACE &&fbsdata
  TEMPORARY TABLESPACE &&fbstemp
  QUOTA UNLIMITED ON   &&fbsdata
/
...
Rem *
PROMPT ********************************************************************
PROMPT * Granting system roles to user &&fbsschema
PROMPT ********************************************************************
GRANT CONNECT, RESOURCE TO &&fbsschema
/
