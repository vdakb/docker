...
// ~~~~~ ~~~~~~~~
/**
 ** Determine if the <code>Entity</code> attribute value is less than the one
 ...
 ** @since   1.0.0.0
 */
public class LessThan extends AttributeFilter {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>LessThan</code> which belongs to the specified
   ** {@link Path}.
   **
   ...
   */
  public LessThan(final Path path, final ValueNode value) {
    // ensure inheritance
    super(Type.LT, path, value);
  }
