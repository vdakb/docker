...
public class ErrorResponse extends Entity<ErrorResponse> {
  ...
  @Attribute(description = "The HTTP status code.", mutability=Definition.Mutability.READ_ONLY, required=true)
  private final int status;

  @JsonProperty("type")
  @Attribute(description="A SCIM detailed error keyword", mutability=Definition.Mutability.READ_ONLY)
  private String    type;

  @JsonProperty("detail")
  @Attribute(description="A detailed, human readable message", mutability=Definition.Mutability.READ_ONLY)
