 ...
 ** @since   1.0.0.0
 */
public class CompanyResult implements Resource<CompanyResult> {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>CompanyResult</code> REST Resource that
   ...
   **                            {@link String}.
   **
   ** @return                    the <code>CompanyResult</code> to allow
   **                            method chaining.
   **                            <br>
   **                            Possible object is
   **                            <code>CompanyResult</code>.
   */
  public final CompanyResult list(final List<String> value) {
    this.list = value;
    return this;
  }
   ...
   ** <p>
   ** Two <code>CompanyResult</code>s are considered equal if and only if
   ** they represent the same properties. As a consequence, two given
   ** <code>CompanyResult</code>s may be different even though they contain
  ...
  public boolean equals(final Object other) {
    ...
    final CompanyResult that = (CompanyResult)other;
