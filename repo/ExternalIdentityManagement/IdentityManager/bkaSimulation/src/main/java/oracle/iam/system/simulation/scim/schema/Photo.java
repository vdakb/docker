...
public class Photo {
  ...
  @JsonProperty("type")
  @Attribute(description="A label indicating the attribute's function; e.g., 'photo' or 'thumbnail'.", required=false, caseExact=false, canonical={PHOTO, THUMBNAIL}, mutability=Definition.Mutability.READ_WRITE, returned=Definition.Returned.DEFAULT, uniqueness=Definition.Uniqueness.NONE)
  private String  type;

  @JsonProperty("value")
  @Attribute(description="URI of a photo of the User.", required=false, reference={ "external" }, mutability=Definition.Mutability.READ_WRITE, returned=Definition.Returned.DEFAULT, uniqueness=Definition.Uniqueness.NONE)
  private URI     value;
