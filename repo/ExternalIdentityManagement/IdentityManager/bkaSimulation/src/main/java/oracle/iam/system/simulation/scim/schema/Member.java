...
public class Member {
  ...
  @JsonProperty("value")
  @Attribute(description="The identifier of a Member member.", required=true, caseExact=false, mutability=Definition.Mutability.IMMUTABLE, returned=Definition.Returned.DEFAULT, uniqueness=Definition.Uniqueness.NONE)
  private String value;

  @JsonProperty("display")
  @Attribute(description="A human readable name, primarily used for display purposes.", required=false, caseExact=false, mutability=Definition.Mutability.IMMUTABLE, returned=Definition.Returned.DEFAULT, uniqueness=Definition.Uniqueness.NONE)
  private String display;

  @JsonProperty("$ref")
  @Attribute(description="The URI of the member resource.", required=true, reference={ "User", "Member" }, mutability=Definition.Mutability.IMMUTABLE, returned=Definition.Returned.DEFAULT, uniqueness=Definition.Uniqueness.NONE)
  private URI    ref;
