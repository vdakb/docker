 ...
 ** HTTPS requests.
 ** <p>
 ** One or more {@link HttpHandler} objects are be associated with the server in
 ** order to process requests. Each such {@link HttpHandler} is registered with
 ** a root URI path which represents the location of the application or service
 ** on this server. The mapping of a handler to a {@link HttpServer} is
 ** encapsulated by a <code>HttpContext</code> object. <code>HttpContext</code>s
...
public class Server {
  ...
  public static final String ROOT             = "/scim/v2";

  public static final String TYPE_SCHEMA      = "Schema";
  public static final String TYPE_RESOURCE    = "ResourceType";

  public static final String CONTEXT_USER     = "Users";
  public static final String CONTEXT_SCHEMA   = "Schemas";
  public static final String CONTEXT_RESOURCE = "ResourceTypes";

  static final Map<String, ResourceTypeDefinition> resourceType = resourceTypeDefinition();
  ...
  /**
   ** Build a <code>Context URI</code> for resource type <code>User</code>.
   **
   ...
   */
  public static String contextUserURI() {
    return contextURI(ROOT, CONTEXT_USER);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   contextSchemaURI
  /**
   ** Build a <code>Context URI</code> for resource type <code>Schema</code>.
   **
   ** @return                    the <code>Context URI</code> for resource type
   **                            <code>Schema</code>.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public static String contextSchemaURI() {
    return contextURI(ROOT, CONTEXT_SCHEMA);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   contextResourceTypeURI
  /**
   ** Build a <code>Context URI</code> for resource type
   ...
   **                            Possible object is {@link String}.
   */
  public static String contextResourceTypeURI() {
    return contextURI(ROOT, CONTEXT_RESOURCE);
  }
  ...
  public static void start(final int port)
    ...
    UserHandler.attach(instance,         contextUserURI());
    SchemaHandler.attach(instance,       contextSchemaURI());
    ResourceTypeHandler.attach(instance, contextResourceTypeURI());
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   resourceTypeDefinition
  private static Map<String, ResourceTypeDefinition> resourceTypeDefinition() {
    Map<String, ResourceTypeDefinition> resourceType = new HashMap<String, ResourceTypeDefinition>();
    try {
      final ResourceTypeDefinition user = new ResourceTypeDefinition.Builder(Account.SCHEMA.resource, "/"+ Server.CONTEXT_USER)
        .core(SchemaFactory.schema(UserResource.class))
        .addRequired(SchemaFactory.schema(EnterpriseUserExtension.class))
        .addRequired(SchemaFactory.schema(UserExtension.class))
        .build()
      ;
     resourceType.put(user.name(), user);
    }
