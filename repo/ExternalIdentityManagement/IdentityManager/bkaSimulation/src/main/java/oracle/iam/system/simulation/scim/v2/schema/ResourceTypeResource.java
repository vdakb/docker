 ...
 ** @since   1.0.0.0
 */
@Schema(id=ResourceTypeResource.ID, name="Resource Type", description="SCIM 2.0 Resource Type Resource")
public class ResourceTypeResource extends Entity {
  ...
  @JsonProperty("name")
  @Attribute(description="The resource type name.", required=true, caseExact=false, mutability=Definition.Mutability.READ_ONLY, returned=Definition.Returned.DEFAULT, uniqueness=Definition.Uniqueness.NONE)
  private final String                name;

  @JsonProperty("description")
  @Attribute(description="The resource type's human readable description.", required=false, caseExact=false, mutability=Definition.Mutability.READ_ONLY, returned=Definition.Returned.DEFAULT, uniqueness=Definition.Uniqueness.NONE)
  private final String                description;

  @JsonProperty("endpoint")
  @Attribute(description="The resource type's HTTP addressable endpoint relative to the Base URL; e.g., \"/Users\".", reference={"uri"}, required=true, caseExact=true, mutability=Definition.Mutability.READ_ONLY, returned=Definition.Returned.DEFAULT, uniqueness=Definition.Uniqueness.NONE)
  private final URI                   endpoint;

  @JsonProperty("schema")
  @Attribute(description="The resource types primary/base schema URI.", reference={"uri"}, required=true, caseExact=true, mutability=Definition.Mutability.READ_ONLY, returned=Definition.Returned.DEFAULT, uniqueness=Definition.Uniqueness.NONE)
  private final URI                   schema;

  @JsonProperty("schemaExtensions")
  @Attribute(description="A list of URIs of the resource type's schema extensions.", required=false, mutability=Definition.Mutability.READ_ONLY, returned=Definition.Returned.DEFAULT, multiValueClass=Extension.class)
  ...
  public static class Extension {
    ...
    @Attribute(description="A Boolean value that specifies whether the schema extension is required for the resource type. If true, a resource of this type MUST include this schema extension and include any attributes declared as required in this schema extension. If false, a resource of this type MAY omit this schema extension", required=true, mutability=Definition.Mutability.READ_ONLY, returned=Definition.Returned.DEFAULT)
    private final boolean required;

    @JsonProperty("schema")
    @Attribute(description="The URI of a schema extension.", required=true, caseExact=true, mutability=Definition.Mutability.READ_ONLY, returned=Definition.Returned.DEFAULT, uniqueness=Definition.Uniqueness.NONE, reference={"uri"} )
    private final URI     schema;
