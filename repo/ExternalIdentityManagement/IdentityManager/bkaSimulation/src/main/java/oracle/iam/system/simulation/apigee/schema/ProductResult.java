 ...
 ** </ol>
 ** Furthermore in searching for <code>Product</code>s only the list of
 ** provisioned Product id's is returned and a follow up request is
 ** required to get the details for each <code>Product</code> REST resource.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class ProductResult implements Resource<ProductResult> {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>ProductResult</code> REST Resource that allows
   ** use as a JavaBean.
   ** <br>
  ...
  // Method:   list
  /**
   ** Sets the product result set.
   **
   ** @param  value              the product result set.
   **                            <br>
   **                            Allowed object is {@link List} of
   **                            {@link String}.
   **
   ** @return                    the <code>ProductResult</code> to allow
   **                            method chaining.
   **                            <br>
   **                            Possible object is
   **                            <code>ProductResult</code>.
   */
  public final ProductResult list(final List<String> value) {
    this.list = value;
    return this;
  }
  ...
  // Method:   list
  /**
   ** Returns the product result set.
   ** <p>
   ...
   ** <p>
   ** Two <code>ProductResult</code>s are considered equal if and only if
   ** they represent the same properties. As a consequence, two given
   ** <code>ProductResult</code>s may be different even though they contain
  ...
  public boolean equals(final Object other) {
    ...
    final ProductResult that = (ProductResult)other;
