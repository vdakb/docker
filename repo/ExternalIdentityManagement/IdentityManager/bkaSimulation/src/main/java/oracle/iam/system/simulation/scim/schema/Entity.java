...
public class Entity<T extends Entity> implements Resource<T> {
  ...
  @JsonProperty("id")
  @Attribute(description="A unique identifier for a SCIM resource as defined by the service provider", required=false, caseExact=true, mutability=Definition.Mutability.READ_ONLY, returned=Definition.Returned.ALWAYS, uniqueness=Definition.Uniqueness.SERVER)
  private String           id;
  ...
  private final ObjectNode extensionObjectNode = Support.jsonNodeFactory().objectNode();
