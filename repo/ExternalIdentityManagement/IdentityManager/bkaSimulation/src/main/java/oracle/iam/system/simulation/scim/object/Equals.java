...
// ~~~~~ ~~~~~~
/**
 ** Determine if the <code>Entity</code> contains an attribute that matches a
 ...
 ** @since   1.0.0.0
 */
public class Equals extends AttributeFilter {
   ...
   */
  public Equals(final Path path, final ValueNode value) {
    // ensure inheritance
    super(Type.EQ, path, value);
  }
  ...
  public <R, P> R accept(final Visitor<R, P> visitor, final P parameter)
    ...
    return visitor.equals(parameter, this);
  }
}