...
package oracle.iam.system.simulation.scim.v2;
...
public class ResourceTypeDefinition {
  ...
  public static class Builder {
     ...
     **                          Allowed object is {@link String}.
     **
     ** @throws ServiceException if either name or endpoint is <code>null</code>
     */
    public Builder(final String name, final String endpoint)
      ...
      // prevent bogus input
      if (name == null)
        throw new ServiceException(ServiceError.ARGUMENT_IS_NULL, "name");

      // prevent bogus input
      if (endpoint == null)
        throw new ServiceException(ServiceError.ARGUMENT_IS_NULL, "endpoint");
