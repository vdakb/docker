...
public class Server {
  ...
  public static final String CONTEXT_ROLE        = "userroles";
  public static final String CONTEXT_TENANT      = "organizations";
  public static final String CONTEXT_COMPANY     = "companies";
  public static final String CONTEXT_PRODUCT     = "apiproducts";
  public static final String CONTEXT_DEVELOPER   = "developers";
  public static final String CONTEXT_APPLICATION = "apps";
   ...
   **                            Possible object is {@link String}.
   */
  public static String contextTenantURI() {
    return contextURI(ROOT, CONTEXT_TENANT);
  }
  ...
  public static void start(final int port)
    ...
    RoleHandler.attach(instance,        contextUserURI());
    UserHandler.attach(instance,        contextUserURI());
    TenantHandler.attach(instance,      contextTenantURI());
