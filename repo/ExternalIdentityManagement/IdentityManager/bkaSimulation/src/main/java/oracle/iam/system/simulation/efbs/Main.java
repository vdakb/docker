...
import oracle.iam.system.simulation.efbs.service.Provider;
 ...
 ** that simulates eFBS SCIM interface.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public class Main {
  ...
  private static void parseCommandLine(final String[] args) {
    ...
    opts[ 1] = new CommandLine.Option("listener",  CommandLine.ARGUMENT_REQUIRED, null, 'l');
    opts[ 2] = new CommandLine.Option("service",   CommandLine.ARGUMENT_REQUIRED, null, 's');
    opts[ 3] = new CommandLine.Option("username",  CommandLine.ARGUMENT_REQUIRED, null, 'u');
    opts[ 4] = new CommandLine.Option("password",  CommandLine.ARGUMENT_REQUIRED, null, 'w');
    opts[ 5] = new CommandLine.Option("interface", CommandLine.ARGUMENT_REQUIRED, null, 'i');
    opts[ 6] = new CommandLine.Option("port",      CommandLine.ARGUMENT_REQUIRED, null, 'p');

    final CommandLine cli = new CommandLine("eFBS SCIM Service Simulator", args, "-h:l:s:u:w:i:p:?", opts);
  ...
  private static void usage() {
    ...
    System.out.println("                    Defaults to port 7021");
