 ...
 ** @since   1.0.0.0
 */
public class StartsWith extends AttributeFilter {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>StartsWith</code> w/ the {@link ValueNode} to compare.
   **
   ...
   **                            attribute.
   */
  public StartsWith(final Path path, final ValueNode value) {
    // ensure inheritance
    super(Type.SW, path, value);
  }
  ...
  public <R, P> R accept(final Visitor<R, P> visitor, final P parameter)
    ...
    return visitor.startsWith(parameter, this);
  }
}