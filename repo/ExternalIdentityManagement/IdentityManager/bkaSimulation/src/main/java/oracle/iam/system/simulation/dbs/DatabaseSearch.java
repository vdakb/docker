...
public class DatabaseSearch extends DatabaseSelect {
   ...
   **                            returned result set.
   */
  public DatabaseSearch(final DatabaseEntity entity, final DatabaseFilter filter, final List<Pair<String, String>> returning) {
    // ensure inheritance
    super(entity, filter, returning);
  }
   ...
   */
  public static DatabaseSearch build(final DatabaseEntity entity, final DatabaseFilter filter, final Pair<String, String>... returning) {
    return new DatabaseSearch(entity, filter, CollectionUtility.list(returning));
  }
   ...
   **                            with the properties provided.
   */
  public static DatabaseSearch build(final DatabaseEntity entity, final DatabaseFilter filter, final List<Pair<String, String>> returning) {
    return new DatabaseSearch(entity, filter, returning);
  }
   ...
   **                            performed.
   */
  public List<List<Pair<String, Object>>> execute(final long startRow, final long lastRow)
    throws DatabaseException {
   ...
   **                            performed.
   */
  public List<List<Pair<String, Object>>> execute(final List<DatabaseParameter> parameter, final long startRow, final long lastRow)
    throws DatabaseException {
