...
// ~~~~~ ~~~~~~~~~~~
/**
 ** Determine if the <code>Entity</code> attribute value is greater than the one
 ...
 ** @since   1.0.0.0
 */
public class GreaterThan extends AttributeFilter {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>GreaterThan</code> filter which belongs to the
   ** specified {@link Path}.
   **
   ...
   */
  public GreaterThan(final Path path, final ValueNode value) {
    // ensure inheritance
    super(Type.GT, path, value);
  }
