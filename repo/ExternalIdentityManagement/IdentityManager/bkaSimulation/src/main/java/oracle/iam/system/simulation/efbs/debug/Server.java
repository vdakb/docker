...
public class Server {
  ...
  private static Map<String, ResourceTypeDefinition> resourceTypeDefinition() {
    ...
    try {
      final ResourceTypeDefinition user = new ResourceTypeDefinition.Builder(Account.SCHEMA.resource, "/"+ oracle.iam.system.simulation.efbs.service.Server.CONTEXT_USER)
