 ...
 ** @since   1.0.0.0
 */
public class EndsWith extends AttributeFilter {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>EndsWith</code> w/ the {@link ValueNode} to compare.
   **
   ...
   **                            attribute.
   */
  public EndsWith(final Path path, final ValueNode value) {
    // ensure inheritance
