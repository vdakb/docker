...
public class PatchRequest<T extends PatchRequest> extends    Entity<T>
   ...
   */
  @JsonCreator
  public PatchRequest(final @JsonProperty(value=OPERATIONS, required = true) List<PatchOperation> operation) {
	  // ensure inheritance
    super();
  ...
  @Override
  public int hashCode() {
    return 31 * super.hashCode() + this.operation.hashCode();
  }
  ...
  // Method:   apply
  /**
   ** Apply this patch request to the {@link GenericResource}.
   **
   ...
   **                            invalid.
   */
  public void apply(final GenericResource object)
