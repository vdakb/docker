/*
    ...
    File        :   EnterpriseUserExtension.java
...
import oracle.iam.system.simulation.scim.schema.EnterpriseUser;
 ...
 ** @since   1.0.0.0
 */
@Schema(id=EnterpriseUserExtension.ID, name="EnterpriseUser", description="Enterprise User")
public class EnterpriseUserExtension extends EnterpriseUser<EnterpriseUserExtension>  {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  public static final String ID = "urn:ietf:params:scim:schemas:extension:enterprise:2.0:User";
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>EnterpriseUserExtension</code> SCIM Resource
