...
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** Exception class for throwing from <code>Zero</code> operations if
 ...
 ** @since   1.0.0.0
 */
public final class ZeroException extends TaskException {
   ...
   */
  public ZeroException(final String code) {
    // ensure inheritance
    super(ZeroBundle.RESOURCE, code);
  }
   ...
   */
  public ZeroException(final String code, final String parameter) {
    // ensure inheritance
    super(ZeroBundle.RESOURCE, code, parameter);
  }
  ...
  ** @param  code               the resource key for the exception message.
   ...
   */
  public ZeroException(final String code, final Throwable causing) {
    // ensure inheritance
    super(ZeroBundle.RESOURCE, code, causing);
  }
   ...
   ** @param  causing            the causing exception.
   */
  public ZeroException(final String code, final String parameter, final Throwable causing) {
    // ensure inheritance
    super(ZeroBundle.RESOURCE, code, parameter, causing);
  }
