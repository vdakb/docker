...
////////////////////////////////////////////////////////////////////////////////
// final class EFSBEducationValidator
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~
/**
 ...
 ** @since   1.0.0.0
 */
public final class EFBSProductionValidator extends MultipleAccountValidator {
   ...
   */
  private static final String REQUESTNAME = "userName";
  /**
   ** the name of the attribute in the account data identifying the account
   */
  private static final String ACCOUNTNAME = "UD_EFBSP_USERNAME";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>EFBSProductionValidator</code> event handler that
   ...
   ** Default Constructor
   */
  public EFBSProductionValidator() {
    // ensure inheritance
