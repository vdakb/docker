 ...
 ** @since   1.0.0.0
 */
public class UTCEndDateDecoder extends UTCDateDecoder {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>UTCEndDateDecoder</code> adpater that allows use
   ** as a JavaBean.
   ** <br>
   ...
   ** Default Constructor
   */
  public UTCEndDateDecoder() {
    // ensure inheritance
    super(Logger.create(UTCEndDateDecoder.class.getName()));
  }
  ...
  public Object transform(final HashMap<String,Object> identity, final HashMap<String, Object> entitlement, final String attribute) {
    return parseExternal((String)identity.get(attribute));
  }
}