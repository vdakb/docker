 ...
 ** @since   1.0.0.0
 */
public final class EFSBEducationValidator extends MultipleAccountValidator {
   ...
   */
  private static final String ACCOUNTNAME = "UD_EFBSE_USERNAME";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>EFSBEducationValidator</code> event handler that
