          ...
          <div id="layoutDrawer_dashboard">
				...
				<div class="card card-code card-compact card-documentation mb-3">
					<div class="card-header">
						<h4><span class="insight-mode-marker">Insight-Modus: Userinfo-Abfrage</span></h4>
					</div>
					<div class="card-body">
				...
				<% if (request.getAttribute( OidcDemoConst.ATTR_USERINFO_REQUEST ) != null) { %>
				<div class="card card-code card-compact card-documentation mb-3">
					<div class="card-header">
						<h4>Userinfo-Anfrage</h4>
					</div>
					<div class="card-body">
						<p>Aufruf des Userinfo-Endpoints des STS per GET:</p>
						<%= request.getAttribute( OidcDemoConst.ATTR_USERINFO_REQUEST ) %>
					</div>
				</div>
				<% } %>

				<% if (request.getAttribute( OidcDemoConst.ATTR_USERINFO_RESPONSE ) != null) { %>
				<div class="card card-code card-compact card-documentation mb-3">
					<div class="card-header">
						<h4>Userinfo-Antwort</h4>
					</div>
					<div class="card-body">
						<p>Antwort des STS:</p>
						<%= request.getAttribute( OidcDemoConst.ATTR_USERINFO_RESPONSE ) %>
					</div>
				</div>
				<% } %>
