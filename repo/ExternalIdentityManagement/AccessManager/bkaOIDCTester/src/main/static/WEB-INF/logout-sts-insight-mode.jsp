          ...
          <div id="layoutDrawer_dashboard">
				...
				<div class="card card-code card-compact card-documentation mb-3">
					<div class="card-header">
						<h4><span class="insight-mode-marker">Insight-Modus: Login</span></h4>
					</div>
					<div class="card-body">
						<p>Redirects sind im Insight-Modus unterbunden.</p>
						<p>Die Weiterleitung zur Logout-Seite des STS muss manuell erfolgen:
				...
				<div class="card card-code card-compact card-documentation mb-3">
					...
					<div class="card-body">
						<p>Zum Ausloggen beim STS erfolgt ein Redirect auf diese Seite:</p>
