          ...
          <div id="layoutDrawer_dashboard">
				...
				<div class="card card-code card-compact card-documentation mb-3">
					<div class="card-header">
						<h4><span class="insight-mode-marker">Insight-Modus: Redirect</span></h4>
					</div>
					<div class="card-body">
						<p>Redirects sind im Insight-Modus unterbunden.</p>
				...
				<div class="card card-code card-compact card-documentation mb-3">
					<div class="card-header">
						<h4>Redirect vom STS</h4>
					</div>
					<div class="card-body">
						<p>Der STS hat einen Redirect auf diese Seite vorgenommen:</p>
						<%=request.getAttribute( OidcDemoConst.ATTR_REQUEST_URI )%>
					</div>
				</div>
				...
				<div class="card card-code card-compact card-documentation mb-3">
					...
					<div class="card-body">
						<p>Nach erfolgreicher Authentifizierung würde diese Seite einen Redirect auf die Hauptseite durchführen:</p>
						<%=DemoHtmlUtil.uriToHtml( (String)request.getAttribute( OidcDemoConst.ATTR_REDIRECT_URI ) )%>
					</div>
				</div>
