<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
	import="de.itk.oidcdemo.demowebanwendung.OidcDemoConst,
		...
		de.itk.auth.client.InitException,
			...
			<div class="container-xl p-5">
				...
				<div class="card card-code card-compact card-documentation mb-3">
					<div class="card-header">
						<h4 class="error">Initialisierung fehlgeschlagen</h4>
					</div>
					<div class="card-body">
						<p>Aktion: <%= ((InitException)request.getAttribute( "javax.servlet.error.exception" )).getAction() %></p>
						<p>Fehlermeldung: <code><%= ((InitException)request.getAttribute( "javax.servlet.error.exception" )).getException().toString() %></code></p>
