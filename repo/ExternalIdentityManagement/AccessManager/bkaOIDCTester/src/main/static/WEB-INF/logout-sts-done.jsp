          ...
          <div id="layoutDrawer_dashboard">
				...
				<div class="card card-code card-compact card-documentation mb-3">
					<div class="card-header">
						<h4><span class="insight-mode-marker">Insight-Modus: Logout STS Done</span></h4>
					</div>
					<div class="card-body">
						<p>Der Logout ist erfolgt, die Session der Anwendung wie auch beim STS wurde beendet.</p>
						<p>Zurück zur Hauptseite: <a class="btn btn-primary" href="<%=DemoUtil.getBaseUrl( request ).replace("&", "&amp;") + (("1".equals( request.getParameter( OidcDemoConst.QP_INSIGHT_MODE) ) ) ? "?no-redirect=1" : "")%>">Klick</a></p>
					</div>
				</div>
			</div>
