...
import bka.iam.platform.access.ecc.mbean.ConfigurationService;
import bka.iam.platform.access.ecc.mbean.ConfigurationServiceMXBean;
...
public class ContextLoader implements ServletContextListener {
  ...
  static {
    try {
      MBEAN = new ObjectName("bka.iam.platform:Name=config,Type=ecc");
    }
