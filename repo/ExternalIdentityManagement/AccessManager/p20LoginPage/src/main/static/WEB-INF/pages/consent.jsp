                    ...
                    <div class="card-body h-100">
                      ...
                      <c:choose>
                        ...
                        <c:otherwise>
                          ...
                          <p class="jumbo-body-title"><fmt:message key="consent.instruction"/></p>
                          <form id="f01" name="consent" method="post" action="/oauth2/rest/approval">
                            <div class="form-row">
                              <button id="b01" type="submit" class="btn-submit" onclick="deny();"><fmt:message key="consent.action.reject"/></button>
                              <button id="b02" type="submit" class="btn-submit ml-4" onclick="accept();"><fmt:message key="consent.action.accept"/></button>
                            </div>
