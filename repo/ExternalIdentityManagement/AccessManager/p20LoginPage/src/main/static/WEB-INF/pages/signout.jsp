            ...
            <div class="card jumbo">
              <div class="card-body jumbo-body">
                <div class="row h-100 no-gutters">
                  <div class="col-md-6">
                    <img class="ml-4 mt-4" src="img/p20-signin-md.png" alt="signout"/>
                  </div>
                  <div class="col-md-6">
                    <div class="h-100">
                      <div>
                      ...
                      <p class="jumbo-body-title"><fmt:message key="signout.instruction"/></p>
                      <div class="d-flex justify-content-start">
                        <a href="/p20" class="btn-submit" role="button"><fmt:message key="signin.action"/></a>
                      </div>
                    </div>
                  </div>
                </div>
