...
Rem
Rem Purpose:
Rem     This script deletes Anonymous Identifier Generator seeded data and
Rem     objects.
Rem
...
@resources/pid/install/val/delete
@resources/pid/install/api/delete
@resources/pid/install/obj/delete
