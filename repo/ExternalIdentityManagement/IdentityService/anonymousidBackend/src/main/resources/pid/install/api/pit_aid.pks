-- /Users/dsteding/Project/Bundeskriminalamt12c/ExternalIdentityManagement/IdentityService/identifierBackend/src/main/resources/install/pid/api/pit_aid.pks
--
...
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PROMPT Creating API Package Specification for Table 'pit_identifiers'
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
--------------------------------------------------------------------------------
-- Name:        cg$pit_identifiers
-- Description: pit_identifiers table API package declarations
--------------------------------------------------------------------------------
CREATE OR REPLACE PACKAGE cg$pit_identifiers
IS

  called_from_package BOOLEAN := FALSE;

  -- Repository User-Defined Error Messages
  PIT_AID_PK    CONSTANT VARCHAR2(10) := 'PIT-00101';
  PIT_AID_CK1   CONSTANT VARCHAR2(10) := 'PIT-00301';
  ...
  P45USEDBY     CONSTANT VARCHAR2(30) := 'Used by';

  cg$row pit_identifiers%ROWTYPE;

  -- pit_identifiers row type variable
  ...
  , usedby      cg$row.usedby%TYPE
  , the_rowid   ROWID
  );

  -- pit_identifiers indicator type variable
  ...
  , usedby      BOOLEAN DEFAULT FALSE
  );

  cg$ind_true cg$ind_type;

  -- pit_identifiers primary key type variable
  ...
  TYPE cg$table_type IS TABLE OF pit_identifiers%ROWTYPE
