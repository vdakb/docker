...
public class RequestBundle extends ListResourceBundle {
  ...
  , { RequestError.REQUEST_APPLICATION_NOTFOUND,   "Application %1$s does not exists." }
  , { RequestError.REQUEST_FAILED,                 "Submitting request of %2$s in %1$s for beneficiary %3$s failed due to error\n\n%4$s." }
  };
