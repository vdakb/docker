/*
    ...
    File        :   ApplicationEntityReader.java
...
public class ApplicationEntityReader implements MessageBodyReader<ApplicationEntity> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>ApplicationEntityReader</code> allows use as a
   ** JavaBean.
   ** <br>
   ...
   ** Default Constructor
   */
  public ApplicationEntityReader() {
    // ensure inheritance
    super();
  }
   ...
   */
  @Override
  public ApplicationEntity readFrom(final Class<ApplicationEntity> type, final Type generic, final Annotation[] annotation, final MediaType mediaType, final MultivaluedMap<String,String> header, final InputStream stream)
    throws IOException
    ,      WebApplicationException {

    return Schema.unmarshalApplication(stream);
  }
}