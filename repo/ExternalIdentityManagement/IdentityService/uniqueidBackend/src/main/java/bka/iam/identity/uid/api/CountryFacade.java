...
// ~~~~~ ~~~~~~~~~~~~~
/**
 ** The session facade to manage {@link Country} entity persistent.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
@Stateless(name=CountryFacade.NAME)
public class CountryFacade extends    PersistenceService
  ...
  public static final String NAME             = "countryFacade";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>CountryFacade</code> allows use as a JavaBean.
   ** <br>
  ...
  public Integer count(final SearchFilter filter)
    ...
    return total(Country.class, filter);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   list
  /**
   ** Search for entities of type {@link Country} and returns
   ...
   **                            each element is of type {@link Country}.
   **
   ** @throws PersistenceException if the entity manager has been closed or the
   **                              criteria query is found to be invalid.
   */
  @Transactional(readOnly=true)
  public SearchResult<Country> list(final SearchRequest request)
    throws PersistenceException {

    return list(Country.class, request.start(), request.count(), request.total(), request.filter(), request.order());
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   lookup
  /**
   ** JPA request to retrieve a certain {@link Country} by its <code>id</code>.
   **
   ...
   */
  @Transactional(readOnly=true)
  public Country lookup(final String id)
    throws PersistenceException {

    return lookup(Country.class, id);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   create
  /**
   ** JPA request to persist a {@link Country} entity.
   **
  ...
  public Country create(final Country entity)
    ...
    if (entity.getId() == null || entity.getId().isEmpty())
      throw PersistenceException.notNull(Country.class, Country.Attribute.ID.id);

    // prevent bogus state of the entity
    if (entity.getName() == null || entity.getName().isEmpty())
      throw PersistenceException.notNull(Country.class, Country.Attribute.NAME.id);
  ...
  // Method:   modify
  /**
   ** JPA request to modify a {@link Country} entity.
   **
   ...
   */
  @Transactional
  public Country modify(final Country entity)
    throws PersistenceException {
  ...
  // Method:   delete
  /**
   ** JPA request to remove a {@link Country} entity.
   **
   ...
   */
  @Transactional
  public Country delete(final Country entity)
    throws PersistenceException {
