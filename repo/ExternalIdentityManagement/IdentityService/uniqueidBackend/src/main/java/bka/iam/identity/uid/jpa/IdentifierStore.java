...
package bka.iam.identity.uid.jpa;
...
// ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** A store for entity managers handling transactions belonging to unique
 ** identifiers.
 ** <br>
...
public class IdentifierStore extends EntityManagerStore {
  ...
  // compatible with
  @SuppressWarnings("compatibility:5158317961082233096")
  private static final long serialVersionUID = -3243709822240254919L;
  ...
  public void startup() {
    ...
    initialize(Persistence.createEntityManagerFactory("uid"));
  }
}