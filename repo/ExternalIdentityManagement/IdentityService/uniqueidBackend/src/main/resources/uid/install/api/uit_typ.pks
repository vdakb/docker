-- /Users/dsteding/Project/Bundeskriminalamt12c/ExternalIdentityManagement/IdentityService/uniqueidBackend/src/main/resources/install/uid/api/uit_typ.pks
--
...
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PROMPT Creating API Package Specification for Table 'uit_types'
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
--------------------------------------------------------------------------------
-- Name:        cg$uit_types
-- Description: uit_types table API package declarations
--------------------------------------------------------------------------------
CREATE OR REPLACE PACKAGE cg$uit_types
IS

  called_from_package BOOLEAN := FALSE;

  -- Repository User-Defined Error Messages
  UIT_TYP_PK        CONSTANT VARCHAR2(10) := 'UIT-00107';
  UIT_TYP_UK        CONSTANT VARCHAR2(10) := 'UIT-00205';
  UIT_TYP_CK1       CONSTANT VARCHAR2(10) := 'UIT-00306';
  ...
  cg$row uit_types%ROWTYPE;

  -- uit_types row type variable
  ...
  -- uit_types indicator type variable
  ...
  -- uit_types primary key type variable
  ...
  TYPE cg$table_type IS TABLE OF uit_types%ROWTYPE
