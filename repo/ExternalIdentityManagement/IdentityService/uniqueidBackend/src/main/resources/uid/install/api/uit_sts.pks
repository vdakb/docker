...
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PROMPT Creating API Package Specification for Table 'uit_states'
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
--------------------------------------------------------------------------------
-- Name:        cg$uit_states
-- Description: uit_states table API package declarations
--------------------------------------------------------------------------------
CREATE OR REPLACE PACKAGE cg$uit_states
IS

  called_from_package BOOLEAN := FALSE;

  -- Repository User-Defined Error Messages
  UIT_STS_PK        CONSTANT VARCHAR2(10) := 'UIT-00103';
  UIT_STS_UK        CONSTANT VARCHAR2(10) := 'UIT-00203';
  UIT_STS_CK1       CONSTANT VARCHAR2(10) := 'UIT-00303';
  ...
  cg$row uit_states%ROWTYPE;

  -- uit_states row type variable
  ...
  -- uit_states indicator type variable
  ...
  -- uit_states primary key type variable
  ...
  TYPE cg$table_type IS TABLE OF uit_states%ROWTYPE
