-- /Users/dsteding/Project/Bundeskriminalamt12c/ExternalIdentityManagement/IdentityService/uniqueidBackend/src/main/resources/install/uid/api/uit_cnt.pks
--
...
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PROMPT Creating API Package Specification for Table 'uit_countries'
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
--------------------------------------------------------------------------------
-- Name:        cg$uit_countries
-- Description: uit_countries table API package declarations
--------------------------------------------------------------------------------
CREATE OR REPLACE PACKAGE cg$uit_countries
IS

  called_from_package BOOLEAN := FALSE;

  -- Repository User-Defined Error Messages
  UIT_CNT_PK        CONSTANT VARCHAR2(10) := 'UIT-00102';
  UIT_CNT_UK        CONSTANT VARCHAR2(10) := 'UIT-00202';
  UIT_CNT_CK1       CONSTANT VARCHAR2(10) := 'UIT-00302';
  ...
  cg$row uit_countries%ROWTYPE;

  -- uit_countries row type variable
  ...
  -- uit_countries indicator type variable
  ...
  -- uit_countries primary key type variable
  ...
  TYPE cg$table_type IS TABLE OF uit_countries%ROWTYPE
