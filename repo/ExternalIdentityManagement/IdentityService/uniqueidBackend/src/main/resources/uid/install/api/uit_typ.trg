-- /Users/dsteding/Project/Bundeskriminalamt12c/ExternalIdentityManagement/IdentityService/uniqueidBackend/src/main/resources/install/uid/api/uit_typ.trg
--
...
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PROMPT Creating Trigger Logic for Table 'uit_types'
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PROMPT Creating Before Insert Statement Trigger on 'uit_types'
CREATE OR REPLACE TRIGGER cg$bis_uit_types
BEFORE INSERT ON uit_types
BEGIN
  -- Application_logic Pre-Before-Insert-statement <<Start>>
  -- Application_logic Pre-Before-Insert-statement << End >>

  cg$uit_types.cg$table.DELETE;
  cg$uit_types.cg$tableind.DELETE;
  cg$uit_types.idx := 1;
...
/
SHOW ERROR
PROMPT Creating Before Insert Row Trigger on 'uit_types'
CREATE OR REPLACE TRIGGER cg$bir_uit_types
BEFORE INSERT ON uit_types FOR EACH ROW
DECLARE
...
BEGIN
  ...
  THEN
    cg$uit_types.ins(cg$rec, cg$ind, FALSE);
    cg$uit_types.called_from_package := FALSE;
  END IF;

  cg$uit_types.cg$table(cg$uit_types.idx).id                := cg$rec.id;
  cg$uit_types.cg$tableind(cg$uit_types.idx).id             := cg$ind.id;

  cg$uit_types.cg$table(cg$uit_types.idx).rowversion        := cg$rec.rowversion;
  cg$uit_types.cg$tableind(cg$uit_types.idx).rowversion     := cg$ind.rowversion;

  cg$uit_types.cg$table(cg$uit_types.idx).created_by        := cg$rec.created_by;
  cg$uit_types.cg$tableind(cg$uit_types.idx).created_by     := cg$ind.created_by;

  cg$uit_types.cg$table(cg$uit_types.idx).created_on        := cg$rec.created_on;
  cg$uit_types.cg$tableind(cg$uit_types.idx).created_on     := cg$ind.created_on;

  cg$uit_types.cg$table(cg$uit_types.idx).updated_by        := cg$rec.updated_by;
  cg$uit_types.cg$tableind(cg$uit_types.idx).updated_by     := cg$ind.updated_by;

  cg$uit_types.cg$table(cg$uit_types.idx).updated_on        := cg$rec.updated_on;
  cg$uit_types.cg$tableind(cg$uit_types.idx).updated_on     := cg$ind.updated_on;

  cg$uit_types.cg$table(cg$uit_types.idx).name              := cg$rec.name;
  cg$uit_types.cg$tableind(cg$uit_types.idx).name           := cg$ind.name;

  cg$uit_types.cg$table(cg$uit_types.idx).description       := cg$rec.description;
  cg$uit_types.cg$tableind(cg$uit_types.idx).description    := cg$ind.description;
...
/
SHOW ERROR
PROMPT Creating After Insert Row Trigger on 'uit_types'
CREATE OR REPLACE TRIGGER cg$air_uit_types
AFTER INSERT ON uit_types FOR EACH ROW
DECLARE
  cg$rec cg$uit_types.cg$row_type;
  cg$ind cg$uit_types.cg$ind_type;
BEGIN
...
END;
/
PROMPT Creating After Insert Statement Trigger on 'uit_types'
CREATE OR REPLACE TRIGGER cg$ais_uit_types
...
/
SHOW ERROR
PROMPT Creating Before Update Statement Trigger on 'uit_types'
CREATE OR REPLACE TRIGGER cg$bus_uit_types
BEFORE UPDATE ON uit_types
BEGIN
...
/
SHOW ERROR
PROMPT Creating Before Update Row Trigger on 'uit_types'
CREATE OR REPLACE TRIGGER cg$bur_uit_types
BEFORE UPDATE ON uit_types FOR EACH ROW
DECLARE
  cg$rec     cg$uit_types.cg$row_type;
  cg$ind     cg$uit_types.cg$ind_type;
  cg$old_rec cg$uit_types.cg$row_type;
BEGIN
  ...
  cg$uit_types.cg$table(cg$uit_types.idx).rowversion := :old.rowversion;
  ...
  cg$uit_types.cg$table(cg$uit_types.idx).created_by := :old.created_by;
  ...
  cg$uit_types.cg$table(cg$uit_types.idx).created_on := :old.created_on;
  ...
  cg$uit_types.cg$table(cg$uit_types.idx).updated_by := :old.updated_by;
  ...
  cg$uit_types.cg$table(cg$uit_types.idx).updated_on := :old.updated_on;
  ...
  cg$uit_types.cg$table(cg$uit_types.idx).name := :old.name;
  ...
  cg$uit_types.cg$table(cg$uit_types.idx).description := :old.description;

  cg$uit_types.idx := cg$uit_types.idx + 1;

  IF NOT (cg$uit_types.called_from_package)
  THEN
    cg$uit_types.upd(cg$rec, cg$ind, FALSE);
    cg$uit_types.called_from_package := FALSE;
  END IF;
...
/
SHOW ERROR
PROMPT Creating After Update Statement Trigger on 'uit_types'
CREATE OR REPLACE TRIGGER cg$aus_uit_types
...
/
SHOW ERROR
PROMPT Creating Before Delete Statement Trigger on 'uit_types'
CREATE OR REPLACE TRIGGER cg$bds_uit_types
BEFORE DELETE ON uit_types
BEGIN
...
/
SHOW ERROR
PROMPT Creating Before Delete Row Trigger on 'uit_types'
CREATE OR REPLACE TRIGGER cg$bdr_uit_types
...
/
SHOW ERROR
PROMPT Creating After Delete Statement Trigger on 'uit_types'
CREATE OR REPLACE TRIGGER cg$ads_uit_types
AFTER DELETE ON uit_types
DECLARE
  idx        BINARY_INTEGER := cg$uit_types.cg$table.FIRST;
  cg$rec     cg$uit_types.cg$row_type;
  cg$old_rec cg$uit_types.cg$row_type;
BEGIN
  ...
  THEN
    ...
    LOOP
      cg$rec.id := cg$uit_types.cg$table(idx).id;
      cg$uit_types.cg$tableind(idx).id := TRUE;

      cg$rec.rowversion := cg$uit_types.cg$table(idx).rowversion;
      cg$uit_types.cg$tableind(idx).rowversion := TRUE;

      cg$rec.created_by := cg$uit_types.cg$table(idx).created_by;
      cg$uit_types.cg$tableind(idx).created_by := TRUE;

      cg$rec.created_on := cg$uit_types.cg$table(idx).created_on;
      cg$uit_types.cg$tableind(idx).created_on := TRUE;

      cg$rec.updated_by := cg$uit_types.cg$table(idx).updated_by;
      cg$uit_types.cg$tableind(idx).updated_by := TRUE;

      cg$rec.updated_on := cg$uit_types.cg$table(idx).updated_on;
      cg$uit_types.cg$tableind(idx).updated_on := TRUE;

      cg$uit_types.validate_foreign_keys_del(cg$rec);
      cg$uit_types.cascade_delete(cg$rec);

      cg$rec.name := cg$uit_types.cg$table(idx).name;
      cg$uit_types.cg$tableind(idx).name := TRUE;

      cg$rec.description := cg$uit_types.cg$table(idx).description;
      cg$uit_types.cg$tableind(idx).description := TRUE;
