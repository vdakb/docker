-- /Users/dsteding/Project/Bundeskriminalamt12c/ExternalIdentityManagement/IdentityService/uniqueidBackend/src/main/resources/install/uid/api/uit_tnt.pks
--
...
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PROMPT Creating API Package Specification for Table 'uit_tenants'
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
--------------------------------------------------------------------------------
-- Name:        cg$uit_tenants
-- Description: uit_tenants table API package declarations
--------------------------------------------------------------------------------
CREATE OR REPLACE PACKAGE cg$uit_tenants
IS

  called_from_package BOOLEAN := FALSE;

  -- Repository User-Defined Error Messages
  UIT_TNT_PK        CONSTANT VARCHAR2(10) := 'UIT-00105';
  UIT_TNT_CK1       CONSTANT VARCHAR2(10) := 'UIT-00305';
  ...
  cg$row uit_tenants%ROWTYPE;

  -- uit_tenants row type variable
  ...
  -- uit_tenants indicator type variable
  ...
  -- uit_tenants primary key type variable
  ...
  TYPE cg$table_type IS TABLE OF uit_tenants%ROWTYPE
