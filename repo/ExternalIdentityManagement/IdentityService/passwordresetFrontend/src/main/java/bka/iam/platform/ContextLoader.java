...
import bka.iam.platform.identity.pwr.mbean.ConfigurationService;
import bka.iam.platform.identity.pwr.mbean.ConfigurationServiceMXBean;
...
public class ContextLoader implements ServletContextListener {
  ...
  static {
    try {
      MBEAN = new ObjectName("bka.iam.platform:Name=config,Type=pwr");
    }
