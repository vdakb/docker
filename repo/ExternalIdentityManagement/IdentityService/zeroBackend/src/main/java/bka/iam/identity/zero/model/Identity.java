...
public final class Identity {
  ...
  public static final String RESOURCE_NAME = "Identity";
  
  // Names of the JSON attributes
  private final String JSON_ATTR_IDENTITY = "identity";
  private final String JSON_ATTR_ACC      = "accounts";
  ...
  public Identity(String identity, List<Account> accounts) {
    // ensure inheritance
    super();
   ...
   */
  public Identity identity(final String value) {
    this.identity = value;
    return this;
  }
   ...
   **                            Possible object is <code>Entitlement</code>.
   */
  public Identity accounts(final List<Account> value) {
    this.accounts = value;
    return this;
  }
  ...
  public String toString() {
    ...
    result.append("\" accounts=\"").append(this.accounts);
    result.append("\"");
