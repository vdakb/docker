...
public class AsserterConfiguration extends    BearerAsserterConfiguration {
  ...
  private static final long serialVersionUID = -2836263058773298371L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>AssertionConfiguration</code> that use the
   ** <code>uidresource</code> later for realm that will be sent via the
   ** <code>WWW-Authenticate</code> header.
   ** <br>
   ** <b>Note</b>
   ** <br>
   ** This <code>uidresource</code> <b>does not</b> couple a named identity
   ** store configuration to the authentication mechanism.
   ** <p>
   ** The <code>uidresource</code> its also used to maintain the persisted
   ** configuration.
   ** <br>
