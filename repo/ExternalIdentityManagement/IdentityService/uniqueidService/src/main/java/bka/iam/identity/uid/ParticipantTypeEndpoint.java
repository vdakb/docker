/*
    ...
    File        :   ParticipantTypeEndpoint.java
...
////////////////////////////////////////////////////////////////////////////////
// class ParticipantTypeEndpoint
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The REST service {@link Endpoint} for {@link ParticipantType} transactions.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
@Path(ParticipantTypeEndpoint.PATH)
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public class ParticipantTypeEndpoint extends Endpoint {
  ...
  public static final String PATH = "participantType";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>ParticipantTypeEndpoint</code> allows use as a
   ** JavaBean.
   ** <br>
   ...
   ** Default Constructor
   */
  public ParticipantTypeEndpoint() {
    // ensure inheritance
    super();
  }
  ...
  // Method:   list
  /**
   ** Service REST request to retrieve all {@link ParticipantType}s paginated by
   ...
   **
   ** @return                    the collection of {@link ParticipantType}s.
   **                            <br>
  ...
  public Response list(final @Context UriInfo context) {
    try {
      ...
      final SearchResult<ParticipantType> result   = this.facade.list(request);
      ...
      final JsonObject                    response = Schema.participantType(trimmer, request.start() + 1, result);
  ...
  // Method:   lookup
  /**
   ** REST service request to retrieve a certain {@link ParticipantType} by its
   ** <code>id</code>.
   ** <p>
   ** If the principal isn't equiped with the role <code>administrator</code>
   ** this method responed with a {@link ForbiddenException}.
   **
   ** @param  id                 the identifier of the {@link ParticipantType} to
   **                            lookup.
   **                            <br>
   ...
   **                              for a participant type identifier have been
   **                              violated.
  ...
  public Response lookup(final @PathParam("id") String id, final @Context UriInfo context)
    ...
    // prevent bogus input
    SurrogateSchema.validateParticipantType(id);

    final ParticipantType subject = this.facade.lookup(id);
    if (subject == null)
      throw notFound(ParticipantType.NAME, id);
  ...
  // Method:   create
  /**
   ** REST service request to create a certain {@link ParticipantType} using
   ** POST.
   ** <p>
   ** If the principal isn't equiped with the role <code>administrator</code>
   ** this method responed with a {@link ForbiddenException}.
   ...
   **                                    rules for a participant type identifier
   **                                    have been violated.
  ...
  public Response create(final JsonObject resource, final @Context UriInfo context)
    ...
    final ParticipantType entity = Schema.participantType(resource);
    // prevent bogus input
    SurrogateSchema.validate(entity);

    if (this.facade.lookup(entity.getId()) != null)
      throw conflict(ParticipantType.NAME, entity.getId());
  ...
  // Method:   modify
  /**
   ** REST service request to modify a certain {@link ParticipantType} using
   ** PUT.
   ** <p>
   ** If the principal isn't equiped with the role <code>administrator</code>
   ** this method responed with a {@link ForbiddenException}.
   **
   ** @param  id                 the identifier of the {@link ParticipantType}
   **                            to modify.
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  resource           an object that represents the resource to
  ...
  public Response modify(final @PathParam("id") String id, final JsonObject resource, final @Context UriInfo context)
    ...
    final ParticipantType entity = this.facade.lookup(id);
    if (entity == null)
      throw notFound(ParticipantType.NAME, id);
    ...
    return Response
      ...
      .entity(
         trimmer.convert(
           this.facade.modify(
             Schema.participantType(entity, resource)
           )
         )
       )
      .build()
  ...
  // Method:   delete
  /**
   ** REST service request to delete a certain {@link ParticipantType} using
   ** DELETE.
   ** <p>
   ** If the principal isn't equiped with the role <code>administrator</code>
   ** this method responed with a {@link ForbiddenException}.
