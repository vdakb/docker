...
// ~~~~~ ~~~~~~~~
/**
 ** The <code>TriState</code> converts a {@link Boolean} object to its boolean
...
public class TriState implements Converter
                      ,          Serializable {
  ...
  // compatible with
  @SuppressWarnings("compatibility:5392640160961186224")
  private static final long serialVersionUID = 6796554933236455422L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>TriState</code> that allows use as a JavaBean.
   ** <br>
