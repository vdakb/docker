...
// ~~~~~ ~~~~~~
/**
 ** The <code>Locale</code> converts a {@link Language} object to its string
...
public class Locale implements Converter
                    ,          Serializable {
  ...
  // compatible with
  @SuppressWarnings("compatibility:1184552269795804993")
  private static final long serialVersionUID = -6291075090621825120L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Locale</code> that allows use as a JavaBean.
   ** <br>
  ...
  public Object getAsObject(final FacesContext context, final UIComponent component, final String value) {
    if (value != null && value.trim().length() > 0) {
      try {
        return this.domain.getLocaleMapping().get(Integer.parseInt(value));
      }
      catch (NumberFormatException e) {
        throw new ConverterException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Conversion Error", "Not a valid language."));
      }
    }
    else {
      return null;
  ...
  public String getAsString(final FacesContext context, final UIComponent component, final Object value) {
    return (value instanceof Language) ? (value != null) ? String.valueOf(((Language)value).getCode()) : null : null;
  }
}