...
// ~~~~~ ~~~~~
/**
 ** The <code>State</code> converts an {@link Boolean} object to its string
...
public class State implements Converter
                   ,          Serializable {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-1301029698733630865")
  private static final long serialVersionUID = 7503750688485147547L;
  ...
  public Object getAsObject(final FacesContext context, final UIComponent component, final String value) {
    if (value != null && value.trim().length() > 0) {
      try {
        return this.domain.getActiveMapping().get(Boolean.valueOf(value));
      }
      catch (NumberFormatException e) {
        throw new ConverterException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Conversion Error", "Not a valid state."));
      }
    }
    else {
      return null;
  ...
  public String getAsString(final FacesContext context, final UIComponent component, final Object value) {
    return (value instanceof Boolean) ? (value != null) ? String.valueOf(((Active)value).getState()) : null : null;
  }
}