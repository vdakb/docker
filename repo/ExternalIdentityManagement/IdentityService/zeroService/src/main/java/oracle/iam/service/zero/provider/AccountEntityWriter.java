...
public class AccountEntityWriter implements MessageBodyWriter<AccountEntity> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>AccountEntityWriter</code> allows use as a JavaBean.
   ** <br>
   ** Zero argument constructor required by the framework.
   ** <br>
   ** Default Constructor
   */
  public AccountEntityWriter() {
    // ensure inheritance
    super();
  }
   ...
   */
  @Override
  public long getSize(final AccountEntity object, final Class<?> type, final Type generic, final Annotation[] annotation, final MediaType mediaType) {
   ...
   */
  @Override
  public void writeTo(final AccountEntity entity, final Class<?> type, final Type generic, final Annotation[] annotation, final MediaType mediaType, final MultivaluedMap<String, Object> header, final OutputStream stream) {
    Schema.marshalAccount(entity, stream);
  }
}