...
public class PolicyEntityReader implements MessageBodyReader<PolicyEntity> {
   ...
   */
  @Override
  public PolicyEntity readFrom(final Class<PolicyEntity> type, final Type generic, final Annotation[] annotation, final MediaType mediaType, final MultivaluedMap<String,String> header, final InputStream stream)
    throws IOException
    ,      WebApplicationException {
    try {
      return Schema.unmarshalPolicy(stream);
    } catch (NullPointerException e) {
      System.out.println("PolicyEntityReader#readFrom(): Exception caught: " + e.getMessage());
