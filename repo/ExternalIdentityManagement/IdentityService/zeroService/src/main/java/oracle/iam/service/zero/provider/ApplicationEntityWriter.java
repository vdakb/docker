/*
    ...
    File        :   ApplicationEntityWriter.java
...
public class ApplicationEntityWriter implements MessageBodyWriter<ApplicationEntity> {
   ...
   ** Default Constructor
   */
  public ApplicationEntityWriter() {
    // ensure inheritance
    super();
  }
  ...
  public boolean isWriteable(final Class<?> type, final Type generic, final Annotation[] annotation, final MediaType mediaType) {
    return type.equals(ApplicationEntity.class) && mediaType.toString().equals(MediaType.APPLICATION_JSON);
  }
   ...
   */
  @Override
  public long getSize(final ApplicationEntity object, final Class<?> type, final Type generic, final Annotation[] annotation, final MediaType mediaType) {
    return -1;
  }
   ...
   */
  @Override
  public void writeTo(final ApplicationEntity entity, final Class<?> type, final Type generic, final Annotation[] annotation, final MediaType mediaType, final MultivaluedMap<String, Object> header, final OutputStream stream) {
    Schema.marshalApplication(entity, stream);
  }
}