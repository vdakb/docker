var application_Module_Factory = function () {
  var application = {
    name: 'application',
...
if (typeof define === 'function' && define.amd) {
  define([], application_Module_Factory);
}
else {
  var application_Module = application_Module_Factory();
  if (typeof module !== 'undefined' && module.exports) {
    module.exports.application = application_Module.application;
  }
  else {
    var application = application_Module.application;
  }
}