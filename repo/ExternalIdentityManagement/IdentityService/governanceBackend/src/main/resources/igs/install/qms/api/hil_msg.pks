-- D:\Project\Bundeskriminalamt12c\ExternalIdentityManagement\IdentityService\identityIdentifier\src\main\resources\dbs\qms\api\hil_msg.pks
--
-- Generated for Oracle 10g on Tue Mar 30 08:58:19 2010 by Server Generator 10.1.2.93.10

PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PROMPT Creating API Package Specification 'hil$message'
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
CREATE or REPLACE PACKAGE hil$message
AS
  TYPE hil$row_type IS RECORD (
    code             VARCHAR2   (15)
  , severity         VARCHAR2    (1)
  ...
  TYPE hil$table_type IS TABLE OF hil$row_type
    INDEX BY BINARY_INTEGER;

  TYPE hil$ind_type IS TABLE OF VARCHAR2(15)
    INDEX BY BINARY_INTEGER;
