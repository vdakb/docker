-- D:\Project\Bundeskriminalamt12c\ExternalIdentityManagement\IdentityService\identityIdentifier\src\main\resources\dbs\qms\api\qms_spf.pkb
--
-- Generated for Oracle 10g on Tue Mar 30 08:58:19 2010 by Server Generator 10.1.2.93.10

PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PROMPT Creating API Package Implementation 'qms$preference'
PROMPT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
IS
  ...
  CURSOR c_value(p_group IN VARCHAR2, p_name  IN VARCHAR2)
  IS
    SELECT tag_value
...
BEGIN
  ...
  ELSE
    ...
    LOOP
      ...
      END IF;
      --
      l_tag_start_pos := INSTR(l_value, EVAL_START);
      ...
      ELSE
        ...
        l_tag_end_pos   := INSTR(l_value, EVAL_STOP);
