...
// ~~~~~ ~~~~~~
/**
 ** The <code>Active</code> status virtual resources.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
@Entity(name=Active.NAME)
...
public class Active implements Serializable
  ...
  // compatible with
  @SuppressWarnings("compatibility:-809773379558987420")
  private static final long  serialVersionUID = -4422051624920550668L;
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>Active</code> virtual resource that allows use
   ** as a JavaBean.
   ** <br>
  ...
  // Method:   Ctor
  /**
   ** Constructs a virtual <code>Active</code> datbase resource with the
   ** properties specified.
   **
   ** @param  state              the <code>state</code> property of the
   **                            <code>Active</code> to set.
   **                            <br>
   **                            Allowed object is {@link Boolean}.
   ** @param  name               the name for the <code>state</code>
   **                            property for the <code>Active</code>.
   **                            <br>
   **                            Allowed object is {@link String}.
   */
  public Active(final Boolean state, final String name) {
    // ensure inheritance
    super();
  ...
  // Method:   setState
  /**
   ** Sets the <code>state</code> property of the <code>Active</code>.
   **
   ...
   **                            Allowed object is {@link Boolean}.
   */
  public final void setState(final Boolean value) {
    this.state = value;
  }
  ...
  // Method:   getState
  /**
   ** Returns the <code>state</code> property of the <code>Active</code>.
   **
  ...
  // Method:   setName
  /**
   ** Sets the <code>name</code> property of the <code>Active</code>.
   **
  ...
  // Method:   getName
  /**
   ** Returns the <code>name</code> property of the <code>Active</code>.
   **
   ...
   */
  @Override
  public final int compareTo(final Active other) {
   ...
   ** <p>
   ** Two <code>Active</code>s are considered equal if and only if they
   ** represent the same properties. As a consequence, two given
   ** <code>Active</code>s may be different even though they contain the same
  ...
  public boolean equals(final Object other) {
    ...
    final Active that = (Active)other;
