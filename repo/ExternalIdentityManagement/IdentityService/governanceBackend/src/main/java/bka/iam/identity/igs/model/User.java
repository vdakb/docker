 ...
 ** <b>Important</b>:
 ** <br>
 ** <i>CascadeType.REMOVE</i> applied at the collection of {@link Role}s is the
 ** way to delete or child entity or entities whenever the deletion of the
 ** <code>User</code> itself happens. More important is to annotate the
...
public class User extends Base<Long> {
  ...
  // compatible with
  @SuppressWarnings("compatibility:7053375107979925425")
  private static final long  serialVersionUID = -6380087672062263418L;
  ...
  @OneToMany(mappedBy="user", fetch=FetchType.LAZY, orphanRemoval=true, cascade={CascadeType.REMOVE, CascadeType.PERSIST})
  ...
  // ~~~~~ ~~~~~~~~~~
  /**
   ** The <code>UserPreference</code> database resources.
   ** <p>
   ** <b>Important</b>:
   ** <br>
   ** The relation declared to {@link User} must not be annotated with any
   ** <i>CascadeType</i> or <i>orphanRemoval</i>.
   ** <p>
   ** <b>Important</b>:
   ** <br>
   ** The counterpart of the relation declared in {@link User} must be annotated
   ** with <i>CascadeType.REMOVE</i> and <i>orphanRemoval=true</i>. That's the
   ** only way to delete orphaned entities from the persistence layer. An entity
   ** that is no longer attached to its parent is the definition of being an
   ** orphan.
   */ 
  public static class Preference implements Serializable {
    ...
    @SuppressWarnings("compatibility:-1481171876369416954")
    private static final long serialVersionUID = 732592925430869453L;

    ////////////////////////////////////////////////////////////////////////////
    // instance attributes
    ////////////////////////////////////////////////////////////////////////////
    
    protected boolean         sidebarCollapse  = false;
    ...
    // Method: Ctor
    /**
     ** Constructs an empty <code>Preference</code> database resource that
    ...
    ////////////////////////////////////////////////////////////////////////////
    // Method: setSidebasrCollapse
    /**
     ** Sets the <code>sidebarCollapse</code> preference of the
     ** {@link User}.
     **
     ** @param  value            the <code>sidebarCollapse</code> preference of
     **                          the {@link User} to set.
     **                          <br>
     **                          Allowed object is <code>boolean</code>.
     */
    public void setSidebasrCollapse(final boolean value) {
      this.sidebarCollapse = value;
    }
    
    ////////////////////////////////////////////////////////////////////////////
    // Method: getSidebasrCollapse
    /**
     ** Returns the <code>sidebarCollapse</code> preference of the
     ** {@link User}.
     **
     ** @return                  the <code>sidebarCollapse</code> preference of
     **                          the {@link User} to set.
     **                          <br>
     **                          Possible object is <code>boolean</code>.
     */
    public boolean getSidebasrCollapse() {
   ...
   **                            {@link UserRole}.
   */
  public final void setRole(final List<UserRole> value) {
    this.role = value;
  }
   ...
   ** <p>
   ** This accessor method returns a reference to the live {@link Preference},
   ** not a snapshot. Therefore any modification you make to the returned object
   ** will be present inside the JPA entity.
   **
