...
public class AsserterConfiguration extends BearerAsserterConfiguration {
  ...
  private static final long serialVersionUID = -5557804332400158670L;
   ...
   ** <code>scimservice</code> later for realm that will be sent via the
   ** <code>WWW-Authenticate</code> header.
   ** <br>
   ** <b>Note</b>
   ** <br>
   ** This <code>scimservice</code> <b>does not</b> couple a named identity
   ** store configuration to the authentication mechanism.
   ** <p>
   ** The <code>scimservice</code> its also used to maintain the persisted
   ** configuration.
   ** <br>
