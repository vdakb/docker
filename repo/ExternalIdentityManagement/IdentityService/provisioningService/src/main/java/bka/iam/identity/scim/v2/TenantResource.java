 ...
 ** tenants that belong to, or act on behalf of a business or enterprise.
 ** <br>
 ** The core schema for <code>TenantResource</code> is identified using the URI
 ** <code>urn:ietf:params:scim:schemas:extension:p20:1.0:Tenant</code>
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
@JsonPropertyOrder({TenantResource.PRIMARY, TenantResource.UNIQUE, TenantResource.STATUS, TenantResource.Role.PREFIX, Resource.METADATA})
public final class TenantResource implements Resource<TenantResource> {
  ...
  @JsonIgnore(true)
  public static final String SCHEMA  = "urn:ietf:params:scim:schemas:extension:p20:1.0:Tenant";
  ...
  @Attribute(description="Unique identifier for a tenant typically used to identify the tenant at the service provider.", required=true, caseExact=true, mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.SERVER)
  ...
  @Attribute(description="A human-readable name for a Tenant.", required=true, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
   ...
   */
  @JsonPropertyOrder({"type", "value", "scope", "display", "$ref"})
  public static final class Role {
    ...
    @Attribute(description="The identifier of the resource in the tenant's claim.", required=true, caseExact=false, mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
    private Long   value;
    ...
    @Attribute(description="The scope a resource claims in the tenant.", required=true, caseExact=false, returned=Returned.DEFAULT)
    ...
    @JsonProperty("$ref")
    @Attribute(description="The URI of the resource in the tenant's claim.", required=false, reference={ "Tenant", "Claim" }, mutability=Mutability.IMMUTABLE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
    private URI    ref;
    ...
    // Method: scope
    /**
     ** Sets the scope a member resource claims in a tenant.
     **
     ** @param  value            the scope a member resource claims in a tenant.
     **                          <br>
     **                          Allowed object is {@link String}.
     **
     ** @return                  the <code>Role</code> to allow method chaining.
  ...
  // Method:   displayName
  /**
   ** Sets the name of the Tenant, suitable for display to end-users.
   **
   ** @param  value              the name of the Tenant, suitable for display to
   **                            end-users.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
