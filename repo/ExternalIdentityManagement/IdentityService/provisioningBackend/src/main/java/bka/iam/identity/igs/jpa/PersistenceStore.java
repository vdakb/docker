...
package bka.iam.identity.igs.jpa;
...
// ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** A store for entity managers handling transactions belonging to service
 ** administration.
 ** <br>
...
@Startup
@Singleton
public class PersistenceStore extends EntityManagerStore {
  ...
  // compatible with
  @SuppressWarnings("compatibility:8828114510987002296")
  private static final long serialVersionUID = 2311971531768148005L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>PersistenceStore</code> allows use as a JavaBean.
   ** <br>
  ...
  public void startup() {
    ...
    initialize(Persistence.createEntityManagerFactory("igs"));
  }
}