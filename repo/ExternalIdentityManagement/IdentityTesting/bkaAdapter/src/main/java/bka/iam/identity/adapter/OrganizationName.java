 ...
 ** adapter to obtain the name of an <code> Organization</code> by the key
 ** assigned at an <code>Identity</code> profile.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class OrganizationName extends TestCase {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>OrganizationName</code> that allows use as a JavaBean.
   ** <br>
