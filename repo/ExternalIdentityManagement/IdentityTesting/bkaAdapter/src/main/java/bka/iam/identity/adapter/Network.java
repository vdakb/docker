...
public abstract class Network {
  ...
  private static IdentityServer endpoint(final String serverName)
    ...
    final IdentityServerFeature  feature  = IdentityServerFeature.build(CONSOLE);
    final IdentityServerResource resource = IdentityServerResource.build(
      CONSOLE
    , serverName
    , "8005"
    , "weblogic"
    ...
    return IdentityServer.build(CONSOLE, resource, feature);
  }
}
