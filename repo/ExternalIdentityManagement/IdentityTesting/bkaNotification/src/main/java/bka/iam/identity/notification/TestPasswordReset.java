...
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** The test case to send notification about password reset by administrator.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class TestPasswordReset extends TestCase {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String TEMPLATE  = "bka-password-reset";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>TestPasswordReset</code> that allows use as a JavaBean.
   ** <br>
  ...
  public static void main(String[] args) {
    ...
    final TestPasswordReset test = new TestPasswordReset();
    try {
      test.connect();
