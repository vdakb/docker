 ...
 ** @since   1.0.0.0
 */
public class TestPasswordWarning extends TestCase  {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String TEMPLATE  = "bka-password-warning";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>TestPasswordWarning</code> that allows use as a JavaBean.
   ** <br>
  ...
  public static void main(String[] args) {
    ...
    final TestPasswordWarning test = new TestPasswordWarning();
    try {
      test.connect();
