 ...
 ** <code>Identity Governance Services Connector</code> Service Provider.
 **
...
public abstract class Service extends EntityReconciliation {
  ...
  private static final String CATEGORY  = "OCS.IGS.RECONCILIATION";
  ...
  protected void beforeExecution()
    ...
    try {
      ...
      try {
        ...
        resultSet = objectFacade().getReconciliationFields(resultSet.getLongValue(ResourceObject.KEY));
