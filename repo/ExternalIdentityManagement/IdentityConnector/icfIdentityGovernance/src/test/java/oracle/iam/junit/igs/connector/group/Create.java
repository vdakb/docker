...
import oracle.iam.junit.igs.connector.Network;

////////////////////////////////////////////////////////////////////////////////
// class Create
// ~~~~~ ~~~~~~
/**
 ** The test case create operation on groups at the target system leveraging the
...
public class Create extends Base {
  ...
  @Test
  public void execute() {
    Network.CONSOLE.info("group::create::execute");
  }
}