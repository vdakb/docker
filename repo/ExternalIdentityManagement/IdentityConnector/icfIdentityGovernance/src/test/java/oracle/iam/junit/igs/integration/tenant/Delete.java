...
// ~~~~~ ~~~~~~
/**
 ** The test case for delete operation on tenants at the target system
...
public class Delete extends Base {
  ...
  // Method:   deleteT36099
  /**
   ** Test that a particular tenant could be deleted by its primary identifier.
   */
  @Test
  public void deleteT36099() {
    try {
      facade(service()).delete(ExtensionClass.TENANT, new Uid("T-36-0-99"), null);
    }
