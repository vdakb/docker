...
import oracle.iam.junit.igs.connector.account.Search;
import oracle.iam.junit.igs.connector.account.Lookup;
import oracle.iam.junit.igs.connector.account.Create;
import oracle.iam.junit.igs.connector.account.Modify;
import oracle.iam.junit.igs.connector.account.Delete;
 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({Search.class,Lookup.class,Create.class,Modify.class,Delete.class})
