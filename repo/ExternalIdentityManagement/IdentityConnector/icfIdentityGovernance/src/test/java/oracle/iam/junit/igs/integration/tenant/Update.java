...
public class Update extends Base {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Update</code> that allows use as a JavaBean.
   ** <br>
  ...
  public static void main(final String[] args) {
    final String[] parameter = {Update.class.getName()};
   ...
   */
  @Test
  public void updateT36099() {
    final Uid            identifier = new Uid("T-36-0-99");
    final Set<Attribute> payload = CollectionUtility.set(
      Marshaller.buildAttribute(Name.NAME, "nochmal").build()
    );
    try {
      final Uid uid = facade(service()).update(ExtensionClass.TENANT, identifier, payload, null);
      assertNotNull(uid);
      assertEquals(uid.getUidValue(), "T-36-0-99");
    }
