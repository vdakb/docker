...
public class Assign extends Base {
  ...
  public void assignIGSAdmin() {
    ...
    assignUser("azitterbacke", ObjectClass.GROUP, Pair.of(ObjectClass.GROUP_NAME, "UD_IGS_URL"), data);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   assignUIDAdmin
  /**
   ** Test that a particular role could be modified by its primary identifier.
   */
  @Test
  public void assignUIDAdmin() {
    // the map simulates how Identity Governance provides the data after the
    // adapter task createProcessData applied on the process data
    final Map<String, Object>  data = CollectionUtility.map(
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   assignPIDAdmin
  /**
   ** Test that a particular role could be modified by its primary identifier.
   */
  @Test
  public void assignPIDAdmin() {
    // the map simulates how Identity Governance provides the data after the
    // adapter task createProcessData applied on the process data
    final Map<String, Object>  data = CollectionUtility.map(
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   assignUIDGenerate
  /**
   ** Test that a particular role could be modified by its primary identifier.
   */
  @Test
  public void assignUIDGenerate() {
    // the map simulates how Identity Governance provides the data after the
    // adapter task createProcessData applied on the process data
    final Map<String, Object>  data = CollectionUtility.map(
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   assignUIDRegister
  /**
   ** Test that a particular role could be modified by its primary identifier.
   */
  @Test
  public void assignUIDRegister() {
    // the map simulates how Identity Governance provides the data after the
    // adapter task createProcessData applied on the process data
    final Map<String, Object>  data = CollectionUtility.map(
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   assignNeverUsed
  /**
   ** Test that a particular role could be modified by its primary identifier.
   */
  @Test
  public void assignNeverUsed() {
    // the map simulates how Identity Governance provides the data after the
    // adapter task createProcessData applied on the process data
    final Map<String, Object> data = CollectionUtility.map(
  ...
  public void assignUIDGenerateOnT36099() {
    ...
    assignUser("azitterbacke", ExtensionClass.TENANT, Pair.of(ExtensionClass.TENANT_NAME, "UD_IGS_UTN"), data);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   assignUIDRegisterOnT36099
  /**
   ** Test that a particular tenant could be modified by its primary identifier.
   */
  @Test
  public void assignUIDRegisterOnT36099() {
    // the map simulates how Identity Governance provides the data after the
    // adapter task createProcessData applied on the process data
    final Map<String, Object>  data = CollectionUtility.map(
      "UD_IGS_UTN_UID" , "T-36-0-99"
   ...
   */
  private void assignUser(final String userName, final ObjectClass type, final Pair<String, String> pointer, final Map<String, Object> data) {
    try {
      ...
      facade.addAttributeValues(ObjectClass.ACCOUNT, facade.resolveUsername(ObjectClass.ACCOUNT, userName, null), dataSet, null);
    }
