...
// ~~~~~ ~~~~~~
/**
 ** The test case for delete operation on roles at the target system leveraging
...
public class Delete extends Base {
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   deleteNeverUsed
  /**
   ** Test that a particular role could be deleted by its primary identifier.
   */
  @Test
  public void deleteNeverUsed() {
    try {
      facade(service()).delete(ObjectClass.GROUP, new Uid("never.used"), null);
    }
