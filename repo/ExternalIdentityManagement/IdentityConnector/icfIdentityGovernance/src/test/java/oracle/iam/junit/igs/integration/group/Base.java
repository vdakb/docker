...
// ~~~~~ ~~~~
/**
 ** The base class for CRUD operation on roles at the target system leveraging
...
public class Base extends TestBaseIntegration {
  ...
  public static final File PROVISIONING      = new File("src/test/resources/mds/igs-role-provisioning.xml");
  public static final File RECONCILIATION    = new File("src/test/resources/mds/igs-role-reconciliation.xml");
