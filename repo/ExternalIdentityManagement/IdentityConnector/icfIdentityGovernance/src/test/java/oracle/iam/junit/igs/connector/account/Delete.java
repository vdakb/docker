...
// ~~~~~ ~~~~~~
/**
 ** The test case delete operation on accounts at the target system leveraging the
...
public class Delete extends Base {
  ...
  // Method:   wellknown
  /**
   ** Test delete request for an know entity leveraging Web Access Context.
   */
  @Test
  public void wellknown() {
    assertNotNull(Base.latest);
    try {
      CONTEXT.deleteAccount(Base.latest.id());
    }
