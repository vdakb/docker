...
// ~~~~~ ~~~~~~
/**
 ** The test case for search operation on roles at the target system leveraging
...
public class Search extends Base {
  ...
  public void testSearch() {
    try {
      final Descriptor              mapping   = DescriptorFactory.configure(Descriptor.buildProvisioning(CONSOLE), RECONCILIATION);
      ...
      facade(service()).search(ObjectClass.GROUP, null, new Handler(mapping), option.build());
    }
