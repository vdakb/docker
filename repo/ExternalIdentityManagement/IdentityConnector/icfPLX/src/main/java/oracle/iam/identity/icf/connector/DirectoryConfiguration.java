...
public class DirectoryConfiguration extends AbstractConfiguration {
  ...
  static final String             CATEGORY = "OCS.GDS.CONNECTOR";
  ...
  public final void setDistinguishedName(final String value) {
    if (StringUtility.blank(value)) {
      this.endpoint.distinguishedName().clear();
    } else {
      //this.endpoint.distinguishedName(CollectionUtility.set((String[])value.split("\\|")));
    } 
  }
   ...
   **                            Possible object is {@link String}.
   */
  public final List<String> getDistinguishedName() {
   ...
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=42, operations={CreateOp.class, SearchOp.class}, objectClasses="__GROUP__", displayMessageKey=Connector.Feature.GROUP_CLASS_LABEL, helpMessageKey=Connector.Feature.GROUP_CLASS_HINT)
   ...
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=43, displayMessageKey=Connector.Feature.GROUP_MEMBER_PREFIX_LABEL, helpMessageKey=Connector.Feature.GROUP_MEMBER_PREFIX_HINT)
  ...
  public final String getGroupMemberPrefix() {
    ...
    //////////////////////////////////////////////////////////////////////////////
  // Method:   setProxyClass
  /**
   ** Sets the name of the proxy object class defined for a Directory
   ** Service.
   **
   ** @param  value              the name of the proxy object class.
   **                            <br>
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=44, operations={CreateOp.class, SearchOp.class}, objectClasses="__PROXY__", displayMessageKey=Connector.Feature.GROUP_CLASS_LABEL, helpMessageKey=Connector.Feature.GROUP_CLASS_HINT)
  public final void setProxyClass(final String value) {
    // a value passed in is never null but can be empty hence avoid creation of
    // waste
    if (!StringUtility.blank(value)) {
      this.endpoint.proxyClass(CollectionUtility.set(value.split("\\|")));
    }
  }
  ...
  /**
   ** Returns the name of the proxy object class defined for a Directory
   ** Service.
   **
   ...
   **                            Possible object is {@link String}.
   */
  public final String getProxyClass() {
    return (CollectionUtility.empty(this.endpoint.proxyClass())) ? SystemConstant.EMPTY : this.endpoint.proxyClass().toString();
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   setProxyPrefix
  /**
   ** Sets the prefix of the proxy object class defined for a Directory
   ** Service.
   **
   ** @param  value              the prefix of the proxy object class.
   **                            <br>
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=45, displayMessageKey=Connector.Feature.PROXY_PREFIX_LABEL, helpMessageKey=Connector.Feature.PROXY_PREFIX_HINT)
  public final void setProxyPrefix(final String value) {
    this.endpoint.proxyPrefix(value);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   getProxyPrefix
  /**
   ** Returns the prefix of the proxy object class defined for a Directory
   ** Service.
   **
   ** @return                    the prefix of the proxy object class.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String getProxyPrefix() {
    return this.endpoint.proxyPrefix();
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   setProxyMemberPrefix
  /**
   ** Sets the prefix of the attribute of a membership of an object within a
   ** proxy defined for a Directory Service.
   **
   ** @param  value              the prefix of the attribute of a membership of
   **                            an object within a proxy.
   **                            <br>
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=46, displayMessageKey=Connector.Feature.PROXY_MEMBER_PREFIX_LABEL, helpMessageKey=Connector.Feature.PROXY_MEMBER_PREFIX_HINT)
  public final void setProxyMemberPrefix(final String value) {
    this.endpoint.proxyMember(value);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   getProxyMemberPrefix
  /**
   ** Returns the prefix of the attribute of a membership of an object within a
   ** proxy defined for a Directory Service.
   **
   ...
   **                            Possible object is {@link String}.
   */
  public final String getProxyMemberPrefix() {
    return this.endpoint.proxyMember();
  }
   ...
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=47, operations={CreateOp.class, SearchOp.class}, objectClasses="__ACCOUNT__", displayMessageKey=Connector.Feature.ACCOUNT_CLASS_LABEL, helpMessageKey=Connector.Feature.ACCOUNT_CLASS_HINT)
   ...
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=48, displayMessageKey=Connector.Feature.ACCOUNT_PREFIX_LABEL, helpMessageKey=Connector.Feature.ACCOUNT_PREFIX_HINT)
   ...
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=50, displayMessageKey=Connector.Feature.ACCOUNT_ROLE_PREFIX_LABEL, helpMessageKey=Connector.Feature.ACCOUNT_ROLE_PREFIX_HINT)
  public final void setAccountRolePrefix(final String value) {
    this.endpoint.accountMemberPrefix(value);
  }
  ...
  public final String getAccountRolePrefix() {
    return this.endpoint.accountMemberPrefix();
  }
  
    //////////////////////////////////////////////////////////////////////////////
  // Method:   setAccountMemberPrefix
  /**
   ** Sets the prefix of the account membership attribute defined for a
   ** Directory Service.
   **
   ** @param  value              the prefix of the account membership
   **                            attribute defined for a Directory Service.
   **                            <br>
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=51, displayMessageKey=Connector.Feature.ACCOUNT_MEMBER_PREFIX_LABEL, helpMessageKey=Connector.Feature.ACCOUNT_MEMBER_PREFIX_HINT)
  public final void setAccountMemberPrefix(final String value) {
    this.endpoint.accountMemberPrefix(value);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   getAccountMemberPrefix
  /**
   ** Returns the prefix of the account membership attribute defined for
   ** a Directory Service.
   **
   ** @return                    the prefix of the account membership
   **                            attribute defined for a Directory Service.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String getAccountMemberPrefix() {
    return this.endpoint.accountMemberPrefix();
  }
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   setHomeOrganizationDN
  /**
   ** Set the dn of the home organization for the user in the Directory
   ** Service.
   ** 
   ** @param  value              the prefix of the password credential attribute
   **                            of an object class entry how it might exits in
   ...
   **
   */
  @ConfigurationProperty(order=54, displayMessageKey=Connector.Feature.HOME_ORGANIZATION_DN_LABEL, helpMessageKey=Connector.Feature.HOME_ORGANIZATION_DN_HINT)
  public final void setHomeOrganizationDN(final String value) {
    this.endpoint.homeOrganizationDN(value);
  }
  
  //////////////////////////////////////////////////////////////////////////////
  // Method:   getHomeOrganizationDN
  /**
   ** Returns the dn of the home organization for the user in the Directory
   ** Service.
   ** <p>
   ** This dn must hold the user entry.
   **
   ** @return                    the dn of the home organization for the user in
   **                            the Directory Service.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String getHomeOrganizationDN() {
    return this.endpoint.homeOrganizationDN();
  }
  
  //////////////////////////////////////////////////////////////////////////////
  // Method:   setProxyOrganizationDN
  /**
   ** Set the dn of the home organization for the user in the Directory
   ** Service.
   ** 
   ...
   **
   */
  @ConfigurationProperty(order=55, displayMessageKey=Connector.Feature.PROXY_ORGANIZATION_DN_LABEL, helpMessageKey=Connector.Feature.PROXY_ORGANIZATION_DN_HINT)
  public final void setProxyOrganizationDN(final String value) {
    this.endpoint.proxyOrganizationDN(value);
  }
  
  //////////////////////////////////////////////////////////////////////////////
  // Method:   getProxyOrganizationDN
  /**
   ** Returns the dn of the home organization for the user in the Directory
   ** Service.
   ** <p>
   ...
   **                            Possible object is {@link String}.
   */
  public final String getProxyOrganizationDN() {
    return this.endpoint.proxyOrganizationDN();
  }
