...
public class ConnectorBundle_de extends ListResourceBundle {
  ...
  private static final String[][] CONTENT = {
    { Connector.Bundle.NAME,                             "Directory Account Management Connector" }
  ...
  , { Connector.Endpoint.PRINCIPAL_USERNAME_HINT,        "Admin-Benutzername" }
  , { Connector.Endpoint.PRINCIPAL_PASSWORD_LABEL,       "Kennwort des Benutzers" }
  , { Connector.Endpoint.PRINCIPAL_PASSWORD_HINT,        "Kennwort des Benutzers mit Administratorrechten\n" }
  ...
  , { Connector.Feature.PROXY_PREFIX_LABEL,              "Proxy Object Prefix" }
  , { Connector.Feature.PROXY_PREFIX_HINT,               "Proxy Object Prefix" }
  , { Connector.Feature.PROXY_MEMBER_PREFIX_LABEL,       "Proxy Member Prefix" }
  , { Connector.Feature.PROXY_MEMBER_PREFIX_HINT,        "Proxy Member Prefix" }
  , { Connector.Feature.HOME_ORGANIZATION_DN_HINT,       "Home Organization DN" }
  , { Connector.Feature.HOME_ORGANIZATION_DN_LABEL,      "Home Organization DN" }
  };
