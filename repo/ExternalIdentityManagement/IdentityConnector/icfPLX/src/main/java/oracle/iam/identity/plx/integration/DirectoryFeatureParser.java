...
final class DirectoryFeatureParser extends FeatureParser {
  ...
  public static final String ELEMENT_PROXY_LINK          = "proxy-link";
  ...
  public static final String ATTRIBUTE_HOME_ROOT_DN      = "home-account-dn";
  public static final String ATTRIBUTE_PROXY_ROOT_DN     = "home-proxy-dn";
  ...
  enum Grammar {
    ...
    , PROXY              (new Grammar[]{FEATURE},                                  ELEMENT_PROXY)
    , GROUP              (new Grammar[]{FEATURE},                                  ELEMENT_GROUP)
    , MULTIVALUED        (new Grammar[]{PROXY, GROUP, ACCOUNT},                    ELEMENT_MULTIVALUED)
  ...
  public void startElement(final String uri, final String localName, final String qualifiedName, final Attributes attributes)
    ...
    switch (state) {
      ...
      case SERVER              : processServer(attributes);
                                 break;
      case PROXY               : this.feature.put(Directory.OIM.Feature.PROXY_CLASS,                   attributes.getValue(ATTRIBUTE_OBJECT_CLASS));
                                 this.feature.put(Directory.OIM.Feature.PROXY_PREFIX,                  attributes.getValue(ATTRIBUTE_OBJECT_PREFIX));
                                 this.feature.put(Directory.OIM.Feature.PROXY_MEMBER_PREFIX,           attributes.getValue(ATTRIBUTE_OBJECT_MEMBER));
                                 this.feature.put(Directory.OIM.Feature.HOME_PROXY_DN,                 attributes.getValue(ATTRIBUTE_PROXY_ROOT_DN));
                                 break;
