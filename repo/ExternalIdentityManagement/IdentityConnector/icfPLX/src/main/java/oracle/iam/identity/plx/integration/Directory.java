...
public interface Directory {
   ...
   */
  static final String      GROUP_MEMBER_PREFIX_DEFAULT           = "member";

  /**
   ** Default value of the group objectClass of an entry in a V3 compliant
   ** Directory Service.
   */
  static final String      GROUP_CLASS_DEFAULT                   = "group";
   ...
   ** Directory Service.
   */
  static final String      ACCOUNT_CLASS_DEFAULT                 = "user";

  /**
   ** Default value of the account prefix of an entry in a V3 compliant
   ** Directory Service in a group.
   */
  static final String      ACCOUNT_PREFIX_DEFAULT                = "cn";
  ...
  /**
   ** Default value of the name of the status attribute of an entry in a V3
   ** compliant Directory Service.
   */
  static final String      ENTRY_STATUS_PREFIX_DEFAULT           = "pwdAccountLockedTime";
  
  /**
   ** Default value indicating if connector should run by assigning group
   ** membership bi-directionally.
   */
  static final String      GROUP_MEMBER_MIMIC_AD_DEFAULT         = "false";
  ...
  interface ICF {
    ...
    public interface Feature {
      ...
      */
      ...
      /**
       ** Attribute tag which must be defined on a
       ** <code>Metadata Descriptor</code> to specify the name of the proxy
       ** object class of an entry in the Directory Service.
       */
      static final String PROXY_CLASS                                 = "proxyClass";

      /**
       ** Attribute tag which must be defined on a
       ** <code>Metadata Descriptor</code> to specify the prefix of the proxy
       ** object prefix of an entry in the Directory Service.
       */
      static final String PROXY_PREFIX                                = "proxyPrefix";
       ...
       */
      static final String PROXY_MEMBER_PREFIX                         = "proxyMemberPrefix";
      
      /**
       ** Attribute tag which can be defined on a
       ** <code>Metadata Descriptor</code> to specify the dn of the root
       ** organization where assignable proxy entries must be member of.
       */
      static final String HOME_PROXY_DN                               = "proxyOrganizationDN";
      
      /**
       ** Attribute tag which can be defined on a
       ** <code>Metadata Descriptor</code> to specify the dn of the root
       ** organization DN where every assignable user entries must be a
       ** sub-entry to this DN
       */
      static final String HOME_ORGANIZATION_DN                        = "homeOrganizationDN";
      ...
      /**
       ** Attribute tag which must be defined on a
       ** <code>Metadata Descriptor</code> to specify the prefix of entry
       ** membership of a group or a proxy in a Directory Service.
       */
      static final String ACCOUNT_MEMBER_PREFIX                       = "accountMemberPrefix";
  ...
  interface OIM {
    ...
    interface Feature {
      ...
      */
       ...
       ** object class of an entry in the Directory Service.
       */
      static final String PROXY_CLASS                                  = "proxy-class";
       ...
       ** object prefix of an entry in the Directory Service.
       */
      static final String PROXY_PREFIX                                 = "proxy-prefix";
       ...
       */
      static final String PROXY_MEMBER_PREFIX                          = "proxy-member-prefix";
      
      /**
       ** Attribute tag which can be defined on a
       ** <code>Metadata Descriptor</code> to specify the dn of the root
       ** organization where every assignable proxy entries in the home
       ** organization must be member of.
       */
      static final String HOME_PROXY_DN                                = "home-proxy-dn";
      
      /**
       ** Attribute tag which can be defined on a
       ** <code>Metadata Descriptor</code> to specify the dn of the root
       ** entry where every assignable user entries must be a sub-entry to this
       ** DN.
       */
      static final String HOME_ORGANIZATION_DN                         = "home-account-dn";
       ...
       ** Attribute tag which must be defined on a
       ** <code>Metadata Descriptor</code> to specify the prefix of the object
       ** account membership of an entry in Directory Service.
       */
      static final String ACCOUNT_MEMBER_PREFIX                       = "account-member-prefix";
  ...
  , OIM.Feature.ACCOUNT_CLASS
  , OIM.Feature.ACCOUNT_PREFIX 
  , OIM.Feature.ACCOUNT_MEMBER_PREFIX
    
  , OIM.Feature.GROUP_CLASS
  , OIM.Feature.GROUP_PREFIX
  , OIM.Feature.GROUP_MEMBER_PREFIX
    
  , OIM.Feature.PROXY_CLASS
  , OIM.Feature.PROXY_PREFIX
  , OIM.Feature.PROXY_MEMBER_PREFIX
  , OIM.Feature.HOME_PROXY_DN
  , OIM.Feature.HOME_ORGANIZATION_DN
  );
  ...
  static final Map<String, String> FEATURE =
    new HashMap<String, String>() { {
      ...
      put(ICF.Feature.PROXY_CLASS,               OIM.Feature.PROXY_CLASS);
      put(ICF.Feature.PROXY_PREFIX,              OIM.Feature.PROXY_PREFIX);
      put(ICF.Feature.PROXY_MEMBER_PREFIX,       OIM.Feature.PROXY_MEMBER_PREFIX);
      put(ICF.Feature.HOME_PROXY_DN,             OIM.Feature.HOME_PROXY_DN);
      ...
      put(ICF.Feature.ACCOUNT_MEMBER_PREFIX,     OIM.Feature.ACCOUNT_MEMBER_PREFIX);
      ...
      put(ICF.Feature.HOME_ORGANIZATION_DN,      OIM.Feature.HOME_ORGANIZATION_DN);
    }
  };
