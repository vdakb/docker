...
//  private Set<String>                binary                     = CollectionUtility.caseInsensitiveSet(CollectionUtility.set("audio","authorityRevocationList","caCertificate","certificateRevocationList","crossCertificatePair","deltaRevocationList","jpegPhoto","personalSignature","photo","supportedAlgorithms","thumbnailLogo","thumbnailPhoto","userCertificate","userPassword","x500UniqueIdentifier"));
   ...
   */
  private Set<String>               distinguishedName               = CollectionUtility.set("password");
  
  private String                    distinguishedNameAttribute      = "distinguishedName";
  /**
   ** Attribute tag which must be defined on a <code>Metadata Descriptor</code>
  ...
  /**
  ** Attribute tag which can be defined on a
  ** <code>Metadata Descriptor</code>. This attribute change the behavior
  ** of the connector by assigning group bi-directionally as AD.
  */
  private String                     groupMemberMimicAD         = "false";
  
  /**
  ** Attribute tag which can be defined on a
  ** <code>Metadata Descriptor</code>. This attribute define the entry
  ** where the every root organization belong to. 
  */
  private String                     rootOrganizationContext     = null;
  /**
   ** Attribute tag which may be defined on a <code>Metadata Descriptor</code>
   ...
   ** compliant Directory Service.
   */
  private Schema                     proxyEntity                 = new Schema("cn", CollectionUtility.set("group"), "member", "memberOf");
  /**
   ** Attribute tag which may be defined on a <code>Metadata Descriptor</code>
   ** to specify the name of the role object class of an entry in a V3
   ** compliant Directory Service.
   */
  private Schema                     groupEntity                = new Schema("cn", CollectionUtility.set("group"), "member", "memberOf");
  /**
   ** Attribute tag which may be defined on a <code>Metadata Descriptor</code>
  ...
  /**
   ** Attribute tag which may be defined on a <code>Metadata Descriptor</code>
   ** to specify the name of the organization object class of an entry compliant
   ** Active Directory Server.
   ** <p>
   ** The standard object class name of a Directory Service V3 account is
   ** <code>organization</code> with the <code>ou</code> as the prefix.
   */
  private Entry                      organizationalUnitPEntity  = new Entry("ou", CollectionUtility.set("organizationalUnitP"), null, null);
  /**
   ** Attribute tag which may be defined on a <code>Metadata Descriptor</code>
   ...
   */
  private Bind                       accountEntity              = new Bind("cn", CollectionUtility.set("user"), "memberOf", "memberOf","userPassword", false);
  
  /**
   ** Attribute tag which must be defined on a <code>Metadata Descriptor</code>
   ** to specify the dn of the home organization where the user entries belong
   ** to.
   */
  private String                     homeOrganizationDN         = "cn=???";
  
  /**
   ** Attribute tag which must be defined on a <code>Metadata Descriptor</code>
   ** to specify the dn of the proxy organization.
   */
  private String                     proxyOrganizationDN         = "cn=???";
  ...
  public static class Schema {
     ...
     ** Schema.
     */
    protected String      memberOf     = null;
    /**
     ...
     **                          exits in the connected Directory Service
     **                          Schema.
     ** @paramm  memberOf        the name of the 'linking attribute' form one
     **                          object class entry to another one how it might
     **                          exits in the connected Active Directory Service
     **                          Schema.
     **                          <br>
     **                          Allowed object is {@link String}.
     */
    private Schema(final String prefix, final Set<String> clazz, final String member, final String memberOf) {
      // ensure inheritance
      super();
  ...
  private class Entry extends Schema {
    ...
    /**
     ** the name of the 'linking attribute' of a member of an object class entry
     ** to an account class how it might exits in the connected Directory
     ** Service Schema.
     */
    protected String account  = null;
    /**
     ** the name of the 'linking attribute' of a member object class entry to
     ** a proxy permission class how it might exits in the connected Directory
     ** Service Schema.
     */
     ...
     **                          Allowed object is {@link Set} where each
     **                          element is of type {@link String}.
     ** @param   proxy           the name of the 'linking attribute' of a member
     **                          object class entry to a proxy permission class
     ...
     **                          Allowed object is {@link String}.
     */
    private Entry(final String prefix, final Set<String> clazz, final String proxy, final String group) {
      // ensure inheritance
      super(prefix, clazz);
   ...
   ** in a connected Directory Service.
   */
  private class Bind extends Entry {
  ...
  public final Schema schemaSupport(final ObjectClass type) {
    if (DirectorySchema.ANY.equals(type))
      ...
      return groupEntity;
    else if (DirectorySchema.PROXY.equals(type))
      return proxyEntity;
    ...
    else if (DirectorySchema.ORGANIZATIONAL_UNIT_P.equals(type))
      return organizationalUnitPEntity;
   ...
   **                            <code>DirectoryEndpoint</code>.
   */
  public final DirectoryEndpoint distinguishedName(final List<String> value) {
   ...
   **                            Possible object is {@link String}.
   */
  public final List<String> distinguishedName() {
    List<String> value = new ArrayList<String>();
    value.addAll(this.distinguishedName);
    return value;
  }
  ...
  /**
   ** Sets the dn of the home organization where the user entry must be a
   ** sub-entry of this dn in the Directory Service.
   **
   ** @param  value              the dn of the home organization
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ** @return                    the <code>DirectoryEndpoint</code> to allow
   ...
   **                            <code>DirectoryEndpoint</code>.
   */
  public final DirectoryEndpoint homeOrganizationDN(final String value) {
    this.homeOrganizationDN = value;
    return this;
  }
  ...
  // Method:   homeOrganizationDN
  /**
   ** Returns the dn of the home organization where the user entry must be a
   ** sub-entry of this dn in the Directory Service.
   **
  ...
  public final String homeOrganizationDN() {
    return this.homeOrganizationDN;
  }
  
  //////////////////////////////////////////////////////////////////////////////
  // Method:   proxyOrganizationDN
  /**
   ** Returns the dn of the proxy organization where the proxy entry must be a
   ** a member of any sub-entry of this dn in the Directory Service.
   **
   ** @return                    the dn of the proxy organization.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String proxyOrganizationDN() {
    return this.proxyOrganizationDN;
  }
  
  //////////////////////////////////////////////////////////////////////////////
  // Method:   proxyOrganizationDN
  /**
   ** Sets the dn of the proxy organization where every assignable proxy entries
   ** in the home organization must be member of.
   **
   ** @param  value              the dn of the proxy organization where every
   **                            assignable proxy entries in the home
   **                            organization must be member of 
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ** @return                    the <code>DirectoryEndpoint</code> to allow
   ...
   **                            <code>DirectoryEndpoint</code>.
   */
  public final DirectoryEndpoint proxyOrganizationDN(final String value) {
    this.proxyOrganizationDN = value;
    return this;
  }
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   distinguishedNameAttr
  /**
   ** Returns the name of the distinguished name attribute of an entry in
   ** a V3 compliant Directory Service.
   **
   ** @return                    the name of the distinguished name attribute
   **                            of an entry in a V3 compliant Directory
   **                            Service.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String distinguishedNameAttr() {
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   rootOrganisationContext
  /**
   ** Returns the DN of the root organization context.
   **
   ** @return                    the name of the any object prefix.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String rootOrganisationContext() {
    return this.rootOrganizationContext;
  }
  
  //////////////////////////////////////////////////////////////////////////////
  // Method:   rootOrganisationContext
  /**
   ** Sets the DN of the root Organization Context.
   **
   ** @param  value              the DN of the root Organization Context.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ** @return                    the <code>DirectoryEndpoint</code> to allow
   ...
   **                            <code>DirectoryEndpoint</code>.
   */
  public final DirectoryEndpoint rootOrganisationContext(final String value) {
    this.rootOrganizationContext = value;
    return this;
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   groupMemberMimicAD
  /**
   ** Returns the boolean value which define if the connector must fill 
   ** groups membership bidirectionally. If the value is set to true then an
   ** object assigned to a group contains the dn of this object thought the
   ** attribut memberof but the group also contains the dn of the object in the
   ** attribute member.
   **
   ** @return                    the boolean value which define if the connector
   **                            must fulfil groups membership bidirectionally
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String groupMemberMimicAD() {
    return this.groupMemberMimicAD;
  }
  ...
  public final String groupMember() {
    ...
    //////////////////////////////////////////////////////////////////////////////
  // Method:   groupMemberOf
  /**
   ** Sets the name of the attribute prefix of a membership of a group by an
   ** object for a Active Directory Service.
   **
   ** @param  value              the name of the attribute prefix of a
   **                            membership of a group by an object for a 
   **                            Directory Service.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ...
   **                            <code>DirectoryEndpoint</code>.
   */
  public final DirectoryEndpoint groupMemberOf(final String value) {
    this.groupEntity.memberOf = value;
    return this;
  }
  ...
  // Method:   proxyClass
  /**
   ** Sets the collection of names of the proxy object classes that need to be
   ** set for en entry if its created in the connected Directory Service.
   **
   ** @param  value              the collection of names of the proxy object
   **                            classes that need to be set for en entry if its
   **                            created in the connected Directory Service.
   **                            <br>
   **                            Allowed object is {@link Set} where each
   ...
   **                            <code>DirectoryEndpoint</code>.
   */
  public final DirectoryEndpoint proxyClass(final Set<String> value) {
    this.proxyEntity.clazz = value;
    return this;
  }
  ...
  // Method:   proxyClass
  /**
   ** Returns the collection of names of the proxy object classes that need to
   ** be set for en entry if its created in the connected Directory Service.
   **
   ** @return                    the collection of names of the proxy object
   **                            classes that need to be set for en entry if its
   **                            created in the connected Directory Service.
   **                            <br>
   **                            Possible object is {@link Set} where each
   **                            element is of type {@link String}.
   */
  public final Set<String> proxyClass() {
    return this.proxyEntity.clazz;
  }
   ...
   **                            <code>DirectoryEndpoint</code>.
   */
  public final DirectoryEndpoint proxyPrefix(final String value) {
    this.proxyEntity.prefix = value;
    return this;
  }
  ...
  public final String proxyPrefix() {
    return this.proxyEntity.prefix;
  }
  ...
  /**
   ** Sets the name of the attribute prefix of a membership of an object within
   ** a proxy defined for a Directory Service.
   **
   ** @param  value              the name of the attribute prefix of a
   **                            membership of an object within a proxy defined
   **                            for a Directory Service.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ...
   **                            <code>DirectoryEndpoint</code>.
   */
  public final DirectoryEndpoint proxyMember(final String value) {
    this.proxyEntity.member = value;
    return this;
  }
  ...
  /**
   ** Returns the name of the attribute prefix of a membership of an object
   ** within a proxy defined for a Directory Service.
   **
   ** @return                    the name of the attribute prefix of a
   **                            membership of an object within a proxy defined
   **                            for a Directory Service.
   ...
   **                            Possible object is {@link String}.
   */
  public final String proxyMember() {
    return this.proxyEntity.member;
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   groupMemberOf
  /**
   ** Returns the name of the attribute prefix of a membership of a group by an
   ** object for a Active Directory Service.
   **
   ** @return                    the name of the attribute prefix of a
   **                            membership of a group by an object for a 
   ...
   **                            Possible object is {@link String}.
   */
  public final String groupMemberOf() {
    return this.groupEntity.memberOf;
  }
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   organizationalUnitClassP
  /**
   ** Returns the collection of names of the organizationalUnitP object classes
   ** that need to be set for en entry if its created in the connected Directory
   ** Service.
   **
   ** @return                    the collection of names of the
   **                            organizationalUnitP object classes that need to
   **                            be set for en entry if its created in the
   **                            connected Directory Service.
   **                            <br>
   **                            Possible object is {@link Set} where each
   **                            element is of type {@link String}.
   */
  public final Set<String> organizationalUnitPClass() {
    return this.organizationalUnitPEntity.clazz;
  }
  
      //////////////////////////////////////////////////////////////////////////////
  // Method:   organizationalUnitPrefixP
  /**
   ** Sets the name of the organizationalUnit object prefix defined for a
   ** Active Directory Service.
   **
   ** @param  value              the name of the organizationalUnitP object
   **                            prefix. <br>
   **                            Allowed object is {@link String}.
   **
   ** @return                    the <code>DirectoryEndpoint</code> to allow
   ...
   **                            <code>DirectoryEndpoint</code>.
   */
  public final DirectoryEndpoint organizationalUnitPPrefix(final String value) {
  ...
  // Method:   organizationalUnitPrefixP
  /**
   ** Returns the name of the organizationalUnitP object prefix defined for a
   ** Active Directory Service.
   **
   ** @return                    the name of the organizationalUnitP object
   **                            prefix.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String organizationalUnitPPrefix() {
    return this.organizationalUnitPEntity.prefix;
  }
   ...
   **                            <code>DirectoryEndpoint</code>.
   */
  public final DirectoryEndpoint accountMemberPrefix(final String value) {
    this.accountEntity.account = value;
    return this;
  }
  ...
  public final String accountMemberPrefix() {
    return this.accountEntity.account;
  }
  ...
  public String entryPrefix(final ObjectClass type) {
    if (DirectorySchema.ANY.equals(type))
      ...
      return organizationalUnitPPrefix();
    else if (DirectorySchema.DOMAIN.equals(type))
      return domainPrefix();
    else if (DirectorySchema.COUNTRY.equals(type))
  ...
  public Set<String> objectClass(final ObjectClass type) {
    if (DirectorySchema.ANY.equals(type))
      ...
      return organizationalUnitPClass();
    else if (DirectorySchema.DOMAIN.equals(type))
      return domainClass();
    else if (DirectorySchema.LOCALITY.equals(type))
...
//      throw ConnectorException.wrap(e);
  ...
  public final void modify(final DirectoryName entryDN, final BasicAttributes attribute, final int operation)
    ...
    // failed, such as where resolution last proceeded to.
      ...
      throw DirectoryException.abort(e);
    }
    finally {
      disconnect();
      trace(method, Loggable.METHOD_EXIT);
