...
public class DirectorySchema extends DirectoryOperation {
  ...
  public static final ObjectClass  PROXY                     = new ObjectClass(SchemaUtility.createSpecialName("PROXY"));
  ...
  /** the object class for an organizational uit */
  public static final ObjectClass  ORGANIZATIONAL_UNIT_P     = new ObjectClass(SchemaUtility.createSpecialName("ORGANIZATIONALUNITP"));
  ...
  public static final class Static extends DirectorySchema {
    ...
    private void types() {
      ...
      this.structuralClasses.add("group");
    ...
    private void optionalAttributes() {
      ...
      this.optionalAttributes.put("group",                    CollectionUtility.set("cn", "distinguishedName", "member", "memberOf", "name"));
