...
public interface DirectoryError {
  ...
  static final String OBJECT_CLASS_NOT_SUPPORTED      = PREFIX + "00052";
  static final String OPERATION_NOT_SUPPORTED         = PREFIX + "00053";
  static final String OPERATION_NOT_PERMITTED         = PREFIX + "00054";
  static final String INSUFFICIENT_INFORMATION        = PREFIX + "00055";
  static final String SEARCH_FILTER_INVALID           = PREFIX + "00056";
  static final String OBJECT_NAME_INVALID             = PREFIX + "00057";
  static final String OBJECT_PATH_NOT_EXISTS          = PREFIX + "00058";
  static final String OBJECT_PATH_NOT_RESOLVED        = PREFIX + "00059";
  static final String PASSWORD_CHANGE_REQUIRES_TLS    = PREFIX + "00060";
