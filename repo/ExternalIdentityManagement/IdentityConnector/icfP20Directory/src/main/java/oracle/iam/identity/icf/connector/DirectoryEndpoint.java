...
public class DirectoryEndpoint extends AbstractEndpoint<DirectoryEndpoint> {
  ...
  */
   ...
   */
  private Entry                      organizationEntity         = new Entry("o", CollectionUtility.set("organization"), "uniqueMember");
  /**
   ** Attribute tag which may be defined on a <code>Metadata Descriptor</code>
   ** to specify the name of the organization object class of an entry in a V3
   ** compliant Directory Service.
   ...
   */
  private Entry                      organizationalUnitEntity   = new Entry("ou", CollectionUtility.set("organization"), "uniqueMember");
  /**
   ** Attribute tag which may be defined on a <code>Metadata Descriptor</code>
   ...
   ** <code>organization</code> with the <code>ou</code> as the prefix.
   */
  private Entry                      organizationalUnitPEntity  = new Entry("ou", CollectionUtility.set("organizationalUnitP"), null);
  /**
   ** Attribute tag which may be defined on a <code>Metadata Descriptor</code>
   ...
   */
  private Bind                       accountEntity              = new Bind("cn", CollectionUtility.set("user"), "memberOf","userPassword", false);
  ...
  private class Entry extends Schema {
     ...
     **                          Allowed object is {@link String}.
     */
    private Entry(final String prefix, final Set<String> clazz, final String group) {
      // ensure inheritance
      super(prefix, clazz);
  ...
  private class Bind extends Entry {
     ...
     */
    private Bind(final String prefix, final Set<String> clazz, final String group, final String credential, final boolean quoted) {
      // ensure inheritance
      super(prefix, clazz, group);
