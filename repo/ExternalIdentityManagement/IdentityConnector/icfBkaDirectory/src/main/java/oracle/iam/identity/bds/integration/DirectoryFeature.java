...
public class DirectoryFeature extends TargetFeature {
   ...
   ** {@link Directory.OIM.Feature#URL_ENCODING_DEFAULT}.
   **
   ...
   ** {@link Directory.OIM.Feature#INITIAL_CONTEXT_FACTORY_DEFAULT}.
   **
   ...
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#SECURITY_PROVIDER_DEFAULT}.
   **
   ...
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#MULTIVALUE_SEPARATOR_DEFAULT}.
   **
   ...
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#SCHEMA_CONTAINER_DEFAULT}.
   **
   ...
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#CATALOG_CONTAINER_DEFAULT}.
   **
   ...
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#CHANGELOG_CONTAINER_DEFAULT}.
   **
   ...
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#CHANGELOG_TARGETGUID_DEFAULT}.
   **
   ** @return                    the name of the {@link TargetFeature} that
   **                            defines attribute name of the change number
   **                            within a changelog entry.
   ...
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#CHANGELOG_TARGETDN_DEFAULT}.
   **
   ** @return                    the name of the {@link TargetFeature} that
   ...
   ** the underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#REFERENTIAL_INTEGRITY_DEFAULT}.
   **
   ...
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#TIMESTAMP_FORMAT_DEFAULT}.
   **
  ...
  public final List<String> distinguishedName() {
    return stringList(Directory.OIM.Feature.DISTINGUISHED_NAME);
  }
   ...
   ** {@link Directory.OIM.Feature#DISTINGUISHED_NAME_PREFIX_DEFAULT}.
   **
   ...
   ** {@link Directory.OIM.Feature#ENTRY_IDENTIFIER_PREFIX_DEFAULT}.
   **
   ** @return                    the name of the attribute to detect the
   **                            created timestamp.
   **                            <br>
   ...
   ** the underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#ENTRY_CREATOR_PREFIX_DEFAULT}.
   **
   ** @return                    the name of the attribute to detect the
   **                            creator name.
   **                            <br>
   ...
   ** the underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#ENTRY_CREATED_PREFIX_DEFAULT}.
   **
   ** @return                    the name of the attribute to detect the
   **                            created timestamp.
   **                            <br>
   ...
   ** the underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#ENTRY_MODIFIER_PREFIX_DEFAULT}.
   **
   ** @return                    the name of the attribute to detect the
   **                            modifier name.
   **                            <br>
   ...
   ** the underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#ENTRY_MODIFIED_PREFIX_DEFAULT}.
   **
   ** @return                    the name of the attribute to detect the
   **                            modified timestamp.
   **                            <br>
   ...
   ** the underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#ENTRY_STATUS_PREFIX_DEFAULT}.
   **
   ** @return                    the name of the attribute to detect the
   **                            modified timestamp.
   **                            <br>
  ...
  // Method:   roleClass
  /**
   ** Returns the name of the role object class defined for a Directory Service.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#ROLE_CLASS}.
   **
   ** @return                    the name of the role object class.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String roleClass() {
    return stringValue(Directory.OIM.Feature.ROLE_CLASS);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   rolePrefix
  /**
   ** Returns the name of the role object prefix defined for a Directory
   ** Service.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#ROLE_PREFIX}.
   ** <p>
   ** If {@link Directory.OIM.Feature#ROLE_PREFIX} is not mapped in the
  ...
  public final String rolePrefix() {
    return stringValue(Directory.OIM.Feature.ROLE_PREFIX);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   roleMemberPrefix
  /**
   ** Returns the name of the attribute of a membership of an object within a
   ** role defined for a Directory Service.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#ROLE_MEMBER_PREFIX}.
   **
   ...
   **                            Possible object is {@link String}.
   */
  public final String roleMemberPrefix() {
    return stringValue(Directory.OIM.Feature.ROLE_MEMBER_PREFIX);
  }
   ...
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#SCOPE_CLASS}.
   **
   ** @return                    the name of the scope object class.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String scopeClass() {
    return stringValue(Directory.OIM.Feature.SCOPE_CLASS);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   scopePrefix
  /**
   ** Returns the name of the scope object prefix defined for a Directory
   ** Service.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#SCOPE_PREFIX}.
   ** <p>
   ** If {@link Directory.OIM.Feature#SCOPE_PREFIX} is not mapped in the
   ** underlying {@link TargetFeature} this method returns <code>null</code>.
   **
  ...
  public final String scopePrefix() {
    return stringValue(Directory.OIM.Feature.SCOPE_PREFIX);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   scopeMemberPrefix
  /**
   ** Returns the name of the attribute of a membership of an object within a
   ** scope defined for a Directory Service.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#SCOPE_MEMBER_PREFIX}.
   **
   ** @return                    the name of the attribute of a membership of an
   ...
   **                            Possible object is {@link String}.
   */
  public final String scopeMemberPrefix() {
    return stringValue(Directory.OIM.Feature.SCOPE_MEMBER_PREFIX);
  }
   ...
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#GROUP_CLASS_DEFAULT}.
   **
   ...
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#GROUP_PREFIX_DEFAULT}.
   **
   ...
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#ACCOUNT_CLASS_DEFAULT}.
   **
   ...
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#ACCOUNT_PREFIX_DEFAULT}.
   **
   ...
   ** in the underlying {@link TargetFeature} this method returns
   ** {@link Directory.OIM.Feature#ACCOUNT_CREDENTIAL_PREFIX_DEFAULT}.
   **
  ...
  /**
   ** Returns the prefix of the account role membership attribute defined for a
   ** Directory Service.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#ACCOUNT_ROLE_PREFIX}.
   **
  ...
  public final String accountRolePrefix() {
    return stringValue(Directory.OIM.Feature.ACCOUNT_ROLE_PREFIX);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   accountScopePrefix
  /**
   ** Returns the prefix of the account scope membership attribute defined for a
   ** Directory Service.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#ACCOUNT_SCOPE_PREFIX}.
   **
   ** @return                    the name of the account scope membership
   **                            attribute.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String accountScopePrefix() {
    return stringValue(Directory.OIM.Feature.ACCOUNT_SCOPE_PREFIX);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   accountGroupPrefix
  /**
   ** Returns the prefix of the account group membership attribute defined for a
   ** Directory Service.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#ACCOUNT_GROUP_PREFIX}.
   **
   ...
   **                            Possible object is {@link String}.
   */
  public final String accountGroupMemberPrefix() {
    return stringValue(Directory.OIM.Feature.ACCOUNT_GROUP_PREFIX);
  }
  ...
  /**
   ** Returns a set of attributes that represent the entry status in the directory.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#ENTRY_STATUS}.
   ** <p>
   ** If {@link Directory.OIM.Feature#ENTRY_STATUS} is not
   ** mapped in the underlying {@link TargetFeature} this method returns
   ** empty string.
   **
   ** @return                    the name of the role mapping prefix.
   ...
   **                            Possible object is {@link String}.
   */
  public final String  entryStatusAttributes() {
    return stringValue(Directory.OIM.Feature.ENTRY_STATUS);
  }
