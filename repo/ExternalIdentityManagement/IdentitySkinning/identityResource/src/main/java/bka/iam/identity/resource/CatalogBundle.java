 ...
 ** @since   1.0.0.0
 */
public class CatalogBundle extends ListResourceBundle {
  ...
  , {Catalog.OIG_UPO_HEADER,                "OU Roles"}
  , {Catalog.OIG_UPO_SID_TITLE,             "OU Role"}
  , {Catalog.OIG_UPO_SID_HINT,              "Identity Governance Access Policy with Organizations"}
  , {Catalog.OIG_UPO_OU_TITLE,              "Organization Unit"}
  , {Catalog.OIG_UPO_OU_LABEL,              "Organization Unit"}
  , {Catalog.OIG_UPO_OU_HINT,               "Organization Unit name used during a provisioning"}
