...
public class Bundle_en extends ListResourceBundle {
  ...
  private static final String[][] CONTENT = {
    ...
    { UIDError.GENERAL,                       "General error: %1$s" }
  , { UIDError.UNHANDLED,                     "An unhandled exception has occured: %1$s"}
  , { UIDError.ABORT,                         "Execution aborted due to reason: %1$s"}
  , { UIDError.NOTIMPLEMENTED,                "Feature is not yet implemented"}
