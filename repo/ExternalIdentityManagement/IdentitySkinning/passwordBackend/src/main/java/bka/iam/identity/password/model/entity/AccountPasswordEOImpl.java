/*
    ...
    File        :   AccountPasswordEOImpl.java
...
import bka.iam.identity.password.schema.AccountPasswordAdapter;

////////////////////////////////////////////////////////////////////////////////
// class AccountPasswordEOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>Entity Object</code> to coordinate representations of database
 ** rows belonging to <code>Account Password</code>s.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class AccountPasswordEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>AccountPasswordEOImpl</code> values object that
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createAccountPasswordDataProvider();
  }
}