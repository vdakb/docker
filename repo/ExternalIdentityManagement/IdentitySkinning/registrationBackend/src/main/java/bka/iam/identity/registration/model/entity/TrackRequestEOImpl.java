...
import bka.iam.identity.registration.schema.TrackRequestAdapter;
 ...
 ** @since   2.0.0.0
 */
public class TrackRequestEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>TrackRequestEOImpl</code> values object that
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createTrackRequestDataProvider();
  }
}