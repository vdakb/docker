 ...
 ** @since   1.0.0.0
 */
public class TrackRequestVOImpl extends OIMProgrammaticVO {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>TrackRequestVOImpl</code> view object that allows use
   ** as a JavaBean.
   ** <br>
