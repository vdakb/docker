/*
    ...
    File        :   YesNoBooleanDefaultTrue.java
...
////////////////////////////////////////////////////////////////////////////////
// class YesNoBooleanDefaultTrue
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** {@link AbstractConverter} implementation for ...
 */
public class YesNoBooleanDefaultTrue extends AbstractConverter {
  ...
  public static final String CONVERTER_ID = "oracle.hst.foundation.faces.YesNoBooleanDefaultTrue";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>YesNoBooleanDefaultTrue</code> converter that allows
   ** use as a JavaBean.
   ** <br>
   ...
   ** Default Constructor
   */
  public YesNoBooleanDefaultTrue() {
    // ensure inheritance
    super();
  }
  ...
  public Object getAsObject(final FacesContext context, final UIComponent component, final String value) {
    return value == null ? "yes" : "true".equals(value) ? "Y" : "N";
  }
  ...
  public String getAsString(final FacesContext context, final UIComponent component, final Object value) {
    return value == null ? "true" : "yes".equalsIgnoreCase(value.toString()) ? "true" : "false";
  }
}