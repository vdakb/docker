/*
    ...
    File        :   YesNoBooleanDefaultFalse.java
...
////////////////////////////////////////////////////////////////////////////////
// class YesNoBooleanDefaultFalse
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** {@link AbstractConverter} implementation for ...
 */
public class YesNoBooleanDefaultFalse extends AbstractConverter {
  ...
  public static final String CONVERTER_ID = "oracle.hst.foundation.faces.YesNoBooleanDefaultFalse";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>YesNoBooleanDefaultFalse</code> converter that allows
   ** use as a JavaBean.
   ** <br>
   ...
   ** Default Constructor
   */
  public YesNoBooleanDefaultFalse() {
    // ensure inheritance
    super();
  }
  ...
  public Object getAsObject(final FacesContext context, final UIComponent component, final String value) {
    return value == null ? "no" : "true".equals(value) ? "yes" : "no";
  }
  ...
  public String getAsString(final FacesContext context, final UIComponent component, final Object value) {
    return value == null ? "false" : "yes".equalsIgnoreCase(value.toString()) ? "true" : "false";
  }
}