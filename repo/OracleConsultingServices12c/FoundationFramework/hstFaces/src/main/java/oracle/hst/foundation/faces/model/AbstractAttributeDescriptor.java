/*
    ...
    File        :   AbstractAttributeDescriptor.java
...
////////////////////////////////////////////////////////////////////////////////
// class AbstractAttributeDescriptor
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** An <code>AbstractAttributeDescriptor</code> represents an attribute that is
 ** part of a view object (in ADF) or any other model object.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 */
public class AbstractAttributeDescriptor extends AttributeDescriptor {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>AbstractAttributeDescriptor</code> which use the
   ** specified {@link AbstractAttribute} as the model.
   **
   ** @param  attribute          the {@link AbstractAttributeDescriptor}
   **                            providing the model.
   */
  public AbstractAttributeDescriptor(final AbstractAttribute attribute) {
    // ensure inheritance
    super();
