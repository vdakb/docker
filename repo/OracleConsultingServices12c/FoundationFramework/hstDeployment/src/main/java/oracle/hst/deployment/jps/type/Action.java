...
// ~~~~~ ~~~~~~
/**
 ** <code>Action</code> defines the attribute restriction on values that can
 ** be passed as an action attribute of a credential.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public class Action extends EnumeratedAttribute {
  ...
  private static final String[] VALUE = {
    ServiceOperation.create.id()
  , ServiceOperation.delete.id()
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Action</code> type that allows use as a JavaBean.
   ** <br>
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Action</code> with the specified name and value.
   **
