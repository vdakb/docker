 ...
 ** @since   1.0.0.0
 */
public class Type extends ServiceDataType {

  //////////////////////////////////////////////////////////////////////////////
  // instance attributes
  //////////////////////////////////////////////////////////////////////////////

  private final EnvironmentHandler.Type delegate = new EnvironmentHandler.Type();
  ...
  // Method:   instance
  /**
   ** Returns the {@link EnvironmentHandler.Bean} delegate of Oracle Identity
   ** Manager to handle.
   **
   ** @return                    the {@link EnvironmentHandler.Bean} delegate
   **                            of Oracle WebLogic Domain entity instance.
   */
  public final EnvironmentHandler.Type instance() {
   ...
   ** <code>type</code>.
   **
   ** @param  type               a fully configured type.
   **
   ...
   ** <code>bean</code>.
   **
   ** @param  bean               a fully configured bean.
   **
   ** @throws BuildException     if the specified bean is already part of the
   **                            parameter mapping.
   */
