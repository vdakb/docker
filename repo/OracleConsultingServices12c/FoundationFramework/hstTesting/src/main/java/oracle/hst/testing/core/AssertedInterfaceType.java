/*
    ...
    File        :   AssertedInterfaceType.java
 ...
 ** @since   1.0.0.0
 */
public class AssertedInterfaceType {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>AssertedInterfaceType</code>.
   ** <br>
   ** This constructor is private to prevent other classes to use
   ** "new AssertedInterfaceType()" and enforces use of the public method below.
   */
  private AssertedInterfaceType() {
  ...
  // Method:   assertThat
  /**
   ** Factory method to create assertion for {@link java.util.Optional}.
   **
   ...
   **                             <br>
   **                             Allowed object is {@link Optional}.
   **
   ** @return                     the created assertion object.
   **                             <br>
   **                             Allowed object is {@link OptionalAssert}.
   */
  public static <V> AssertedOptional<V> assertThat(final Optional<V> actual) {
    return new AssertedOptional<>(actual);
  }

  /**
   * Creates a new instance of {@link AssertedIterable}.
   *
   * @param <ELEMENT> the type of elements.
   * @param actual the actual value.
   * @return the created assertion object.
   */
  public static <E> AssertedIterable<E> assertThat(final Iterable<? extends E> actual) {
    return AssertedIterable.assertThatIterable(actual);
  }
}
