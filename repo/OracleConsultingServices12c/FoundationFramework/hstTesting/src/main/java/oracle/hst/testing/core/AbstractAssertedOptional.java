/*
    ...
    File        :   AbstractAssertedOptional.java
...
////////////////////////////////////////////////////////////////////////////////
// abstract class AbstractAssertedOptional
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ...
 ** @since   1.0.0.0
 */
public class AbstractAssertedOptional<T extends AbstractAssertedOptional<T, V>, V> extends AbstractAsserted<T, Optional<V>> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>AbstractAssertedOptional</code> with the
   ...
   */
  protected AbstractAssertedOptional(final Optional<V> actual, final Class<?> self) {
    // ensure inheritance
    super(actual, self);
  }
}