...
public class PBKDF2HMACSHA1Digester extends PBKDF2HMACDigester {
   ...
   ** slowness to the SHA-1 computation. 160 bits was chosen because it is
   ** <ol>
  ...
  public static final String                   TAG       = "{PBKDF2-HMAC-SHA1}";
   ...
   ** Singleton Pattern
   */
  private static PBKDF2HMACSHA1Digester     instance       = new PBKDF2HMACSHA1Digester();
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>PBKDF2HMACSHA1Digester</code> handler that allows use
   ** as a JavaBean.
   ** <br>
   ...
   ** Default Constructor
   */
  private PBKDF2HMACSHA1Digester() {
    // ensure inheritance
   ...
   */
  public static PBKDF2HMACSHA1Digester instance() {
    return instance;
  }
}