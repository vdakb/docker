...
////////////////////////////////////////////////////////////////////////////////
// class SaltedSHA1Digester
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~
/**
 ** This class defines a Directory Server password storage scheme based on the
 ** SHA-1 algorithm defined in FIPS 180-1.
 ** <p>
 ...
 ** <p>
 ** A SHA-1 hash is then generated based on this, the salt is appended to the
 ** hash, and then the entire value is base64-encoded.
 ** Here are some example hashes (all of the password "Welcome1"):
 ** <pre>
 **   6fXDPLmKirE67unefo72axMgP9ARFFF4SkSzJg==
 **   4PtFyJasNcPu75c+ufI5k6FFX6cJ50e47sQyQg==
 **   FDqrpfTY0zcbJSPeW81sDefrSkY3yVbuWaaEgw==
 **   2lgDcE7QM1jslv8XR2ZTx9CMBkhR3tA4jMk7TQ==
 **   cdQqOTdt7UTBlDSton+/FBCjmnXQNx0XyP29Uw==
 ** </pre>
 ...
 ** @since   1.0.0.0
 */
public class SaltedSHA1Digester extends SaltedSHADigester {
  ...
  /**
   ** The number of SHA-1 output bytes.
   ** <br>
   ** By default, 20 bytes, which is 160 bits. While it may seem useful to
   ...
   ** slowness to the SHA-1 computation. 160	160	int bits was chosen because it
   ** is
   ** <ol>
   **   <li>Default SHA1's 160-bit output (to avoid unnecessary PBKDF2
   **       overhead)
  ...
  /**
   ** default encryption algorithm will be SHA-1 as the hashing algorithm.
   ** <br>
   ...
   ** Singleton Pattern
   */
  private static SaltedSHA1Digester       instance       = new SaltedSHA1Digester();
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>SaltedSHA1Digester</code> handler that allows use as a
   ** JavaBean.
   ** <br>
   ...
   */
  public static SaltedSHA1Digester instance() {
    return instance;
  }
}