...
public final class DigesterException extends RuntimeException {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-782402693937658941")
  ...
  // Method:   Ctor
  /**
   ** Create a new <code>DigesterException</code> with <code>null</code> as its
   ** detail message.
   ** <p>
  ...
  // Method:   Ctor
  /**
   ** Create a new <code>DigesterException</code> with <code>reason</code> as
   ** its detail message.
   ** <p>
   ** The cause is not initialized, and may subsequently be initialized by a
   ** call to {@link #initCause}.
