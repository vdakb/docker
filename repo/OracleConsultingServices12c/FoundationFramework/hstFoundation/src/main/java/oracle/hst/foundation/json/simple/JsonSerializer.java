...
public final class JsonSerializer {
  ...
  static class Stream {
    ...
    Stream(final OutputStream stream) {
      // ensure inheritance
      this(stream, JsonContext.CHARSET_DEFAULT, Collections.<String, Object>emptyMap());
    }
     ...
     **                          <code>null</code>.
     */
    Stream(final OutputStream stream, final Map<String, ?> config) {
      // ensure inheritance
      this(stream, JsonContext.CHARSET_DEFAULT, config);
    }
    ...
    Stream(final OutputStream stream, final Charset charset) {
      // ensure inheritance
      this(stream, charset, Collections.<String, Object>emptyMap());
    }
     ...
     **                          <code>null</code>.
     */
    Stream(final OutputStream stream, final Charset charset, final Map<String, ?> config) {
      // ensure inheritance
      super();
    ...
    Stream(final Writer stream) {
      // ensure inheritance
      this(stream, Collections.<String, Object>emptyMap());
    }
     ...
     **                          <code>null</code>.
     **
     ** @param  stream           the {@link Writer} to deleget further.
     */
    Stream(final Writer stream, final Map<String, ?> config) {
      // ensure inheritance
      super();
  ...
  static final class Factory {
    ...
    /**
     ** Creates a JSON serializer to write JSON text to the byte stream
     ** <code>stream</code>.
     ** <br>
...
//      throw new JsonException("Nesting problem");
  ...
  private JsonSerializer property(final String name)
    ...
    // prevent bogus input
    if (name == null)
      throw new JsonException("name must not be null");
