...
public final class JsonDeserializer {
  ...
  static class Stream {
     ...
     **                          <code>null</code>.
     */
    Stream(final InputStream stream, final Map<String, ?> config) {
      // ensure inheritance
     ...
     **                          <code>null</code>.
     */
    Stream(final InputStream stream, final Charset charset, final Map<String, ?> config) {
      // ensure inheritance
      super();
     ...
     ** configuration properties.
     **
     ** @param  stream           an {@link Reader} to which JSON is read.
     ** @param  config           a {@link Map} of provider specific properties
     **                          to configure the JSON reader.
     **                          The {@link Map} may be empty or
     **                          <code>null</code>.
     */
    Stream(final Reader stream, final Map<String, ?> config) {
      // ensure inheritance
      super();
