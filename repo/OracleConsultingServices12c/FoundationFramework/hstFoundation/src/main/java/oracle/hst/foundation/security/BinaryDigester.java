...
////////////////////////////////////////////////////////////////////////////////
// interface BinaryDigester
// ~~~~~~~~~ ~~~~~~~~~~~~~~
/**
 ** Common interface for all digesters which receive a byte array and return a
 ** byte array digest.
 ** <p>
 ** For a default implementation, see {@link DefaultBinaryDigester}.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.1.0
 ** @since   1.0.1.0
 */
public interface BinaryDigester extends Encryptor {
   ...
   ** @return                    the digest
   */
  byte[] digest(final byte[] message);
   ...
   */
  boolean match(final byte[] message, final byte[] digest);
}