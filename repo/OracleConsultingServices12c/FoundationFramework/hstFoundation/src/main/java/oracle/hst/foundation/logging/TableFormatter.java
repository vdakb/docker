...
public class TableFormatter {
  ...
  // Method:   print
  /**
   ** Prints the table in its current state using the system output stream.
   **
   ** @return                    this instance for method chaining purpose.
   */
   ...
   ** Prints the table in its current state using the provided table printer.
   **
   ** @param  writer             the table printer.
   **
   ** @return                    this instance for method chaining purpose.
   */
  public TableFormatter print(final StringWriter writer) {
