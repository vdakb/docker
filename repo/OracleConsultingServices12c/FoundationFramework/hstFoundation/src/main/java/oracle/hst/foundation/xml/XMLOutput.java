 ...
 ** @since   1.0.1.0
 */
class XMLOutput extends    XMLOperation
  ...
  // compatible with
  @SuppressWarnings("compatibility:-4809765521795325198")
  ...
  private static class Stack extends ArrayList<XMLOutputNode> {
    ...
    // the official serial version ID which says cryptically which version we're
    // compatible with
    @SuppressWarnings("compatibility:8950848535611114508")
  ...
  private static class Resolver extends    LinkedHashMap<String, String>
    ...
    // the official serial version ID which says cryptically which version we're
    // compatible with
    @SuppressWarnings("compatibility:8612231349610437404")
    private static final long serialVersionUID = -1L;
    ...
    public String reference(final String reference) {
      return reference(reference, XMLConstants.NULL_NS_URI);
    }
  ...
  private static class Element implements XMLOutputNode {
    ...
    // the official serial version ID which says cryptically which version we're
    // compatible with
    @SuppressWarnings("compatibility:-8606914344850209663")
    private static final long serialVersionUID = -1L;
    ...
    public final XMLOutputNode element(final String name)
      ...
      if (this.value != null)
        throw new XMLException(XMLError.OUTPUT_NODE_INVALID);
     ...
     ** <p>
     ** It is used for debugging purposes. When evaluating the element the to
     ** string can be used to print out the element name.
     **
     ** @return                  a text description of the element.
     */
    public String toString() {
      return XMLStreamBundle.format(XMLMessage.ELEMENT, name);
    }
  }
  ...
  private static class Document extends Element {
    ...
    // the official serial version ID which says cryptically which version we're
    // compatible with
    @SuppressWarnings("compatibility:-8519063565318266535")
    private static final long serialVersionUID = -1L;
    ...
    public void remove()
      ...
      if (this.stack.isEmpty())
         throw new XMLException(XMLError.OUTPUT_ROOT);
   ...
   */
  public XMLOutput(final Loggable loggable, final Writer writer) {
    this(loggable, writer, new XMLFormat());
  }
   ...
   */
  public XMLOutput(final Loggable loggable, final Writer writer, final XMLFormat format) {
    this(loggable, writer, format, false);
  }
   ...
   */
  public XMLOutput(final Loggable loggable, final Writer writer, final XMLFormat format, boolean verbose) {
    // ensure inheritance
    super(loggable);
  ...
  public void remove(final XMLOutputNode node)
    ...
    if (this.stack.top() != node)
      throw new XMLException(XMLError.OUTPUT_NODE_REMOVE, node.name());
  ...
  private XMLOutputNode writeStart(final XMLOutputNode parent, final String name)
    ...
    // prevent bogus input
    if (name == null)
      throw new XMLException(XMLError.OUTPUT_NODE_NAME);
