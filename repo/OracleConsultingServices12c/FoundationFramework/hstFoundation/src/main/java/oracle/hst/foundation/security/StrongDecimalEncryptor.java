/*
    ...
    File        :   StrongDecimalEncryptor.java
...
public class StrongDecimalEncryptor implements DecimalEncryptor
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>StrongDecimalEncryptor</code> that allows use as
   ** a JavaBean.
   ** <br>
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>StrongDecimalEncryptor</code> with the specified
   ** password to use.
   ** <p>
   ...
   */
  public StrongDecimalEncryptor(final String password) {
    // ensure inheritance
    this();
   ...
   ** @param  password           the password to be used.
   */
  public StrongDecimalEncryptor(final char[] password) {
    // ensure inheritance
    this();
