...
public class XMLFormat implements Serializable {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-5827539399462531184")
   ...
   */
   public XMLFormat(int indent) {
     this(indent, null, StringUtility.ASCII, new XMLStyle.NULL());
   }
  ...
  public XMLFormat(final String prolog) {
    this(prolog, StringUtility.ASCII);
  }
  ...
  public XMLFormat(final int indent, final String prolog) {
    this(indent, prolog, StringUtility.ASCII, new XMLStyle.NULL());
  }
