...
// ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** Determine if the {@link Entity} {@link Attribute} value is less than or
 ...
 ** @since   1.1.0.0
 */
public class LessThanOrEqual<T> extends ComparableAttributeFilter<T> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>LessThanOrEqual</code> w/ the {@link Attribute}
   ** to compare.
   **
   ** @param  attribute          the {@link Attribute} this
   **                            {@link ComparableAttributeFilter} belongs to.
   */
  public LessThanOrEqual(final Attribute attribute) {
    // ensure inheritance
    super(attribute);
  }
