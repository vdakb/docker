 ...
 */
 public final class RandomGUID {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>RandomGUID</code> handler that allows use as a
   ** JavaBean.
   ** <br>
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>RandomGUID</code> with security option.
   ** <br>
  ...
  private synchronized void guid(final boolean secure) {
    ...
    try {
      ...
      buffer.append(":");
      buffer.append(Long.toString(random));

      this.beforeMD5 = buffer.toString();
  ...
  public static String generate(final boolean secure, final boolean upperCase) {
    final RandomGUID guid = new RandomGUID(secure);
