...
public abstract class CollectionUtility {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>CollectionUtility</code>.
   ** <br>
   ...
   */
  public static <T> List<T> notNullList(final Collection<T> collection) {
    return new ArrayList<T>(notNull(collection));
  }
   ...
   ** <code>defaultValue</code> if the given map contains no mapping for the
   ** key.
   ** <p>
   ** More formally, if the given map contains a mapping from a key
   ** <code>k</code> to a value <code>v</code> such that
   ** <code>(key==null ? k==null : key.equals(k))</code>. then this method
   ** returns <code>v</code>; otherwise it returns <code>defaultValue</code>.
   ** <br>
   ...
   **                            or <code>defaultValue</code> if the given map
   **                            contains no mapping for the key.
   */
  public static <K, V> V value(final Map<K, V> map, final K key, final V defaultValue) {
    V value = map.get(key);
    if (value == null || StringUtility.isBlank(value.toString()))
      value = defaultValue;
   ...
   **
   ** @return                    the value to which the specified key is mapped,
   **                            or <code>null</code> if the given map contains
  ...
  public static <K, V> V valueRequired(final Map<K, V> map, final K key) {
    ...
    if (value == null || (value instanceof String && StringUtility.isBlank((String)value)))
