/*
    ...
    File        :   StrongStringEncryptor.java
 ...
 ** @since   1.0.1.0
 */
public class StrongStringEncryptor implements StringEncryptor
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>StrongStringEncryptor</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>StrongStringEncryptor</code> with the specified
   ** password to use.
   ** <p>
   ...
   */
  public StrongStringEncryptor(final String password) {
    // ensure inheritance
    this();
   ...
   ** @param  password           the password to be used.
   */
  public StrongStringEncryptor(final char[] password) {
    // ensure inheritance
    this();
