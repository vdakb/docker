...
public class SystemBundle extends ListResourceBundle  {
  ...
  , { SystemError.CMDLINE_ARGUMENT2,         "%1$s: commandline-option %2$s,%3$s doss not accept an argument!" }
  ...
  , { SystemError.CMDLINE_UNREGCOGNIZED2,    "%1$s: commandline-option %2$s not expected in %3$s!" }
  ...
  , { SystemError.TIMER_STILL_RUNNING,       "Can't start timer task [%1$s]: it's already running!" }
  , { SystemError.TIMER_NOT_RUNNING,         "Can't stop timer task [%1$s]: it's not running!" }
