...
////////////////////////////////////////////////////////////////////////////////
// final class JsonBigInteger
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~~
/**
 ** An immutable JSON number value.
 ** <p>
 ** Implementations use a {@link BigInteger} object to store the numeric value
 ** internally.
 ** <p>
 ** The <code>JsonBigInteger</code> object can be constructed from the following
 ** types:
 ** <ul>
...
final class JsonBigInteger extends JsonNumber {
  ...
  // compatible with
  @SuppressWarnings("compatibility:3339672359366545543")
  private static final long serialVersionUID = -8420957710764047079L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>JsonBigInteger</code> which ths specified
   ** {@link BigInteger} value.
   **
   ** @param  value              the <code>BigInteger</code> value
   **                            Allowed object {@link BigInteger}.
   */
  JsonBigInteger(final BigInteger value) {
    // ensure inheritance
    super();
  ...
  public final boolean equals(Object other) {
    ...
    final JsonBigInteger that = (JsonBigInteger)other;
