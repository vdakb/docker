 ...
 ** <p>
 ** Implementation use a <code>double</code> object to store the numeric value
 ** internally.
 ** <p>
...
final class JsonDouble extends JsonNumber {
  ...
  // compatible with
  @SuppressWarnings("compatibility:2924321625205533580")
  private static final long serialVersionUID = -6805176620266777806L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>JsonDouble</code> which ths specified
   ** <code>double</code> value.
   **
   ** @param  value              the <code>double</code> value
   **                            Allowed object <code>double</code>.
   */
  ...
  public final boolean equals(Object other) {
    ...
    final JsonDouble that = (JsonDouble)other;
