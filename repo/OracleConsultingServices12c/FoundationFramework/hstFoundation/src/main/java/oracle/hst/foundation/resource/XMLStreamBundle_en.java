 ...
 ** @since   0.0.0.1
 */
public class XMLStreamBundle_en extends ListResourceBundle  {
  ...
  , { XMLError.ENCODING_UNSUPORTED,            "Error while loading XML Schema %1$s: %2$s" }
     ...
     // XML-00071 - XML-00080 schema load related errors
