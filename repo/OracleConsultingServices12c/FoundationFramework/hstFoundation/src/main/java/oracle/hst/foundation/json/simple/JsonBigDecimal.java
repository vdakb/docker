...
////////////////////////////////////////////////////////////////////////////////
// final class JsonBigDecimal
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~~
/**
 ** An immutable JSON number value.
 ** <p>
 ** Implementations use a {@link BigDecimal} object to store the numeric value
 ** internally.
 ** <p>
...
final class JsonBigDecimal extends JsonNumber {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-5318845149266112832")
  private static final long serialVersionUID = -2353658966492787063L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>JsonBigDecimal</code> which ths specified
   ** {@link BigDecimal} value.
   **
   ** @param  value              the <code>BigDecimal</code> value
   **                            Allowed object {@link BigDecimal}.
   */
  JsonBigDecimal(final BigDecimal value) {
    // ensure inheritance
    super(value);
  }
  ...
  public final boolean equals(Object other) {
    ...
    final JsonBigDecimal that = (JsonBigDecimal)other;
