...
class Record extends LogRecord {
  ...
  private static final String HST_LOG_CLASS   = "oracle.hst.foundation.logging.Logger";

  private transient String  category          = "oracle.hst.foundation.logging.Logger";
  ...
  private void inferCaller() {
    ...
    while (i < stack.length) {
      ...
      if ((clazz.equals(JDK_LOG_CLASS)) || (clazz.equals(HST_LOG_CLASS)) || (clazz.equals(this.category)))
        break;
      i++;
    }
