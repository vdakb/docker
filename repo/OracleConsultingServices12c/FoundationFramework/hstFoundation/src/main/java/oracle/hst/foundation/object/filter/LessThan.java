...
// ~~~~~ ~~~~~~~~
/**
 ** Determine if the {@link Entity} {@link Attribute} value is less than the
 ...
 ** @since   1.1.0.0
 */
public class LessThan<T> extends ComparableAttributeFilter<T> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>LessThan</code> w/ the {@link Attribute} to compare.
   **
   ** @param  attribute          the {@link Attribute} this {@link ComparableAttributeFilter}
   **                            belongs to.
   */
  public LessThan(final Attribute attribute) {
    // ensure inheritance
    super(attribute);
  }
   ...
   ** has the same name and contains a value that is less than the value of the
  ...
  public <R, P> R accept(final FilterVisitor<R, P> visitor, final P parameter) {
    return visitor.lessThan(parameter, this);
  }
}