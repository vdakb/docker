 ...
 ** @since   1.1.0.0
 */
public class StartsWith extends StringFilter {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>StartsWith</code> w/ the {@link Attribute} to compare.
   **
   ...
   */
  public StartsWith(final Attribute attribute, final boolean caseIgnore) {
    // ensure inheritance
