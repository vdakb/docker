/*
    ...
    File        :   StrongBinaryEncryptor.java
 ...
 ** @since   1.0.1.0
 */
public class StrongBinaryEncryptor implements BinaryEncryptor
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>StrongBinaryEncryptor</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>StrongBinaryEncryptor</code> with the specified
   ** password to use.
   ** <p>
   ...
   */
  public StrongBinaryEncryptor(final String password) {
    // ensure inheritance
    this();
   ...
   ** @param  password           the password to be used.
   */
  public StrongBinaryEncryptor(final char[] password) {
    // ensure inheritance
    this();
