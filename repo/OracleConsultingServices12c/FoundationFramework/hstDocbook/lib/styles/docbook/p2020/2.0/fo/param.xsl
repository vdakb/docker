...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  =====================================================================
  -->
  <xsl:param name="body.font.family"     select="'Calibri'"/>
  <!--
  =====================================================================
  ...
  =====================================================================
  -->
  <xsl:param name="region.before.extent"  select="'10mm'"/>
  <!--
  =====================================================================
  ...
  =====================================================================
  -->
  <xsl:param name="region.after.extent"  select="'10mm'"/>
  <!--
  =====================================================================
  ...
  <xsl:attribute-set name="normal.para.spacing">
    <xsl:attribute name="space-before.optimum">2.12mm</xsl:attribute>
    <xsl:attribute name="space-before.minimum">2.12mm</xsl:attribute>
    <xsl:attribute name="space-before.maximum">2.12mm</xsl:attribute>
    <xsl:attribute name="space-after.optimum">2.12mm</xsl:attribute>
    <xsl:attribute name="space-after.minimum">2.12mm</xsl:attribute>
    <xsl:attribute name="space-after.maximum">2.12mm</xsl:attribute>
  </xsl:attribute-set>
  <!--
  =====================================================================
  ...
  =====================================================================
  -->
  <xsl:param name="admon.graphic.width">16px</xsl:param>
  <!--
  =====================================================================
  ...
  =====================================================================
  -->
  <xsl:param name="admon.graphics.path">file:///Users/dsteding/Project/OracleConsultingServices12c/FoundationFramework/hstDocbook/lib/styles/docbook/p2020/ico/</xsl:param>
  <!--
  =====================================================================
  ...
  <xsl:attribute-set name="section.title.level1.properties">
    <!--
     dsteding: font size is calculated dynamically by section.heading template
    -->
  ...
  <!--
  <xsl:param name="edition.date"            select="format-date(date-time(),[MMM yyyy])"/>
  -->
  <!--
  =====================================================================
  ...
  =====================================================================
  -->
  <xsl:param name="major.title.color"       select="'#000000'"/>
  <xsl:param name="minor.title.color"       select="'#000000'"/>
  <!--
  =====================================================================
  == Highlighting table colors
  =====================================================================
  -->
  <xsl:param name="table.title.color"       select="'#ffffff'"/>
  <xsl:param name="table.title.background"  select="'#004b76'"/>
  ...
  =====================================================================
  -->
  <xsl:param name="chapter.color"            select="'#004b76'"/>
  ...
  <xsl:attribute-set name="chapter.title.properties">
    <xsl:attribute name="color">
      <xsl:value-of select="$chapter.color"/>
    </xsl:attribute>
    <xsl:attribute name="font-family">
      <xsl:value-of select="$title.fontset"/>
    </xsl:attribute>
    ...
    <xsl:attribute name="space-before.optimum">0mm</xsl:attribute>
    <xsl:attribute name="space-before.maximum">0mm</xsl:attribute>
    <xsl:attribute name="space-after.minimum">2.5mm</xsl:attribute>
    <xsl:attribute name="space-after.optimum">2.5mm</xsl:attribute>
    <xsl:attribute name="space-after.maximum">2.5mm</xsl:attribute>
    <xsl:attribute name="keep-with-next.within-column">always</xsl:attribute>
  </xsl:attribute-set>
  <!--
  =====================================================================
  ...
  <xsl:attribute-set name="monospace.style.program">
    ...
    <xsl:attribute name="margin-{$direction.align.start}">3mm</xsl:attribute>
    <xsl:attribute name="margin-{$direction.align.end}">3mm</xsl:attribute>
  ...
  <xsl:attribute-set name="nongraphical.admonition.style">
    <xsl:attribute name="margin-top">0mm</xsl:attribute>
    <xsl:attribute name="margin-bottom">0mm</xsl:attribute>
    <xsl:attribute name="margin-{$direction.align.start}">0mm</xsl:attribute>
    <xsl:attribute name="margin-{$direction.align.end}">0mm</xsl:attribute>
    <xsl:attribute name="padding-top">2mm</xsl:attribute>
    <xsl:attribute name="padding-bottom">0mm</xsl:attribute>
    <xsl:attribute name="padding-{$direction.align.start}">2mm</xsl:attribute>
    <xsl:attribute name="padding-{$direction.align.end}">2mm</xsl:attribute>
  </xsl:attribute-set>
  <!--
  =====================================================================
  == Specifies the padding in a table cell
  =====================================================================
  -->
  ...
  <!--
  =====================================================================
  == Specifies the border style of frame border
  =====================================================================
  -->
  ...
  =====================================================================
  -->
  <xsl:param name="table.frame.top.thickness"     select="'0pt'"/>
  <xsl:param name="table.frame.bottom.thickness"  select="'1pt'"/>
  <!--
  =====================================================================
  == Specifies the border color of the frame border
  =====================================================================
  -->
  ...
  <!--
  =====================================================================
  == Specifies the thickness of the header border
  =====================================================================
  -->
  <xsl:param name="table.header.top.thickness"    select="'0pt'"/>
  <xsl:param name="table.header.bottom.thickness" select="'1pt'"/>
</xsl:stylesheet>