...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version='1.0'>
  ...
  -->
  <xsl:import href="@docbook.base@/lib/styles/docbook/@docbook.style@/html/inline.xsl"/>
  <!--
  ...
  =====================================================================
  -->
  <xsl:import href="@docbook.base@/xsl/1.0/html/chunk-common.xsl"/>
  <xsl:import href="@docbook.base@/xsl/1.0/html/manifest.xsl"/>
  <xsl:import href="@docbook.base@/xsl/1.0/html/chunk-code.xsl"/>
