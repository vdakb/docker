...
<xsl:stylesheet xmlns:xsl              ="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="titlepage.logo">
    <fo:block-container absolute-position="absolute" top="25mm" left="-5mm" display-align="before">
      <fo:block line-height="0">
        <fo:external-graphic src="file:///Users/dsteding/Project/OracleConsultingServices12c/FoundationFramework/hstDocbook/lib/styles/docbook/oracle/img/oracle-consulting-red.png"/>
      </fo:block>
    </fo:block-container>
    <fo:block-container absolute-position="absolute" bottom="-25mm" display-align="after">
      <fo:block line-height="0">
        <fo:external-graphic src="file:///Users/dsteding/Project/OracleConsultingServices12c/FoundationFramework/hstDocbook/lib/styles/docbook/oracle/img/oracle-whitepaper-clp.png"/>
      </fo:block>
    </fo:block-container>
  </xsl:template>
  <!--
  ...
  <xsl:template match="title" mode="book.titlepage.recto.auto.mode">
    <fo:block xsl:use-attribute-sets="book.titlepage.recto.style" font-size="24pt" font-weight="bold" color="{$major.title.color}" space-before="150pt">
  ...
  <xsl:template match="subtitle" mode="book.titlepage.recto.auto.mode">
    <fo:block xsl:use-attribute-sets="book.titlepage.recto.style" font-size="14pt" font-style="italic" color="{$minor.title.color}" space-before="0.5em">
  ...
  == OVERRIDE:
  ==
  == Verso (Left) Subtitle Page Generator
  =====================================================================
  -->
  <xsl:template match="subtitle" mode="book.titlepage.verso.auto.mode">
    <fo:block xsl:use-attribute-sets="book.titlepage.verso.style" font-size="14pt" font-style="italic" color="{$minor.title.color}" space-before="0.5em">
  ...
  == OVERRIDE:
  ==
  == Verso (Left) Corp Edition Generator
  =====================================================================
  -->
  ...
  == OVERRIDE:
  ==
  == Verso (Left) Corp Author Generator
  =====================================================================
  -->
  ...
  == OVERRIDE:
  ==
  == Verso (Left) Author Group Generator
  =====================================================================
  -->
  ...
  == OVERRIDE:
  ==
  == Verso (Left) Other Credit Generator
  =====================================================================
  -->
  ...
  == OVERRIDE:
  ==
  == Verso (Left) Publication Date Generator
  =====================================================================
  -->
  ...
  == OVERRIDE:
  ==
  == Verso (Left) Copyright Generator
  =====================================================================
  -->
  ...
  <xsl:template match="title" mode="part.titlepage.recto.auto.mode">
    <fo:block xsl:use-attribute-sets="part.titlepage.recto.style" text-align="center" font-size="24pt" space-before="18.6624pt" font-weight="bold" font-family="{$title.fontset}" color="{$minor.title.color}">
      <xsl:call-template name="division.title">
  ...
  <xsl:template match="subtitle" mode="part.titlepage.recto.auto.mode">
    <fo:block xsl:use-attribute-sets="part.titlepage.recto.style" text-align="center" font-size="20pt" space-before="15.552pt" font-weight="bold" font-style="italic" font-family="{$title.fontset}">
