<?xml version='1.0'?>
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:doc="http://nwalsh.com/xsl/documentation/1.0" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink" exclude-result-prefixes="doc xlink" version='1.0'>
  <!-- ********************************************************************
  ...
  <doc:pi name="dbfo_background-color" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo background-color="<replaceable>color</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>background-color="<replaceable>color</replaceable>"</term>
          <listitem>
  ...
  <doc:pi name="dbfo_bgcolor" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo bgcolor="<replaceable>color</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>bgcolor="<replaceable>color</replaceable>"</term>
          <listitem>
            <para>An HTML color value</para>
          </listitem>
        </varlistentry>
  ...
  <doc:pi name="dbfo_font-size" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo font-size="SIZE"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>font-size="SIZE"</term>
          <listitem>
  ...
  <doc:pi name="dbfo_glossterm-width" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo glossterm-width="<replaceable>width</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>glossterm-width="<replaceable>width</replaceable>"</term>
          <listitem>
  ...
  <doc:pi name="dbfo_keep-together" xmlns="">
    ...
    <refsee role="tcg">
      <para>
        <link role="tcg" xlink:href="PageBreaking.html#KeepTogetherPI">Keep-together processing instruction</link>
      </para>
    </refsee>
  </doc:pi>
  ...
  or calloutlist</refpurpose>
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo label-width="<replaceable>width</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>label-width="<replaceable>width</replaceable>"</term>
          <listitem>
  ...
  <doc:pi name="dbfo_linenumbering.everyNth" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo linenumbering.everyNth="<replaceable>N</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>linenumbering.everyNth="<replaceable>N</replaceable>"</term>
          <listitem>
  ...
  <doc:pi name="dbfo_linenumbering.separator" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo linenumbering.separator="<replaceable>text</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>linenumbering.separator="<replaceable>text</replaceable>"</term>
          <listitem>
  ...
  <doc:pi name="dbfo_linenumbering.width" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo linenumbering.width="<replaceable>width</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>linenumbering.width="<replaceable>width</replaceable>"</term>
          <listitem>
  ...
  <doc:pi name="dbfo_list-presentation" xmlns="">
    ...
    <refsee role="tcg">
      <para>
        <link role="tcg" xlink:href="Variablelists.html#ListIndents">Variable list formatting in print</link>
      </para>
    </refsee>
  </doc:pi>
  ...
  <doc:pi name="dbfo_list-width" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo list-width="<replaceable>width</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>list-width="<replaceable>width</replaceable>"</term>
          <listitem>
  ...
  <doc:pi name="dbfo_rotated-width" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo rotated-width="<replaceable>width</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>rotated-width="<replaceable>width</replaceable>"</term>
          <listitem>
  ...
  <doc:pi name="dbfo_sidebar-width" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo sidebar-width="<replaceable>width</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>sidebar-width="<replaceable>width</replaceable>"</term>
          <listitem>
  ...
  <doc:pi name="dbfo_start" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo start="<replaceable>character</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>start="<replaceable>character</replaceable>"</term>
          <listitem>
  ...
  <doc:pi name="dbfo_table-width" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo table-width="<replaceable>width</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>table-width="<replaceable>width</replaceable>"</term>
          <listitem>
  ...
  <doc:pi name="dbfo_term-width" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo term-width="<replaceable>width</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>term-width="<replaceable>width</replaceable>"</term>
          <listitem>
  ...
  <doc:pi name="dbfo-need" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo-need height="<replaceable>n</replaceable>" [space-before="<replaceable>n</replaceable>"]</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>height="<replaceable>n</replaceable>"</term>
          <listitem>
            <para>The amount of height needed (including units)</para>
          </listitem>
        </varlistentry>
        <varlistentry>
          <term>space-before="<replaceable>n</replaceable>"</term>
          <listitem>
    ...
    <refsee role="tcg">
      <para>
        <link role="tcg" xlink:href="PageBreaking.html#SoftPageBreaks">Soft page breaks</link>
      </para>
    </refsee>
  </doc:pi>
  <doc:pi name="dbfo_row-height" xmlns="">
    ...
    <refsynopsisdiv>
      <synopsis>
        <tag class="xmlpi">dbfo row-height="<replaceable>height</replaceable>"</tag>
      </synopsis>
    </refsynopsisdiv>
    <refparameter>
      <variablelist>
        <varlistentry>
          <term>row-height="<replaceable>height</replaceable>"</term>
          <listitem>
  ...
  <xsl:template name="pi.dbfo-need">
    ...
    <xsl:choose>
      ...
      <xsl:when test="following-sibling::para">
        <fo:block space-after="0pt" xsl:use-attribute-sets="normal.para.spacing">
          <xsl:copy-of select="$spacer"/>
        </fo:block>
      </xsl:when>
      ...
      following-sibling::tip">
        <xsl:choose>
          <xsl:when test="$admon.graphics = 0">
            <fo:block space-after="0pt" xsl:use-attribute-sets="nongraphical.admonition.properties">
              <xsl:copy-of select="$spacer"/>
            </fo:block>
          </xsl:when>
          <xsl:otherwise>
            <fo:block space-after="0pt" xsl:use-attribute-sets="graphical.admonition.properties">
              <xsl:copy-of select="$spacer"/>
            </fo:block>
          </xsl:otherwise>
        </xsl:choose>
      ...
      following-sibling::equation">
        <fo:block space-after="0pt" xsl:use-attribute-sets="formal.object.properties">
          <xsl:copy-of select="$spacer"/>
        </fo:block>
      </xsl:when>
      ...
      following-sibling::informalequation">
        <fo:block space-after="0pt" xsl:use-attribute-sets="informal.object.properties">
          <xsl:copy-of select="$spacer"/>
        </fo:block>
      </xsl:when>
      ...
      following-sibling::step">
        <fo:list-item space-after="0pt" xsl:use-attribute-sets="informal.object.properties">
          <fo:list-item-label>
      ...
      following-sibling::section">
        <fo:block space-after="0pt" xsl:use-attribute-sets="section.title.properties">
          <xsl:copy-of select="$spacer"/>
        </fo:block>
      </xsl:when>
      <xsl:otherwise>
    ...
    <xsl:choose>
      ...
      <xsl:when test="following-sibling::listitem or
      following-sibling::step">
        <fo:list-item space-before.precedence="force" space-before="-{$height}" space-after="0pt" space-after.precedence="force">
          <fo:list-item-label>
            <fo:block line-height="0pt"/>
          </fo:list-item-label>
          <fo:list-item-body start-indent="0pt" end-indent="0pt">
      ...
      <xsl:otherwise>
        <fo:block space-before.precedence="force" space-before="-{$height}" space-after="0pt" space-after.precedence="force">
      </fo:block>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
