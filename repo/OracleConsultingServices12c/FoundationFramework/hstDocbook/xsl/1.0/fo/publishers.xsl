<?xml version="1.0"?>
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:dc="http://purl.org/dc/elements/1.1/" exclude-result-prefixes="dc" version='1.0'>
  ...
  <xsl:template match="drama">
    ...
    <xsl:element name="fo:{$section.container.element}" use-attribute-sets="drama.properties">
  ...
  <xsl:template match="dialogue">
    ...
    <xsl:element name="fo:{$section.container.element}" use-attribute-sets="dialogue.properties">
      <xsl:attribute name="id">
        <xsl:value-of select="$id"/>
      </xsl:attribute>
  ...
  <xsl:template match="poetry">
    ...
    <xsl:element name="fo:{$section.container.element}" use-attribute-sets="poetry.properties">
      <xsl:attribute name="id">
        <xsl:value-of select="$id"/>
      </xsl:attribute>
