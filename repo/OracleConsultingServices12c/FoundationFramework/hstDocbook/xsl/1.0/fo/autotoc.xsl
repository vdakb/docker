...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:axf="http://www.antennahouse.com/names/XSL/Extensions" version='1.0'>
  ...
  <xsl:template name="division.toc">
    ...
    <xsl:variable name="nodes" select="$toc-context/part
  ...
  <xsl:template match="question" mode="toc">
    ...
    <fo:block xsl:use-attribute-sets="toc.line.properties" end-indent="{$toc.indent.width}pt" last-line-end-indent="-{$toc.indent.width}pt">
  ...
  <xsl:template match="sect1" mode="toc">
    ...
    <xsl:if test="$toc.section.depth > 1 
      ...
      <fo:block id="toc.{$cid}.{$id}">
        ...
        <xsl:apply-templates select="sect2|qandaset[$qanda.in.toc != 0]" mode="toc">
          <xsl:with-param name="toc-context" select="$toc-context"/>
        </xsl:apply-templates>
      </fo:block>
    </xsl:if>
  ...
  <xsl:template match="sect2" mode="toc">
    ...
    <xsl:if test="$toc.section.depth > 2 
      ...
      <fo:block id="toc.{$cid}.{$id}">
        ...
        <xsl:apply-templates select="sect3|qandaset[$qanda.in.toc != 0]" mode="toc">
          <xsl:with-param name="toc-context" select="$toc-context"/>
        </xsl:apply-templates>
      </fo:block>
    </xsl:if>
  ...
  <xsl:template match="sect3" mode="toc">
    ...
    <xsl:if test="$toc.section.depth > 3 
      ...
      <fo:block id="toc.{$cid}.{$id}">
        ...
        <xsl:apply-templates select="sect4|qandaset[$qanda.in.toc != 0]" mode="toc">
          <xsl:with-param name="toc-context" select="$toc-context"/>
        </xsl:apply-templates>
      </fo:block>
    </xsl:if>
  ...
  <xsl:template match="sect4" mode="toc">
    ...
    <xsl:if test="$toc.section.depth > 4 
      ...
      <fo:block id="toc.{$cid}.{$id}">
        ...
        <xsl:apply-templates select="sect5|qandaset[$qanda.in.toc != 0]" mode="toc">
          <xsl:with-param name="toc-context" select="$toc-context"/>
        </xsl:apply-templates>
      </fo:block>
    </xsl:if>
    ...
    <xsl:if test="$toc.section.depth &gt;= $depth">
      ...
      <xsl:if test="$toc.section.depth > $depth 
        ...
        <fo:block id="toc.{$cid}.{$id}">
          ...
          <xsl:apply-templates select="section|qandaset[$qanda.in.toc != 0]" mode="toc">
            <xsl:with-param name="toc-context" select="$toc-context"/>
          </xsl:apply-templates>
        </fo:block>
      </xsl:if>
  ...
  <xsl:template name="list.of.titles">
    ...
    <xsl:if test="$nodes">
      <fo:block id="lot...{$titles}...{$id}" xsl:use-attribute-sets="toc.margin.properties">
        <xsl:choose>
