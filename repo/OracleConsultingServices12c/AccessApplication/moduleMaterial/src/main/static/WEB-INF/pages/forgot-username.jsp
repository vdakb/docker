  ...
  <body>
    <form name="sigin" role="form" action="#" method="post">
      <div class="container sm">
        <div class="box">
          <div class="title"><fmt:message key="forgot.username"/></div>
          <p><fmt:message key="reset.username"/></p>
          <div class="input">
            <label for="fc-email"><fmt:message key="reset.input"/></label>
            <input id="fc-email" name="emailaddress" type="email" required>
            <span class="spin"></span>
          </div>
          <div class="button signin">
            <button><span><fmt:message key="reset.submit"/></span>&nbsp;<i class="fa fa-check"></i></button>
          </div>
