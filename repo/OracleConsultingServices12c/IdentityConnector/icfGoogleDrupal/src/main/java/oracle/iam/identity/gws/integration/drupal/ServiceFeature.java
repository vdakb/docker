/*
    ...
    Subsystem   :   Google Drupal Portal Connector
...
public class ServiceFeature extends TargetFeature {
  ...
  public final boolean fetchSchema() {
    return booleanValue(oracle.iam
                              .identity
                              .gws
                              .integration
                              .drupal
  ...
  /**
   ** Returns the value of the extended configuration attribute to detect the
   ** created timestamp of an entry provided by the Service Provider.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Service.OIM.Feature#ENTRY_CREATED_ATTRIBUTE}.
   **
  ...
  /**
   ** Returns the value of the extended configuration attribute to detect the
   ** modified timestamp of an entry provided by the Service Provider.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Service.OIM.Feature#ENTRY_MODIFIED_ATTRIBUTE}.
   **
   ** @return                    the value of the extended configuration
   **                            attribute to detect the modified timestamp.
   **                            <br>
   **                            Possible object is {@link String}.
   */
   ...
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Service.OIM.Feature#ENTITLEMENT_PREFIX_REQUIRED}.
   **
   ...
   * <br>
   * Possible object is {@link ServiceFeature} .
   */
