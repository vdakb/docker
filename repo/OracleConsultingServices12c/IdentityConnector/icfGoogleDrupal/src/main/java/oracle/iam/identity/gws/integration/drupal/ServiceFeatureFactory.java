...
final class ServiceFeatureFactory extends FeatureFactory  {
   ...
   *
   * @param feature the {@link oracle.iam.identity.gws.integration.drupal.ServiceFeature} that this
   * factory will configure.
   * <br>
   * Allowed object is {@link oracle.iam.identity.gws.integration.drupal.ServiceFeature} .
   *
  ...
  // Method:   configure
  /**
   * Factory method to configure a {@link oracle.iam.identity.gws.integration.drupal.ServiceFeature} from a {@link File} .
   *
   * @param feature the {@link oracle.iam.identity.gws.integration.drupal.ServiceFeature} to be configured by
   ...
   *
   * @return the {@link oracle.iam.identity.gws.integration.drupal.ServiceFeature} to allow method
   * chaining.
   * <br>
   * Possible object {@link oracle.iam.identity.gws.integration.drupal.ServiceFeature} .
   *
  ...
  // Method:   configure
  /**
   * Factory method to configure a {@link oracle.iam.identity.gws.integration.drupal.ServiceFeature} from an
   * {@link InputStream} .
   *
   * @param feature the {@link oracle.iam.identity.gws.integration.drupal.ServiceFeature} to be configured by
   * this {@link FeatureFactory} .
