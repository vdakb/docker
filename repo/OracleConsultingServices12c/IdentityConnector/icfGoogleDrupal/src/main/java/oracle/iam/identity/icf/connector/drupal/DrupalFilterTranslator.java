...
// ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** PCF SCIM implementation to translate ICF Filter in the PCF SCIM syntax.
 ** <p>
 ...
 ** @since   1.0.0.0
 */
class DrupalFilterTranslator extends FilterTranslator<String> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a PCF SCIM filter <code>DrupalFilterTranslator</code> that allows use
   ** as a JavaBean.
   ** <br>
   ...
   ** Default Constructor
   */
  private DrupalFilterTranslator() {
    // ensure inheritance
    super();
  }
  ...
  /**
   ** Factory method to create a PCF SCIM <code>OR</code> filter expression.
   **
   ** @param  lhs                the left hand side PCF SCIM <code>OR</code>
   **                            filter expression.
   **                            <br>
   **                            Must never be <code>null</code>.
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  rhs                the right hand side PCF SCIM <code>OR</code>
   **                            filter expression.
   **                            <br>
   **                            Must never be <code>null</code>.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ** @return                    the PCF SCIM <code>OR</code> expression.
  ...
  /**
   ** Factory method to create a PCF SCIM <code>AND</code> filter expression.
   **
   ** @param  lhs                the left hand side PCF SCIM <code>AND</code>
   **                            filter expression.
   **                            <br>
   **                            Must never be <code>null</code>.
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  rhs                the right hand side PCF SCIM <code>AND</code>
   **                            filter expression.
   **                            <br>
   **                            Must never be <code>null</code>.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ** @return                    the PCF SCIM <code>AND</code> expression.
   **                            A return value of <code>null</code> means a
  ...
  /**
   ** Factory method to create a PCF SCIM <code>EQUAL</code> filter expression.
   **
   ...
   **
   ** @return                    the PCF SCIM <code>EQUAL</code> filter
   **                            expression.
   **                            A return value of <code>null</code> means a
  ...
  protected String createEQ(final EqualsFilter filter, final boolean not) {
    return filter(filter.getAttribute().getName(), SchemaUtility.singleValue(filter.getAttribute(), String.class), not ? NE : EQ, false);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   createGT (ServiceFilterTranslator)
  /**
   ** Factory method to create a PCF SCIM <code>GREATER-THAN</code> filter
   ** expression.
   **
  ...
  protected String createGT(final GreaterThanFilter filter, final boolean not) {
    return filter(filter.getAttribute().getName(), SchemaUtility.singleValue(filter.getAttribute(), String.class), GT, not);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   createGE (ServiceFilterTranslator)
  /**
   ** Factory method to create a PCF SCIM <code>GREATER-THAN-EQUAL</code> filter
   ** expression.
   **
  ...
  protected String createGE(final GreaterThanOrEqualFilter filter, final boolean not) {
    return filter(filter.getAttribute().getName(), SchemaUtility.singleValue(filter.getAttribute(), String.class), GE, not);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   createLT (ServiceFilterTranslator)
  /**
   ** Factory method to create a PCF SCIM <code>LESS-THAN</code> filter
   ** expression.
   **
  ...
  protected String createLT(final LessThanFilter filter, final boolean not) {
    return filter(filter.getAttribute().getName(), SchemaUtility.singleValue(filter.getAttribute(), String.class), LT, not);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   createLE (ServiceFilterTranslator)
  /**
   ** Factory method to create a PCF SCIM <code>LESS-THAN-EQUAL</code> filter
   ** expression.
   **
  ...
  protected String createLE(final LessThanOrEqualFilter filter, final boolean not) {
    return filter(filter.getAttribute().getName(), SchemaUtility.singleValue(filter.getAttribute(), String.class), LE, not);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   createSW (ServiceFilterTranslator)
  /**
   ** Factory method to create a PCF SCIM <code>STARTS-WITH</code> filter
   ** expression.
   **
  ...
  protected String createSW(final StartsWithFilter filter, final boolean not) {
    return filter(filter.getAttribute().getName(), SchemaUtility.singleValue(filter.getAttribute(), String.class), SW, not);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   createEW (ServiceFilterTranslator)
  /**
   ** Factory method to create a PCF SCIM <code>ENDS-WITH</code> filter
   ** expression.
   **
...
//  @Override
  protected String createEW(final EndsWithFilter filter, final boolean not) {
    return filter(filter.getAttribute().getName(), SchemaUtility.singleValue(filter.getAttribute(), String.class), EW, not);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   createCO (ServiceFilterTranslator)
  /**
   ** Factory method to create a PCF SCIM <code>CONTAINS</code> filter
   ** expression.
   **
  ...
  protected String createCO(final ContainsFilter filter, final boolean not) {
    return filter(filter.getAttribute().getName(), SchemaUtility.singleValue(filter.getAttribute(), String.class), CO, not);
  }
   ...
   **                            <br>
   **                            Possible object is {@link DrupalFilterTranslator}.
   */
  static DrupalFilterTranslator build() {
    final String method = "DrupalFilterTranslator#build()";
  ...
  static String filter(final String name, final String value, final String operator, final boolean not) {
    final String method = "DrupalFilterTranslator#filter()";
