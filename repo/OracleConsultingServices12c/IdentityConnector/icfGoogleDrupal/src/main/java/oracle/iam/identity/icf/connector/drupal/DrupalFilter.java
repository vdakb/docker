...
public class DrupalFilter {
   ...
   **                            Allowed object is {@link String}.
   */
  private DrupalFilter(final String expression, final String entryDN) {
    // ensure inheritance
    super();

    final String method = "DrupalFilter#DrupalFilter()";
//    System.out.println(method + " expression=" + expression + ", entryDN=" + entryDN);
   ...
   */
  public DrupalFilter with(final String expression) {
    return new DrupalFilter(expression, this.entryDN);
  }
   ...
   * <br>
   * Possible object is {@link DrupalFilter} .
   */
  public static DrupalFilter expression(final String expression) {
    return new DrupalFilter(expression, null);
  }
   ...
   * Possible object is {@link DrupalFilter} .
   */
  public static DrupalFilter entry(final String entryDN) {
    return new DrupalFilter(null, entryDN);
  }
  ...
  public final boolean equals(final Object other) {
    if ((other instanceof DrupalFilter)) {
      final DrupalFilter that = (DrupalFilter)other;
   ...
   **                            <code>DirectoryFilter</code>.
   */
  public DrupalFilter and(final DrupalFilter other) {
    if ((this.entryDN == null) || (other.entryDN == null)) {
      return new DrupalFilter(compose(this.expression, other.expression, '&'), this.entryDN != null ? this.entryDN : other.entryDN);
    }
    return null;
  }
   ...
   **                            <code>DirectoryFilter</code>.
   */
  public DrupalFilter or(final DrupalFilter other) {
    if ((this.entryDN == null) || (other.entryDN == null)) {
      return new DrupalFilter(compose(this.expression, other.expression, '|'), this.entryDN != null ? this.entryDN : other.entryDN);
    }
    return null;
