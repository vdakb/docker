...
final class ServiceFeatureParser extends FeatureParser {
  ...
  enum Grammar {
     ...
     ** all the enums are constructed.
      */
    static {
      for (Grammar state : ServiceFeatureParser.Grammar.values()) {
   ...
   *
   * @param feature the {@link oracle.iam.identity.gws.integration.drupal.ServiceFeature} to be configured
