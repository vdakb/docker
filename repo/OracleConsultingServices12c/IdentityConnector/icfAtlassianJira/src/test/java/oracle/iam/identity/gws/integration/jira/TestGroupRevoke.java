...
public class TestGroupRevoke extends TestCase {
  ...
  static final String identifier = "max";

  static final Set<Attribute> groupAttribute = AttributeFactory.set(
    new String[]{
        Uid.NAME
      , Name.NAME
    }
  ...
  public static void main(String[] args) {
    ...
    object.addAttributes(groupAttribute);
    final OperationOptions option   = new OperationOptionsBuilder().build();
    final Set<Attribute>  attribute = CollectionUtility.set(AttributeBuilder.build("group", object.build()));
    
    try {
      Network.facade(Network.intranet()).removeAttributeValues(ObjectClass.ACCOUNT, new Uid(identifier), attribute, option);
    }
