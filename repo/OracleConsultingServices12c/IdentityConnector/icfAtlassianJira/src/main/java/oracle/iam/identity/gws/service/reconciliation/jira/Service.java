/*
    ...
    ------------+-----------+-----------+-----------------------------------
    1.0.0.0      2021-04-06  SBernet    First release version
*/
 ...
 ** <code>Atlassian Jira Connector</code> Service Provider.
 **
 ** @author  sylvert.bernet@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public abstract class Service extends EntityReconciliation {
  ...
  private static final String CATEGORY  = "OCS.AJS.RECONCILIATION";
