 ...
 */
public class GenericHttpURLConnection extends HttpURLConnection {

  /**
   ** Constructs an {@link GenericHttpURLConnection} instance.
   **
   ** @param url                 An {@link URL} instance to connect.
   */
  public GenericHttpURLConnection(URL url) {
    this(url, null);
  }
   ...
   */
  public GenericHttpURLConnection(URL url, Proxy proxy) {
    super(url, proxy);
  }
