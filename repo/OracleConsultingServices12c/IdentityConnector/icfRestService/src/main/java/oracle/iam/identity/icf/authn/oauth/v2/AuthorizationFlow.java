 ...
 ** Flows). The result of the authorization is the {@link Token access token}.
 ...
 ** <ol>
 **   <li>Get the instance of this interface using {@link AuthorizationClient}.
 ...
 **   <li>You can use access token from <code>Token</code> together with
 **       {@link Principal} to perform the authenticated requests to the Service
 **       Provider. You can also call methods
...
public interface AuthorizationFlow {
  ...
  public interface Builder<T extends Builder> {
    ...
    // Method: build
    /**
     ** Factory method to build a <code>AuthorizationFlow</code> instance.
     **
     ** @return                  the new instance of {@code AuthorizationFlow}.
     **                          <br>
     **                          Possible object is {@link AuthorizationFlow}.
     */
    AuthorizationFlow build();
  }
   ...
   */
  Token finish(final String code, final String state);
   ...
   */
  Token refreshToken(final String refreshToken)
