/*
    ...
    File        :   MappedStringListDeserializer.java
...
////////////////////////////////////////////////////////////////////////////////
// final class MappedStringListDeserializer
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** Serializes the mapping for list of strings from a REST object
 ** representation.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public final class MappedStringListDeserializer extends JsonDeserializer<Object> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>MappedStringListDeserializer</code> REST object
   ...
   ** Default Constructor
   */
  public MappedStringListDeserializer() {
	  // ensure inheritance
    super();
  }
  ...
  public Object deserialize(final JsonParser parser, final DeserializationContext context)
    ...
    while (cursor.hasNext()) {
      ...
      if (!e.getValue().isArray()) {
        v.add((e.getValue().isNull()) ? null : e.getValue().asText());
      }
      else {
