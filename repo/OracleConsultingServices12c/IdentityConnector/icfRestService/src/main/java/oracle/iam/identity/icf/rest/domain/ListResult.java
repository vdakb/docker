...
public class ListResult<T> implements Iterable<T> {
   ...
   ** operation.
   */
  public static final String TOTAL    = "total_results";
  /**
  ...
  /**
   ** The number of resources returned in a list result page.
   */
  @JsonProperty(PAGES)
  ...
  // Method:   Ctor
  /**
   ** Constructs a REST <code>ListResult</code> result obtaining the
   ** properties from the given value mapping
   **
   ** @param  properties         the value mapping
   */
  @JsonCreator(mode=JsonCreator.Mode.DELEGATING)
  public ListResult(final Map<String, Object> properties) {
    // ensure inheritance
    ...
    this.pages    = properties.containsKey(PAGES) ? (Integer)properties.get(PAGES) : null;
  ...
  // Method:   Ctor
  /**
   ** Constructs a SCIM <code>ListResult</code> with the specified properties
   **
   ...
   ** @param  pages              the number of pages returned in a list
   **                            result page.
   **                            <br>
   **                            Allowed object is {@link Integer}.
   */
  public ListResult(final int total, final List<T> resource, final Integer start, final Integer pages) {
    // ensure inheritance
    super();
  ...
  // Method:   Ctor
  /**
   ** Constructs a SCIM <code>ListResult</code>.
   **
   ...
   **                            element is of type <code>T</code>.
   */
  public ListResult(final Collection<T> resources) {
  ...
  // Method:   pages
  /**
   ** Returns the number of pages returned in a list result page.
   **
   ** @return                    the number of pages returned in a list
   **                            result page.
   **                            <br>
   **                            Possible object is <code>int</code>.
   */
  ...
  public final boolean equals(final Object other) {
    ...
    final ListResult that = (ListResult)other;
