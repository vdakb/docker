 ...
 ** Which are:
 ** <ul>
 **   <li><b>Fast</b>           - we read and create so much JSON that the
 **                               parser directly affects the server
 **                               performance.
 **   <li><b>Lightweight</b>    - it should deal with memory sparingly as we
 **                               deal with lots of messages.
