...
///////////////////////////////////////////////////////////////////////////////
// final class FilterUnicodeStream
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~
/**
 ** A <code>FilterUnicodeStream</code> contains some other input stream, which
 ** it uses as its  basic source of data, possibly transforming the data along
 ...
 */
final class FilterUnicodeStream extends FilterInputStream {
  ...
  // Method:   Ctor
  /**
   ** Creates a <code>FilterUnicodeStream</code> by remember the argument
   ...
   */
  public FilterUnicodeStream(final InputStream stream) {
    // ensure inheritance
    super(stream);
   ...
   **                            <br>
   **                            Possible object is {@link Charset}.
   */
  Charset charset() {
    return this.charset;
  }
