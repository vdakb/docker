 ...
 ** synchronization.
 ** <p>
 ** This class is usually used to verify performance during proof-of-concepts
 ** and in development, rather than as part of production applications.
 ** <p>
 ** Example:
 ** <pre>
 **   Watch watch = new Watch();<br>
 **   watch.start("key1");
 **   &emsp;&emsp; :
 **   watch.start("key2");
 **   &emsp;&emsp; :
...
public class Watch {
  ...
  public static class Task {
    ...
    //
    /**
     ** @param  name             the name of this task timer.
     **                          <br>
     **                          Allowed object is <code>Task</code>.
     */
     ...
     **                          <br>
     **                          Possible object is <code>Task</code>.
     **
     ** @see    #restart()
     */
   ...
   */
  public Watch(final String identifier) {
    // ensure inheritance
    super();
   ...
   ** <p>
   ** Set this to <code>false</code> when using a <code>Watch</code> for
  ...
  public String formatted() {
    ...
    final TableFormatter table  = new TableFormatter()
      .header(LoggingBundle.string(LoggerMessage.TIMER_ELAPSED))
      .header(LoggingBundle.string(LoggerMessage.TIMER_PERCENT))
      .header(LoggingBundle.string(LoggerMessage.TIMER_COUNTER))
      ;
    for (String name : this.timer.keySet()) {
  ...
  public String summary() {
    stop();
    return LoggingBundle.string(LoggerMessage.TIMER_SUMMARY, this.root.name, this.root.elapsed);
  }
  ...
  public synchronized void stop(final String name)
    ...
    if (this.keep) {
      final Task task = this.timer.get(name);
      if (task == null)
        throw new IllegalStateException(LoggingBundle.string(LoggerError.TIMER_NOT_RUNNING));
