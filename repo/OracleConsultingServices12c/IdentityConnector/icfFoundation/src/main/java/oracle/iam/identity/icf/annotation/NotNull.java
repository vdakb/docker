 ...
 ** <br>
 ** This annotation type is not strictly enforced by the compiler, but
 ** development environments may be configured to warn or reject attempts to use
 ** <code>null</code> values where non-<code>null</code> values are expected.
 ** <p>
