...
import oracle.iam.identity.icf.foundation.utility.PropertyUtility;
...
public final class SecurityContext {
  ...
  public SSLContext create(final KeyManager[] identity, final TrustManager[] trusted, final SecureRandom random)
    ...
    try {
      ...
      throw new SystemException(SystemError.SECURITY_INITIALIZE, e);
    }
    catch (NoSuchAlgorithmException e) {
      throw new SystemException(SystemError.SECURITY_ALGORITHM, e);
    }
  }
  ...
  protected KeyManagerFactory identity()
    ...
    if (identity == null && (this.identity.payload != null || this.identity.file != null)) {
      try {
        ...
        throw new SystemException(SystemError.IDENTITY_IMPLEMENTATION, this.identity.type);
      }
      catch (CertificateException e) {
        throw new SystemException(SystemError.IDENTITY_CERT_NOTLOADED);
      }
      catch (FileNotFoundException e) {
        throw new SystemException(SystemError.IDENTITY_FILE_NOTFOUND, this.identity.file);
      }
      catch (IOException e) {
        throw new SystemException(SystemError.IDENTITY_FILE_NOTLOADED, this.identity.file);
      }
      catch (NoSuchProviderException e) {
        throw new SystemException(SystemError.IDENTITY_PROVIDER, this.identity.provider);
      }
      catch (NoSuchAlgorithmException e) {
...
//          LOGGER.config(LocalizationMessages.SSL_KMF_NO_PASSWORD_SET(ksName));
        ...
        throw new SystemException(SystemError.SECURITY_UNRECOVERABLE, e);
      }
      catch (NoSuchAlgorithmException e) {
        throw new SystemException(SystemError.SECURITY_ALGORITHM, e);
      }
      catch (NoSuchProviderException e) {
        throw new SystemException(SystemError.SECURITY_PROVIDER, e);
      }
    }
    return factory;
  }
  ...
  protected TrustManagerFactory trusted()
    ...
    if (trusted == null && (this.trusted.payload != null || this.trusted.file != null)) {
      try {
        ...
        throw new SystemException(SystemError.TRUSTED_IMPLEMENTATION, this.trusted.type);
      }
      catch (CertificateException e) {
        throw new SystemException(SystemError.TRUSTED_CERT_NOTLOADED);
      }
      catch (FileNotFoundException e) {
        throw new SystemException(SystemError.TRUSTED_FILE_NOTFOUND, this.trusted.file);
      }
      catch (IOException e) {
        throw new SystemException(SystemError.TRUSTED_FILE_NOTLOADED, this.trusted.file);
      }
      catch (NoSuchProviderException e) {
        throw new SystemException(SystemError.TRUSTED_PROVIDER, this.trusted.provider);
      }
      catch (NoSuchAlgorithmException e) {
