...
// ~~~~~ ~~~~
/**
 ** The base class for CRUD operation on global roles (aka AdminRole) at the
...
public class Base extends TestFixture {
  ...
  /**
   ** The UID belonging to the global admin role <i>System Administrator</i>.
   */
  public static final Uid  UID_1          = new Uid("1");
  /**
   ** The UID belonging to an unknown global admin role <i>OrclOIMSystemAdministrator</i>.
   */
  public static final Uid  UID_SYSADMIN   = new Uid("1");
  /**
   ** The UID belonging to an unknown global admin role <i>OrclOIMSystemConfigurator</i>.
   */
  public static final Uid  UID_SYSCONFIG  = new Uid("2");
  /**
   ** The UID belonging to an unknown global admin role <i>OrclOIMCatalogAdmin</i>.
   */
  public static final Uid  UID_CATADMIN   = new Uid("3");
  /**
   ** The UID belonging to an unknown global admin role <i>OrclOIMCertificationAdministrator</i>.
   */
  public static final Uid  UID_CERTADMIN  = new Uid("22");
  /**
   ** The UID belonging to an unknown global admin role <i>OrclOIMCertificationViewer</i>.
   */
  public static final Uid  UID_CERTVIEWER = new Uid("23");
  /**
   ** The UID belonging to an unknown global admin role <i>Unknown</i>.
   */
  public static final Uid  UID_UNKNOWN    = new Uid("999999");

  public static final File PROVISIONING   = new File("src/test/resources/mds/oig-globalrole-provisioning.xml");
  public static final File RECONCILIATION = new File("src/test/resources/mds/oig-globalrole-reconciliation.xml");
