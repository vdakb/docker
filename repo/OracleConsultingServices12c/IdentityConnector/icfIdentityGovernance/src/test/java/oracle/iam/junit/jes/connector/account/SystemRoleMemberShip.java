/*
    ...
    File        :   SystemRoleMemberShip.java
 ...
 ** @since   1.0.0.0
 */
public class SystemRoleMemberShip extends TestFixture {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>SystemRoleMemberShip</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public static void main(final String[] args) {
    final String[] parameter = {SystemRoleMemberShip.class.getName()};
  ...
  public void listUnknown() {
    try {
      CONTEXT.listSystemRoleMembership("999999");
    }
  ...
  public void listSystemAdministrator() {
    try {
      ...
      final List<Role> result = CONTEXT.listSystemRoleMembership("1");
  ...
  public void listRegularUser() {
    try {
      ...
      final List<Role> result = CONTEXT.listSystemRoleMembership("3001");
      assertNotNull(result);
      assertTrue(result.size() == 1);
      
      assertEquals(result.get(0).getName(), "ALL USERS");
    }
    catch (SystemException e) {
      failed(e);
    }
