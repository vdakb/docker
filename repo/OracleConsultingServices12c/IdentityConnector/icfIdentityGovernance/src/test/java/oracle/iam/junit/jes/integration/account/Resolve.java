...
public class Resolve extends Base {
  ...
  public void resolveUnknown() {
    try {
      FACADE.resolveUsername(ObjectClass.ACCOUNT, "unknown", null);
    }
  ...
  public void resolveSystemAdministrator() {
    try {
      assertEquals(FACADE.resolveUsername(ObjectClass.ACCOUNT, "xelsysadm", null), UID_XELSYSADM);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void resolveSystemOperator() {
    try {
      assertEquals(FACADE.resolveUsername(ObjectClass.ACCOUNT, "xeloperator", null), UID_XELOPERATOR);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void resolveServerAdministrator() {
    try {
      assertEquals(FACADE.resolveUsername(ObjectClass.ACCOUNT, "weblogic", null), UID_WEBLOGIC);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void resolveInternalAdministrator() {
    try {
      assertEquals(FACADE.resolveUsername(ObjectClass.ACCOUNT, "oiminternal", null), UID_OIMINTERNAL);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void resolveRegularUser() {
    try {
      assertEquals(FACADE.resolveUsername(ObjectClass.ACCOUNT, "an4711124", null), "3001");
    }
    catch (ConnectorException e) {
      failed(e);
    }
