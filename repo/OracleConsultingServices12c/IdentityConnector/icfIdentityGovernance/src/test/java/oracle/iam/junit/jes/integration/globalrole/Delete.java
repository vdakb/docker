...
public class Delete extends Base {
  ...
  public void deleteUnknown() {
    try {
      FACADE.delete(ServiceClass.GLOBAL, UID_UNKNOWN, null);
    }
  ...
  public void orclOIMSystemAdministrator() {
    try {
      FACADE.delete(ServiceClass.GLOBAL, UID_SYSADMIN, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void deleteOrclOIMSystemConfigurator() {
    try {
      FACADE.delete(ServiceClass.GLOBAL, UID_SYSCONFIG, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void deleteOrclOIMCatalogAdmin() {
    try {
      FACADE.delete(ServiceClass.GLOBAL, UID_CATADMIN, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void deleteOrclOIMCertificationAdministrator() {
    try {
      FACADE.delete(ServiceClass.GLOBAL, UID_CERTADMIN, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void deleteOrclOIMCertificationViewer() {
    try {
      FACADE.delete(ServiceClass.GLOBAL, UID_CERTVIEWER, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
