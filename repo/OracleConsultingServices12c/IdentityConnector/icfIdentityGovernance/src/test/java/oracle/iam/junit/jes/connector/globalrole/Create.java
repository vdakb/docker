...
public class Create extends TestFixture {
  ...
  public void createUnknown() {
    try {
      CONTEXT.createGlobalRole("Unkown");
    }
  ...
  public void createOrclOIMSystemAdministrator() {
    try {
      assertEquals(CONTEXT.createGlobalRole("OrclOIMSystemAdministrator"), 1L);
    }
    catch (SystemException e) {
      failed(e);
    }
  ...
  public void createOrclOIMSystemConfigurator() {
    try {
      assertEquals(CONTEXT.createGlobalRole("OrclOIMSystemConfigurator"), 2L);
    }
    catch (SystemException e) {
      failed(e);
    }
  ...
  public void createOrclOIMCatalogAdmin() {
    try {
      assertEquals(CONTEXT.createGlobalRole("OrclOIMCatalogAdmin"), 3L);
    }
    catch (SystemException e) {
      failed(e);
    }
  ...
  public void createOrclOIMCertificationAdministrator() {
    try {
      assertEquals(CONTEXT.createGlobalRole("OrclOIMCertificationAdministrator"), 22L);
    }
    catch (SystemException e) {
      failed(e);
    }
  ...
  public void createOrclOIMCertificationViewer() {
    try {
      assertEquals(CONTEXT.createGlobalRole("OrclOIMCertificationViewer"), 23L);
    }
    catch (SystemException e) {
      failed(e);
    }
