...
public class Search extends TestReconciliation {
  ...
  public void testSearch() {
    try {
      ...
      facade(endpoint()).search(ServiceClass.TENANT, null, new Base.Handler("testSearch", mapping), option.build());
    }
  ...
  public void testFuture() {
    try {
      ...
      facade(endpoint()).search(ServiceClass.TENANT, null, new Base.Handler("testFuture", mapping), option.build());
    }
    catch (ConnectorException e) {
      failed(e);
    }
