...
import oracle.iam.junit.jes.integration.tenant.Search;
import oracle.iam.junit.jes.integration.tenant.Create;
import oracle.iam.junit.jes.integration.tenant.Delete;
import oracle.iam.junit.jes.integration.tenant.Resolve;

////////////////////////////////////////////////////////////////////////////////
// class TestTenant
// ~~~~~ ~~~~~~~~~~
/**
 ** The test suite to apply CRUD operations on scoped tenants (aka Organization)
 ** at the target system leveraging the leveraging the connector bundle deployed
 ** on a <code>Java Connector Server</code>.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
