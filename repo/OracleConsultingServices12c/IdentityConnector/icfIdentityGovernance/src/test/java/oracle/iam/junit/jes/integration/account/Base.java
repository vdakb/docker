...
public class Base extends TestFixture {
   ...
   */
  public static final Uid  UID_XELSYSADM   = new Uid("1");

  /**
   ** The UID belonging to the internel administrator <i>XELOPERATOR</i>.
   */
  public static final Uid  UID_XELOPERATOR = new Uid("2");

  /**
   ** The UID belonging to the server administrator <i>weblogic</i>.
   */
  public static final Uid  UID_WEBLOGIC    = new Uid("3");

  /**
   ** The UID belonging to the internel administrator <i>oiminternal</i>.
   */
  public static final Uid  UID_OIMINTERNAL = new Uid("4");

  /**
   ** The UID belonging to Alfons Zitterbacke <i>an4711124</i>.
   */
  public static final Uid  UID_ZITTERBACKE = new Uid("3001");
  ...
  public static final File PROVISIONING   = new File("src/test/resources/mds/oig-account-provisioning.xml");
  public static final File RECONCILIATION = new File("src/test/resources/mds/oig-account-reconciliation.xml");
