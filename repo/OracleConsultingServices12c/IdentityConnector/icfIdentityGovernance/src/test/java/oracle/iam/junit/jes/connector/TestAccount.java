...
import oracle.iam.junit.jes.connector.account.SystemRoleMemberShip;
import oracle.iam.junit.jes.connector.account.GlobalRoleMemberShip;
import oracle.iam.junit.jes.connector.account.ScopedRoleMemberShip;
 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({Lookup.class, Search.class, Create.class, SystemRoleMemberShip.class, GlobalRoleMemberShip.class, GlobalRoleMemberShip.class, ScopedRoleMemberShip.class, Delete.class})
