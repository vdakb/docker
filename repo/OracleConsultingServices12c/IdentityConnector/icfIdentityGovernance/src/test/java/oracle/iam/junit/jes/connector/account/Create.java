...
public class Create extends TestFixture {
  ...
  public void createSystemAdministrator() {
    try {
      assertEquals(CONTEXT.createUser("xelsysadm"), "1");
    }
    catch (SystemException e) {
      failed(e);
    }
  ...
  public void createSystemInternal() {
    try {
      assertEquals(CONTEXT.createUser("oiminternal"), "4");
    }
    catch (SystemException e) {
      failed(e);
    }
  ...
  public void createSystemServer() {
    try {
      assertEquals(CONTEXT.createUser("weblogic"), "3");
    }
    catch (SystemException e) {
      failed(e);
    }
  ...
  public void createSystemLegacy() {
    try {
      assertEquals(CONTEXT.createUser("XELOPERATOR"), "2");
    }
    catch (SystemException e) {
      failed(e);
    }
