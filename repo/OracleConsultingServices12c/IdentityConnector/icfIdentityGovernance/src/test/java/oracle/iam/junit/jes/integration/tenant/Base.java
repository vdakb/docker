...
// ~~~~~ ~~~~
/**
 ** The base class for CRUD operation on tenants at the target system
...
public class Base extends TestFixture {
  ...
  /**
   ** The UID belonging to an known standard organization <i>Xellerate Users</i>.
   */
  public static final Uid  UID_XELLERATE  = new Uid("1");
  /**
   ** The UID belonging to an known standard organization <i>Top</i>.
   */
  public static final Uid  UID_TOP        = new Uid("3");
  /**
   ** The UID belonging to an unknown standard organization <i>Unknown</i>.
   */
  public static final Uid  UID_UNKNOWN    = new Uid("999999");

  public static final File PROVISIONING   = new File("src/test/resources/mds/oig-tenant-provisioning.xml");
  public static final File RECONCILIATION = new File("src/test/resources/mds/oig-tenant-reconciliation.xml");
  ...
  static class Handler implements ResultsHandler {
    ...
    public boolean handle(final ConnectorObject object) {
      try {
        assertEquals(object.getObjectClass(), ServiceClass.TENANT);
