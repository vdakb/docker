...
public class Create extends Base {
  ...
  public void createSystemAdministrators() {
    assertEquals(createSystemRole("igd/create-systemrole-sysadmin.conf"), UID_SYSADMIN);
  }
  ...
  public void createAllUsers() {
    assertEquals(createSystemRole("igd/create-systemrole-allusers.conf"), UID_ALLUSERS);
  }
  ...
  public void createAdministrator() {
    assertEquals(createSystemRole("igd/create-systemrole-administrator.conf"), UID_ADMINISTRATOR);
  }
  ...
  public void createOperators() {
    assertEquals(createSystemRole("igd/create-systemrole-sysoper.conf"), UID_SYSOPER);
  }
  ...
  public void createSelfOperators() {
    assertEquals(createSystemRole("igd/create-systemrole-selfoper.conf"), UID_SELFOPER);
  }
  ...
  public void createBIReportAdministrator() {
    assertEquals(createSystemRole("igd/create-systemrole-bireport.conf"), UID_BIREPORT);
  }
