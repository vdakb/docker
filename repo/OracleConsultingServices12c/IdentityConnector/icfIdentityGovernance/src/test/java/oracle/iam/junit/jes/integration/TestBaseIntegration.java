...
public class TestBaseIntegration extends TestBase {
   ...
   */
  public static final File          ENDPOINT            = new File(RESOURCES, "igd/extranet.conf");
  /**
   ** The location of the connector server configuration in a distributed
   ** network.
   */
  public static final File          SERVER              = new File(RESOURCES, "igd/server.conf");
  /**
   ** The location of the credential file to use
   */
  public static final File          FEATURE             = new File(RESOURCES, "mds/oig-feature.xml");
  /**
