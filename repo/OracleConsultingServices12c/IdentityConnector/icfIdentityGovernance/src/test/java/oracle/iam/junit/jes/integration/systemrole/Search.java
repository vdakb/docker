...
public class Search extends TestReconciliation {
  ...
  public void testSearch() {
    try {
      ...
      facade(endpoint()).search(ObjectClass.GROUP, null, new Base.Handler("testSearch", mapping, true), option.build());
    }
  ...
  public void testFuture() {
    try {
      ...
      facade(endpoint()).search(ObjectClass.GROUP, null, new Base.Handler("testFuture", mapping, true), option.build());
    }
    catch (ConnectorException e) {
      failed(e);
    }
