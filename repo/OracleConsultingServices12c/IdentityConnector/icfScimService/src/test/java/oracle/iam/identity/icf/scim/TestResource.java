...
public class TestResource extends TestBase {
  ...
  // Method:   jsonNode
  /**
   ** Load a JSON file’s content and convert it into a {@link JsonNode}.
   **
   ** @param  path               the abstract path of the file to load.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ** @return                    the {@link JsonNode} providing the
   ...
   */
  public JsonNode jsonNode(final String path)
    throws IOException {

    return Support.objectReader().readTree(stream(path));  
  }
