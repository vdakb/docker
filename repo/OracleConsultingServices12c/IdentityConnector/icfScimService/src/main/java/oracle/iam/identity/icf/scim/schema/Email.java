...
// ~~~~~ ~~~~~
/**
 ** Stores E-mail addresses for the user.
 ** <p>
 ** The value <b>should</b> be canonicalized by the Service Provider, e.g.
 ** mmustermann@example.com instead of mmustermann@EXAMPLE.COM.
 ** <br>
...
public class Email {
  ...
  @JsonProperty("type")
  @Attribute(description="A label indicating the attribute's function; e.g., 'work' or 'home'.", canonical={WORK, HOME, OTHER})
  private String  type;
