 ...
 ** @since   1.0.0.0
 */
@Schema(id=GroupResource.SCHEMA, name=Group.NAME, description="The core schema for \"Group\" are meant to enable expression of common group-based or role-based access control models. The group core schema is identified using the following schema URI: \"urn:ietf:params:scim:schemas:core:2.0:Group\".")
public class GroupResource<T extends GroupResource> extends Entity<T> {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty SCIM 2 <code>GroupResource</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  // Method:   Ctor
  /**
   ** Constructs a new SCIM 2 <code>GroupResource</code> with the properties
   ** specified.
   **
  ...
  public T displayName(final String value) {
   ...
   */
  @SuppressWarnings({"cast", "unchecked"})
  public T members(final List<Member> value) {
    this.members = value;
    return (T)this;
  }
  ...
  // Method:   of
  /**
   ** Factory method to create a new SCIM 2 <code>GroupResource</code> with the
