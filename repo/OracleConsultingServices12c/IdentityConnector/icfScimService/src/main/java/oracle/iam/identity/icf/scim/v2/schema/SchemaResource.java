 ...
 ** @since   1.0.0.0
 */
@Schema(id=SchemaResource.ID, name="Schema", description="SCIM 2.0 Schema Resource")
public class SchemaResource extends Entity<SchemaResource> {
   ...
   **                            <br>
   **                            Allowed object of {@link Collection} where each
   **                            element is of type {@link Definition}.
   */
  @JsonCreator
