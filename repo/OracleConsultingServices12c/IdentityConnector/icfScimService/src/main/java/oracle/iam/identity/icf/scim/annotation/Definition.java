...
public class Definition {
  ...
  @Attribute(description="The attribute's name.", required=true, mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private final String                 name;

  /** the attribute's data type constraint */
  @Attribute(description="The attribute's data type.", required=true, mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private final  Type                  type;

  /** indicating whether or not this attribute is required to be present */
  @Attribute(description="A Boolean value that specifies if the attribute is required.", required=true, mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
   ...
   */
  @Attribute(description="A Boolean value that specifies if the String attribute is case sensitive.", mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private final boolean                caseExact;

  /** indicating whether or not this attribute can have multiple values */
  @Attribute(description="Boolean value indicating the attribute's plurality.", required=true, mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private final boolean                multiValued;

  /** the attribute's human readable description */
  @Attribute(description="The attribute's human readable description.", mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private final String                 description;

  /** a set of canonical values that this attribute may contain */
  @Attribute(description="A collection of suggested canonical values that MAY be used.", mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE, multiValueClass=String.class)
  private final Collection<String>     canonical;

  /** indicate the SCIM resource types that may be referenced */
  @Attribute(description="A multi-valued array of JSON strings that indicate the SCIM resource types that may be referenced.", mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE, multiValueClass=String.class)
  private final Collection<String>     reference;

  /** the sub-attributes of this attribute */
  @Attribute(description = "When an attribute is of type \"complex\", \"subAttributes\" defines set of sub-attributes.", mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE, multiValueClass=Definition.class)
   ...
   ** values
   */
  @Attribute(description="A single keyword value that specifies how the service provider enforces uniqueness of attribute values.", mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
   ...
   ** request
   */
  @Attribute(description="A single keyword that indicates when an attribute and associated values are returned in response to a GET request or in response to a PUT, POST, or PATCH request.", required=true, mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
   ...
   ** (re)defined
   */
  @Attribute(description="A single keyword indicating the circumstances under which the value of the attribute can be (re)defined.", required=true, mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
   ...
   ** attribute type constraint in a SCIM Service Provider schema.
   ** <br>
  ...
  public enum Type {
    ...
    , REFERENCE("reference")
       ...
       ** sub-attributes may have any data type except for <code>complex</code>.
       */
    , COMPLEX("complex")
    ;
   ...
   ** describing an attribute mutability in a SCIM Service Provider schema.
   */
  public enum Mutability {
     ...
     */
    @JsonCreator
    public static Mutability from(final String value) {
   ...
   ** an attribute return constraint in a SCIM Service Provider schema.
   */
  public enum Returned {
     ...
     */
    @JsonCreator
    public static Returned from(final String value) {
   ...
   ** describing an attribute uniqueness constraint in a SCIM Service Provider
   ** schema.
   */
  public enum Uniqueness {
     ...
     */
    @JsonCreator
    public static Uniqueness from(final String value) {
  ...
  Definition(@JsonProperty(value="name", required=true) final String name, @JsonProperty(value="description") final String description, @JsonProperty(value="type", required=true) final Type type, @JsonProperty(value="subAttributes") final Collection<Definition> attributes, @JsonProperty(value="multiValued") final Boolean multiValued, @JsonProperty(value="required", required=true) final Boolean required, @JsonProperty(value="caseExact") final Boolean caseExact, @JsonProperty(value="returned", required=true) final Returned returned, @JsonProperty(value="mutability") final Mutability mutability, @JsonProperty(value="uniqueness") final Uniqueness uniqueness, @JsonProperty(value="canonicalValues") final Collection<String> canonical, @JsonProperty(value="referenceTypes") final Collection<String> reference) {
    ...
    // following RFC 7643 some of the values are fallback to default
