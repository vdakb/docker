...
// ~~~~~ ~~~~~~~~~~
/**
 ** An interface to transfer SCIM 2 Resource object to and from Identity
...
public class Marshaller {
  ...
  /** The name of the user t attribute */
  ...
  // Method:   transfer
  /**
   ** Converts the specified SCIM 2 user resource to the transfer options
   ...
   ** @param  resource           the SCIM 2 user resource to convert.
   **                            <br>
  ...
  public static void transfer(final ConnectorObjectBuilder collector, final User resource)
    ...
    for (Field field : properties) {
      ...
      if (!field.isAnnotationPresent(JsonIgnore.class) && !empty(value)) {
        if (field.getGenericType().toString().contains(Name.class.getName())) {
          name(collector, Name.class.cast(value));
        }
          ...
          if (field.getType().equals(List.class)) {
            ...
            for (Email cursor : multiple) {
              email(collector, cursor);
            }
          }
          else {
            email(collector, Email.class.cast(value));
          }
        }
          ...
          if (field.getType().equals(List.class)) {
            ...
            for (PhoneNumber cursor : multiple) {
              phoneNumber(collector, cursor);
            }
          }
          else {
            phoneNumber(collector, PhoneNumber.class.cast(value));
          }
        }
          ...
          if (field.getType().equals(List.class)) {
            ...
            for (Address cursor : multiple) {
              address(collector, cursor);
            }
          }
          else {
            address(collector, Address.class.cast(value));
          }
        }
          ...
          if (field.getType().equals(List.class)) {
            ...
            for (InstantMessaging cursor : multiple) {
              instantMessaging(collector, cursor);
            }
          }
          else {
            instantMessaging(collector, InstantMessaging.class.cast(value));
          }
        }
          ...
          if (field.getType().equals(List.class)) {
            ...
            for (Photo cursor : multiple) {
              photo(collector, cursor);
            }
          }
          else {
            photo(collector, Photo.class.cast(value));
          }
        }
        else if (field.getGenericType().toString().contains(Group.class.getName())) {
          if (field.getType().equals(List.class)) {
            final List<Group> multiple = (List<Group>)value;
            // handle multi-valued group attributes as embebbed collections
            if (!CollectionUtility.empty(multiple)) {
              // add the collection to the connector object builder
              multiValuedGroup(collector, ObjectClass.GROUP, multiple);
            }
          }
        }
          ...
          if (field.getType().equals(List.class)) {
            ...
            for (Role cursor : multiple) {
              role(collector, cursor);
            }
          }
          else {
            role(collector, Role.class.cast(value));
          }
        }
          ...
          if (field.getType().equals(List.class)) {
            ...
            for (Entitlement cursor : multiple) {
              entitlement(collector, cursor);
            }
          }
          else {
            entitlement(collector, Entitlement.class.cast(value));
          }
        }
          ...
          if (field.getType().equals(List.class)) {
            ...
            for (Certificate cursor : multiple) {
              certificate(collector, cursor);
            }
          }
          else {
            certificate(collector, Certificate.class.cast(value));
          }
        }
        else if (field.getGenericType().toString().contains(Metadata.class.getName())) {
          metadata(collector, Metadata.class.cast(value));
        }
        else {
          switch (field.getName()) {
            case USERNAME   :
            case IDENTIFIER : break;
            case STATUS     : collector.addAttribute(buildAttribute(OperationalAttributes.ENABLE_NAME, field.get(resource)).build());           
                              break;
            default         : collector.addAttribute(buildAttribute(field.getName(), field.get(resource)).build());
                              break;
          }
        }
      }
  ...
  // Method:   transfer
  /**
   ** Converts the specified SCIM 2 group resource to the transfer options
   ** required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  resource           the SCIM 2 group resource to convert.
   **                            <br>
   ...
   */
  @SuppressWarnings("unchecked")
  public static void transfer(final ConnectorObjectBuilder collector, final GroupResource resource)
    throws IllegalAccessException
    ,      IllegalArgumentException {
    ...
    for (Field field : properties) {
      ...
      if (!field.isAnnotationPresent(JsonIgnore.class) && !empty(value)) {
        if (field.getGenericType().toString().contains(Member.class.getName())) {
          if (field.getType().equals(List.class)) {
            final List<Member> multiple = (List<Member>)value;
            // handle multi-valued member attributes as embebbed collections
            if (!CollectionUtility.empty(multiple)) {
              // add the collection to the connector object builder
              multiValuedMember(collector, ObjectClass.ACCOUNT, multiple);
            }
          }
        }
        else if (field.getGenericType().toString().contains(Metadata.class.getName())) {
          ...
          attributes.add(buildAttribute(field.getName(), field.get(resource)).build());
        }
      }
    }
  }
   ...
   ** specified {@link Set} of {@link Attribute}s to the SCIM 2 user resource.
   **
   ...
   **                            on the SCIM 2 user resource.
   **                            <br>
   **                            Allowed object is {@link Set} where each
   **                            elemment is of type {@link Attribute}.
   **
   ** @return                    the SCIM 2 user resource to manipulate.
   **                            <br>
   ...
   ** the specified {@link Set} of {@link Attribute}s to the SCIM 2 group
   ** resource.
   **
   ** @param  <T>                the type of the implementation.
   **                            <br>
   ...
   **                            <code>T</code>.
   ** @param  attribute          the {@link Set} of {@link Attribute}s to set
   **                            on the SCIM 2 group resource.
   **                            <br>
   **                            Allowed object is {@link Set} where each
   **                            elemment is of type {@link Attribute}.
   **
   ** @return                    the SCIM 2 group resource to convert.
   **                            <br>
   ...
   ** the specified {@link Set} of {@link Attribute}s to modify the SCIM 2 user
   ** resource.
   **
   ** @param  attribute          the {@link Set} of {@link Attribute}s to set
   **                            on the SCIM 2 user resource.
  ...
  public static List<Operation> operationUser(final Set<Attribute> attribute)
    ...
    for (Attribute cursor : attribute) {
      ...
      switch (name) {
        case "__NAME__"       : operation.add(Operation.replace(USERNAME, AttributeUtil.getSingleValue(cursor)));
                                break;
  ...
  public static List<Operation> operationGroup(final Set<Attribute> attribute, final boolean remove)
    ...
    for (Attribute cursor : attribute) {
      ...
      // only NON-READ-ONLY fields here
      switch (name) {
        case "__NAME__"       : operation.add(Operation.replace(GROUPNAME, AttributeUtil.getSingleValue(cursor)));
                                break;
        case MEMBEROF         : if (remove)
                                  operation.add(Operation.remove(String.format("%s[value eq %s]", MEMBEROF, AttributeUtil.getSingleValue(cursor))));
                                else
                                  operation.add(Operation.add(MEMBEROF, cursor.getValue()));
                                break;
        default               : operation.add(Operation.replace(name, String.class.cast(value.get(0))));
                                break;
      }
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   transferExtension
  /**
   ** Factory method to create a new {@link Set} of {@link Attribute}s for a
   ** SCIM 2 schema extension.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   **                            <br>
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  namespace          the SCIM 2 schema extension namespace.
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  resource           the {@link JsonNode} of a SCIM 2 schema
   **                            extension.
   **                            <br>
   **                            Allowed object is {@link JsonNode}.
   */
  public static void transferExtension(final ConnectorObjectBuilder collector, final String namespace, final JsonNode resource) {
    final Iterator<String>  node = resource.fieldNames();
    while (node.hasNext()) {
      final String name = node.next();
      collector.addAttribute(namespace.concat(":").concat(name), resource.get(name).asText());
    }
  }
   ...
   **
   ** @return                    the {@link AttributeBuilder} equiped with the
   **                            value pair.
   **                            <br>
   **                            Possible object is {@link AttributeBuilder}.
   */
  public static AttributeBuilder buildAttribute(final String name, final Object value) {
    ...
    if (value != null) {
      if (value instanceof List<?>) {
        ...
        if (Uid.NAME.equals(name) || "__NAME__".equals(name))
   ...
   **                            <br>
   **                            Allowed object is <code>&lt;T&gt;</code>.
   ** @param  resource           the SCIM 2 entity resource to manipulate.
   **                            <br>
   ...
   */
  @SuppressWarnings("unchecked")
  public static <T extends Resource> void extend(final Resource<T> resource, final String name, final Object value) {
    ...
    if (split != -1) {
      ...
      if (node == null) {
        ...
        resource.extension().set(namespace, node);
      }
  ...
  /**
   ** Converts the specified SCIM 2 resource attribute to the transfer options
   ** required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  layer              the SCIM 2 resource prefix.
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  property           the SCIM 2 resource property accessor.
   **                            <br>
   **                            Allowed object is {@link Object}.
   **
   ** @throws IllegalAccessException   if this <code>Field</code> of the
   ...
   **                                  subclass or implementor thereof).
   */
  private static void layerAttribute(final ConnectorObjectBuilder collector, final String layer, final Object property)
    ...
    for (Field field : properties) {
      if (!field.isAnnotationPresent(JsonIgnore.class)) {
        ...
        // field is assinged to
        field.setAccessible(true);
        collector.addAttribute(buildAttribute(layer.concat(".").concat(field.getName()), field.get(property)).build());
      }
    }
  }
   ...
   ** required by the Identity Connector Framework.
   **
   ** @param  resource           the SCIM 2 user resource to manipulate.
   **                            <br>
   **                            Allowed object is {@link User}.
   ** @param  name               the name of the attribute to manipulate.
   **                            <br>
   ...
   */
  @SuppressWarnings("unchecked")
  private static void collect(final User resource, final String name, final Object value) {
    // only NON-READ-ONLY fields here
    switch (name) {
   ...
   ** required by the Identity Connector Framework.
   **
   ** @param  resource           the SCIM 2 group resource to manipulate.
   **                            <br>
   **                            Allowed object is {@link GroupResource}.
   ** @param  name               the name of the attribute to manipulate.
   **                            <br>
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   multiValuedGroup
  /**
   ** Converts the specified SCIM 2 group resource attribute to the transfer
   ...
   ** @param  resource           the SCIM 2 group resource providing the data to
   **                            obtain.
   **                            <br>
   **                            Allowed object is {@link List} where each
   **                            element is of type {@link Group}.
   */
  public static void multiValuedGroup(final ConnectorObjectBuilder collector, final ObjectClass type, final List<Group> resource) {
    if (!CollectionUtility.empty(resource)) {
      ...
      for (Group group : resource) {
        permission.add(new EmbeddedObjectBuilder().setObjectClass(type).addAttribute(Uid.NAME, group.value()).build());
      }
      // add the collection to the connector object builder
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   multiValuedMember
  /**
   ** Converts the specified SCIM 2 member resource attribute to the transfer
   ** options required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            <br>
   **                            Allowed object is {@link ObjectClass}.
   ** @param  resource           the SCIM 2 member resource providing the data
   **                            to obtain.
   **                            <br>
   **                            Allowed object is {@link List} where each
   **                            element is of type {@link Member}.
   */
  public static void multiValuedMember(final ConnectorObjectBuilder collector, final ObjectClass type, final List<Member> resource) {
    if (!CollectionUtility.empty(resource)) {
      final List<EmbeddedObject> permission = new ArrayList<EmbeddedObject>();
      // a lambda function can avoid this loop but performance benchmarks had
      // shown saying that the overhead of Stream.forEach() compared to an
      // ordinary for loop is so significant in general that using it by default
      // will just pile up a lot of useless CPU cycles across the application 
      for (Member member : resource) {
        permission.add(new EmbeddedObjectBuilder().setObjectClass(type).addAttribute(Uid.NAME, member.value()).build());
      }
      // add the collection to the connector object builder
      collector.addAttribute(type.getObjectClassValue(), permission);
    }
  ...
  // Method:   name
  /**
   ** Converts the specified SCIM 2 name resource to the transfer options
   ** required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  resource           the SCIM 2 name resource to convert.
   **                            <br>
   ...
   **                                  subclass or implementor thereof).
   */
  private static void name(final ConnectorObjectBuilder collector, final Name resource)
    throws IllegalArgumentException
    ,      IllegalAccessException {

    layerAttribute(collector, Name.PREFIX, resource);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   name
  /**
   ** Factory method to create and associate a name SCIM 2 resource with the
   ** specified SCIM 2 user resource to the transfer options from the Identity
   ** Connector Framework.
   **
   ** @param  resource           the SCIM 2 user resource to manipulate.
   **                            <br>
   ...
   */
  private static Name name(final User resource) {
  ...
  // Method:   email
  /**
   ** Converts the specified SCIM 2 email resource to the transfer options
   ** required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  resource           the SCIM 2 email resource to convert.
   **                            <br>
   ...
   **                                  subclass or implementor thereof).
   */
  private static void email(final ConnectorObjectBuilder collector, final Email resource)
    throws IllegalArgumentException
    ,      IllegalAccessException {

    complexAttribute(collector, Email.PREFIX, resource.type() == null ? "work" : resource.type(), resource);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   email
  /**
   ** Factory method to create and associate a email SCIM 2 resource with the
   ** specified SCIM 2 user resource to the transfer options from the Identity
   ** Connector Framework.
   **
   ** @param  resource           the SCIM 2 user resource to manipulate.
   ...
   **                            <br>
   **                            Possible object is a {@link Email}.
   */
  @SuppressWarnings("unchecked")
  private static Email email(final User resource, final String type) {
    Email selected = null;
  ...
  // Method:   address
  /**
   ** Converts the specified SCIM 2 address resource to the transfer options
   ** required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  resource           the SCIM 2 address resource to convert.
   **                            <br>
   ...
   **                                  subclass or implementor thereof).
   */
  private static void address(final ConnectorObjectBuilder collector, final Address resource)
    throws IllegalArgumentException
    ,      IllegalAccessException {

    complexAttribute(collector, Address.PREFIX, resource.type(), resource);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   address
  /**
   ** Factory method to create and associate a address SCIM 2 resource with the
   ** specified SCIM 2 user resource to the transfer options from the Identity
   ** Connector Framework.
   **
   ** @param  resource           the SCIM 2 user resource to manipulate.
   ...
   */
  @SuppressWarnings("unchecked")
  private static Address address(final User resource, final String type) {
  ...
  // Method:   phoneNumber
  /**
   ** Converts the specified SCIM 2 phone number resource to the transfer
   ** options required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  resource           the SCIM 2 phone number resource to convert.
   **                            <br>
   ...
   **                                  subclass or implementor thereof).
   */
  private static void phoneNumber(final ConnectorObjectBuilder collector, final PhoneNumber resource)
    throws IllegalArgumentException
    ,      IllegalAccessException {

    complexAttribute(collector, PhoneNumber.PREFIX, resource.type() == null ? "work" : resource.type(), resource);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   phoneNumber
  /**
   ** Factory method to create and associate a phone number SCIM 2 resource with
   ** the specified SCIM 2 user resource to the transfer options from the Identity
   ** Connector Framework.
   **
   ** @param  resource           the SCIM 2 user resource to manipulate.
   **                            <br>
   ...
   */
  @SuppressWarnings("unchecked")
  private static PhoneNumber phoneNumber(final User resource, final String type) {
  ...
  // Method:   photo
  /**
   ** Converts the specified SCIM 2 photo resource to the transfer options
   ** required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  resource           the SCIM 2 photo resource to convert.
   **                            <br>
   ...
   **                                  subclass or implementor thereof).
   */
  private static void photo(final ConnectorObjectBuilder collector, final Photo resource)
    throws IllegalArgumentException
    ,      IllegalAccessException {

    complexAttribute(collector, Photo.PREFIX, resource.type(), resource);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   photo
  /**
   ** Factory method to create and associate a photo SCIM 2 resource with the
   ** specified SCIM 2 user resource to the transfer options from the Identity
   ** Connector Framework.
   **
   ** @param  resource           the SCIM 2 user resource to manipulate.
   ...
   */
  @SuppressWarnings("unchecked")
  private static Photo photo(final User resource, final String type) {
    Photo selected = null;
  ...
  /**
   ** Converts the specified SCIM 2 instant messaging resource to the transfer
   ** options required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  resource           the SCIM 2 instant messaging resource to
   **                            convert.
   **                            <br>
   **                            Allowed object is {@link InstantMessaging}.
   **
   ** @return                    the {@link Set} of {@link Attributes} to send
   **                            back.
   **                            <br>
   ...
   **                                  subclass or implementor thereof).
   */
  private static void instantMessaging(final ConnectorObjectBuilder collector, final InstantMessaging resource)
    throws IllegalArgumentException
    ,      IllegalAccessException {

    complexAttribute(collector, InstantMessaging.PREFIX, resource.type(), resource);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   instantMessaging
  /**
   ** Factory method to create and associate a instant messaging SCIM 2 resource
   ** with the specified SCIM user resource to the transfer options from the
   ...
   */
  @SuppressWarnings("unchecked")
  private static InstantMessaging instantMessaging(final User resource, final String type) {
  ...
  // Method:   group
  /**
   ** Factory method to create and associate a group SCIM 2 resource with the
   ** specified SCIM 2 user resource to the transfer options from the Identity
   ** Connector Framework.
   **
   ** @param  resource           the SCIM 2 user resource to manipulate.
   ...
   **                            with the SCIM 2 user resource so far.
   **                            <br>
   **                            Possible object is a {@link List} where each
   **                            element is of type {@link Group}.
   */
  @SuppressWarnings("unchecked")
  private static List<Group> group(final User resource) {
  ...
  // Method:   role
  /**
   ** Converts the specified SCIM 2 role resource to the transfer options
   ** required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  resource           the SCIM 2 role resource to convert.
   **                            <br>
   ...
   **                                  subclass or implementor thereof).
   */
  private static void role(final ConnectorObjectBuilder collector, final Role resource)
    throws IllegalArgumentException
    ,      IllegalAccessException {

    layerAttribute(collector, Role.PREFIX, resource);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   role
  /**
   ** Factory method to create and associate a role SCIM 2 resource with the
   ** specified SCIM 2 user resource to the transfer options from the Identity
   ** Connector Framework.
   **
   ** @param  resource           the SCIM 2 user resource to manipulate.
   ...
   */
  @SuppressWarnings("unchecked")
  private static List<Role> role(final User resource) {
  ...
  // Method:   entitlement
  /**
   ** Converts the specified SCIM 2 entitlement resource to the transfer options
   ** required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  resource           the SCIM 2 entitlement resource to convert.
   **                            <br>
   ...
   **                                  subclass or implementor thereof).
   */
  private static void entitlement(final ConnectorObjectBuilder collector, final Entitlement resource)
    throws IllegalArgumentException
    ,      IllegalAccessException {

    layerAttribute(collector, Entitlement.PREFIX, resource);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   entitlement
  /**
   ** Factory method to create and associate a entitlement SCIM 2 resource with
   ** the specified SCIM 2 user resource to the transfer options from the
   ** Identity Connector Framework.
   **
   ** @param  resource           the SCIM 2 user resource to manipulate.
   **                            <br>
   ...
   **                            associated with the SCIM 2 user resource so
   **                            far.
   **                            <br>
   **                            Possible object is a {@link List} where each
   ...
   */
  @SuppressWarnings("unchecked")
  private static List<Entitlement> entitlement(final User resource) {
  ...
  // Method:   certificate
  /**
   ** Converts the specified SCIM 2 certificate resource to the transfer options
   ** required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  resource           the SCIM 2 certificate resource to convert.
   **                            <br>
   ...
   **                                  subclass or implementor thereof).
   */
  private static void certificate(final ConnectorObjectBuilder collector, final Certificate resource)
    throws IllegalArgumentException
    ,      IllegalAccessException {

    layerAttribute(collector, Certificate.PREFIX, resource);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   certificate
  /**
   ** Factory method to create and associate a certificate SCIM 2 resource with
   ** the specified SCIM 2 user resource to the transfer options from the
   ** Identity Connector Framework.
   **
   ** @param  resource           the SCIM 2 user resource to manipulate.
   ...
   */
  @SuppressWarnings("unchecked")
  private static List<Certificate> certificate(final User resource) {
  ...
  // Method:   metadata
  /**
   ** Converts the specified SCIM 2 metadata resource to the transfer options
   ** required by the Identity Connector Framework.
   **
   ** @param  collector          the {@link ConnectorObjectBuilder} to collect
   **                            the attributes.
   ...
   **                            Allowed object is
   **                            {@link ConnectorObjectBuilder}.
   ** @param  resource           the SCIM 2 metadata resource to convert.
   **                            <br>
   ...
   **                                  subclass or implementor thereof).
   */
  private static void metadata(final ConnectorObjectBuilder collector, final Metadata resource)
    throws IllegalArgumentException
    ,      IllegalAccessException {

    layerAttribute(collector, Metadata.PREFIX, resource);
  }
   ...
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  type               the canonical type of SCIM 2 resource.
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  property           the SCIM 2 resource property accessor.
   **                            <br>
   ...
   **                                  subclass or implementor thereof).
   */
  private static void complexAttribute(final ConnectorObjectBuilder collector, final String layer, final String type, final Object property)
    throws IllegalArgumentException
    ,      IllegalAccessException {
    ...
    for (Field field : properties) {
      if (!field.isAnnotationPresent(JsonIgnore.class)) {
        ...
        // field is assinged to
        field.setAccessible(true);
        collector.addAttribute(buildAttribute(layer.concat(".").concat(type).concat(".").concat(field.getName()), field.get(property)).build());
      }
    }
  }
}