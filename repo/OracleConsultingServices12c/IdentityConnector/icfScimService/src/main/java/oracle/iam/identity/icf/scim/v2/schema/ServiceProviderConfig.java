...
import oracle.iam.identity.icf.scim.schema.BulkConfig;
import oracle.iam.identity.icf.scim.schema.ETagConfig;
import oracle.iam.identity.icf.scim.schema.SortConfig;
import oracle.iam.identity.icf.scim.schema.PatchConfig;
import oracle.iam.identity.icf.scim.schema.FilterConfig;
import oracle.iam.identity.icf.scim.schema.ChangePasswordConfig;
import oracle.iam.identity.icf.scim.schema.AuthenticationScheme;
 ...
 **/
@Schema(id=ServiceProviderConfig.ID, name="Service Provider Config", description="SCIM 2.0 Service Provider Config Resource")
