...
// ~~~~~ ~~~~~~~
/**
 ** This represents a SCIM complex type that optionally allows Service Providers
...
public class Manager {
  ...
  @JsonProperty("value")
  @Attribute(description="The id of the SCIM resource representing the User's manager.", required=true)
  private String value;

  @JsonProperty("displayName")
  @Attribute(description="The displayName of the User's manager.", mutability=Definition.Mutability.READ_ONLY)
  private String displayName;

  @JsonProperty("$ref")
  @Attribute(description="The URI of the SCIM resource representing the User's manager.", required=true, reference={"User"} )
  private URI    ref;
