...
// ~~~~~ ~~~~~~~~~~~
/**
 ** Stores entitlements for the User that represent a thing the User has.
 ** <br>
 ...
 ** value so as to accurately and without ambiguity determine what the User has
 ** access to.
 ** <p>
 ** This value has NO canonical types though type may be useful as a means to
 ** scope entitlements.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
...
public class Entitlement {
  ...
  @JsonIgnore(true)
  public static final String PREFIX   = "entitlements";
