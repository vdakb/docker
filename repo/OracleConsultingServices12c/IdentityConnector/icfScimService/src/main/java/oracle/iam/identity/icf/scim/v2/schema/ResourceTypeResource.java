...
public class ResourceTypeResource extends Entity {
  ...
  @JsonProperty("name")
  @Attribute(description="The resource type name.", required=true, mutability=Definition.Mutability.READ_ONLY)
  private final String                name;

  @JsonProperty("description")
  @Attribute(description="The resource type's human readable description.", mutability=Definition.Mutability.READ_ONLY)
  private final String                description;

  @JsonProperty("endpoint")
  @Attribute(description="The resource type's HTTP addressable endpoint relative to the Base URL; e.g., \"/Users\".", reference={"uri"}, required=true, caseExact=true, mutability=Definition.Mutability.READ_ONLY)
  private final URI                   endpoint;

  @JsonProperty("schema")
  @Attribute(description="The resource types primary/base schema URI.", reference={"uri"}, required=true, caseExact=true, mutability=Definition.Mutability.READ_ONLY)
  private final URI                   schema;

  @JsonProperty("schemaExtensions")
  @Attribute(description="A list of URIs of the resource type's schema extensions.", mutability=Definition.Mutability.READ_ONLY, multiValueClass=Extension.class)
   ...
   **                            <br>
   **                            Possible object of {@link String}.
   */
