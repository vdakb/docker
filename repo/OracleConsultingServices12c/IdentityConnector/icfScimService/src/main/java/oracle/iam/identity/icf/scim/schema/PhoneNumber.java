...
// ~~~~~ ~~~~~~~~~~~
/**
 ** Stores phone numbers for the User.
 ** <p>
 ** The value <b>should</b> be canonicalized by the Service Provider according
 ** to format in RFC3966 e.g. 'tel:+1-201-555-0123'.
 ** <br>
...
public class PhoneNumber {
  ...
  @JsonProperty("type")
  @Attribute(description="A label indicating the attribute's function; e.g., 'work' or 'home' or 'mobile' etc.", canonical={WORK, HOME, MOBILE, FACSIMILE, PAGER, OTHER})
  private String  type;
