 ...
 ** @since   1.0.0.0
 */
@Schema(id=EnterpriseUserResource.SCHEMA, name=EnterpriseUser.NAME, description="Enterprise User")
public class EnterpriseUserResource extends EnterpriseUser<EnterpriseUserResource>  {
  ...
  @JsonIgnore(true)
  public static final String SCHEMA = "urn:scim:schemas:extension:enterprise:1.0";
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty SCIM 1 <code>EnterpriseUserResource</code> that allows
   ** use as a JavaBean.
   ** <br>
