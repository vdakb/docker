...
import oracle.iam.identity.icf.schema.Discoverable;
...
public class EnterpriseUser<T extends EnterpriseUser> implements Discoverable {
  ...
  @JsonIgnore(true)
  public static final String NAME   = "EnterpriseUser";
  ...
  @Attribute(description="Numeric or alphanumeric identifier assigned to a person, typically based on order of hire or association with an organization.")
