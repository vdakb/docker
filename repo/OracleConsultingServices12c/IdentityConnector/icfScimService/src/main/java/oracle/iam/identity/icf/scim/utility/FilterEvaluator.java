...
import oracle.iam.identity.icf.scim.Evaluator;
...
public class FilterEvaluator extends Evaluator {
   ...
   */
  protected FilterEvaluator(final ResourceTypeDefinition type) {
    // ensure inheritance
    super();
  ...
  protected Definition definition(final Path path) {
    return null;
  }
}