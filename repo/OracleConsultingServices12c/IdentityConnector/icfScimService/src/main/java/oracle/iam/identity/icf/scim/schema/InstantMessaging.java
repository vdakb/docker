...
// ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** Stores Instant messaging address for the User.
 ** <p>
 ** No official canonicalization rules exist for all instant messaging
 ** addresses, but Service Providers <b>should</b>, when appropriate, remove all
 ** whitespace and convert the address to lowercase.
 ** <br>
 ** Instead of the standard Canonical Values for type, this attribute defines
 ** the following Canonical Values to represent currently popular IM services:
 ** <ul>
 **   <li>aim
 **   <li>gtalk
 **   <li>icq
...
public class InstantMessaging {
  ...
  @JsonProperty("type")
  @Attribute(description="A label indicating the attribute's function; e.g., 'aim', 'gtalk', 'mobile' etc.", canonical={AIM, GTALK, ICQ, XMPP, MSN, SKYPE, QQ, YAHOO})
  private String  type;
