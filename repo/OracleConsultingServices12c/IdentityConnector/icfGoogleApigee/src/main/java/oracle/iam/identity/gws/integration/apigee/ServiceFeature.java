...
public class ServiceFeature extends TargetFeature {
  ...
  public final String entryCreatedAttribute() {
    return stringValue(Service.OIM.Feature.ENTRY_CREATED_ATTRIBUTE);
  }
  ...
  public final String entryModifiedAttribute() {
    return stringValue(Service.OIM.Feature.ENTRY_MODIFIED_ATTRIBUTE);
  }
  ...
  public final boolean entitlementPrefixRequired() {
    return booleanValue(Service.OIM.Feature.ENTITLEMENT_PREFIX_REQUIRED);
  }
