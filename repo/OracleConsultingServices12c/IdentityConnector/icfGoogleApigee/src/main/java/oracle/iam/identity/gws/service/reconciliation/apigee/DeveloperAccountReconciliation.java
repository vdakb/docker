/*
    ...
    File        :   DeveloperAccountReconciliation.java
    ...
    Purpose     :   This file implements the class
                    DeveloperAccountReconciliation.
...
////////////////////////////////////////////////////////////////////////////////
// class DeveloperAccountReconciliation
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>DeveloperAccountReconciliation</code> acts as the service endpoint
 ** for Identity Manager to reconcile developer account information from a
 ...
 ** @since   1.0.0.0
 */
public class DeveloperAccountReconciliation extends DeveloperReconciliation {
  ...
  , TaskAttribute.build(TIMESTAMP,            TaskAttribute.MANDATORY)
     ...
     ** the query
     */
  , TaskAttribute.build(SEARCH_CONTAINER,     TaskAttribute.MANDATORY)
    /** the task attribute that specifies the search base of the query */
  , TaskAttribute.build(SEARCH_BASE,          TaskAttribute.MANDATORY)
    /**
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>DeveloperAccountReconciliation</code> job that
   ...
   ** Default Constructor
   */
  public DeveloperAccountReconciliation() {
    // ensure inheritance
    super();
  }
