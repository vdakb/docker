...
// ~~~~~ ~~~~~~~~~~
/**
 ** The REST entity of a Google Apigee Edge seach result for <code>User</code>s.
 ** <br>
...
public class UserResult {
  ...
  // Method:   list
  /**
   ** Sets the {@link List} of entries that make up the result set.
   **
   ** @param  value              the {@link List} of entries that make up the
   **                            result set.
   **                            <br>
  ...
  public String toString() {
    final StringBuilder builder = new StringBuilder();
    builder.append("{\"user\":[\"").append(this.list).append("]}");
    return builder.toString();
  }
}