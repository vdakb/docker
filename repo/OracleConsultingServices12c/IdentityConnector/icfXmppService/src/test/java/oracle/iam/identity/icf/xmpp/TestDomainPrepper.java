...
////////////////////////////////////////////////////////////////////////////////
// class TestDomainPrepper
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** Verifies {@link JabberIdentifier#domainPrepper(String)}.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class TestDomainPrepper {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>TestDomainPrepper</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public void testValidString()
    ...
    // do magic
    final String result = JabberIdentifier.domainPrepper(domain);
    // verify
  ...
  public void testToLong()
    ...
    // do magic / verify
    JabberIdentifier.domainPrepper(big);
  }
  ...
  public void testMapping()
    ...
    // do magic
    final String result = JabberIdentifier.domainPrepper(input);
    // verify
  ...
  public void testCachedResult()
    ...
    // do magic
    final String result1 = JabberIdentifier.domainPrepper(input);
    final String result2 = JabberIdentifier.domainPrepper(input);
    // verify
