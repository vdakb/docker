 ...
 ** @since   1.0.0.0
 */
public class Assign extends TestFixture {
  ...
  /**
   ** Test assign team request leveraging server context.
   ** <p>
   ** <b>Alfons Zitterbacke</b> on <code>Saxony</code>
   */
//  @Test
  public void zitterbackeSaxony() {
    assignTeam(Identity.ZITTERBACKE.tag, Tenant.SN.tag);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   zitterbackeDI41
  /**
   ** Test assign organization request leveraging server context.
   ** <p>
   ** <b>Alfons Zitterbacke</b> on <code>DI41</code>
   */
  @Test
  public void zitterbackeDI41() {
    assignOrganization(Identity.ZITTERBACKE.tag, Department.DI41.tag, "Admin");
  }
   ...
   ** Test assign team request leveraging server context.
   */
  protected void assignOrganization(final String beneficiary, final String organization, final String role) {
    try {
      ...
      CONTEXT.assignOrganization(user.login(), subject.id(), role);      
    }
   ...
   ** Test assign team request leveraging server context.
   */
  protected void assignTeam(final String beneficiary, final String team) {
    try {
      final User user = CONTEXT.resolveUser(beneficiary);
      assertNotNull(user);
      ...
      CONTEXT.assignTeam(user.id(), subject.id());      
    }
    catch (SystemException e) {
      failed(e);
    }
