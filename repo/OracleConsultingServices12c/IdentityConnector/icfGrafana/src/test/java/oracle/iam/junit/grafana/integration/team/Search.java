...
public class Search extends TestReconciliation {
  ...
  static class Handler implements ResultsHandler {
    ...
    public boolean handle(final ConnectorObject object) {
      try {
        assertEquals(object.getObjectClass(), Grafana.TEAM.clazz);
  ...
  public void searchAll() {
    try {
      final Descriptor              mapping = DescriptorFactory.configure(Descriptor.buildProvisioning(CONSOLE), TestFixture.Team.RECONCILIATION);
      ...
      facade.search(Grafana.TEAM.clazz, null, new Handler("Team searchAll", mapping), option.build());
    }
