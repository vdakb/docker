...
// ~~~~~ ~~~~~~
/**
 ** The test case delete operation on teams at the target system leveraging the
...
public class Delete extends TestFixture {
  ...
  protected void delete(final String identity) {
    try {
      final Team target = CONTEXT.resolveTeam(identity);
      assertNotNull(target);
      assertNotNull(target.id());
      CONTEXT.deleteTeam(target.id());
    }
