...
import oracle.iam.junit.grafana.integration.TestReconciliation;
...
public class Search extends TestReconciliation {
  ...
  static class Handler implements ResultsHandler {
    ...
    public boolean handle(final ConnectorObject object) {
      try {
        assertEquals(object.getObjectClass(), Grafana.ORGANIZATION.clazz);
  ...
  public void searchAll() {
    try {
      final Descriptor              mapping = DescriptorFactory.configure(Descriptor.buildProvisioning(CONSOLE), TestFixture.Organization.RECONCILIATION);
      ...
      facade.search(Grafana.ORGANIZATION.clazz, null, new Handler("Organization searchAll", mapping), option.build());
    }
