...
// ~~~~~ ~~~~~~~
/**
 ** The test case replace operation on identities at the target system
 ...
 ** @since   1.0.0.0
 */
public class Replace extends TestFixture {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Replace</code> that allows use as a JavaBean.
   ** <br>
  ...
  public static void main(final String[] args) {
    final String[] parameter = {Replace.class.getName()};
