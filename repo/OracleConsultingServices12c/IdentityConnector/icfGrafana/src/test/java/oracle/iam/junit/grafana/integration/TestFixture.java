...
public class TestFixture extends TestBaseIntegration {
  ...
  public interface Team {
    ...
    */
    ...
    static final File               PROVISIONING   = new File(RESOURCES, "mds/gfn-team-provisioning.xml");
    static final File               RECONCILIATION = new File(RESOURCES, "mds/gfn-team-reconciliation.xml");
  }
  ...
  public interface Organization {
    ...
    /**
     ** The data provider belonging to organization <i>DI41</i>.
     */
    static final Pair<String, File> DI41 = Pair.of("DI41",     new File(RESOURCES, "organization-di41.json"));
    /**
     ** The data provider belonging to organization <i>DI41-1</i>.
     */
    static final Pair<String, File> DI41_1 = Pair.of("DI41-1", new File(RESOURCES, "organization-di41-1.json"));
    /**
     ** The data provider belonging to organization <i>DI41-2</i>.
     */
    static final Pair<String, File> DI41_2 = Pair.of("DI41-2", new File(RESOURCES, "organization-di41-2.json"));

    static final File               PROVISIONING   = new File(RESOURCES, "mds/gfn-organization-provisioning.xml");
    static final File               RECONCILIATION = new File(RESOURCES, "mds/gfn-organization-reconciliation.xml");
  }
