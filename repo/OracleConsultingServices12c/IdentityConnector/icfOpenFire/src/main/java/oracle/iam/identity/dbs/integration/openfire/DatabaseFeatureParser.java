/*
    ...
    File        :   DatabaseFeatureParser.java
...
////////////////////////////////////////////////////////////////////////////////
// final class DatabaseFeatureParser
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~~~
/**
 ** This is the class to unmarshalls meta information of for a Database Service.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
final class DatabaseFeatureParser extends FeatureParser {
  ...
  enum Grammar {
    ...
    /** The array of parent states to this one. */
  ...
  // Method:   Ctor
  /**
   ** Constructor for <code>DatabaseFeatureParser</code>.
   **
   ...
   */
  protected DatabaseFeatureParser(final DatabaseFeature feature)
    throws SAXException {

    // ensure inheritance
    super(feature, Database.PROPERTY);
  }
  ...
  protected void processProperty(final Attributes attributes)
    ...
    if (Database.PROPERTY.contains(external))
