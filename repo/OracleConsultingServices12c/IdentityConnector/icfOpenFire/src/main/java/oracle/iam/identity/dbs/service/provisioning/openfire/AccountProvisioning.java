...
package oracle.iam.identity.dbs.service.provisioning.openfire;
...
public class AccountProvisioning extends Provisioning {
  ...
  private static final String LOGGER_CATEGORY = "OCS.OFS.PROVISIONING";
  ...
  protected TargetResource populateResource(final Long resourceInstance)
    ...
    timerStart(method);
    try {
      return DatabaseResource.build(this, resourceInstance);
    }
    finally {
      timerStop(method);
  ...
  // Method:   assignGroup
  /**
   ** Assign an <code>Account</code> to a group entity in the Service Provider.
   **
   ** @param  resourceInstance   the <code>IT Resource</code> used by this
   **                            instance to establish a connection to the
   **                            Service Provider.
   ...
   **                            Possible object is {@link String}.
   */
  public String assignGroup(final Long resourceInstance) {
  ...
  // Method:   revokeGroup
  /**
   ** Revoke an <code>Account</code> from a group entity in the Service Provider.
   **
   ** @param  resourceInstance   the <code>IT Resource</code> used by this
   **                            instance to establish a connection to the
   **                            Service Provider.
   ...
   **                            Possible object is {@link String}.
   */
  public String revokeGroup(final Long resourceInstance) {
