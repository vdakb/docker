...
import oracle.iam.junit.nextcloud.integration.account.Search;
import oracle.iam.junit.nextcloud.integration.account.Create;
import oracle.iam.junit.nextcloud.integration.account.Delete;
import oracle.iam.junit.nextcloud.integration.account.Resolve;
 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({Create.class, Search.class, Resolve.class, Delete.class})
