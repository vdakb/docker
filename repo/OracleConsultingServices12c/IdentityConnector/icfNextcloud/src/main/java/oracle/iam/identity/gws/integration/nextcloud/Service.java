...
public interface Service {
  ...
  interface ICF {
    ...
    public interface Feature {
      ...
      /**
       ** Attribute tag which may be defined on a
       ** <code>Metadata Descriptor</code> to specify the Nextcloud Server is
       ** licensed to use these enhanced features of Nextcloud Enterprise.
       ** <p>
       ** Default: <code>false</code>
       */
      static final String ENTERPRISE_FEATURE = "enterpriseFeature";
    }
  }
  ...
  interface OIM {
    ...
    interface Feature {
       ...
       ** Default: <code>false</code>
       */
      static final String ENTERPRISE_FEATURE = "enterprise-feature";
    }
  }
  /**
  ...
  static final Map<String, String> FEATURE = CollectionUtility.unmodifiableMap(
    ...
    , {ICF.Feature.ENTERPRISE_FEATURE, OIM.Feature.ENTERPRISE_FEATURE}
    }
  );
  /**
  ...
  , OIM.Feature.ENTERPRISE_FEATURE
  );
  /**
   ** The attribute mapping of the feature transfer from the
