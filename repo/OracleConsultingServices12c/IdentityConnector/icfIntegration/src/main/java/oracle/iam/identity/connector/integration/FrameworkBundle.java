...
public class FrameworkBundle extends ListResourceBundle  {
  ...
  , { FrameworkError.RECONCILIATION_POOL_SIZE,        "Batch size has to be >= 1." }
  , { FrameworkError.RECONCILIATION_POOL_CLOSED,      "Processing was finished already, cannot add any more events." }
  , { FrameworkError.RECONCILIATION_POOL_FINISHED,    "Processing was finished already, cannot call finish again." }

     // ICF-00061 - 00070 reconciliation thread executor related errors
  , { FrameworkError.RECONCILIATION_EVENT_LOGIN,      "Unable to login as administrator, the batch with [%d] reconciliation events will be discarded." }
  ...
  public static final ListResourceBundle RESOURCE = (ListResourceBundle)ResourceBundle.getBundle(
    FrameworkBundle.class.getName()
  , Locale.getDefault()
  , FrameworkBundle.class.getClassLoader()
  );
