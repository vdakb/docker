...
public class ConnectorBundle_en extends ListResourceBundle  {
  ...
  private static final String[][] CONTENT = {
    { Connector.Endpoint.DRIVER_LABEL,                  "Connector Driver" }
  , { Connector.Endpoint.DRIVER_HINT,                   "Driver class. Example driver values Oracle - oracle.jdbc.driver.OracleDriver, MSSQL - com.microsoft.sqlserver.jdbc.SQLServerDriver, MySQL - com.mysql.jdbc.Driver, DB2 - com.ibm.db2.jcc.DB2Driver, Sybase - com.sybase.jdbc2.jdbc.SybDriver" }
  , { Connector.Endpoint.HOST_LABEL,                    "Connector Host" }
  , { Connector.Endpoint.HOST_HINT,                     "Connector Host" }
  , { Connector.Endpoint.PORT_LABEL,                    "Connector Host" }
  , { Connector.Endpoint.PORT_HINT,                     "Connector Host" }
  , { Connector.Endpoint.SECURE_LABEL,                  "Secure Socket" }
  , { Connector.Endpoint.SECURE_HINT,                   "Secure Socket" }
  , { Connector.Endpoint.NAME_LABEL,                    "Connector Name" }
  , { Connector.Endpoint.NAME_HINT,                     "Connector Name" }
  , { Connector.Endpoint.SCHEMA_LABEL,                  "Connector Schema" }
  , { Connector.Endpoint.NAME_HINT,                     "Connector Schema" }
