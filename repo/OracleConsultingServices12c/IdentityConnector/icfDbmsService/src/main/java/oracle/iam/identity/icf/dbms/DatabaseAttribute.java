...
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** The <code>DatabaseAttribute</code> implements the base functionality
 ** for describing an attribute object in a Database Service.
 ** <br>
 ** An Database Service object may have attributes or not. Some of them are
...
public class DatabaseAttribute {
   ...
   ** attribute object in a Database Service.
   ** <br>
   ** An Database Service object may have attributes or not. Some of them are
   ** mandatory for the functionality.
   */
  public static class Type {
    ...
    // Method: type
    /**
     ** Returns the type of the <code>DatabaseEntity</code>.
     **
     ** @return                  the implementation type attribute.
     **                          <br>
     ...
     */
    public Set<AttributeInfo.Flags> flags() {
      return this.flags;
    }
     ...
     */
    public AttributeInfo build(final String id) {
    ...
    public AttributeInfo build(final String id, final Set<AttributeInfo.Flags> add, final Set<AttributeInfo.Flags> remove) {
      ...
      return new AttributeInfoBuilder(id, this.type == Date.class ? Long.class : this.type).setFlags(flags).build();
    }
  }
   ...
   ** describing a entitlement assignment object in a Database Service.
   ** <br>
   ** An Database Service object may have attributes or not. Some of them are
   ** mandatory for the functionality.
   */
  public static final class Entitlement<E> implements List<E> {
    ...
    private final class Element implements Iterator<E> {
      ...
      @Override
      public final E next() {
        return DatabaseAttribute.Entitlement.this.cast(this.delegate.next());
      }
       ...
       **       object is modified. This integer need not remain consistent from
    ...
    private final class ElementList implements ListIterator<E> {
      ...
      public final E previous() {
        return DatabaseAttribute.Entitlement.this.cast(this.delegate.previous());
      }
       ...
       ** to {@link #next} would be unaffected, and a subsequent call to
     ...
     **                           otherwise, a new array of the same runtime
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>DatabaseAttribute</code> which has a type and flags.
   **
   ** @param  id                 the unique identifier of an attribute.
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  alias              the user friendly identifier of an attribute.
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  type               the implementation type attribute.
   **                            <br>
   **                            Allowed object is {@link Type}.
   ** @param  predicate          a predicate to prepand for database operation.
   **                            <br>
   **                            Allowed object is {@link String}.
   */
  DatabaseAttribute(final String id, final String alias, final Type type, final String predicate) {
    // ensure inheritance
    super();

    // initialize instance attributes
    this.id        = id;
    this.alias     = StringUtility.empty(alias) ? id : alias;
    this.type      = type;
  ...
  // Method:   id
  /**
   ** Returns the unique identifier of an attribute.
   **
   ** @return                    the unique identifier of an attribute.
   **                            Possible object is {@link String}.
   */
  public String id() {
    return this.id;
  ...
  // Method:   alias
  /**
   ** Returns the user friendly identifier of an attribute.
   **
   ** @return                    the user friendly identifier of an attribute.
   **                            Possible object is {@link String}.
   */
  public String alias() {
    return this.alias;
  ...
  // Method:   required
  /**
   ** Returns <code>true</code> if this attribute is a required attribute.
   ** <br>
   ** This does not mean that this attribute is required for the transfer to
   ** the Identity Connector Server itsself but its required for the
  ...
  public boolean required() {
    return this.type.flags.contains(AttributeInfo.Flags.REQUIRED);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   readonly
  /**
   ** Returns <code>true</code> if this attribute is a readonly attribute.
   ** <p>
   ** Convenience method to shortens the access to the attribute flags.
   **
   ** @return                  <code>true</code> if this attribute is a
   **                          readonly attribute; otherwise
   **                          <code>false</code>.
   **                          Possible object <code>boolean</code>.
   */
  public boolean readonly() {
    return this.type.flags.contains(AttributeInfo.Flags.NOT_UPDATEABLE);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   omitted
  /**
   ** Returns <code>true</code> if this attribute is not returned by default.
   ** <br>
   ** This does not mean that this attribute is required for the transfer to
   ** the Identity Connector Server itsself but its required for the
   ** transformation of any event.
   ...
   ** Convenience method to shortens the access to the attribute flags.
   **
   ** @return                  <code>true</code> if this attribute is an
   **                          omitted attribute; otherwise
   **                          <code>false</code>.
   **                          Possible object <code>boolean</code>.
   */
  public boolean omitted() {
    return this.type.flags.contains(AttributeInfo.Flags.NOT_RETURNED_BY_DEFAULT);
  }
  ...
  // Method:   build
  /**
   ** Factory method to create an attribute with the specified unique
   ** identifier.
   ** <p>
   ** The <code>DatabaseAttribute</code> returned will be of type {@link String}
   ** and has no flags set; means it will be an optional modifiable attribute.
   **
   ** @param  id                 the unique identifier of an attribute.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ** @return                    an instance of <code>DatabaseAttribute</code>
   **                            with the specified properties.
   **                            <br>
   **                            Possible object is {@link DatabaseAttribute}.
   */
  public static DatabaseAttribute build(final String id) {
    return build(id, id);
  }
   ...
   **                            Possible object is {@link DatabaseAttribute}.
   */
  public static DatabaseAttribute build(final String id, final Type type) {
    return build(id, id, type);
  }
   ...
   **                            Possible object is {@link DatabaseAttribute}.
   */
  public static DatabaseAttribute build(final String id, final String alias) {
    return build(id, alias, type(NULL));
  }
   ...
   ** identifier and alias.
   ** <p>
   ** The <code>DatabaseAttribute</code> returned will be of type
   ** {@link Type#type} and has the flags set determined by {@link Type#type}.
   **
   ** @param  id                 the unique identifier of an attribute.
   **                            <br>
   **                            Allowed object is {@link String}.
   ...
   **                            Possible object is {@link DatabaseAttribute}.
   */
  public static DatabaseAttribute build(final String id, final String alias, final Type type) {
    return new DatabaseAttribute(id, alias, type, null);
  }
   ...
   **                            Possible object is {@link DatabaseAttribute}.
   */
  public static DatabaseAttribute build(final String id, final String alias, final String predicate) {
    return build(id, alias, type(String.class, NULL), predicate);
  }
   ...
   **                            <code>DatabaseAttribute.Type</code> with the
   **                            specified properties.
   **                            <br>
   **                            Possible object is
   **                            {@link DatabaseAttribute.Type}.
   */
  public static DatabaseAttribute.Type type(final Class<?> type) {
    return new DatabaseAttribute.Type(type, NULL);
  }
   ...
   **                            Possible object is {@link DatabaseAttribute}.
   */
  public static DatabaseAttribute build(final String id, final String alias, final Type type, final String predicate) {
    return new DatabaseAttribute(id, alias, type, predicate);
  }
   ...
   ** flags.
   **
   ** @param  flag               the operational flags for an attribute.
   **                            <br>
   ...
   **                            {@link DatabaseAttribute.Type}.
   */
  public static DatabaseAttribute.Type type(final Set<AttributeInfo.Flags> flag) {
    return type(String.class, flag);
  }
   ...
   **                            {@link DatabaseAttribute.Type}.
   */
  public static DatabaseAttribute.Type type(final Class<?> type, final Set<AttributeInfo.Flags> flag) {
    return new DatabaseAttribute.Type(type, flag);
  }
   ...
   **                            <br>
   **                            Allowed object is {@link List} where each elemment
   **                            is of type <code>T</code>.
   ** @param  clazz              the implementation type attribute.
   **                            <br>
   **                            Allowed object is {@link Class}.
   **
   ** @return                    an instance of
   **                            <code>DatabaseAttribute.Entitlement</code>
   **                            with the specified properties.
   **                            <br>
   **                            Possible object
   **                            {@link DatabaseAttribute.Entitlement}.
   */
  ...
  public boolean equals(final Object other) {
    ...
    final DatabaseAttribute that = (DatabaseAttribute)other;
