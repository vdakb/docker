...
public class ConnectorBundle extends ListResourceBundle  {
  ...
  , { Connector.Endpoint.HOST_LABEL,                    "Server Host" }
  , { Connector.Endpoint.HOST_HINT,                     "Server Host" }
  ...
  , { Connector.Endpoint.NAME_LABEL,                    "Service Name" }
  , { Connector.Endpoint.NAME_HINT,                     "Service Name" }
  , { Connector.Endpoint.SCHEMA_LABEL,                  "Service Schema" }
  , { Connector.Endpoint.NAME_HINT,                     "Service Schema" }
