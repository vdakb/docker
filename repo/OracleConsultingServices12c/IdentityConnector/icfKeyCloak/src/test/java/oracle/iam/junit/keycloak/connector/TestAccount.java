...
import oracle.iam.junit.keycloak.connector.account.Search;
import oracle.iam.junit.keycloak.connector.account.Create;
import oracle.iam.junit.keycloak.connector.account.Delete;
import oracle.iam.junit.keycloak.connector.account.Lookup;
import oracle.iam.junit.keycloak.connector.account.Resolve;
 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({Create.class, Search.class, Resolve.class, Lookup.class, Delete.class})
