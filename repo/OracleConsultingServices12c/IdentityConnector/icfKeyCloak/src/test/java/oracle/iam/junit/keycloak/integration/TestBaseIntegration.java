...
import oracle.iam.junit.keycloak.TestBase;
...
public class TestBaseIntegration extends TestBase {
   ...
   */
  public static final File          FEATURE   = new File(RESOURCES, "mds/rkc-feature.xml");
  /**
   ...
   ** <br>
   ** This value is aligned with the default limits of Red Hat Keycloak Server.
   */
