...
public class TestFixture extends TestBaseIntegration {
  ...
  public interface User {
    ...
    static final File              PROVISIONING   = new File(RESOURCES, "mds/rkc-account-provisioning.xml");
    static final File              RECONCILIATION = new File(RESOURCES, "mds/rkc-account-reconciliation.xml");
  }
  ...
  public interface Role {
    ...
    static final File              PROVISIONING   = new File(RESOURCES, "mds/rkc-role-provisioning.xml");
    static final File              RECONCILIATION = new File("src/test/resources/mds/rkc-role-reconciliation.xml");
  }
  ...
  public interface Group {
    ...
    static final File              PROVISIONING   = new File(RESOURCES, "mds/rkc-group-provisioning.xml");
    static final File              RECONCILIATION = new File(RESOURCES, "mds/rkc-group-reconciliation.xml");
  }
