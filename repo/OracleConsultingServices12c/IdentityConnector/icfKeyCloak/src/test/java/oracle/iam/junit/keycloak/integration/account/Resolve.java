...
public class Resolve extends TestFixture {
  ...
  public void zitterbacke() {
    try {
      assertNotNull(User.ZITTERBACKE.tag, FACADE.resolveUsername(ObjectClass.ACCOUNT, User.ZITTERBACKE.tag, null).getUidValue());
    }
  ...
  public void musterfrau() {
    try {
      assertNotNull(User.MUSTERFRAU.tag, FACADE.resolveUsername(ObjectClass.ACCOUNT, User.MUSTERFRAU.tag, null).getUidValue());
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void mustermann() {
    try {
      assertNotNull(User.MUSTERMANN.tag, FACADE.resolveUsername(ObjectClass.ACCOUNT, User.MUSTERMANN.tag, null).getUidValue());
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void cambrault() {
    try {
      assertNotNull(User.CAMBRAULT.tag, FACADE.resolveUsername(ObjectClass.ACCOUNT, User.CAMBRAULT.tag, null).getUidValue());
    }
    catch (ConnectorException e) {
      failed(e);
    }
