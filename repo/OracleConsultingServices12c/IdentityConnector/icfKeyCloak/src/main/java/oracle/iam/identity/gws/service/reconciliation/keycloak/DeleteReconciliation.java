...
package oracle.iam.identity.gws.service.reconciliation.keycloak;
...
public class DeleteReconciliation extends Service {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>DeleteReconciliation</code> scheduler that
  ...
  protected void onExecution()
    ...
    final Delete handler = new Delete(this, this.threadPoolSize());
