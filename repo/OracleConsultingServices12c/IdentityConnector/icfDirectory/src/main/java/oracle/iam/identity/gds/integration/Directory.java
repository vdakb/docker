...
public interface Directory {
   ...
   */
  static final String      ORGANIZATION_CLASS_DEFAULT           = "organization";

  /**
   ** Default value of the organization prefix of an entry in a V3 compliant
   ** LDAP server.
   */
  static final String      ORGANIZATION_PREFIX_DEFAULT          = "o";

  /**
   ** Default value of the organizationalUnit objectClass of an entry in a V3
   ** compliant LDAP server.
   */
  static final String      ORGANIZATIONALUNIT_CLASS_DEFAULT     = "organizationalUnit";

  /**
   ** Default value of the organizational unit prefix of an entry in a V3
   ** compliant LDAP server.
   */
  static final String      ORGANIZATIONALUNIT_PREFIX_DEFAULT    = "ou";
  ...
  interface ICF {
    ...
    public interface Feature {
      ...
      */
       ...
       ** Attribute tag which must be defined on a
       ** <code>Metadata Descriptor</code> to specify the name of the
       ** organization object class of an entry in a V3 compliant Directory
       ** Service.
       ** <p>
       ** The standard object class name of a LDAP V3 group is
       ...
       ** Attribute tag which may be defined on a
       ** <code>Metadata Descriptor</code> to specify the prefix of the
       ** organization object of an entry in a V3 compliant Directory Service.
       ** <p>
       ** The standard prefix of a LDAP V3 group entry is <code>o</code>.
       */
      static final String ORGANIZATION_PREFIX                         = "organizationPrefix";

      /**
       ** Attribute tag which must be defined on a
       ** <code>Metadata Descriptor</code> to specify the name of the
       ** organizationalUnit object class of an entry in a V3 compliant Directory
       ** Service.
       ** <p>
       ** The standard object class name of a LDAP V3 group is
       ** <code>organizationalUnit</code>.
       */
      static final String ORGANIZATIONALUNIT_CLASS                    = "organizationalUnitClass";

      /**
       ** Attribute tag which may be defined on a
       ** <code>Metadata Descriptor</code> to specify the prefix of the
       ** organizationalUnit object of an entry in a V3 compliant Directory Service.
       ** <p>
       ** The standard prefix of a LDAP V3 group entry is <code>ou</code>.
       */
      static final String ORGANIZATIONALUNIT_PREFIX                   = "organizationalUnitPrefix";
  ...
  interface OIM {
    ...
    interface Feature {
      ...
      */
       ...
       ** Attribute tag which must be defined on a
       ** <code>Metadata Descriptor</code> to specify the name of the
       ** organization object class of an entry in a V3 compliant LDAP server.
       ** <p>
       ** The standard object class name of a LDAP V3 Organization is
       ** <code>organization</code>.
       */
      static final String ORGANIZATION_CLASS                         = "organization-class";

      /**
       ** Attribute tag which must be defined on a
       ** <code>Metadata Descriptor</code> to specify the name of the
       ** organization object prefix of an entry in a V3 compliant LDAP server.
       ** <p>
       ** The standard prefix of a LDAP V3 organization is <code>o</code>.
       */
      static final String ORGANIZATION_PREFIX                        = "organization-prefix";

      /**
       ** Attribute tag which must be defined on a
       ** <code>Metadata Descriptor</code> to specify the name of the
       ** organization unit object class of an entry in a V3 compliant LDAP
       ** server.
       ** <p>
       ** The standard object class name of a LDAP V3 Organization is
       ** <code>organizationalUnit</code>.
       */
      static final String ORGANIZATIONALUNIT_CLASS                   = "organizationalunit-class";

      /**
       ** Attribute tag which must be defined on a
       ** <code>Metadata Descriptor</code> to specify the name of the
       ** organization unit object prefix of an entry in a V3 compliant LDAP
       ** server.
       ** <p>
       ** The standard prefix of a LDAP V3 organization is <code>ou</code>.
       */
      static final String ORGANIZATIONALUNIT_PREFIX                  = "organizationalunit-prefix";
  ...
  static final Map<String, String> FEATURE =
    new HashMap<String, String>() { {
      ...
      put(ICF.Feature.ORGANIZATION_CLASS,        OIM.Feature.ORGANIZATION_CLASS);
      put(ICF.Feature.ORGANIZATION_PREFIX,       OIM.Feature.ORGANIZATION_PREFIX);

      put(ICF.Feature.ORGANIZATIONALUNIT_CLASS,  OIM.Feature.ORGANIZATIONALUNIT_CLASS);
      put(ICF.Feature.ORGANIZATIONALUNIT_PREFIX, OIM.Feature.ORGANIZATIONALUNIT_PREFIX);
