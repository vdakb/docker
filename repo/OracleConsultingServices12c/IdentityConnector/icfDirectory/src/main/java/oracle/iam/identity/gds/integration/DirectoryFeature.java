...
public class DirectoryFeature extends TargetFeature {
   ...
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#ORGANIZATION_CLASS}.
   ** <p>
   ** If {@link Directory.OIM.Feature#ORGANIZATION_CLASS} is not mapped in the
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory#ORGANIZATION_CLASS_DEFAULT}
   **
  ...
  public final String organizationObjectClass() {
    return stringValue(Directory.OIM.Feature.ORGANIZATION_CLASS, Directory.ORGANIZATION_CLASS_DEFAULT);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   organizationalObjectPrefix
  /**
   ** Returns the name of the organizational unit object prefix defined for a LDAP
   ** server.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#ORGANIZATION_PREFIX}.
   ** <p>
   ** If {@link Directory.OIM.Feature#ORGANIZATION_PREFIX} is not mapped in the
   ** underlying {@link TargetFeature} this method returns
   ** {@link Directory#ORGANIZATION_PREFIX_DEFAULT}
   **
   ** @return                    the name of the organization object prefix.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String organizationalObjectPrefix() {
    return stringValue(Directory.OIM.Feature.ORGANIZATION_PREFIX, Directory.ORGANIZATION_PREFIX_DEFAULT);
  }
  
  //////////////////////////////////////////////////////////////////////////////
  // Method:   organizationalUnitObjectClass
  /**
   ** Returns the name of the organizationUnit object class defined for a LDAP
   ** server.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#ORGANIZATIONALUNIT_CLASS}.
   ** <p>
   ** If {@link Directory.OIM.Feature#ORGANIZATIONALUNIT_CLASS} is not mapped in
   ** the underlying {@link TargetFeature} this method returns
   ** {@link Directory#ORGANIZATIONALUNIT_CLASS_DEFAULT}
   **
   ** @return                    the name of the organization object class.
   **                            <br>
   **                            Possible object is {@link String}.
  ...
  public final String organizationalUnitObjectClass() {
    return stringValue(Directory.OIM.Feature.ORGANIZATIONALUNIT_CLASS, Directory.ORGANIZATIONALUNIT_CLASS_DEFAULT);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   organizationUnitObjectPrefix
  /**
   ** Returns the name of the organizationUnit object prefix defined for a LDAP
   ** server.
   ** <p>
   ** Convenience method to shortens the access to the configuration attribute
   ** {@link Directory.OIM.Feature#ORGANIZATIONALUNIT_PREFIX}.
   ** <p>
   ** If {@link Directory.OIM.Feature#ORGANIZATIONALUNIT_PREFIX} is not mapped
   ** in the underlying {@link TargetFeature} this method returns
   ** {@link Directory#ORGANIZATIONALUNIT_PREFIX_DEFAULT}
   **
   ** @return                    the name of the organization object prefix.
   **                            <br>
   **                            Possible object is {@link String}.
   */
  public final String organizationUnitObjectPrefix() {
    return stringValue(Directory.OIM.Feature.ORGANIZATIONALUNIT_PREFIX, Directory.ORGANIZATIONALUNIT_PREFIX_DEFAULT);
  }
