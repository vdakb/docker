 ...
 ** @since   1.0.0.0
 */
public class TestCaseConnector extends TestCaseBasic {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>TestCaseConnector</code> that allows use as a JavaBean.
   ** <br>
   ** Zero argument constructor required by the framework.
   ** <br>
   ** Default Constructor
   */
  public TestCaseConnector() {
    // ensure inheritance
    super();
  }
