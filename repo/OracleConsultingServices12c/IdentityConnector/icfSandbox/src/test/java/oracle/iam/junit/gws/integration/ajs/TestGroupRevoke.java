...
public class TestGroupRevoke extends TestUser {
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   bkbk4711123jiraCoreUserRevoke
  /**
   ** Test that accounts could be assigned to Jira Core User.
   */
	@Test
	public void bkbk4711123jiraCoreUserRevoke() {
    try {
      final Uid uid = Network.facade(Network.intranet()).removeAttributeValues(ObjectClass.ACCOUNT, bkbk4711123.UID, TestGroup.jiraCoreUser.grant(), null);
