...
// ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The test case to assign a REST usergroup in the target system to an account
...
public class TestRoleAssign extends TestRole {
  ...
  public static void main(String[] args) {
    try {
      Network.facade(Network.localnet()).addAttributeValues(ObjectClass.ACCOUNT, TestAccount.bkbk4711123.UID, ROLE, null);
    }
