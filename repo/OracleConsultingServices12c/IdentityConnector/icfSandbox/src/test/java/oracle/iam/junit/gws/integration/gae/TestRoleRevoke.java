...
// ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The test case to revoke a REST usergroup in the target system from an
 ** account leveraging the <code>Connector Server</code> facade.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public class TestRoleRevoke extends TestRole {
  ...
  public static void main(String[] args) {
    try {
      Network.facade(Network.localnet()).removeAttributeValues(ObjectClass.ACCOUNT, TestAccount.bkbk4711123.UID, ROLE, null);
    }
