...
public class TestDeveloperDelete extends TestDeveloper {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>TestDeveloperDelete</code> that allows use as a
   ** JavaBean.
   ** <br>
   ...
   */
    ...
    try {
      Network.facade(Network.intranet()).delete(DEVELOPER, new Uid("bwg"), deleteControl().build());
    }
  ...
  public void bkbk4711123()
    ...
    final OperationOptionsBuilder option = new OperationOptionsBuilder().setContainer(bkbk4711123.OID);
    try {
      Network.facade(Network.intranet()).delete(DEVELOPER, bkbk4711123.UID, deleteControl().build());
    }
    catch (ConnectorException e) {
      failed(e);
    }
