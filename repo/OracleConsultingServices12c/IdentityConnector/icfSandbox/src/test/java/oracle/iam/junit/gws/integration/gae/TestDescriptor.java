...
public class TestDescriptor extends TestCaseIntegration {
  ...
  public static void main(String[] args) {
    try {
      Descriptor descriptor = DescriptorFactory.configure(Descriptor.buildProvisioning(Network.CONSOLE), TestAccount.PROVISIONING);
