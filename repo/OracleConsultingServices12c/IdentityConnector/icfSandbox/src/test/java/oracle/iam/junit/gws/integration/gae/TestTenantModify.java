...
////////////////////////////////////////////////////////////////////////////////
// class TestTenantModify
// ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** The test case to modify a tenant in the target system leveraging the
...
public class TestTenantModify extends TestTenant {
  ...
  public static void main(String[] args) {
    try {
      ...
      System.out.println(facade.update(TENANT, T3, T3M, null));
      System.out.println(facade.update(TENANT, T2, T2M, null));
      System.out.println(facade.update(TENANT, T1, T1M, null));
    }
