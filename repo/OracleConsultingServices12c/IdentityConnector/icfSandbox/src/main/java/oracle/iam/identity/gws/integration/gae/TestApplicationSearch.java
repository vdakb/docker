/*
    ...
    File        :   TestApplicationSearch.java
...
public class TestApplicationSearch extends TestTenant {
  ...
  public static void main(String[] args) {
    final Set<String>             target = CollectionUtility.set("__UID__", "__NAME__", "attributes.DisplayName");
    ...
    try {
      Network.facade(Network.intranet()).search(APPLICATION, null, new Handler(), option.build());
    }
