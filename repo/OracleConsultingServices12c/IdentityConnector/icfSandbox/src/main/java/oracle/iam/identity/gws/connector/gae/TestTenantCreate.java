...
// ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** The test case to create a tenant resource in the target system.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class TestTenantCreate {
  ...
  public static void main(String[] args) {
    try {
      ...
      final Tenant response = Network.intranet().createTenant(resource);
