...
// ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** The test case to assign a SCIM 1 group in the target system to an account
...
public class TestGroupAssign extends TestCase {
  ...
  public static void main(String[] args) {
    ...
    final Set<Attribute>  attribute = CollectionUtility.set(AttributeBuilder.build("members", "1"));
    try {
      Network.facade(Network.intranet()).addAttributeValues(ObjectClass.GROUP, new Uid("group.id"), attribute, option);
    }
