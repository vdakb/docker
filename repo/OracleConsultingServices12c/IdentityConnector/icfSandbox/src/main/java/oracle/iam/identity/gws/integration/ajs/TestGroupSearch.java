 ...
 ** @since   1.0.0.0
 */
public class TestGroupSearch extends TestGroup {
  ...
  public static void main(String[] args) {
    try {
      final Descriptor              descriptor = DescriptorFactory.configure(Descriptor.buildReconciliation(Network.CONSOLE), TestAccount.RECONCILIATION);
      ...
      facade.search(ObjectClass.GROUP, null, new Handler(), option.build());
    }
