 ...
 ** system by accessing the timestamp values of an entry.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class TestAccountResource extends TestCase {
  ...
  public static void main(String[] args) {
    try {
      ...
      final SyncToken                earliest = new SyncToken(DateUtility.format(DateUtility.startEpoch(), DateUtility.RFC4517_ZULU_NANO));
      sync.execute(earliest, new Handler());
    }
