/*
    ...
    File        :   TestProjectAssign.java

    Compiler    :   Oracle JDeveloper 12c

    Author      :   sylvert.bernets@oracle.com
 ...
 ** @since   1.0.0.0
 */
public class TestProjectAssign extends TestProject {
  ...
  public static void main(String[] args) {
    try {
      final Uid uid = Network.facade(Network.intranet()).addAttributeValues(ObjectClass.ACCOUNT, UID, grant(), null);
