...
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** The test case to rename an existing account in the target system leveraging
 ...
 ** @since   1.0.0.0
 */
public class TestAccountRename extends TestAccount {
  ...
  public static void main(String[] args) {
    try {
      ...
      final Uid             uid      = facade.update(ObjectClass.ACCOUNT, UID, rename(),null);
