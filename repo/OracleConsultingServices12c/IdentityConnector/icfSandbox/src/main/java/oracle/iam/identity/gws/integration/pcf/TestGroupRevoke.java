...
// ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** The test case to revoke a SCIM 1 group in the target system from an account
...
public class TestGroupRevoke extends TestCase {
  ...
  public static void main(String[] args) {
    ...
    try {
      Network.facade(Network.intranet()).update(ObjectClass.GROUP, new Uid("group.id"), attribute, option);
    }
