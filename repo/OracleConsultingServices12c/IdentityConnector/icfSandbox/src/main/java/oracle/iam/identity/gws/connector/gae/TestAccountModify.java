...
public class TestAccountModify {
  ...
  static final String identifier = "0815125@polizei-be.de";
  ...
  static final Set<Attribute> attribute = AttributeFactory.set(
    ...
    , new Object[]{
        identifier
      , new GuardedString("Welcome2".toCharArray())
      , "Korbyn"
      , "Colon"
    }
  );
  ...
  public static void main(String[] args) {
    try {
      ...
      final User response = Network.intranet().modifyAccount(identifier, resource);
      System.out.println(response.emailId());
    }
