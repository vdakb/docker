...
// ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The test case to revoke a role from a user in the target system.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class TestRoleRevoke extends TestCase {
  ...
  public static void main(String[] args) {
    ...
    try {
      DirectoryModify.build(ENDPOINT, DirectorySchema.ROLE).revoke(peopleUUID(ENDPOINT, ACTOR), transfer);
   }
