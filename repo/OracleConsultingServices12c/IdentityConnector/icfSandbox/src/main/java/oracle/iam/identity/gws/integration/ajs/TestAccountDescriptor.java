/*
    ...
    File        :   TestAccountDescriptor.java
...
public class TestAccountDescriptor extends TestAccount {
  ...
  public static void main(String[] args) {
    try {
      Descriptor descriptor = provisioning();
      Network.CONSOLE.info(descriptor.toString());

      final Set<Attribute> set = DescriptorTransformer.build(descriptor, CREATE);
