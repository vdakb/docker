...
public class TestAccountModify {
  ...
  static final Set<Attribute> email = AttributeFactory.set(
    new String[][] {
      {"emails.value", "alfons.zitterbacke@vm.oracle.com"}
    }
  );
  ...
  public static void main(String[] args) {
    try {
      final List<Operation> operation = Marshaller.operation(name);
      Network.intranet().modifyAccount(uid.getUidValue(), operation);
    }
