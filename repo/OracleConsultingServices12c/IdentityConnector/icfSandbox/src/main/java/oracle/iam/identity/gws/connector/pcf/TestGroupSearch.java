...
public class TestGroupSearch {
  ...
  public static void main(String[] args) {
    final int         size   = 500;
    final Set<String> target = CollectionUtility.set("id", "displayName", "meta");
    ...
    try {
      ...
      do {
        final ListResponse<GroupResource> response = context.searchGroup().emit(target).page(index, size).invoke(GroupResource.class);
