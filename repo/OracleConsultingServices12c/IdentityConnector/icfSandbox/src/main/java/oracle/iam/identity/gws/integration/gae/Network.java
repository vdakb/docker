...
//  static final String        EXTRANET       = "172.16.182.90";
  ...
  private static ServiceResource endpoint(final String serverName, final String serverPort)
    ...
    return ServiceResource.build(CONSOLE, serverName, serverPort, "/v1", false, "application/json", "application/json", "basic-preemptive", "", "", "apigee@bka.bund.de", "37DDH3tWse9GF8XR5uDtgBGm5SM5dcxH", "", "", "", "en", "US", "GMT+01:00", "eeeee");
  }
}