...
public class TestSpaceDelete extends TestCase {
  ...
  public static void main(String[] args) {
    ...
    try {
      Network.facade(Network.intranet()).delete(SPACE, AttributeFactory.uid("9bdf0cf7-ba2c-4b75-adbe-d96087a9aa66"), option.build());
    }
