...
public class TestSearch extends TestCase {
  ...
  private static class Handler implements ResultsHandler {
    ...
    public boolean handle(final ConnectorObject object) {
      ...
      final Set<Descriptor.Attribute> mapping = this.descriptor.attribute();
  ...
  public static void main(String[] args)
    ...
    final OperationOptionsBuilder option     = new OperationOptionsBuilder().setAttributesToGet(descriptor.target());
