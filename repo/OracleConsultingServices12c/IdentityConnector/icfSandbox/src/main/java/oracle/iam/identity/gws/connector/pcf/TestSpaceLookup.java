...
public class TestSpaceLookup {
  ...
  public static void main(String[] args) {
    try {
      ...
      final Result.Space response = context.lookupSpace(UriBuilder.fromUri(RestContext.ENDPOINT_SPACES).path("dcba5143-45d4-471a-8e01-40ae5dad6195").build());
      if (response == null) {
