...
public class TestGroupCreate {
  ...
  static final Set<Attribute> attribute = AttributeFactory.set(
    ...
    , {"description",   "A group for testing purpose only"}
    }
  );
  ...
  public static void main(String[] args) {
    try {
      ...
      final GroupResource created = context.createGroup(ScimMarshaller.inboundGroup(attribute));
      System.out.println(created.id());
      context.deleteGroup(created.id());
    }
