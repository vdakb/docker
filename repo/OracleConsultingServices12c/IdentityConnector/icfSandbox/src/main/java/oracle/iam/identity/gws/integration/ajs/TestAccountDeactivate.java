/*
    ...
    File        :   TestAccountDeactivate.java
...
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~
/**
 ** The test case to deactivate an  ativated account leveraging the
 ...
 ** @since   1.0.0.0
 */
public class TestAccountDeactivate extends TestAccount {
  ...
  public static void main(String[] args) {
    try {
      ...
      final Uid             uid      = facade.update(ObjectClass.ACCOUNT, UID, disable(),null);
