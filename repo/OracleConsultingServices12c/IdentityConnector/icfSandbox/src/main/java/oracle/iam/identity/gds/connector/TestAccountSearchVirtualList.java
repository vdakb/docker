/*
    ...
    File        :   TestAccountSearchVirtualList.java
...
////////////////////////////////////////////////////////////////////////////////
// class TestAccountSearchVirtualList
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The test case to fetch a virtual list result set of accounts from the target
 ** system.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class TestAccountSearchVirtualList extends TestCase {
  ...
  public static void main(String[] args) {
    ...
    try {
      final DirectoryFilter   filter   = DirectoryFilterTranslator.build(ENDPOINT.schema(), ObjectClass.ACCOUNT).pr("cn");
      // tweak the configuration to get a Virtual List ResultSet
      DirectorySearch.build(ENDPOINT.virtualListControl(true), ObjectClass.ACCOUNT, PEOPLEOPTS.build(), null).execute(new Handler());
    }
