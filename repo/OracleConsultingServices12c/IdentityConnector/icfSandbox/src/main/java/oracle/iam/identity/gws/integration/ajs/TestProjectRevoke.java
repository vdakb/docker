 ...
 ** @since   1.0.0.0
 */
public class TestProjectRevoke extends TestProject {
  ...
  public static void main(String[] args) {
    try {
      final Uid uid = Network.facade(Network.intranet()).removeAttributeValues(ObjectClass.ACCOUNT, UID, grant(), null);
