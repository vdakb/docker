...
package oracle.iam.identity.gws.integration.rest;
...
class Network {
  ...
  static final SystemConsole CONSOLE  = new SystemConsole("jws");
  /**
  ...
  static final File          FEATURE  = new File("D:/Project/OracleConsultingServices12c/IdentityConnector/icfRESTFul/src/main/resources/mds/rest-feature.xml");
  ...
  private static ServiceResource endpoint(final String serverName)
    ...
    return ServiceResource.build(CONSOLE, serverName, "-1", "", true, "application/json", "application/json", "password", "https://uaa.vm.pivotal.com/oauth/token", "cf", "", "admin", "admin", "", "", "en", "US", "GMT+01:00", "eeeee");
//    return ServiceResource.build(CONSOLE, serverName, "8080", "uaa", false, "application/json", "application/json", "credential", "http://pas.vm.pivotal.com:8080/uaa/oauth/token", "client", "admin", "adminsecret", "", "", "en", "US", "GMT+01:00", "eeeee");
//    return ServiceResource.build(CONSOLE, serverName, "8067", "/oracle.ocs.scimefbs.mockup/scim/v2", false, "application/json", "application/json", "none", "http://pas.vm.pivotal.com:8080/uaa/oauth/token", "client", "admin", "adminsecret", "", "", "en", "US", "GMT+01:00", "eeeee");
  }
}