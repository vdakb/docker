/*
    ...
    File        :   TestAccountSearchSimple.java
...
////////////////////////////////////////////////////////////////////////////////
// class TestAccountSearchSimple
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The test case to fetch a non-paginated result set of accounts from the
 ** target system.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class TestAccountSearchSimple extends TestCase {
  ...
  public static void main(String[] args) {
    try {
      final DirectoryFilter filter = DirectoryFilterTranslator.build(ENDPOINT.schema(), ObjectClass.ACCOUNT).pr("uid");
      DirectorySearch.build(ENDPOINT, ObjectClass.ACCOUNT, PEOPLEOPTS.build(), null).execute(new Handler());
    }
