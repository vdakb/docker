...
// ~~~~~ ~~~~~~~~~~
/**
 ** The test case to obtain the schema from the target system.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public class TestSchema {
  ...
  public static void main(String[] args) {
    try {
      final DatabaseSchema schema = Network.intranet().schema();
      System.out.println(schema.build(DatabaseConnector.class));
    }
