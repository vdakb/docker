...
class Network {
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   facade
  protected static ConnectorFacade facade(final DirectoryResource resource)
    throws TaskException {

    return BundleLocator.create(server(), resource, feature());
  }
   ...
   */
  private static DirectoryFeature feature()
    throws TaskException {

    return DirectoryFeature.build(CONSOLE, CONFIG);
  }
  ...
  private static DirectoryResource endpoint(final String serverName)
    ...
    return new DirectoryResource(CONSOLE, serverName, "7636", "dc=vm,dc=oracle,dc=com", "uid=oimadmin,cn=System,dc=vm,dc=oracle,dc=com", Password.read(PASSWORD), true, false, "en", "US", "GMT+01:00", "eeeee");
  }
}