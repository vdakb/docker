/*
    ...
    File        :   TestGroupSearchSimple.java
...
////////////////////////////////////////////////////////////////////////////////
// class TestGroupSearchSimple
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~
/**
 ** The test case to fetch a non-paginated result set of groups from the target
 ** system.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class TestGroupSearchSimple extends TestCase {
  ...
  public static void main(String[] args) {
    try {
      DirectorySearch.build(ENDPOINT, ObjectClass.GROUP, GROUPOPTS.build(), null).execute(new Handler());
    }
