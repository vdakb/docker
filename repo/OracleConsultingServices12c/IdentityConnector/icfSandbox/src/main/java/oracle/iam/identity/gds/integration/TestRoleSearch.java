...
// ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The test case to search for role entries in the target system leveraging
 ...
 ** @since   1.0.0.0
 */
public class TestRoleSearch extends TestCase {
  ...
  public static void main(String[] args) {
    try {
      ...
      ROLEOPTS.getOptions().put(BATCH_SIZE, new Integer(500));
      Network.facade(Network.internet()).search(Directory.ROLE, null, new Handler(), ROLEOPTS.build());
    }
