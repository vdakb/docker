/*
    ...
    ------------+-----------+-----------+-----------------------------------
    1.0.0.0      2021-29-04  SBernet     First release version
*/
 ...
 ** @since   1.0.0.0
 */
public class TestProjectRoleSearch {
  ...
  public static void main(String[] args) {
    try {
      final List result = Network.intranet().searchProjectRoles("10000");;

      //for (Pair<String, String> cursor : result)
