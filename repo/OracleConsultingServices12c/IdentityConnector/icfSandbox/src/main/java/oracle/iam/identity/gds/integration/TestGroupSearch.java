...
// ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** The test case to search for group entries in the target system leveraging
 ...
 ** @since   1.0.0.0
 */
public class TestGroupSearch extends TestCase {
  ...
  public static void main(String[] args) {
    try {
      GROUPOPTS.getOptions().put(BATCH_SIZE, new Integer(500));
      Network.facade(Network.internet()).search(ObjectClass.GROUP, null, new Handler(), GROUPOPTS.build());
    }
