...
////////////////////////////////////////////////////////////////////////////////
// class TestAccountActivate
// ~~~~~ ~~~~~~~~~~~~~~~~~~~
/**
 ** The test case to activate a previously decativated account leveraging the
 ...
 ** @since   1.0.0.0
 */
public class TestAccountActivate extends TestAccount {
  ...
  public static void main(String[] args) {
    try {
      ...
      final Uid             uid      = facade.update(ObjectClass.ACCOUNT, UID, enable(), null);
