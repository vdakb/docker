...
public class TestTenantDelete extends TestCase {
  ...
  public static void main(String[] args) {
    ...
    try {
      Network.facade(Network.intranet()).delete(TENANT, AttributeFactory.uid("f88c774f-1f28-4012-b9b6-96ab1790280a"), option.build());
    }
