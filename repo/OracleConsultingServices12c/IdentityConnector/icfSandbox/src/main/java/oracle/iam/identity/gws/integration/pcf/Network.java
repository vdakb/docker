...
class Network {
  ...
  static final File          FEATURE        = new File("D:/Project/OracleConsultingServices12c/IdentityConnector/icfSandbox/src/test/resources/mds/pcf-feature.xml");
  ...
  /**
   ** The location of the local bundle directory
   */
  static final File          LOCATION       = new File("D:/Project/OracleConsultingServices12c/deployment/oim/0102 systemIntegration/ics");
...
//    FileSystemLocator.location(LOCATION);
//    return FileSystemLocator.create(resource, ServiceFeature.build(CONSOLE, FEATURE));
  }
  ...
  private static PivotalResource endpoint(final String serviceDomain)
    ...
    return PivotalResource.build(CONSOLE, serviceDomain, "-1", false, "oauth-password", "cf", "", "admin", "admin", "", "", "en", "US", "GMT+01:00", "eeeee");
  }
}