 ...
 ** @since   1.0.0.0
 */
public class TestAccountRevert extends TestAccount {
  ...
  public static void main(String[] args) {
    try {
      ...
      final Uid             uid      = facade.update(ObjectClass.ACCOUNT, UID, revert(),null);
