...
// ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** The test case to create a tenant in the target system leveraging the
...
public class TestTenantCreate extends TestTenant {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println(facade.create(TENANT , T1C, option.build()));
      System.out.println(facade.create(TENANT , T2C, option.build()));
      System.out.println(facade.create(TENANT , T3C, option.build()));
    }
