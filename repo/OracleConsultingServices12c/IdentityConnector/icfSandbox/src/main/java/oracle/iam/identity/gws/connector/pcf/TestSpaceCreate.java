...
// ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** The test case to create a group resource in the target system.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class TestSpaceCreate {
  ...
  public static void main(String[] args) {
    try {
      ...
      final Payload.Space resource = RestMarshaller.buildSpace(attribute);
      final Result.Space  response = context.createSpace(resource);
