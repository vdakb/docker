/*
    ...
    File        :   TestTenantAssignBilling.java
 ...
 ** @since   1.0.0.0
 */
public class TestTenantAssignBilling {
  ...
  public static void main(String[] args) {
    try {
      ...
      final Result.User response = context.assign("eeeeeeee", "b82f7ab9-dc22-4e66-a056-0dcf11b39bdc", "billing_managed_organizations");
