...
// ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** The test case to assign a group resource to a user resource in the target
 ** system.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
...
public class TestGroupAssign {
  ...
  public static void main(String[] args) {
    try {
      final List<Operation> operation = ScimMarshaller.inboundGroup(member, false);
