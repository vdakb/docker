...
public class TestRoleSearch extends TestTenant {
  ...
  public static void main(String[] args) {
    final Set<String>             target = CollectionUtility.set("__UID__", "__NAME__", "tenant.displayName");
    final OperationOptionsBuilder option = new OperationOptionsBuilder().setAttributesToGet(target);
    try {
      Network.facade(Network.localnet()).search(ObjectClass.GROUP, null, new Handler(), option.build());
    }
