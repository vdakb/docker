/*
    ...
    File        :   TestOrganizationSearch.java
...
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The test case to search for organization entries in the target system
 ...
 ** @since   1.0.0.0
 */
public class TestOrganizationSearch extends TestCase {
  ...
  public static void main(String[] args) {
    try {
      final OperationOptionsBuilder controller = new OperationOptionsBuilder()
        .setAttributesToGet("objectClass", "dc", "cn", "c", "st", "l", "o", "ou")
      ;
      final Filter filter = FilterFactory.build("not(equalTo('objectClass','person')|equalTo('objectClass','groupOfNames')|equalTo('objectClass','groupOfUniqueNames'))");
      controller.getOptions().put(BATCH_SIZE, new Integer(500));
      Network.facade(Network.internet()).search(Directory.ANY, filter, new Handler(), controller.build());
    }
