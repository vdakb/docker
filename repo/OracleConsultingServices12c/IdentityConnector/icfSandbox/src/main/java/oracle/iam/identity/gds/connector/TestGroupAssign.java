...
// ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** The test case to assign a group to a user in the target system.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public class TestGroupAssign extends TestCase {
  ...
  public static void main(String[] args) {
    ...
    try {
      DirectoryModify.build(ENDPOINT, ObjectClass.GROUP).assign(peopleUUID(ENDPOINT, ACTOR), transfer);
    }
