...
// ~~~~~ ~~~~~~
/**
 ** The test case delete operation on on tenants at the target system
...
public class Delete extends TestFixture {
  ...
  public void deleteUnknown() {
    try {
      FACADE.delete(ServiceClass.TENANT, Tenant.UNKNOWN.value, null);
    }
  ...
  public void resolveTop() {
    try {
      FACADE.delete(ServiceClass.TENANT, Tenant.TOP.value, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void resolveXellerate() {
    try {
      FACADE.delete(ServiceClass.TENANT, Tenant.LEGACY.value, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
