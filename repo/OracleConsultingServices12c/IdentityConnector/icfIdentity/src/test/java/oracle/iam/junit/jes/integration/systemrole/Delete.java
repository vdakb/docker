...
public class Delete extends TestFixture {
  ...
  public void deleteUnknown() {
    try {
      FACADE.delete(ObjectClass.GROUP, SystemRole.UNKNOWN.value, null);
    }
  ...
  public void deleteAllUsers() {
    try {
      FACADE.delete(ObjectClass.GROUP, SystemRole.ALLUSERS.value, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void deleteSystemAdministrator() {
    try {
      FACADE.delete(ObjectClass.GROUP, SystemRole.OLDADMIN.value, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void deleteOperators() {
    try {
      FACADE.delete(ObjectClass.GROUP, SystemRole.OPERATORS.value, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void deleteSelfOperators() {
    try {
      FACADE.delete(ObjectClass.GROUP, SystemRole.SELFOP.value, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void deleteAdministrator() {
    try {
      FACADE.delete(ObjectClass.GROUP, SystemRole.NEWADMIN.value, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void deleteBIReportAdministrator() {
    try {
      FACADE.delete(ObjectClass.GROUP, SystemRole.BIRADMIN.value, null);
    }
    catch (ConnectorException e) {
      failed(e);
    }
