...
// ~~~~~ ~~~~~~
/**
 ** The test case for search operation on scoped roles (aka AdminRole)s at the
...
public class Search extends TestReconciliation {
  ...
  public void testSearch() {
    try {
      final Descriptor              mapping   = DescriptorFactory.configure(Descriptor.buildProvisioning(CONSOLE), TestFixture.ScopedRole.RECONCILIATION);
      ...
      facade(endpoint()).search(ServiceClass.SCOPED, null, new Handler(mapping), option.build());
    }
