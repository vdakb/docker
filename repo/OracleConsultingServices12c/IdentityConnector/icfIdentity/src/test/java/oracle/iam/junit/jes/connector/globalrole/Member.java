...
public class Member extends TestFixture {
  ...
  public void listUnknown() {
    try {
      final List<AdminRoleMembership> result = CONTEXT.userGlobalRole(Identity.UNKNOWN.value);
  ...
  public void listSystemAdministrator() {
    try {
      ...
      final List<AdminRoleMembership> result = CONTEXT.userGlobalRole(Identity.XELSYSADM.value);
      assertNotNull(result);
      assertTrue(result.size() > 0);
    }
    catch (SystemException e) {
  ...
  public void listRegularUser() {
    try {
      ...
      final List<AdminRoleMembership> result = CONTEXT.userGlobalRole(Identity.CAMBRAULT.value);
      assertNotNull(result);
      assertTrue(result.size() == 0);
    }
    catch (SystemException e) {
