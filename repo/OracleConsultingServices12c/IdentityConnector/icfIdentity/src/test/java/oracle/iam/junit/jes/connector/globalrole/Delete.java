...
public class Delete extends TestFixture {
  ...
  public void deleteUnknown() {
    try {
      CONTEXT.deleteGlobalRole(GlobalRole.UNKNOWN.value);
    }
  ...
  public void orclOIMSystemAdministrator() {
    try {
      CONTEXT.deleteGlobalRole(GlobalRole.SYSADMIN.value);
    }
    catch (SystemException e) {
      failed(e);
    }
  ...
  public void deleteOrclOIMSystemConfigurator() {
    try {
      CONTEXT.deleteGlobalRole(GlobalRole.SYSCONFIG.value);
    }
    catch (SystemException e) {
      failed(e);
    }
  ...
  public void deleteOrclOIMCatalogAdmin() {
    try {
      CONTEXT.deleteGlobalRole(GlobalRole.CATADMIN.value);
    }
    catch (SystemException e) {
      failed(e);
    }
  ...
  public void deleteOrclOIMCertificationAdministrator() {
    try {
      CONTEXT.deleteGlobalRole(GlobalRole.CERTADMIN.value);
    }
    catch (SystemException e) {
      failed(e);
    }
  ...
  public void deleteOrclOIMCertificationViewer() {
    try {
      CONTEXT.deleteGlobalRole(GlobalRole.CERTVIEWER.value);
    }
    catch (SystemException e) {
      failed(e);
    }
