...
public class Search extends TestReconciliation {
  ...
  public void testSearch() {
    try {
      final Descriptor              mapping   = DescriptorFactory.configure(Descriptor.buildProvisioning(CONSOLE), TestFixture.GlobalRole.RECONCILIATION);
      ...
      facade(endpoint()).search(ServiceClass.GLOBAL, null, new Handler(mapping), option.build());
    }
