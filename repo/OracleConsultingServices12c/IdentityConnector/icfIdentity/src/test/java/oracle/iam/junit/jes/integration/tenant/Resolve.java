...
public class Resolve extends TestFixture {
  ...
  public void resolveTop() {
    try {
      assertEquals(FACADE.resolveUsername(ServiceClass.TENANT, Tenant.TOP.tag, null), Tenant.TOP.value);
    }
  ...
  public void resolveXellerate() {
    try {
      assertEquals(FACADE.resolveUsername(ServiceClass.TENANT, Tenant.LEGACY.tag, null), Tenant.LEGACY.value);
    }
    catch (ConnectorException e) {
      failed(e);
    }
