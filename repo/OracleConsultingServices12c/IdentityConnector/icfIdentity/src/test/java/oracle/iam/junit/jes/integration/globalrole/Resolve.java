...
public class Resolve extends TestFixture {
  ...
  public void resolveUnknown() {
    try {
      FACADE.resolveUsername(ServiceClass.GLOBAL, GlobalRole.UNKNOWN.tag, null);
    }
  ...
  public void resolveOrclOIMSystemAdministrator() {
    try {
      assertEquals(FACADE.resolveUsername(ServiceClass.GLOBAL, GlobalRole.SYSADMIN.tag, null), GlobalRole.SYSADMIN.value);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void resolveOrclOIMSystemConfigurator() {
    try {
      assertEquals(FACADE.resolveUsername(ServiceClass.GLOBAL, GlobalRole.CERTVIEWER.tag, null), GlobalRole.SYSCONFIG.value);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void resolveOrclOIMCatalogAdmin() {
    try {
      assertEquals(FACADE.resolveUsername(ServiceClass.GLOBAL, GlobalRole.CATADMIN.tag, null), GlobalRole.CATADMIN.value);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void resolveOrclOIMCertificationAdministrator() {
    try {
      assertEquals(FACADE.resolveUsername(ServiceClass.GLOBAL, GlobalRole.CERTADMIN.tag, null), GlobalRole.CERTADMIN.value);
    }
    catch (ConnectorException e) {
      failed(e);
    }
  ...
  public void resolveOrclOIMCertificationViewer() {
    try {
      assertEquals(FACADE.resolveUsername(ServiceClass.GLOBAL, GlobalRole.CERTVIEWER.tag, null), GlobalRole.CERTVIEWER.value);
    }
    catch (ConnectorException e) {
      failed(e);
    }
