...
public class TestSchema extends TestBaseConnector {
  ...
  public void connectorSchema() {
    final Schema schema = ServiceSchema.instance.schema(Main.class);
    assertNotNull(schema);
    CONSOLE.debug("staticSchema",schema.toString());
    assertNotNull(schema.findObjectClassInfo(ObjectClass.ACCOUNT_NAME));
    assertNotNull(schema.findObjectClassInfo(ObjectClass.GROUP_NAME));
    assertNotNull(schema.findObjectClassInfo(ServiceClass.TENANT_NAME));
  }
}