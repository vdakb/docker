...
public class Create extends TestFixture {
  ...
  public void createUnknown() {
    ...
    try {
      ...
      final Set<Attribute> dataSet = DescriptorTransformer.build(provisioning, transfer(model.form("UD_OIG_USR"), provisioning.attribute()));
  ...
  public void createSystemAdministrator() {
    assertEquals(Account.XELSYSADM.tag, createUser("igd/account-xelsysadm.json"), Account.XELSYSADM.value);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   createSystemOperator
  /**
   ** Test create request leveraging server context.
   */
  @Test
  public void createSystemOperator() {
    assertEquals(Account.XELOPERATOR.tag, createUser("igd/account-xeloperator.json"), Account.XELOPERATOR.value);
  }
  ...
  public void deleteServerAdministrator() {
    assertEquals(Account.WEBLOGIC.tag, createUser("igd/account-weblogic.json"), Account.WEBLOGIC.value);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   createInternalAdministrator
  /**
   ** Test create request leveraging connector bundle deployed on a
   ** <code>Java Connector Server</code>.
   */
  @Test
  public void createInternalAdministrator() {
    assertEquals(Account.OIMINTERNAL.tag, createUser("igd/account-oiminternal.json"), Account.OIMINTERNAL.value);
  }
  ...
  public void createZitterbacke() {
    assertEquals(Account.ZITTERBACKE.tag, createUser("igd/account-zitterbacke.json"), Account.ZITTERBACKE.value);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   createMustermann
  /**
   ** Test create request leveraging connector bundle deployed on a
   ** <code>Java Connector Server</code>.
   */
  @Test
  public void createMustermann() {
    assertEquals(Account.MUSTERMANN.tag, createUser("igd/account-mustermann.json"), Account.MUSTERMANN.value);
  }
  ...
  public void createMusterfrau() {
    assertEquals(Account.MUSTERFRAU.tag, createUser("igd/account-musterfrau.json"), Account.MUSTERFRAU.value);
  }
  ...
  public void createCambrault() {
    assertEquals(Account.CAMBRAULT.tag, createUser("igd/account-cambrault.json"), Account.CAMBRAULT.value);
  }
