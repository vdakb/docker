...
public class Create extends TestFixture {
  ...
  public void createUnknown() {
    try {
      ...
      final Descriptor descriptor = DescriptorFactory.configure(Descriptor.buildProvisioning(CONSOLE), GlobalRole.PROVISIONING);
  ...
  public void createOrclOIMSystemAdministrator() {
    assertEquals(createAdminRole("igd/create-globalrole-sysadmin.conf"), GlobalRole.SYSADMIN.value);
  }
  ...
  public void createOrclOIMSystemConfigurator() {
    assertEquals(createAdminRole("igd/create-globalrole-sysconfig.conf"), GlobalRole.SYSCONFIG.value);
  }
  ...
  public void createOrclOIMCatalogAdmin() {
    assertEquals(createAdminRole("igd/create-globalrole-catadmin.conf"), GlobalRole.CATADMIN.value);
  }
  ...
  public void createOrclOIMCertificationAdministrator() {
    assertEquals(createAdminRole("igd/create-globalrole-certadmin.conf"), GlobalRole.CERTADMIN.value);
  }
  ...
  public void createOrclOIMCertificationViewer() {
    assertEquals(createAdminRole("igd/create-globalrole-certviewer.conf"), GlobalRole.CERTVIEWER.value);
  }
