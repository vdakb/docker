...
// ~~~~~ ~~~~~~~~~~
/**
 ** SCIM 2 implementation to translate ICF Filter in the SCIM 2 syntax.
 ** <p>
...
public class Translator extends FilterTranslator<String> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a SCIM 2 filter <code>Translator</code> that allows use
   ** as a JavaBean.
   ** <br>
  ...
  /**
   ** Factory method to create a SCIM 2 <code>OR</code> filter expression.
   **
   ** @param  lhs                the left hand side SCIM 2 <code>OR</code>
   **                            filter expression.
   **                            <br>
   **                            Must never be <code>null</code>.
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  rhs                the right hand side SCIM 2 <code>OR</code>
   **                            filter expression.
   **                            <br>
   **                            Must never be <code>null</code>.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ** @return                    the SCIM 2 <code>OR</code> expression.
  ...
  /**
   ** Factory method to create a SCIM 2 <code>AND</code> filter expression.
   **
   ** @param  lhs                the left hand side SCIM 2 <code>AND</code>
   **                            filter expression.
   **                            <br>
   **                            Must never be <code>null</code>.
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  rhs                the right hand side SCIM 2 <code>AND</code>
   **                            filter expression.
   **                            <br>
   **                            Must never be <code>null</code>.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ** @return                    the SCIM 2 <code>AND</code> expression.
   **                            A return value of <code>null</code> means a
  ...
  /**
   ** Factory method to create a SCIM 2 <code>EQUAL</code> filter expression.
   **
   ...
   **
   ** @return                    the SCIM 2 <code>EQUAL</code> filter
   **                            expression.
   **                            A return value of <code>null</code> means a
  ...
  /**
   ** Factory method to create a SCIM 2 <code>GREATER-THAN</code> filter
   ** expression.
   **
  ...
  /**
   ** Factory method to create a SCIM 2 <code>GREATER-THAN-EQUAL</code> filter
   ** expression.
   **
  ...
  /**
   ** Factory method to create a SCIM 2 <code>LESS-THAN</code> filter
   ** expression.
   **
  ...
  /**
   ** Factory method to create a SCIM 2 <code>LESS-THAN-EQUAL</code> filter
   ** expression.
   **
  ...
  /**
   ** Factory method to create a SCIM 2 <code>STARTS-WITH</code> filter
   ** expression.
   **
  ...
  /**
   ** Factory method to create a SCIM 2 <code>ENDS-WITH</code> filter
   ** expression.
   **
  ...
  /**
   ** Factory method to create a SCIM 2 <code>CONTAINS</code> filter
   ** expression.
   **
