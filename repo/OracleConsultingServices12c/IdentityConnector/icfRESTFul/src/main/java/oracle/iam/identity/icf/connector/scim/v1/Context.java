...
public class Context extends Feature {
  ...
  /**
   ** Returns a known SCIM 1 user resource from the Service Provider.
   **
   ...
   **                            Allowed object is {@link String}.
   **
   ** @return                    the successfully retrieved SCIM 1 user
   **                            resource.
   **                            <br>
  ...
  /**
   ** Returns a known SCIM 1 user resource from the Service Provider by its
   ** username.
   **
   ** @param  id                 the resource username (for example the value
   **                            of the "<code>userName</code>" attribute).
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ** @return                    the successfully retrieved identifier of a
   **                            SCIM 1 user resource.
   **                            <br>
  ...
  // Method:   lookupGroup
  /**
   ** Returns a known SCIM 1 group resource from the Service Provider.
   **
   ** @param  id                 the resource identifier (for example the value
   ...
   **                            Allowed object is {@link String}.
   **
   ** @return                    the successfully retrieved SCIM 1 group
   **                            resource.
   **                            <br>
  ...
  // Method:   resolveGroup
  /**
   ** Returns a known SCIM 1 group resource from the Service Provider by its
   ** display name.
   **
   ** @param  id                 the resource identifier (for example the value
   **                            of the "<code>displayName</code>" attribute) to
  ...
  /**
   ** Build and executes the request to modify the SCIM 1 user resource at the
   ** Service Provider with the given SCIM 1 user resource.
   ** <br>
   ...
   **
   ** @param  resource           the SCIM 1 user resource to modify.
   **                            <br>
   **                            Allowed object is  {@link UserResource}.
   **
   ** @return                    the successfully modified SCIM 1 user resource.
   **                            <br>
   **                            Possible object is {@link UserResource}.
   **
   ** @throws SystemException    if an error occurs.
  ...
  // Method:   modifyGroup
  /**
   ** Build and executes the request to modify the SCIM 1 group resource at the
   ** Service Provider with the given SCIM 1 group resource.
   ** <br>
   ** If the service provider supports resource versioning, the resource will
   ** only be modified if it has not been modified since it was retrieved.
   ** <p>
   ...
   ** mutability rules defined by the schema.
   **
   ** @param  resource           the SCIM 1 group resource to modify.
   **                            <br>
   **                            Allowed object is  {@link GroupResource}.
   **
   ** @return                    the successfully modified SCIM 1 group resource.
   **                            <br>
   **                            Possible object is {@link GroupResource}.
   **
   ** @throws SystemException    if an error occurs.
  ...
  // Method:   modify
  /**
   ** Modify a SCIM 1 resource by updating one or more attributes using a
   ** sequence of operations to "<code>replace</code>" or "<code>remove</code>"
   ** values.
   ** <br>
   ** If the service provider supports resource versioning, the resource will
   ** only be modified if it has not been modified since it was retrieved.
  ...
  /**
   ** Build a request to patch a SCIM 1 resource at the Service Provider.
   **
   ** @param  <T>                the Java type of the resource to return.
   **                            <br>
   **                            Allowed object is <code>%lt;T&gt;</code>.
