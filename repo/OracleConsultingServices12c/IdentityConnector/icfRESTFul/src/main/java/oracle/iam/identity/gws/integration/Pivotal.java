...
public interface Pivotal {
   ...
   **   <li>BASIC      -
   **   <li>TOKEN      -
   **   <li>CREDENTIAL - The client can request an access token using only its
   **                    client credentials (or other supported means of
   **                    authentication) when the client is requesting access to
   **                    the protected resources under its control, or those of
   **                    another resource owner that have been previously
   **                    arranged with the authorization server (the method of
   ...
   **                    relationship with the client, such as the device
  ...
  interface ICF {
    ...
    public interface Resource {
       ...
       ** specify the domain name for the Service Provider.
       */
      static final String SERVICE_DOMAIN              = "serviceDomain";
      /**
       ** Attribute tag which must be defined on an <code>IT Resource</code> to
       ** specify the listener port for the Service Provider.
       */
      static final String SERVICE_PORT                = "servicePort";
      /**
       ** Attribute tag which must be defined on an <code>IT Resource</code> to
    ...
    public interface Feature {
       ...
       ** <code>Metadata Descriptor</code> to specify the name of the create
       ** timestamp attribute of an entry in a Service Provider.
       */
      static final String ENTRY_CREATED_ATTRIBUTE     = "entryCreatedAttribute";
      /**
       ** Attribute tag which must be defined on a
       ** <code>Metadata Descriptor</code> to specify the name of the modified
       ** timestamp attribute of an entry in a Service Provider.
       */
      static final String ENTRY_MODIFIED_ATTRIBUTE    = "entryModifiedAttribute";
      /**
       ** Attribute tag which must be defined on a
       ** <code>Metadata Descriptor</code> to specify if the entitlement loaded
       ** from a Service Server needs to be prefixed with the internal system
       ** identifier and/or the name of the <code>IT Resource</code>.
       */
      static final String ENTITLEMENT_PREFIX_REQUIRED = "entitlementPrefixRequired";
    }
  }
  ...
  interface OIM {
    ...
    public interface Resource {
       ...
       ** specify the domain name for the Service Provider.
       */
      static final String SERVICE_DOMAIN              = "Service Domain";
      /**
       ** Attribute tag which may be defined on an <code>IT Resource</code> to
       ** specify the listener port for the Service Provider.
       */
      ...
      /**
       ** Attribute tag which may be defined on an <code>IT Resource</code> to
       ** specify the credential of the client to authenticate the connector at
       ** the Service Provider.
       ** <p>
       ** This attribute willl be mandatory if the authentication scheme is
       ** Authentication#Scheme#ClientCredential or
      ...
      /**
       ** Attribute tag which may be defined on an <code>IT Resource</code> to
       ** identify the recipients that the JWT is intended for.
       ** <p>
       ** This attribute will be mandatory if the authentication scheme is
       ** Endpoint#Authentication#TOKEN.
       */
      static final String TOKEN_AUDIENCE              = "Token Audience";
      static final String TOKEN_EXPIRY                = "Token Expiry";
      static final String TOKEN_SUBJECT               = "Token Subject";
    }
  ...
  , OIM.Feature.ENTRY_CREATED_ATTRIBUTE
  , OIM.Feature.ENTRY_MODIFIED_ATTRIBUTE
  ...
  static final Map<String, String> FEATURE = CollectionUtility.unmodifiableMap(
    ...
    , {ICF.Feature.ENTITLEMENT_PREFIX_REQUIRED, OIM.Feature.ENTITLEMENT_PREFIX_REQUIRED}
    , {ICF.Feature.ENTRY_CREATED_ATTRIBUTE,     OIM.Feature.ENTRY_CREATED_ATTRIBUTE}
    , {ICF.Feature.ENTRY_MODIFIED_ATTRIBUTE,    OIM.Feature.ENTRY_MODIFIED_ATTRIBUTE}
    }
  );
  /**
   ** the attribute mapping of the feature transfer from the
  ...
  static final Map<String, String> RESOURCE = CollectionUtility.synchronizedMap(
    new String[][]{
      {ICF.Resource.SERVICE_DOMAIN,            OIM.Resource.SERVICE_DOMAIN}
    , {ICF.Resource.SERVICE_PORT,              OIM.Resource.SERVICE_PORT}
    , {ICF.Resource.SECURE_SOCKET,             PivotalResource.SECURE_SOCKET}
    ...
    , {ICF.Resource.PRINCIPAL_NAME,            PivotalResource.PRINCIPAL_NAME}
    , {ICF.Resource.PRINCIPAL_PASSWORD,        PivotalResource.PRINCIPAL_PASSWORD}
    , {ICF.Resource.RESOURCE_OWNER,            OIM.Resource.RESOURCE_OWNER}
    , {ICF.Resource.RESOURCE_CREDENTIAL,       OIM.Resource.RESOURCE_CREDENTIAL}
    , {ICF.Resource.LOCALE_LANGUAGE,           PivotalResource.LOCALE_LANGUAGE}
    , {ICF.Resource.LOCALE_COUNTRY,            PivotalResource.LOCALE_COUNTRY}
    , {ICF.Resource.LOCALE_TIMEZONE,           PivotalResource.LOCALE_TIMEZONE}
    , {ICF.Resource.CONNECTION_TIMEOUT,        PivotalResource.CONNECTION_TIMEOUT}
    , {ICF.Resource.CONNECTION_RETRY_COUNT,    PivotalResource.CONNECTION_RETRY_COUNT}
    , {ICF.Resource.CONNECTION_RETRY_INTERVAL, PivotalResource.CONNECTION_RETRY_INTERVAL}
    , {ICF.Resource.RESPONSE_TIMEOUT,          PivotalResource.RESPONSE_TIMEOUT}
    }
  );
}