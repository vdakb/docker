...
package oracle.iam.identity.gws.service.provisioning.pcf;
...
public class AccountProvisioning extends Provisioning {
  ...
  private static final String LOGGER_CATEGORY = "OCS.PCF.PROVISIONING";
  ...
  protected TargetResource populateResource(final Long resourceInstance)
    ...
    timerStart(method);
    try {
      return PivotalResource.build(this, resourceInstance);
    }
    finally {
      timerStop(method);
   ...
   ** connected User Access and Authorization Service (UAA) of Pivotal Cloud
   ** Foundry (PCF).
   **
   ** @param  resourceInstance   the <code>IT Resource</code> used by this
   **                            instance to establish a connection to the
   ...
   **                            Possible object is {@link String}.
   */
  public String modify(final Long resourceInstance, final String attribute) {
  ...
  // Method:   activate
  /**
   ** Activates an deactivated <code>Account</code> in connected User Access and
   ** Authorization Service (UAA) of Pivotal Cloud Foundry (PCF).
   **
   ** @param  resourceInstance   the <code>IT Resource</code> used by this
   **                            instance to establish a connection to the
   **                            Service Provider.
  ...
  // Method:   deactivate
  /**
   ** Deactivates an activated <code>Account</code> in connected User Access and
   ** Authorization Service (UAA) of Pivotal Cloud Foundry (PCF).
   **
   ** @param  resourceInstance   the <code>IT Resource</code> used by this
   **                            instance to establish a connection to the
  ...
  // Method:   delete
  /**
   ** Delete an <code>Account</code> in connected User Access and
   ** Authorization Service (UAA) of Pivotal Cloud Foundry (PCF).
   **
   ** @param  resourceInstance   the <code>IT Resource</code> used by this
   **                            instance to establish a connection to the
