...
public class Config extends AbstractConfiguration {
  ...
  static final String    CATEGORY = "JCS.CONNECTOR.PCF";
  ...
  // Method:   Ctor
  /**
   ** Constructs a default <code>Config</code> that allows use as a JavaBean.
   ** <br>
  ...
  public Config() {
    ...
    this.endpoint = Endpoint.build(this);
  }
  ...
  // Method:   endpoint
  /**
   ** Returns the {@link Endpoint} this configuration intialize.
   **
   ** @return                    the {@link Endpoint} this configuration
   **                            initialize.
   **                            <br>
  ...
  ////////////////////////////////////////////////////////////////////////////
  // Method:   setServiceDomain
  /**
   ** Set the <code>primaryHost</code> attribute for the content provider.
   ** <br>
   ** In terms of Pivotal Cloud Foundry this is the service domain.
   **
   ...
   */
  @ConfigurationProperty(order=1, displayMessageKey=Connector.Endpoint.SERVICE_HOST_LABEL, helpMessageKey=Connector.Endpoint.SERVICE_HOST_HINT, required=true)
  public final void setServiceDomain(final String value) {
    this.endpoint.primaryHost(value);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   getServiceDomain
  /**
   ...
   */
  @ConfigurationProperty(order=2, displayMessageKey=Connector.Endpoint.SERVICE_PORT_LABEL, helpMessageKey=Connector.Endpoint.SERVICE_PORT_HINT, required=true)
  public final void setServicePort(final int value) {
   ...
   ** connect to.
   ** <br>
   ** In terms of Pivotal Cloud Foundry this is applicatble only at the
   ** administration services.
   ** <br>
   ** Any access to User Account and Authentication (UAA) service is encrypted
   ** per default.
   **
   ...
   */
  @ConfigurationProperty(order=3, displayMessageKey=Connector.Endpoint.SECURE_LABEL, helpMessageKey=Connector.Endpoint.SECURE_HINT)
   ...
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=4, displayMessageKey=Connector.Endpoint.AUTHENTICATION_SCHEME_LABEL, helpMessageKey=Connector.Endpoint.AUTHENTICATION_SCHEME_HINT)
   ...
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=5, displayMessageKey=Connector.Endpoint.CLIENT_IDENTIFIER_LABEL, helpMessageKey=Connector.Endpoint.CLIENT_IDENTIFIER_HINT)
   ...
   */
  @ConfigurationProperty(order=6, displayMessageKey=Connector.Endpoint.CLIENT_SECRET_LABEL, helpMessageKey=Connector.Endpoint.CLIENT_SECRET_HINT)
   ...
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=7, displayMessageKey=Connector.Endpoint.PRINCIPAL_USERNAME_LABEL, helpMessageKey=Connector.Endpoint.PRINCIPAL_USERNAME_HINT)
   ...
   **                            Allowed object is {@link GuardedString}.
   */
  @ConfigurationProperty(order=8, displayMessageKey=Connector.Endpoint.PRINCIPAL_PASSWORD_LABEL, helpMessageKey=Connector.Endpoint.PRINCIPAL_PASSWORD_HINT)
   ...
   ** {@link Endpoint.Principal#username()}.
   **
   ...
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=9, displayMessageKey=Connector.Endpoint.RESOURCE_OWNERNAME_LABEL, helpMessageKey=Connector.Endpoint.RESOURCE_OWNERNAME_HINT)
   ...
   ** <p>
   ** Convenience method to shortens the access to the configuration property
   ** {@link Endpoint.Principal#password()}.
   **
   ...
   **                            Allowed object is {@link GuardedString}.
   */
  @ConfigurationProperty(order=10, displayMessageKey=Connector.Endpoint.RESOURCE_CREDENTIAL_LABEL, helpMessageKey=Connector.Endpoint.RESOURCE_CREDENTIAL_HINT)
   ...
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=11, displayMessageKey=Connector.Endpoint.LANGUAGE_LABEL, helpMessageKey=Connector.Endpoint.LANGUAGE_HINT)
   ...
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=12, displayMessageKey=Connector.Endpoint.COUNTRY_LABEL, helpMessageKey=Connector.Endpoint.COUNTRY_HINT)
   ...
   **                            Allowed object is {@link String}.
   */
  @ConfigurationProperty(order=13, displayMessageKey=Connector.Endpoint.TIMEZONE_LABEL, helpMessageKey=Connector.Endpoint.TIMEZONE_HINT)
   ...
   **                            Allowed object is <code>int</code>.
   */
  @ConfigurationProperty(order=14, displayMessageKey=Connector.Connection.CONNECT_TIMEOUT_LABEL, helpMessageKey=Connector.Connection.CONNECT_TIMEOUT_HINT)
   ...
   **                            Allowed object is <code>int</code>.
   */
  @ConfigurationProperty(order=15, displayMessageKey=Connector.Connection.RESPONSE_TIMEOUT_LABEL, helpMessageKey=Connector.Connection.RESPONSE_TIMEOUT_HINT)
   ...
   **                            Allowed object is <code>boolean</code>.
   */
  @ConfigurationProperty(order=16, displayMessageKey=Connector.Feature.FETCH_SCHEMA_LABEL, helpMessageKey=Connector.Feature.FETCH_SCHEMA_HINT)
