...
// ~~~~~ ~~~~~~
/**
 ** A factory for APIGEE lookup requests.
 **
 ...
 ** @since   1.0.0.0
 */
public class Lookup<T extends Resource> extends Request<Lookup>  {
   ...
   **                            error.
   */
  public <R extends Resource> R invoke(final Class<R> clazz)
