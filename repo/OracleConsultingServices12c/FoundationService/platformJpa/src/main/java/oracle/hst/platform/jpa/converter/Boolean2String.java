 ...
 */
@Converter
public final class Boolean2String implements AttributeConverter<Boolean, String> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Boolean2String</code> instance that allows use as a
   ** JavaBean.
   ** <br>
