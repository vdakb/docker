 ...
 */
@Converter
public final class Boolean2Character implements AttributeConverter<Boolean, Character> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Boolean2Character</code> instance that allows use as a
   ** JavaBean.
   ** <br>
   ...
   */
  @Override
  public final Character convertToDatabaseColumn(final Boolean value) {
    return value ? 'Y' : 'N';
  }
   ...
   */
  @Override
  public Boolean convertToEntityAttribute(final Character value) {
