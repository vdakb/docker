 ...
 ** @since   1.0.0.0
 */
public class Contains<T> extends AttributeFilter<T> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Contains</code> w/ the <code>value</code> to compare.
   **
   ...
   **                            Allowed object is <code>T</code>.
   */
  public Contains(final Path path, final T value) {
    // ensure inheritance
