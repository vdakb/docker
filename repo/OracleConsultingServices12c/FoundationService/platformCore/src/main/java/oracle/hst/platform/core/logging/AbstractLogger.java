...
// ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The <code>AbstractLogger</code> implements the base functionality of a
 ** service logger.
 **
...
public class AbstractLogger<T extends AbstractLogger> implements Loggable<T> {
   ...
   **
   ** @param  clazz              the category for the {@link Logger}.
   **                            <br>
  ...
  protected AbstractLogger(final Class<?> clazz) {
    // ensure inheritance
    this(ClassUtility.packageName(clazz));
  }
   ...
   **
   ** @return                    the {@link AbstractLogger} to allow method
   **                            chaining.
   **                            <br>
   **                            Possible object is {@link AbstractLogger} of
   **                            type <code>T</code>.
   */
  @Override
  public AbstractLogger<T> fatal(final String method, final Throwable throwable) {
    if (this.logger != null)
   ...
   */
  @Override
  public AbstractLogger<T> error(final String method, final String message) {
    if (this.logger != null)
   ...
   */
  @Override
  public AbstractLogger<T> warning(final String message) {
    if (this.logger != null)
   ...
   */
  @Override
  public AbstractLogger<T> warning(final String method, final String message) {
    if (this.logger != null)
   ...
   */
  @Override
  public AbstractLogger<T> info(final String message) {
    if (this.logger != null)
   ...
   */
  @Override
  public AbstractLogger<T> debug(final String method, final String message) {
    if (this.logger != null)
   ...
   */
  @Override
  public AbstractLogger<T> trace(final String method, final String message) {
    if (this.logger != null)
   ...
   **                            type <code>T</code>.
   */
  public AbstractLogger<T> entering(final String method) {
   ...
   **                            type <code>T</code>.
   */
  public AbstractLogger<T> entering(final String method, final Object... parameter) {
   ...
   **                            type <code>T</code>.
   */
  public AbstractLogger<T> exiting(final String method, final Object... result) {
   ...
   **                            type <code>T</code>.
   */
  public AbstractLogger<T> throwing(final String method, final Throwable throwable) {
