 ...
 ** @since   1.0.0.0
 */
public class StartsWith<T> extends AttributeFilter<T> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>StartsWith</code> w/ the {@link String} to compare.
   **
   ...
   **                            Allowed object is <code>T</code>.
   */
  public StartsWith(final Path path, final T value) {
    // ensure inheritance
