...
public class Logger {
  ...
  private static class Fatal extends Level {
    ...
    // compatible with
    @SuppressWarnings("compatibility:75889390092011505")
    private static final long serialVersionUID = -7958528195963837345L;
  ...
  // Method:   level
  /**
   ** Sets the level that would actually be logged by this logger.
   **
   ** @param  value              the level that would actually be logged by this
   **                            logger.
   **                            <br>
   **                            Allowed object is {@link Level}.
   **
   ** @return                    the <code>Logger</code> to allow method
   **                            chaining.
   **                            <br>
   **                            Possible object is <code>Logger</code>.
   */
  public final Logger level(final Level value) {
  ...
  // Method:   nop
  /**
   ** Creates a {@link Logger} that writes nothing.
   **
   ** @param  category           the category for the {@link Logger}.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ** @return                    a <code>null</code> {@link Logger}.
   **                            <br>
   **                            Possible object is {@link Logger}.
   */
  ...
  public void fatal(final Class<Loggable> clazz, final String method, final Throwable throwable) {
    log(FATAL, ListResourceBundle.message(ClassUtility.shortName(clazz), method, throwable.getLocalizedMessage()), throwable);
  }
  ...
  public void fatal(final String className, final String method, final String message) {
    log(FATAL, ListResourceBundle.message(className, method, message));
  }
  ...
  public void fatal(final String className, final String method, final Throwable throwable) {
    log(FATAL, ListResourceBundle.message(className, method, throwable.getLocalizedMessage()), throwable);
  }
  ...
  public void error(final String className, final String method, final String message) {
    log(ERROR, ListResourceBundle.message(className, method, message));
  }
  ...
  public void warn(final String className, final String method, final String message) {
    log(WARNING, ListResourceBundle.message(className, method, message));
  }
  ...
  public void debug(final String className, final String method, final String message) {
    debug(ListResourceBundle.message(className, method, message));
  }
  ...
  public void trace(final String category, final String method, final String message) {
    trace(ListResourceBundle.message(category, method, message));
  }
   ...
   **                            Allowed object is array of {@link Object}.
   */
  public void log(final Level level, final String message, final Throwable throwable, final Object... parameter) {
    if (loggable(level)) {
      final Record record = new Record(getClass(), level, message);
      record.setParameters(parameter);
      record.setThrown(throwable);
   ...
   **                            Allowed object is array of {@link Object}.
   */
  public void log(final Level level, final String clazz, final String method, final String message, final Throwable throwable, final Object... parameter) {
    if (loggable(level)) {
      final Record record = new Record(getClass(), level, message);
      record.setSourceClassName(clazz);
      record.setSourceMethodName(method);
   ...
   **                            <br>
   **                            Allowed object is array of {@link Record}.
   */
