 ...
 ** @since   1.0.0.0
 */
public class Presence<T> implements Filter<T> {
   ...
   */
  public Presence(final Path path) {
    // ensure inheritance
    super();
  ...
  public <R> R accept(final Visitor<R, T> visitor, final T parameter)
    ...
    return visitor.present(parameter, this);
  }
   ...
   ** <p>
   ** Two <code>Presence</code> filter are considered equal if and only if they
  ...
  public boolean equals(final Object other) {
    ...
    final Presence that = (Presence)other;
  ...
  public String toString() {
    ...
    builder.append(' ').append(Type.PR.value());
