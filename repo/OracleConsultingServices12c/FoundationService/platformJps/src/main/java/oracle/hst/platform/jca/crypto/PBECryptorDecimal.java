...
////////////////////////////////////////////////////////////////////////////////
// class PBECryptorDecimal
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** Default implementation of the {@link Cryptor.Decimal} interface.
 ** <p>
 ...
 ** @since   1.0.0.0
 */
public class PBECryptorDecimal extends    PBECryptorNumeric
                               implements Cryptor.Decimal {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>PBECryptorDecimal</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>PBECryptorDecimal</code> with the specified password to
   ** use.
   ** <p>
   ...
   */
  public PBECryptorDecimal(final char[] password) {
    // ensure inheritance
    super(password);
  }
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>PBECryptorDecimal</code> using the specified
   ...
   */
  protected PBECryptorDecimal(final PBECryptorBinary cryptor) {
    // ensure inheritance
    super(cryptor);
  }
