 ...
 ** <p>
 ** The {@link Password.Guarded} interface alleviates this problem by storing
 ** the characters in memory in an encrypted form. The encryption key will be a
 ** randomly-generated key.
 ** <p>
 ** In their serialized form, {@link Password.Guarded} will be encrypted using a
...
public interface Password {
  ...
  // interface Guarded
  // ~~~~~~~~~ ~~~~~~~
  interface Guarded extends Password {
  ...
  public static char[] normalize(final char[] message) {
    try {
      Password.class.getClassLoader().loadClass(NORMALIZER);
    }
