...
public class NotFoundException extends ProcessingException {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-3172787083296783160")
  private static final long serialVersionUID = 3040698593160549520L;
   ...
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  identifier         the error message for this REST exception.
   **                            <br>
