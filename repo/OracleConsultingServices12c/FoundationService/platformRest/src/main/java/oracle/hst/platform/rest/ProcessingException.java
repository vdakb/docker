...
public class ProcessingException extends ServiceException {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-7599209313386293266")
  private static final long serialVersionUID = 8568998236811594012L;
  ...
  ProcessingException(final ErrorResponse error) {
    ...
    this.error = error;
    this.error.description(getLocalizedMessage());
  }
