...
public class PublicResourcesList {
  ...
  public static final String LOCAL = "publicResourcesList";
  ...
  // Method:   Ctor
  /**
   ** Constructs a empty <code>PublicResourcesList</code> that allows use as a
   ** JavaBean.
   ** <p>
