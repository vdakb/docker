...
// ~~~~~ ~~~~~
/**
 ** <code>Scope</code> represents scopes of a <code>Resource Client</code>
...
public class Scope extends ServiceDataType {
  ...
  final ClientInstance.Scope delegate = new ClientInstance.Scope();
  ...
  // Method:   setPrefix
  /**
   ** Called to inject the argument for attribute <code>prefix</code>.
   **
  ...
  // Method:   delegate
  /**
   ** Returns the {@link ClientInstance.Scope} delegate of
   ** <code>Resource Client</code> scope to handle.
   **
   ** @return                    the {@link ClientInstance.Scope} delegate.
   */
  final ClientInstance.Scope delegate() {
