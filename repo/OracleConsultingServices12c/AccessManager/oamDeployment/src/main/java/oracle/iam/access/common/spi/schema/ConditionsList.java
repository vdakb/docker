...
@XmlRootElement(name=ConditionsList.LOCAL)
...
public class ConditionsList {
  ...
  public static final String LOCAL = "conditionsList";
  ...
  // Method:   Ctor
  /**
   ** Constructs a empty <code>ConditionsList</code> that allows use as a
   ** JavaBean.
   ** <p>
  ...
  // Method:   getCondition
  /**
   ** Returns the value of the <code>condition</code> property.
   ** <p>
