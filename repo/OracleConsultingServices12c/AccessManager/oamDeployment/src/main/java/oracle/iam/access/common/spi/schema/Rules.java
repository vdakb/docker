...
@XmlRootElement(name=Rules.LOCAL)
...
public class Rules {
  ...
  public static final String LOCAL = "rules";
  ...
  // Method:   Ctor
  /**
   ** Constructs a empty <code>Rules</code> that allows use as a JavaBean.
   ** <p>
  ...
  // Method:   getRule
  /**
   ** Returns the value of the <code>rule</code> property.
   ** <p>
