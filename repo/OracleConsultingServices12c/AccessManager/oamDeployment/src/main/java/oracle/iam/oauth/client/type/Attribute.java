 ...
 ** <code>Resource Client</code> instance in Oracle Access Manager which itself
...
public class Attribute extends ServiceDataType {
  ...
  final ClientInstance.Attribute delegate = new ClientInstance.Attribute();
  ...
  // Method:   delegate
  /**
   ** Returns the {@link ClientInstance.Attribute} delegate of
   ** <code>Resource Server</code> token attribute to handle.
   **
   ** @return                    the {@link ClientInstance.Attribute} delegate.
   */
  final ClientInstance.Attribute delegate() {
