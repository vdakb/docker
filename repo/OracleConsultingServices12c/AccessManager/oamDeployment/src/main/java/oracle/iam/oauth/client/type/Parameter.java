 ...
 ** be passed as a nested parameter to a certain <code>Resource Client</code>.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public class Parameter extends FeatureParameter {
  ...
  , ClientProperty.SECRET.id()
  , ClientProperty.DESCRIPTION.id()
  , ClientProperty.DEFAULTSCOPE.id()
  };
