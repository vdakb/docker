...
@XmlRootElement(name=AttrMappingValue.LOCAL)
public class AttrMappingValue {
  ...
  public static final String LOCAL = "AttrMappingValue";
  ...
  // Method:   Ctor
  /**
   ** Constructs a empty <code>AttrMappingValue</code> that allows use
   ** as a JavaBean.
   ** <p>
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>AttrMappingValue</code> with the specified properties.
   **
   ** @param  mapping            the intial collection of attribute mappings.
   **                            Allowed object is {@link List} of
   **                            {@link AttributeMapping}s.
   */
  public AttrMappingValue(final List<AttributeMapping> mapping) {
    // ensure inheritance
    super();

    // initialize instance
    this.attributeMapping = mapping == null ? null : new ArrayList<AttributeMapping>(mapping);
  }
  ...
  /**
   ** Returns the value of the attributeMapping property.
   ** <p>
