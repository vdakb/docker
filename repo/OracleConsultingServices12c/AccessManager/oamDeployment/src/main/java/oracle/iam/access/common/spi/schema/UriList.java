...
@XmlRootElement(name=UriList.LOCAL)
...
public class UriList {
  ...
  public static final String LOCAL = "uriList";
  ...
  // Method:   Ctor
  /**
   ** Constructs a empty <code>UriList</code> that allows use as a JavaBean.
   ** <p>
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>UriList</code> with the specified properties.
   **
   ** @param  uriResource        the intial collection of URI's.
   **                            Allowed object is {@link List} of
   **                            {@link UriResource}s.
   */
  public UriList(final List<UriResource> uriResource) {
    // ensure inheritance
    super();

    // initialize instance
    this.uriResource = uriResource == null ? null : new ArrayList<UriResource>(uriResource);
  }
  ...
  /**
   ** Returns the value of the uriResource property.
   ** <p>
