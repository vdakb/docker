...
import oracle.iam.oauth.common.spi.ResourceHandler;
import oracle.iam.oauth.resource.type.Domain;

////////////////////////////////////////////////////////////////////////////////
// abstract class Invoker
// ~~~~~~~~ ~~~~~ ~~~~~~~
/**
 ** Invokes the Runtime REST API to maintain <code>Resource Server</code> in
...
public abstract class Invoker extends AbstractRESTfulTask {
  ...
  protected Invoker(final ServiceOperation operation) {
    ...
    this.handler = new ResourceHandler(this, operation);
  }
