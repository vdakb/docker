...
package oracle.iam.oauth.client.task;
...
import oracle.iam.oauth.client.type.Domain;

import oracle.iam.oauth.common.spi.ClientHandler;

////////////////////////////////////////////////////////////////////////////////
// abstract class Invoker
// ~~~~~~~~ ~~~~~ ~~~~~~~
/**
 ** Invokes the Runtime REST API to maintain <code>Resource Client</code>s in
...
public abstract class Invoker extends AbstractRESTfulTask {
  ...
  protected Invoker(final ServiceOperation operation) {
    ...
    this.handler = new ClientHandler(this, operation);
  }
   ...
   **                            {@link Domain} with the same name.
   */
  public void addConfiguredDomain(final Domain instance)
