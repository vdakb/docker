...
@XmlRootElement(name=Agent10gUpdate.LOCAL)
@XmlType(name="", propOrder={"preferredHost", "accessClientPasswd", "modifyAccessClientPasswdFlag", "primaryCookieDomain", "security", "state", "maxCacheElement", "cacheTimeout", "maxConnections", "maxSessionTime", "failoverThreshold", "aaaTimeoutThreshold", "logOutUrls", "userDefinedParameters", "sleepFor", "cachePragmaHeader", "cacheControlHeader", "debug", "ipValidation", "ipValidationExceptions", "denyOnNotProtected", "allowManagementOperations"})
public class Agent10gUpdate extends BaseRequest {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  public static final String LOCAL = "OAMUpdateAgentRegRequest";
  ...
  // Method:   Ctor
  /**
   ** Constructs a empty <code>Agent10gUpdate</code> that allows use as a
   ** JavaBean.
   ** <p>
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Agent10gUpdate</code> with the specified properties.
   **
   ...
   **                            Allowed object is {@link String}.
   */
  public Agent10gUpdate(final String mode, final String serverAddress, final String username, final String password,  final String agentName) {
    // ensure inheritance
