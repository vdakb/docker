...
// ~~~~~ ~~~~~~~~~
/**
 ** Invokes the web-server registration servlet to validate
 ...
 ** @since   1.0.0.0
 */
public class Validate extends Servlet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Validate</code> Ant task that allows use as a JavaBean.
   ** <br>
  ...
  public Validate() {
    // ensure inheritance
    super(ServiceOperation.validate);
  }
}