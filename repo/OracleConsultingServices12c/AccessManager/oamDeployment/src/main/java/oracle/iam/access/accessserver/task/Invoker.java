...
import oracle.iam.access.accessserver.type.Instance;

import oracle.iam.access.common.spi.AccessServerHandler;
...
public abstract class Invoker extends FoundationInvokerTask {
  ...
  protected final AccessServerHandler handler;
  ...
  protected Invoker(final ServiceOperation operation) {
    ...
    this.handler = new AccessServerHandler(this, operation);
  }
