...
import oracle.iam.access.common.spi.IdentityStoreInstance;
...
// ~~~~~ ~~~~~~~~
/**
 ** <code>Instance</code> represents an <code>Identity Store</code>
...
public class Instance extends FeatureInstance {
  ...
  final IdentityStoreInstance delegate = new IdentityStoreInstance();
  ...
  // Method:   delegate
  /**
   ** Returns the {@link IdentityStoreInstance} delegate of Identity Store
   ** object to handle.
   **
   ** @return                    the {@link IdentityStoreInstance} delegate.
   */
  public final IdentityStoreInstance delegate() {
  ...
  public void addConfiguredParameter(final Parameter parameter)
    ...
    this.delegate.add(IdentityStoreProperty.from(parameter.getValue()), parameter.name());
  }
}