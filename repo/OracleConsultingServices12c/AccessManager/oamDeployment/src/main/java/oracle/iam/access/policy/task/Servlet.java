...
import oracle.iam.access.policy.type.Instance;

import oracle.hst.deployment.task.AbstractServletTask;

import oracle.iam.access.common.spi.AccessPolicyHandler;

////////////////////////////////////////////////////////////////////////////////
// abstract class Servlet
// ~~~~~~~~ ~~~~~ ~~~~~~~
/**
 ** Invokes the HTTP Registration Service to maintain authentication and
 ** authorization policies in Oracle Access Manager.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public abstract class Servlet extends AbstractServletTask {
  ...
  protected final AccessPolicyHandler handler;
  ...
  protected Servlet(final ServiceOperation operation) {
    ...
    this.handler = new AccessPolicyHandler(this, operation);
  }
