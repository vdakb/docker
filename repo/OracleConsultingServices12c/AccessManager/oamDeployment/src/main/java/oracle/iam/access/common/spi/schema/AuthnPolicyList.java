...
@XmlRootElement(name=AuthnPolicyList.LOCAL)
@XmlType(name="", propOrder={"authentication", "registration"})
public class AuthnPolicyList {
  ...
  @XmlElement(name=RregAuthenticationPolicy.LOCAL)
  protected List<RregAuthenticationPolicy> authentication;
  ...
  // Method:   Ctor
  /**
   ** Constructs a empty <code>AuthnPolicyList</code> that allows use as a
   ** JavaBean.
   ** <p>
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>AuthnPolicyList</code> with the specified properties.
   **
   **
   ** @param  authentication     the intial collection of authentication
   **                            policies.
   ...
   **                            {@link RregAuthorizationPolicy }s.
   */
  public AuthnPolicyList(final List<RregAuthenticationPolicy> authentication, final List<RREGPolicy> registration) {
    // ensure inheritance
    super();

    // initialize instance
    this.authentication = authentication == null ? null : new ArrayList<RregAuthenticationPolicy>(authentication);
  ...
  /**
   ** Returns the value of the authentication property.
   ** <p>
  ...
  public List<RregAuthenticationPolicy> getRregAuthenticationPolicy() {
    if (this.authentication == null)
      this.authentication = new ArrayList<RregAuthenticationPolicy>();
