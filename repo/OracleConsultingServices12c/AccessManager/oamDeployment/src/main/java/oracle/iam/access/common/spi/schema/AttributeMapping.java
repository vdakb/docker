...
@XmlRootElement(name=AttributeMapping.LOCAL)
...
public class AttributeMapping {
  ...
  public static final String LOCAL = "attributeMapping";
  ...
  // Method:   Ctor
  /**
   ** Constructs a empty <code>AttributeMapping</code> that allows use as a
   ** JavaBean.
   ** <p>
