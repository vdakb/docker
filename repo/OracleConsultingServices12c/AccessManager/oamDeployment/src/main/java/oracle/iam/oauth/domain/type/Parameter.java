 ...
 ** be passed as a nested parameter to a certain <code>Identity Domain</code>.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public class Parameter extends FeatureParameter {
  ...
  private static final String[] VALUE = {
    DomainProperty.CONSENTPAGEURL.id()
  , DomainProperty.DESCRIPTION.id()
  , DomainProperty.ERRORPAGEURL.id()
  , DomainProperty.IDENTITYPROVIDER.id()
    // handled separatly to hve more control
//  , DomainProperty.TOKENSETTINGS.id()
  , DomainProperty.TRUSTSTOREIDENTIFIER.id()
  };
