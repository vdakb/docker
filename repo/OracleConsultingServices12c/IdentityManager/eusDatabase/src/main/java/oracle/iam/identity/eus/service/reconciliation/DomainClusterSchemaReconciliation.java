...
////////////////////////////////////////////////////////////////////////////////
// class DomainClusterSchemaReconciliation
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>DomainClusterSchemaReconciliation</code> act as the service end
 ** point for the Identity Manager to reconcile user information from many
 ** Enterprise Domains in a Directory Service.
 ** <p>
 ** The Enterprise Domains the schema mappings needs to be reconciled for are
 ...
 ** <code>Loookup Definition</code> building up what we define as Domain
 ** Cluster.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class DomainClusterSchemaReconciliation extends SchemaReconciliation {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>DomainClusterSchemaReconciliation</code>
   ...
   ** Default Constructor
   */
  public DomainClusterSchemaReconciliation() {
    // ensure inheritance
    super();
  }
