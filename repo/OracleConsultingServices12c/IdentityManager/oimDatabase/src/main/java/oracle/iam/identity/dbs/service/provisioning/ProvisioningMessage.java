...
public interface ProvisioningMessage {
  ...
  static final String CHANGE_PASSWORD   = Constant.PREFIX + "01081";
  static final String CHANGE_DEFTBS     = Constant.PREFIX + "01082";
  static final String CHANGE_TMPTBS     = Constant.PREFIX + "01083";
  static final String CHANGE_PROFILE    = Constant.PREFIX + "01084";
}