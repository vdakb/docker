...
// ~~~~~ ~~
/**
 ** The dictionary dialect to managed accounts in a SyBase Database.
 */
public class sy extends Dialect {

  //////////////////////////////////////////////////////////////////////////////
  // static attributes
  //////////////////////////////////////////////////////////////////////////////

  /** the error translation of SyBase Database to our implementation*/
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Dialect</code> for a SyBase Database that referes to
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   installEntity (Dictionary)
  /**
   ** Creates the administrative entities supported by a SyBase Database.
   **
  ...
  protected final Map<Entity, DatabaseEntity> installEntity() {
    // the administrative entity catalog supported by a SyBase Database.
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   installCatalog (Dictionary)
  /**
   ** Creates the administrative catalog supported by a SyBase Database.
   **
  ...
  protected final Map<Catalog.Type, Catalog> installCatalog() {
    // the system catalog provided by a SyBase Database
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   installPermission (Dictionary)
  /**
   ** Creates the administrative operations providing granted permissions on
   ** objects to accounts and/or roles supported by a SyBase Database.
   **
  ...
  protected final Map<Catalog.Type, Catalog> installPermission() {
    ...
    // to accounts and/or roles supported by a SyBase Database.
    final Map<Catalog.Type, Catalog> mapping = new EnumMap<Catalog.Type, Catalog>(Catalog.Type.class);
