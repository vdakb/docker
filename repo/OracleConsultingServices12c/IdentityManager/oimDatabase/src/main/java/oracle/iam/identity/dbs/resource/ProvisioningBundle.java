...
import oracle.iam.identity.dbs.service.provisioning.ProvisioningMessage;
 ...
 ** @version 1.0.0.0
 */
public class ProvisioningBundle extends ListResourceBundle  {
  ...
  private static final String[][] CONTENT = {
    { ProvisioningMessage.CHANGE_PASSWORD, "Changing Password" }
  , { ProvisioningMessage.CHANGE_DEFTBS,   "Changing Default Tablespace" }
  , { ProvisioningMessage.CHANGE_TMPTBS,   "Changing Temporary Tablespace" }
  , { ProvisioningMessage.CHANGE_PROFILE,  "Changing Profile" }
  };

  // load the resource bundle itself in the resource bundle cache of the virtual
  // machine
  public static final ListResourceBundle RESOURCE = (ListResourceBundle)ResourceBundle.getBundle(
    ProvisioningBundle.class.getName()
  , Locale.getDefault()
  , ProvisioningBundle.class.getClassLoader()
  );
