...
// ~~~~~ ~~~~~~~~~~~~
/**
 ** Pre-Populate Adapter to fillup the state field in any request
 ** data.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class StateAdapter extends AbstractStringAdapter {
  ...
  public Serializable prepopulate(final RequestData requestData)
    ...
    try {
      return beneficiaryState(requestData);
    }
    finally {
