/*
    ...
    File        :   PostalAddressAdapter.java
...
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~
/**
 ** Pre-Populate Adapter to fillup the postal address field in any request
 ** data.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class PostalAddressAdapter extends AbstractStringAdapter {
   ...
   **                            request.
   **
   ** @return                    the postal address from the identity profile of
   **                            the beneficiary.
   */
  @Override
  public Serializable prepopulate(final RequestData requestData)
    ...
    try {
      return beneficiaryPostalAddress(requestData);
    }
    finally {
