...
////////////////////////////////////////////////////////////////////////////////
// class FullNameAdapter
// ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** Pre-Populate Adapter to fillup the full name field in any request data.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class FullNameAdapter extends AbstractStringAdapter {
   ...
   **                            request.
   **
   ** @return                    the full name from the identity profile of
   **                            the beneficiary.
   */
  @Override
  public Serializable prepopulate(final RequestData requestData)
    ...
    try {
      return beneficiaryFullName(requestData);
    }
    finally {
