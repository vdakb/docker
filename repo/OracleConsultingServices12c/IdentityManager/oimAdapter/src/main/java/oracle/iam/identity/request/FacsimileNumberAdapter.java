/*
    ...
    File        :   FacsimileNumberAdapter.java
...
////////////////////////////////////////////////////////////////////////////////
// class FacsimileNumberAdapter
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~
/**
 ** Pre-Populate Adapter to fillup the facsimile number field in any request
 ** data.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class FacsimileNumberAdapter extends AbstractStringAdapter {
   ...
   **                            request.
   **
   ** @return                    the facsimile number from the identity profile
   **                            of the beneficiary.
   */
  @Override
  public Serializable prepopulate(final RequestData requestData)
    ...
    try {
      return beneficiaryFacsimileNumber(requestData);
    }
    finally {
