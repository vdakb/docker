...
////////////////////////////////////////////////////////////////////////////////
// class PagerNumberAdapter
// ~~~~~ ~~~~~~~~~~~~~~~~~~
/**
 ** Pre-Populate Adapter to fillup the pager number field in any request data.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class PagerNumberAdapter extends AbstractStringAdapter {
   ...
   **                            request.
   **
   ** @return                    the pager number from the identity profile of
   **                            the beneficiary.
   */
  @Override
  public Serializable prepopulate(final RequestData requestData)
    ...
    try {
      return beneficiaryPagerNumber(requestData);
    }
    finally {
