...
////////////////////////////////////////////////////////////////////////////////
// class CommonNameAdapter
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** Pre-Populate Adapter to fillup the last name field in any request data.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class CommonNameAdapter extends AbstractStringAdapter {
   ...
   **                            request.
   **
   ** @return                    the common name from the identity profile of
   **                            the beneficiary.
   */
  @Override
  public Serializable prepopulate(final RequestData requestData)
    ...
    try {
      return beneficiaryCommonName(requestData);
    }
    finally {
