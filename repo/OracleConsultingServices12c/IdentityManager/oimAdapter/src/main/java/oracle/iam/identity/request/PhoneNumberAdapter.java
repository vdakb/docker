...
// ~~~~~ ~~~~~~~~~~~~~~~~~~
/**
 ** Pre-Populate Adapter to fillup the phone number field in any request data.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class PhoneNumberAdapter extends AbstractStringAdapter {
   ...
   **                            request.
   **
   ** @return                    the phone number from the identity profile of
   **                            the beneficiary.
   */
  @Override
  public Serializable prepopulate(final RequestData requestData)
    ...
    try {
      return beneficiaryPhoneNumber(requestData);
    }
    finally {
