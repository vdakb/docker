...
// ~~~~~ ~~~~~~~~~~~~~~~~~~
/**
 ** Pre-Populate Adapter to fillup the description field in any request data.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class DescriptionAdapter extends AbstractStringAdapter {
  ...
  /**
   ** Obtains the user description from the identity profile of the beneficiary.
   **
  ...
  public Serializable prepopulate(final RequestData requestData)
    ...
    try {
      return beneficiaryDescription(requestData);
    }
    finally {
