...
////////////////////////////////////////////////////////////////////////////////
// class LoginNameAdapter
// ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** Pre-Populate Adapter to fillup the login name field in any request data.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class LoginNameAdapter extends AbstractStringAdapter {
  ...
  public Serializable prepopulate(final RequestData requestData)
    ...
    try {
      return beneficiaryLoginName(requestData);
    }
    finally {
