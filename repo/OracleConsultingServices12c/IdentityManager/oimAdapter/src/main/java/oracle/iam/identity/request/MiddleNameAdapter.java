...
////////////////////////////////////////////////////////////////////////////////
// class MiddleNameAdapter
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** Pre-Populate Adapter to fillup the middle name field in any request data.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class MiddleNameAdapter extends AbstractStringAdapter {
  ...
  public Serializable prepopulate(final RequestData requestData)
    ...
    try {
      return beneficiaryMiddleName(requestData);
    }
    finally {
