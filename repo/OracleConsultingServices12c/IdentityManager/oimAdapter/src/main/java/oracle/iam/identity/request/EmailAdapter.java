...
// ~~~~~ ~~~~~~~~~~~~
/**
 ** Pre-Populate Adapter to fillup the e-Mail address field in any request data.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class EmailAdapter extends AbstractStringAdapter {
   ...
   **                            request.
   **
   ** @return                    the e-Mail address from the identity profile of
   **                            the beneficiary.
   */
  @Override
  public Serializable prepopulate(final RequestData requestData)
    ...
    try {
      return beneficiaryEmail(requestData);
    }
    finally {
