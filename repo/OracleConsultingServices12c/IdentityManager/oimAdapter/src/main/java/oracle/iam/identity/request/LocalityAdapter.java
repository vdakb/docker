...
// ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** Pre-Populate Adapter to fillup the locality field in any request
 ** data.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class LocalityAdapter extends AbstractStringAdapter {
   ...
   **                            request.
   **
   ** @return                    the locality from the identity profile of
   **                            the beneficiary.
   */
  @Override
  public Serializable prepopulate(final RequestData requestData)
    ...
    try {
      return beneficiaryLocality(requestData);
    }
    finally {
