...
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** The <code>GroupProvisioning</code> acts as the service end point for
 ** the Oracle Identity Manager to provision group properties to a Directory
 ** Service.
 ** <br>
 ** This is wrapper class has methods for group operations like create group,
 ** modify group, delete group etc.
 ** <br>
 ...
 ** @since   0.0.0.2
 */
public class GroupProvisioning extends Provisioning {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>GroupProvisioning</code> task adapter.
   **
   ...
   */
  public GroupProvisioning(final tcDataProvider provider, final Long instance)
   ...
   **
   ** @param  groupDN            Contains the elements in the tree, deepest one
   ...
   */
  public String denormalizePath(String groupDN) {
    return super.denormalizePath(groupDN);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   find
  /**
   ** Lookups an <code>Group</code> in the target system.
   **
   ...
   **                            process form.
   **                            It can be either empty or the OU name selected.
   ** @param  groupRDN           the relative distinguihsed name of the group to
   **                            lookup the group.
   **
   ** @return                    the distinguished name of the group or an
   **                            empty String if the group does not exists.
   */
  public String find(final String parentDN, final String groupRDN) {
    return super.lookup(parentDN, DirectoryConstant.GROUP_OBJECT_PREFIX, groupRDN);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   create
  /**
   ** Create an <code>Group</code> in the target system.
   **
   ** @param  parentDN           the distinguihsed name of the parent branch
   **                            to create the group within and specified
   **                            in the process form.
   **                            It can be either empty or the OU name selected.
   **
  ...
  // Method:   delete
  /**
   ** Delete a <code>Group</code> in the target system.
   **
   ** @param  groupDN            the fullqualified distinguished name of the
   **                            group to delete.
   ** @param  deleteLeafNode     whether or not the group and its leaf nodes
   **                            shall be deleted on the target system.
   **
   ** @return                    an appropriate response message
   */
  public String delete(final String groupDN, final boolean deleteLeafNode) {
    try {
      ...
      final String    superiorDN = normalizePath(DirectoryConnector.superiorDN(groupDN));
      return super.delete(ensureParentRDN(superiorDN), groupDN, reference, deleteLeafNode);
    }
  ...
  // Method:   rename
  /**
   ** Rename an <code>Group</code> from one point in the directory tree to
   ** another.
   **
   ** @param  parentDN           the fullqualified distinguished name of the
   **                            superordinated entry of the group to rename.
   ** @param  groupName          the name the existing group to rename.
   ...
   */
  public String rename(final String parentDN, final String groupName, final String attributeFilter) {
    return super.rename(parentDN, DirectoryConstant.GROUP_OBJECT_PREFIX, groupName, attributeFilter);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   move
  /**
   ** Moves an <code>Group</code> from one point in the directory tree to
   ** another.
   **
   ** @param  grouptDN           the fullqualified distinguished name of the
   **                            group to move.
   ** @param  targetDN           holds the name of the organizational path where
   **                            where the <code>grouptDN</code> has to be moved
   **                            to.
   **
   ** @return                    a appropriate response message
   */
  public String move(final String grouptDN, final String targetDN) {
    return super.move(grouptDN, targetDN);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   enable
  /**
   ** Enables a <code>Group</code> in the Target System for the specified
   ...
   ** @return                    an appropriate response message
   */
  public String enable(final String groupDN, final String entryControlName, final String entryControlValue) {
    return super.maskAttribute(groupDN, entryControlName, entryControlValue);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   disable
  /**
   ** Disables a <code>Group</code> in the Target System for the specified
   ** distinguished name <code>groupDN</code>.
   **
   ** @param  groupDN            the fullqualified distinguished name of the
   **                            group to disable.
   ...
   ** @return                    an appropriate response message
   */
  public String disable(String groupDN, String entryControlName, final String entryControlValue) {
    return super.maskAttribute(groupDN, entryControlName, entryControlValue);
  }
  ...
  /**
   ** Adds an entry to a multi-value attribute at a group.
   **
   ** @param  groupDN            the fullqualified distinguished name of the
   **                            group where the attribute should be added to.
   ...
   ** @return                    an appropriate response message
   */
  public final String addMultiValueAttribute(final String groupDN, final String attributeName, final String attributeValue) {
    return super.addMultiValueAttribute(groupDN, attributeName, attributeValue);
  }
  ...
  /**
   ** Deletes an entry from a multi-value attribute at a group.
   **
   ** @param  groupDN            the fullqualified distinguished name of the
   **                            group where the attribute should be rmoved
   **                            from.
   ** @param  attributeName      the name of the attribute that has to be
   **                            removed.
   ...
   ** @return                    an appropriate response message
   */
  public final String deleteMultiValueAttribute(final String groupDN, final String attributeName, final String attributeValue) {
    return super.deleteMultiValueAttribute(groupDN, attributeName, attributeValue);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   updateAttribute
  /**
   ** Modifies a particular attribute of a <code>Group</code> in the
   ...
   ** @return                    an appropriate response message
   */
  public String updateAttribute(final String groupDN, final String attributeFilter) {
    return super.updateAttribute(groupDN, attributeFilter);
  }
   ...
   *
   ** @param  parentRDN         the name of the group DN which is selected in
  ...
  protected final String ensureParentRDN(final String parentRDN) {
    ...
    return super.ensureParentRDN(parentRDN, this.connector().groupContainer());
  }
}