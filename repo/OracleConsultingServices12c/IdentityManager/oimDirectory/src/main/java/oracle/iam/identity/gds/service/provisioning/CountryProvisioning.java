...
////////////////////////////////////////////////////////////////////////////////
// class CountryProvisioning
// ~~~~~ ~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>CountryProvisioning</code> acts as the service end point for
 ** the Oracle Identity Manager to provision country properties to a Directory
 ** Service.
 ** <br>
 ** This is wrapper class has methods for country operations like create country,
 ** modify country, delete country etc.
 ** <br>
 ...
 ** @since   0.0.0.2
 */
public class CountryProvisioning extends Provisioning {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>CountryProvisioning</code> task adapter.
   **
   ...
   */
  public CountryProvisioning(final tcDataProvider provider, final Long instance)
   ...
   **
   ** @param  countryDN          Contains the elements in the tree, deepest one
   ...
   */
  public String denormalizePath(String countryDN) {
    return super.denormalizePath(countryDN);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   find
  /**
   ** Lookups an <code>Country</code> in the target system.
   **
   ** @param  parentDN           the distinguihsed name of the parent branch to
   **                            lookup the country within and specified in the
   **                            process form.
   ...
   **                            process form.
   **                            It can be either empty or the OU name selected.
   ** @param  countryRDN         the relative distinguihsed name of the country
   **                            to lookup the country.
   **
   ** @return                    the distinguished name of the country or an
   **                            empty String if the country does not exists.
   */
  public String find(final String parentDN, final String countryRDN) {
    return super.lookup(parentDN, DirectoryConstant.GROUP_OBJECT_PREFIX, countryRDN);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   create
  /**
   ** Create an <code>Country</code> in the target system.
   **
   ** @param  parentDN           the distinguihsed name of the parent branch
   **                            to create the country within and specified
   **                            in the process form.
   **                            It can be either empty or the OU name selected.
   **
  ...
  // Method:   delete
  /**
   ** Delete a <code>Country</code> in the target system.
   **
   ** @param  countryDN          the fullqualified distinguished name of the
   **                            country to delete.
   ** @param  deleteLeafNode     whether or not the country and its leaf nodes
   **                            shall be deleted on the target system.
   **
   ** @return                    an appropriate response message
   */
  public String delete(final String countryDN, final boolean deleteLeafNode) {
    final String superiorDN = normalizePath(DirectoryConnector.superiorDN(countryDN));
    return super.delete(ensureParentRDN(superiorDN), countryDN, deleteLeafNode);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   rename
  /**
   ** Rename an <code>Country</code> from one point in the directory tree to
   ** another.
   **
   ** @param  parentDN           the fullqualified distinguished name of the
   **                            superordinated entry of the country to rename.
   ** @param  countryName        the name the existing country to rename.
   ...
   */
  public String rename(final String parentDN, final String countryName, final String attributeFilter) {
    return super.rename(parentDN, DirectoryConstant.GROUP_OBJECT_PREFIX, countryName, attributeFilter);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   move
  /**
   ** Moves an <code>Country</code> from one point in the directory tree to
   ** another.
   **
   ** @param  countrytDN           the fullqualified distinguished name of the
   **                            country to move.
   ** @param  targetDN           holds the name of the organizational path where
   **                            where the <code>countrytDN</code> has to be moved
   **                            to.
   **
   ** @return                    a appropriate response message
   */
  public String move(final String countrytDN, final String targetDN) {
    return super.move(countrytDN, targetDN);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   enable
  /**
   ** Enables a <code>Country</code> in the Target System for the specified
   ** distinguished name <code>countryDN</code>.
   **
   ** @param  countryDN            the fullqualified distinguished name of the
   **                            country to enable.
   ...
   ** @return                    an appropriate response message
   */
  public String enable(final String countryDN, final String entryControlName, final String entryControlValue) {
    return super.maskAttribute(countryDN, entryControlName, entryControlValue);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   disable
  /**
   ** Disables a <code>Country</code> in the Target System for the specified
   ** distinguished name <code>countryDN</code>.
   **
   ** @param  countryDN            the fullqualified distinguished name of the
   **                            country to disable.
   ...
   ** @return                    an appropriate response message
   */
  public String disable(final String countryDN, final String entryControlName, final String entryControlValue) {
    return super.maskAttribute(countryDN, entryControlName, entryControlValue);
  }
  ...
  /**
   ** Adds an entry to a multi-value attribute at a country.
   **
   ** @param  countryDN            the fullqualified distinguished name of the
   **                            country where the attribute should be added to.
   ...
   ** @return                    an appropriate response message
   */
  public final String addMultiValueAttribute(final String countryDN, final String attributeName, final String attributeValue) {
    return super.addMultiValueAttribute(countryDN, attributeName, attributeValue);
  }
   ...
   **
   ** @param  countryDN            the fullqualified distinguished name of the
   **                            country where the attribute should be rmoved
   **                            from.
   ** @param  attributeName      the name of the attribute that has to be
   **                            removed.
   ...
   ** @return                    an appropriate response message
   */
  public final String deleteMultiValueAttribute(final String countryDN, final String attributeName, final String attributeValue) {
    return super.deleteMultiValueAttribute(countryDN, attributeName, attributeValue);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   updateAttribute
  /**
   ** Modifies a particular attribute of a <code>Country</code> in the
   ...
   ** @return                    an appropriate response message
   */
  public String updateAttribute(final String countryDN, final String attributeFilter) {
    return super.updateAttribute(countryDN, attributeFilter);
  }
   ...
   *
   ** @param  parentRDN         the name of the country DN which is selected in
  ...
  protected final String ensureParentRDN(final String parentRDN) {
    ...
    return super.ensureParentRDN(parentRDN, this.connector().countryContainer());
  }
}