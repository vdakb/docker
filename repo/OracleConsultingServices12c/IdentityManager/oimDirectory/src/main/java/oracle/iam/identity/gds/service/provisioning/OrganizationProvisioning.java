/*
    ...
    File        :   OrganizationProvisioning.java
...
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>OrganizationProvisioning</code> acts as the service end point for
 ** the Oracle Identity Manager to provision organization properties to a
 ** Directory Service.
 ** <br>
 ** This is wrapper class has methods for organization operations like create
 ** organization, modify organization, delete organization etc.
 ** <br>
 ...
 ** @since   0.0.0.2
 */
public class OrganizationProvisioning extends Provisioning {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>OrganizationProvisioning</code> task adapter.
   **
   ...
   */
  public OrganizationProvisioning(final tcDataProvider provider, final Long instance)
   ...
   **
   ** @param  organizationDN     Contains the elements in the tree, deepest one
   ...
   */
  public String denormalizePath(String organizationDN) {
    return super.denormalizePath(organizationDN);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   find
  /**
   ** Lookups an <code>Organization</code> in the target system.
   **
  ...
  public String find(final String parentDN) {
    return super.lookup(parentDN, DirectoryConstant.ORGANIZATION_OBJECT_PREFIX);
  }
   ...
   **                            lookup the organization within and specified in
   **                            the process form.
   **                            It can be either empty or the OU name selected.
   ** @param  organizationRDN    the relative distinguihsed name of the
   **                            role to organization lookup the organization.
   **
   ** @return                    the distinguished name of the organization or
   **                            an empty String if the organization does not
   **                            exists.
   */
  public String find(final String parentDN, final String organizationRDN) {
    return super.lookup(parentDN, DirectoryConstant.ORGANIZATION_OBJECT_PREFIX, organizationRDN);
  }
  ...
  public String create(final String parentDN) {
    return super.create(ensureParentRDN(parentDN), DirectoryConstant.ORGANIZATION_OBJECT_PREFIX, DirectoryConstant.ORGANIZATION_OBJECT_CLASS);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   delete
  /**
   ** Delete a <code>Organization</code> in the target system.
   **
   ** @param  organizationDN     the fullqualified distinguished name of the
   **                            organization to delete.
   ** @param  deleteLeafNode     whether or not the organization and its leaf
   **                            nodes shall be deleted on the target system.
   **
   ** @return                    an appropriate response message
   */
  public String delete(final String organizationDN, final boolean deleteLeafNode) {
    try {
      final Reference reference  = createEntryReference(DirectoryConstant.GROUP_OBJECT_CLASS, DirectoryConstant.GROUP_OBJECT_PREFIX, DirectoryConstant.GROUP_OBJECTMEMBER_ATTRIBUTE, DirectoryConstant.ORGANIZATION_GROUPMEMBER_ATTRIBUTE, DirectoryConstant.ORGANIZATION_GROUPMEMBER_ATTRIBUTE_DN);
      final String    superiorDN = normalizePath(DirectoryConnector.superiorDN(organizationDN));
      return super.delete(ensureParentRDN(superiorDN), organizationDN, reference, deleteLeafNode);
    }
  ...
  // Method:   rename
  /**
   ** Rename an <code>Organization</code> from one point in the directory tree to
   ** another.
   **
   ** @param  parentDN           the fullqualified distinguished name of the
   **                            superordinated entry of the role to rename.
   ** @param  organizationName   the name the existing organization to rename.
   ...
   */
  public String rename(final String parentDN, final String organizationName, final String attributeFilter) {
    return super.rename(parentDN, DirectoryConstant.ORGANIZATION_OBJECT_PREFIX, organizationName, attributeFilter);
  }
   ...
   **                            where the <code>organizationDN</code> has to
   **                            be moved to.
   **
   ** @return                    a appropriate response message
   */
  public String move(final String organizationDN, final String targetDN) {
    return super.move(organizationDN, targetDN);
  }
   ...
   ** @return                    an appropriate response message
   */
  public String enable(final String organizationDN, final String entryControlName, final String entryControlValue) {
    return super.maskAttribute(organizationDN, entryControlName, entryControlValue);
  }
   ...
   **
   ** @param  organizationDN     the fullqualified distinguished name of the
   **                            organization to disable.
   ** @param  entryControlName   the <code>Entry Control Attribute</code> name
   ** @param  entryControlValue  the <code>Entry Control Attribute</code> value
   **
   ** @return                    an appropriate response message
   */
  public String disable(final String organizationDN, final String entryControlName, final String entryControlValue) {
    return super.maskAttribute(organizationDN, entryControlName, entryControlValue);
  }
   ...
   ** @return                    an appropriate response message
   */
  public final String addMultiValueAttribute(final String organizationDN, final String attributeName, final String attributeValue) {
    return super.addMultiValueAttribute(organizationDN, attributeName, attributeValue);
  }
   ...
   ** @return                    an appropriate response message
   */
  public final String deleteMultiValueAttribute(final String organizationDN, final String attributeName, final String attributeValue) {
    return super.deleteMultiValueAttribute(organizationDN, attributeName, attributeValue);
  }
   ...
   ** @return                    an appropriate response message
   */
  public String updateAttributes(final String organizationDN, final String attributeFilter) {
    return super.updateAttribute(organizationDN, attributeFilter);
  }
   ...
   **
   ** @param  organizationDN     the fullqualified distinguished name of the
   **                            organization to added as member to the group
   ...
   ** @return                    an appropriate response message
   */
  public String addToGroup(final String organizationDN, final String groupDN) {
    return addToEntry(organizationDN, groupDN, DirectoryConstant.GROUP_OBJECT_CLASS, DirectoryConstant.GROUP_OBJECT_PREFIX, DirectoryConstant.GROUP_OBJECTMEMBER_ATTRIBUTE, DirectoryConstant.ORGANIZATION_GROUPMEMBER_ATTRIBUTE, DirectoryConstant.ORGANIZATION_GROUPMEMBER_ATTRIBUTE_DN);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   addToRole
  /**
   ** Adds aa account to a role.
   **
   **
   ** @param  accountDN          the fullqualified distinguished name of the
   **                            organization to add as member to the role
   **                            specified by the full qualified distinguished
  ...
  public String addToRole(final String accountDN, final String roleDN) {
    return addToEntry(accountDN, roleDN, DirectoryConstant.ROLE_OBJECT_CLASS, DirectoryConstant.ROLE_OBJECT_PREFIX, DirectoryConstant.ROLE_OBJECTMEMBER_ATTRIBUTE, DirectoryConstant.ORGANIZATION_ROLEMEMBER_ATTRIBUTE, DirectoryConstant.ORGANIZATION_ROLEMEMBER_ATTRIBUTE_DN);
  }
   ...
   **
   ** @param  accountDN          the fullqualified distinguished name of the
   **                            organization to be remove as member from the
   **                            role specified by the full qualified
   **                            distinguished name <code>roleDN</code>.
  ...
  public String removeFromRole(final String accountDN, final String roleDN) {
    return removeFromEntry(accountDN, roleDN, DirectoryConstant.ROLE_OBJECT_CLASS, DirectoryConstant.ROLE_OBJECT_PREFIX, DirectoryConstant.ROLE_OBJECTMEMBER_ATTRIBUTE, DirectoryConstant.ORGANIZATION_ROLEMEMBER_ATTRIBUTE, DirectoryConstant.ORGANIZATION_ROLEMEMBER_ATTRIBUTE_DN);
  }
   ...
   **
   ** @param  organizationDN     the fullqualified distinguished name of the
   **                            organization to be removed as member from the
   **                            group specified by the full qualified
   **                            distinguished name <code>groupDN</code>.
   ** @param  groupDN            the relative distinguished name of the group
   **                            selected in the process form
   **
   ** @return                    an appropriate response message
   */
  public String removeFromGroup(final String organizationDN, final String groupDN) {
    return removeFromEntry(organizationDN, groupDN, DirectoryConstant.GROUP_OBJECT_CLASS, DirectoryConstant.GROUP_OBJECT_PREFIX, DirectoryConstant.GROUP_OBJECTMEMBER_ATTRIBUTE, DirectoryConstant.ORGANIZATION_GROUPMEMBER_ATTRIBUTE, DirectoryConstant.ORGANIZATION_GROUPMEMBER_ATTRIBUTE_DN);
  }
  ...
  protected final String ensureParentRDN(final String parentRDN) {
    ...
    return super.ensureParentRDN(parentRDN, this.connector().organizationContainer());
  }
}