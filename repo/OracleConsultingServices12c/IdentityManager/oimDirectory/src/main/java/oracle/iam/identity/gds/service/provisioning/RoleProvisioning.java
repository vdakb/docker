...
// ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** The <code>RoleProvisioning</code> acts as the service end point for
 ** the Oracle Identity Manager to provision role properties to a Directory
 ** Service.
 ** <br>
 ** This is wrapper class has methods for role operations like create role,
 ** modify role, delete role etc.
 ** <br>
 ...
 ** @since   0.0.0.2
 */
public class RoleProvisioning extends Provisioning {
   ...
   **
   ** @param  roleDN             Contains the elements in the tree, deepest one
   ...
   */
  public String denormalizePath(String roleDN) {
    return super.denormalizePath(roleDN);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   find
  /**
   ** Lookups an <code>Role</code> in the target system.
   **
   ** @param  parentDN           the distinguihsed name of the parent branch to
   **                            lookup the role within and specified in the
   **                            process form.
  ...
  public String find(final String parentDN) {
    return super.lookup(parentDN, DirectoryConstant.ROLE_OBJECT_PREFIX);
  }
   ...
   **
   ** @param  parentDN           the distinguihsed name of the parent branch to
   **                            lookup the group within and specified in the
   **                            process form.
   **                            It can be either empty or the OU name selected.
   ** @param  roleRDN            the relative distinguihsed name of the role to
   **                            lookup the role.
   **
   ** @return                    the distinguished name of the role or an
   **                            empty String if the role does not exists.
   */
  public String find(final String parentDN, final String roleRDN) {
    return super.lookup(parentDN, DirectoryConstant.ROLE_OBJECT_PREFIX, roleRDN);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   create
  /**
   ** Create an <code>Role</code> in the target system.
   **
   ** @param  parentDN           the distinguihsed name of the parent branch
   **                            to create the role within and specified
   **                            in the process form.
   **                            It can be either empty or the OU name selected.
   **
  ...
  public String create(final String parentDN) {
    return super.create(ensureParentRDN(parentDN), DirectoryConstant.ROLE_OBJECT_PREFIX, DirectoryConstant.ROLE_OBJECT_CLASS);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   delete
  /**
   ** Delete a <code>Role</code> in the target system.
   **
   ** @param  roleDN             the fullqualified distinguished name of the
   **                            role to delete.
   ** @param  deleteLeafNode     whether or not the role and its leaf nodes
   **                            shall be deleted on the target system.
   **
   ** @return                    an appropriate response message
   */
  public String delete(String roleDN, boolean deleteLeafNode) {
    try {
      final Reference reference  = createRoleReference(DirectoryConstant.ROLE_OBJECT_CLASS, DirectoryConstant.ROLE_OBJECT_PREFIX, DirectoryConstant.ROLE_OBJECTMEMBER_ATTRIBUTE, DirectoryConstant.ACCOUNT_ROLEMEMBER_ATTRIBUTE);
      final String    superiorDN = normalizePath(DirectoryConnector.superiorDN(roleDN));
      return super.delete(ensureParentRDN(superiorDN), roleDN, reference, deleteLeafNode);
    }
  ...
  // Method:   rename
  /**
   ** Rename an <code>Role</code> from one point in the directory tree to
   ** another.
   **
   ** @param  parentDN           the fullqualified distinguished name of the
   **                            superordinated entry of the role to rename.
   ** @param  roleName           the name the existing role to rename.
   ...
   */
  public String rename(final String parentDN, final String roleName, final String attributeFilter) {
    return super.rename(parentDN, DirectoryConstant.ROLE_OBJECT_PREFIX, roleName, attributeFilter);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   move
  /**
   ** Moves an <code>Role</code> from one point in the directory tree to
   ** another.
   **
   ** @param  roletDN            the fullqualified distinguished name of the
   **                            role to move.
   ** @param  targetDN           holds the name of the organizational path where
   **                            where the <code>role</code> has to be moved to.
   **
   ** @return                    a appropriate response message
   */
  public String move(final String roletDN, final String targetDN) {
    return super.move(roletDN, targetDN);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   enable
  /**
   ** Enables a <code>Role</code> in the Target System for the specified
   ...
   ** @return                    an appropriate response message
   */
  public String enable(final String roleDN, final String entryControlName, final String entryControlValue) {
    return super.maskAttribute(roleDN, entryControlName, entryControlValue);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   disable
  /**
   ** Disables a <code>Role</code> in the Target System for the specified
   ** distinguished name <code>roleDN</code>.
   **
   ** @param  roleDN             the fullqualified distinguished name of the
   **                            role to disable.
   ...
   ** @return                    an appropriate response message
   */
  public String disable(String roleDN, String entryControlName, final String entryControlValue) {
    return super.maskAttribute(roleDN, entryControlName, entryControlValue);
  }
  ...
  /**
   ** Adds an entry to a multi-value attribute at a role.
   **
   ** @param  roleDN             the fullqualified distinguished name of the
   **                            role where the attribute should be added to.
   ...
   ** @return                    an appropriate response message
   */
  public final String addMultiValueAttribute(final String roleDN, final String attributeName, final String attributeValue) {
    return super.addMultiValueAttribute(roleDN, attributeName, attributeValue);
  }
  ...
  /**
   ** Deletes an entry from a multi-value attribute at a role.
   **
   ** @param  roleDN             the fullqualified distinguished name of the
   **                            role where the attribute should be removed
   **                            from.
   ** @param  attributeName      the name of the attribute that has to be
   **                            removed.
   ...
   ** @return                    an appropriate response message
   */
  public final String deleteMultiValueAttribute(final String roleDN, final String attributeName, final String attributeValue) {
    return super.deleteMultiValueAttribute(roleDN, attributeName, attributeValue);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   updateAttribute
  /**
   ** Modifies a particular attribute of a <code>Role</code> in the
   ...
   ** @return                    an appropriate response message
   */
  public String updateAttribute(final String roleDN, final String attributeFilter) {
    return super.updateAttribute(roleDN, attributeFilter);
  }
   ...
   *
   ** @param  parentRDN         the name of the role DN which is selected in
  ...
  protected final String ensureParentRDN(final String parentRDN) {
    ...
    return super.ensureParentRDN(parentRDN, this.connector().roleContainer());
  }
}