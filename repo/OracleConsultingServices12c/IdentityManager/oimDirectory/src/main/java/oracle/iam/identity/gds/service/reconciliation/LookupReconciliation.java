/*
    ...
    1.0.0.3      2013-03-19  DSteding    Fixed DE-000080
                                         Reconciliation does not check if a
                                         key/value pair is really changed.
    1.0.0.2      2012-11-09  DSteding    Fixed DE-000041
                                         Log the identifier of the entry
                                         being reconciled
 ...
 ** Oracle Identity Manager to reconcile group information from a Directory
 ** Service.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
...
public class LookupReconciliation extends Reconciliation {
   ...
   ** This attribute is mandatory.
   */
  public static final String LOOKUPGROUP           = "Lookup Group";
  ...
  enum Operation {
    ...
    // compatible with
    @SuppressWarnings("compatibility:-8398135804995964556")
