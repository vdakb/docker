/*
    ...
    File        :   OrganizationalUnitProvisioning.java
    ...
    Purpose     :   This file implements the class
                    OrganizationalUnitProvisioning.
...
////////////////////////////////////////////////////////////////////////////////
// class OrganizationalUnitProvisioning
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>OrganizationalUnitProvisioning</code> acts as the service end point
 ** for the Oracle Identity Manager to provision organizational unit properties
 ** to a Directory Service.
 ** <br>
 ** This is wrapper class has methods for organizational unit operations like
 ** create organizational unit, modify organizational unit,
 ** delete organizational unit etc.
 ** <br>
 ...
 ** @since   0.0.0.2
 */
public class OrganizationalUnitProvisioning extends Provisioning {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>OrganizationalUnitProvisioning</code> task adapter.
   **
   ...
   */
  public OrganizationalUnitProvisioning(final tcDataProvider provider, final Long instance)
  ...
  // Method:   find
  /**
   ** Lookups an <code>OrganizationalUnit</code> in the target system.
   **
   ** @param  parentDN           the distinguihsed name of the parent branch to
   **                            lookup the organizational unit within and
  ...
  public String find(final String parentDN) {
    return super.lookup(parentDN, DirectoryConstant.ORGANIZATIONALUNIT_OBJECT_PREFIX);
  }
   ...
   **                            specified in the process form.
   **                            It can be either empty or the OU name selected.
   ** @param  organzationRDN     the relative distinguihsed name of the
   **                            organizational unit to lookup.
   **
   ** @return                    the distinguished name of the organizational
   **                            unit or an empty String if the organizational
   **                            unit does not exists.
   */
  public String find(final String parentDN, final String organzationRDN) {
    return super.lookup(parentDN, DirectoryConstant.ORGANIZATIONALUNIT_OBJECT_PREFIX, organzationRDN);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   create
  /**
   ** Create an <code>OrganizationalUnit</code> in the target system.
   **
   ** @param  parentDN           the distinguihsed name of the parent branch
   **                            to create the organizational unit within and
   **                            specified
   **                            in the process form.
   **                            It can be either empty or the OU name selected.
   **
  ...
  public String create(final String parentDN) {
    return super.create(ensureParentRDN(parentDN), DirectoryConstant.ORGANIZATIONALUNIT_OBJECT_PREFIX, DirectoryConstant.ORGANIZATIONALUNIT_OBJECT_CLASS);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   delete
  /**
   ** Delete a <code>OrganizationalUnit</code> in the target system.
   **
   ** @param  organzationDN      the fullqualified distinguished name of the
   **                            organizational unit to delete.
   ** @param  deleteLeafNode     whether or not the organizational unit and its
   **                            leaf nodes shall be deleted on the target
   **                            system.
   **
   ** @return                    an appropriate response message
   */
  public String delete(final String organzationDN, final boolean deleteLeafNode) {
    final String superiorDN = normalizePath(DirectoryConnector.superiorDN(organzationDN));
    return super.delete(ensureParentRDN(superiorDN), organzationDN, deleteLeafNode);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   rename
  /**
   ** Rename an <code>OrganizationalUnit</code> from one point in the directory tree to
   ** another.
   **
   ** @param  parentDN           the fullqualified distinguished name of the
   **                            superordinated entry of the organizational unit
   **                            to rename.
   ** @param  organizationName   the name the existing organizational ubit to
   **                            rename.
  ...
  public String rename(final String parentDN, final String organizationName, final String attributeFilter) {
    return super.rename(parentDN, DirectoryConstant.ORGANIZATIONALUNIT_OBJECT_PREFIX, organizationName, attributeFilter);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   move
  /**
   ** Moves an <code>OrganizationalUnit</code> from one point in the directory tree to
   ** another.
   **
   ** @param  organizationDN     the fullqualified distinguished name of the
   **                            organizational unit to move.
   ** @param  targetDN           holds the name of the organizational path where
   **                            where the <code>organizationDN</code> has to be
   **                            moved to.
   **
   ** @return                    a appropriate response message
   */
  ...
  // Method:   enable
  /**
   ** Enables a <code>OrganizationalUnit</code> in the Target System for the specified
   ** distinguished name <code>organizationDN</code>.
   **
   ** @param  organizationDN     the fullqualified distinguished name of the
   **                            organizational unit to enable.
  ...
  // Method:   disable
  /**
   ** Disables a <code>OrganizationalUnit</code> in the Target System for the
   ** specified distinguished name <code>organizationDN</code>.
   **
   ** @param  organizationDN     the fullqualified distinguished name of the
   **                            organizational unit to disable.
   ** @param  entryControlName   the <code>Entry Control Attribute</code> name
   ** @param  entryControlValue  the <code>Entry Control Attribute</code> value
   **
   ** @return                    an appropriate response message
  ...
  /**
   ** Adds an entry to a multi-value attribute at a organizational unit.
   **
   ** @param  organizationDN     the fullqualified distinguished name of the
   **                            organizational unit where the attribute should
   **                            be added to.
  ...
  /**
   ** Deletes an entry from a multi-value attribute at a country.
   **
   ** @param  organizationDN     the fullqualified distinguished name of the
   **                            organizational unit where the attribute should
   **                            be rmoved from.
  ...
  /**
   ** Modifies a particular attribute of a <code>OrganizationalUnit</code> in the
   ...
   ** @return                    an appropriate response message
   */
  public String updateAttribute(final String organizationDN, final String attributeFilter) {
   ...
   *
   ** @param  parentRDN         the name of the organizational unit DN which is
