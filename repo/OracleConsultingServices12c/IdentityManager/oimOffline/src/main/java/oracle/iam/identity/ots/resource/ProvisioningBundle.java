...
import oracle.iam.identity.ots.service.provisioning.ProvisioningMessage;
...
public class ProvisioningBundle extends ListResourceBundle  {
  ...
  private static final String[][] CONTENT = {
     // OTS-01011 - 01020 export process related messages
    { ProvisioningMessage.COLLECTING_BEGIN,    "Starting collecting data ..." }
  , { ProvisioningMessage.COLLECTING_COMPLETE, "Collecting data completed" }
  };
