 ...
 ** @since   3.0.0.0
 */
public class HarvesterBundle extends ListResourceBundle  {
  ...
  , { HarvesterError.CATALOG_NOTFOUND,           "Harvester item of type [%1$s] and name [%2$s] does not exists" }
  , { HarvesterError.CATALOG_AMBIGUOUS,          "Harvester item of type [%1$s] and name [%2$s] defined ambigously" }
  ...
  , { HarvesterError.ENTITLEMENT_NO_PREFIX,      "Entitlement [%1$s] does not have a prefix" }
  ...
  // ARC-00071 - ARC-00080 export process related messages
  , { HarvesterMessage.EXPORTING_XML_BEGIN,       "[%2$s] for [%1$s] using file [%3$s] started ..." }
  , { HarvesterMessage.EXPORTING_XML_COMPLETE,    "[%2$s] for [%1$s] using file [%3$s] completed" }
  , { HarvesterMessage.EXPORTING_XML_STOPPED,     "[%2$s] for [%1$s] using file [%3$s] stopped" }
  , { HarvesterMessage.EXPORTING_XML_SUCCESS,     "%1$s entries was exported for [%2$s]" }
  , { HarvesterMessage.EXPORTING_XML_ERROR,       "Entry [%1$s] was not exported for [%2$s]" }

  , { HarvesterMessage.COLLECTING_BEGIN,          "Starting collecting data ..." }
  , { HarvesterMessage.COLLECTING_COMPLETE,       "Collecting data completed" }
    //"Processing " + appName +" [" + lkName + "]"
  , { HarvesterMessage.PROCESSING_ROWS,           "Processing Applications Instance %1$s [ [%2$s] ]" }
  , { HarvesterMessage.EXPORTING_XML_SUMMARY,     "Exported successfully [%1$s], ignored for [%2$s] and failed using file [%3$s]" }
  ...
  , { HarvesterMessage.OPERATION_EXPORT_BEGIN,   "Exporting %1$s [%2$s] ..."}
  , { HarvesterMessage.OPERATION_EXPORT_SUCCESS, "%1$s [%2$s] exported"}
  , { HarvesterMessage.OPERATION_EXPORT_IGNORED,  "Export of %1$s [%2$s] ignored."}
  ...
  public static final ListResourceBundle RESOURCE = (ListResourceBundle)ResourceBundle.getBundle(
    HarvesterBundle.class.getName()
  , Locale.getDefault()
  , HarvesterBundle.class.getClassLoader()
  );
