...
public enum Severity {
  ...
  , @XmlEnumValue("debug")       DEBUG("debug")
  ...
  public static final String LOCAL            = "severity";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:-3153010923778021729")
  ...
  // Method:   Ctor
  /**
   ** Constructs a empty <code>Severity</code> that allows use as a JavaBean.
   **
  ...
  public static Severity fromValue(final String value) {
    for (Severity cursor : Severity.values()) {
