 ...
 ** @since   3.0.0.0
 */
public class ControllerBundle extends ListResourceBundle  {
  ...
  , { ControllerMessage.COMMENT_END,      "<!-- Provisioning of %1$s completed at %2$s -->" }
     ...
     // OTS-01041 - 01050 lookup reconciliation related messages
  ...
  public static final ListResourceBundle RESOURCE = (ListResourceBundle)ResourceBundle.getBundle(
    ControllerBundle.class.getName()
  , Locale.getDefault()
  , ControllerBundle.class.getClassLoader()
  );
