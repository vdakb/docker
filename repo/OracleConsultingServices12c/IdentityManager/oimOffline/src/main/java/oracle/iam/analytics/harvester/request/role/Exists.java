...
public class Exists {
  ...
  // Method:   Ctor
  /**
   ** Constructs a empty <code>Exists</code> that allows use as a JavaBean.
   ** <p>
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>Exists</code> with the specified id.
   **
   ** @param  id                 the id of this <code>Role</code>.
   */
  public Exists(final String id) {
    // ensure inheritance
    super();
