 ...
 ** @since   3.0.0.0
 */
public final class RequestException extends TaskException {
  ...
  // compatible with
  @SuppressWarnings("compatibility:2900297213287380334")
  private static final long serialVersionUID = -2724135225893675810L;
  ...
  // Method:   Ctor
  /**
   ** Create a new <code>RequestException</code> from a message code.
   ** <p>
  ...
  // Method:   Ctor
  /**
   ** Create a new <code>RequestException</code> from a resource bundle
   ** code.
   ** <p>
   ** The cause is not initialized, and may subsequently be initialized by a
   ** call to {@link #initCause}.
  ...
  // Method:   Ctor
  /**
   ** Create a new <code>RequestException</code> from a code and a array
