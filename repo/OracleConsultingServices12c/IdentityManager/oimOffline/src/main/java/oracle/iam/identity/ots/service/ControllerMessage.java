...
public interface ControllerMessage {
  ...
  static final String COMMENT_START   = PREFIX + "01031";
  static final String COMMENT_END     = PREFIX + "01032";

  // 01041 - 01050 lookup reconciliation related messages
  static final String CREATE_VALUE    = PREFIX + "01041";
  static final String DUPLICATE_VALUE = PREFIX + "01042";
}