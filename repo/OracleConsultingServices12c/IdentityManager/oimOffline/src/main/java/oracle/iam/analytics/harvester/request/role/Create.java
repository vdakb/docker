 ...
 **       &lt;sequence&gt;
 **         &lt;element name="context" type="{http://service.api.oia.iam.ots/role}context"/&gt;
 **         &lt;element name="policy"  type="{http://service.api.oia.iam.ots/role}policy"/&gt;
 **       &lt;/sequence&gt;
 **     &lt;/restriction&gt;
 **   &lt;/complexContent&gt;
 ** &lt;/complexType&gt;
 ...
 ** @since   3.0.0.0
 */
@XmlRootElement(name=Create.LOCAL)
...
public class Create {
  ...
  public final static String LOCAL = "create";

  //////////////////////////////////////////////////////////////////////////////
  // instance attributes
  //////////////////////////////////////////////////////////////////////////////

  @XmlElement(required=true, nillable=true, namespace=oracle.iam.analytics.harvester.domain.role.ObjectFactory.NAMESPACE, name=Context.LOCAL)
  protected Context context;
  @XmlElement(required=true, nillable=true, namespace=oracle.iam.analytics.harvester.domain.role.ObjectFactory.NAMESPACE, name=Policy.LOCAL)
  ...
  // Method:   Ctor
  /**
   ** Constructs a empty <code>Create</code> that allows use as a JavaBean.
   ** <p>
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Create</code> request that wraps the specified
   ...
   */
  public Create(final Context context, final Policy policy) {
    // ensure inheritance
    super();
