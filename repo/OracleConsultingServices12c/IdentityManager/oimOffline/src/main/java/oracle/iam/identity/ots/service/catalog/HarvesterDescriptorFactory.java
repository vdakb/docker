/*
    ...
    File        :   HarvesterDescriptorFactory.java
...
////////////////////////////////////////////////////////////////////////////////
// final class HarvesterDescriptorFactory
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
...
public final class HarvesterDescriptorFactory extends TaskDescriptorFactory {
  ...
  /**
   ** the XML element that defines the transactional context.
   */
  public static final String ELEMENT_CONTEXT     = "context";

  /**
   ** the XML attribute specifies the name of an <code>IT Resource Type</code>.
   */
  public static final String ATTRIBUTE_TYPE      = "type";

  /**
   ** the XML attribute specifies the pattern of the encoded value of an
   ** entitlement.
   */
  public static final String ATTRIBUTE_ENCODED   = "encoded";

  /**
   ** the XML attribute specifies the pattern of the decoded value of an
   ** entitlement.
   */
  public static final String ATTRIBUTE_DECODED   = "decoded";

  /**
   ** the XML attribute specifies if warnings can be ignored.
   */
  public static final String ATTRIBUTE_IGNORE   = "ignoreWarning";

  //////////////////////////////////////////////////////////////////////////////
  // instance attributes
  //////////////////////////////////////////////////////////////////////////////

  private final HarvesterDescriptor descriptor;
  ...
  enum Grammar {
    ...
    // compatible with
    @SuppressWarnings("compatibility:1678764414486870919")
  ...
  private class Parser extends SAXInput {
    ...
    public void startElement(final String uri, final String localName, final String qualifiedName, final Attributes attributes)
      ...
      this.cursor = state;
      switch (this.cursor) {
        case DESCRIPTOR  : processHarvesterDescriptor(HarvesterDescriptorFactory.this.descriptor, attributes);
                           break;
        case ATTRIBUTE   : processHarvesterAttribute(HarvesterDescriptorFactory.this.descriptor, attributes);
                           break;
        case TRANSFORMER : processHarvesterTransformation(HarvesterDescriptorFactory.this.descriptor, attributes);
                           break;
        case MULTIVALUED : // there must be a task descriptor on the value stack
                           final AttributeMapping mapping = ((Descriptor)peek()).multivalued();
                           mapping.put(attributes.getValue(ATTRIBUTE_NAME), attributes.getValue(ATTRIBUTE_NAME));
                           break;
        case ENTITLEMENT : HarvesterDescriptorFactory.this.descriptor.type(attributes.getValue(ATTRIBUTE_TYPE), attributes.getValue(ATTRIBUTE_SOURCE), attributes.getValue(ATTRIBUTE_ENCODED), attributes.getValue(ATTRIBUTE_DECODED));
                           break;
        case CONTEXT     : HarvesterDescriptorFactory.this.descriptor.uniqueName(attributes.getValue(HarvesterDescriptor.UNIQUE_NAME));
                           HarvesterDescriptorFactory.this.descriptor.relationShip(attributes.getValue(HarvesterDescriptor.RELATIONSHIP));
                           HarvesterDescriptorFactory.this.descriptor.exactMatch(attributes.getValue(HarvesterDescriptor.EXACT_MATCH));
                           HarvesterDescriptorFactory.this.descriptor.ignoreWarning(attributes.getValue(HarvesterDescriptor.IGNORE_WARNINGS));
                           break;
      }
    }
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>HarvesterDescriptorFactory</code> that configures the
   ** specified {@link HarvesterDescriptor}.
   **
   ** @param  descriptor         the {@link HarvesterDescriptor} to be
   **                            configured by this
   ...
   */
  private HarvesterDescriptorFactory(final HarvesterDescriptor descriptor)
  ...
  // Method:   configure
  /**
   ** Factory method to configure a {@link HarvesterDescriptor} from a
   ** {@link File}.
   **
   ** @param  descriptor         the {@link HarvesterDescriptor} to be configured
   **                            by this {@link TaskDescriptorFactory}.
   ...
   **                            initialization fails.
   */
  public static void configure(final HarvesterDescriptor descriptor, final File file)
    throws TaskException {
   ...
   **                            initialization fails.
   */
  public static void configure(final HarvesterDescriptor descriptor, final File file, final boolean validate)
    throws TaskException {
  ...
  // Method:   configure
  /**
   ** Factory method to configure a {@link HarvesterDescriptor} from an
   ** {@link InputStream}.
   **
   ** @param  descriptor         the {@link HarvesterDescriptor} to be configured
   **                            by this {@link TaskDescriptorFactory}.
   ...
   **                            initialization fails.
   */
  public static void configure(final HarvesterDescriptor descriptor, final InputStream stream)
    throws TaskException {
   ...
   **                            initialization fails.
   */
  public static void configure(final HarvesterDescriptor descriptor, final InputStream stream, final boolean validate)
    throws TaskException {
   ...
   **                            initialization fails.
   */
  public static void configure(final HarvesterDescriptor descriptor, final InputSource source)
    throws TaskException {
   ...
   **                            initialization fails.
   */
  public static void configure(final HarvesterDescriptor descriptor, final InputSource source, final boolean validate)
    throws TaskException {
    ...
    final HarvesterDescriptorFactory factory = new HarvesterDescriptorFactory(descriptor);
    if (validate) {
      try {
        factory.validate(HarvesterDescriptor.class, source);
      }
  ...
  // Method:   configure
  /**
   ** Factory method to configure a {@link HarvesterDescriptor} from a {@link PDocument}.
   **
   ** @param  descriptor         the {@link HarvesterDescriptor} to be configured
   **                            by this {@link TaskDescriptorFactory}.
   ...
   **                            initialization fails.
   */
  public static void configure(final HarvesterDescriptor descriptor, final PDocument document)
    throws TaskException {
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   processHarvesterDescriptor
  /**
   ** Initialize the instance attributes of the specified
   ** {@link HarvesterDescriptor} instance from the provided {@link Attributes}.
   **
   ** @param  descriptor         the {@link HarvesterDescriptor} to be
   **                            configured by this
   **                            {@link TaskDescriptorFactory}.
   ...
   **                            exception.
   */
  protected final void processHarvesterDescriptor(final HarvesterDescriptor descriptor, final Attributes attributes)
    throws SAXException {

    super.processDescriptor(descriptor, attributes);

    // get the name of the risk attribute identifier
    descriptor.multiValueSeparator(attributes.getValue(HarvesterDescriptor.MULTIVALUE_SEPARATOR));
    descriptor.riskLevel(attributes.getValue(HarvesterDescriptor.RISK_LEVEL));
    descriptor.deleteStatus(attributes.getValue(HarvesterDescriptor.DELETE_STATUS));
    descriptor.requestStatus(attributes.getValue(HarvesterDescriptor.REQUEST_STATUS));
    descriptor.nullValue(attributes.getValue(HarvesterDescriptor.NULL_VALUE));
    descriptor.dateFormat(attributes.getValue(HarvesterDescriptor.DATE_FORMAT));
    descriptor.timestampFormat(attributes.getValue(HarvesterDescriptor.TIMESTAMP_FORMAT));
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   processHarvesterAttribute
  /**
   ** Initialize the attribute mapping of the specified
   ** {@link HarvesterDescriptor} instance from the provided {@link Attributes}.
   **
   ** @param  descriptor         the {@link HarvesterDescriptor} to be
   **                            configured by this
   ...
   **                            exception.
   */
  protected final void processHarvesterAttribute(final HarvesterDescriptor descriptor, final Attributes attributes)
    throws SAXException {

    if (descriptor.inbound()) {
      final String source = attributes.getValue(ATTRIBUTE_SOURCE);
      descriptor.attributeMapping().put(source, attributes.getValue(ATTRIBUTE_NAME).toUpperCase());
    }
    else {
      final String source = attributes.getValue(ATTRIBUTE_SOURCE).toUpperCase();
      descriptor.attributeMapping().put(source, attributes.getValue(ATTRIBUTE_NAME));
    }
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   processHarvesterTransformation
  /**
   ** Initialize the attribute mapping of the specified
   ** {@link HarvesterDescriptor} transformation from the provided
   ** {@link Attributes}.
   **
   ** @param  descriptor         the {@link HarvesterDescriptor} to be
   **                            configured by this
   ...
   **                            exception.
   */
  protected final void processHarvesterTransformation(final HarvesterDescriptor descriptor, final Attributes attributes)
    throws SAXException {

    if (descriptor.inbound()) {
      final String name = attributes.getValue(ATTRIBUTE_NAME).toUpperCase();
      descriptor.transformationMapping().put(name, attributes.getValue(ATTRIBUTE_CLASS));
    }
    else {
