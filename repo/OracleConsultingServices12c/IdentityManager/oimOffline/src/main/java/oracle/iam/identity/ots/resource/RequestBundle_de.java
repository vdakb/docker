 ...
 ** @since   3.0.0.0
 */
public class RequestBundle_de extends ListResourceBundle  {
  ...
  , { RequestError.COMPOSITE_CONFIG_INCOMPLETE, "Die Konfiguration des Composite ist unvollständig" }
  , { RequestError.COMPOSITE_NOT_FOUND,         "Der Composite [%1$s] existiert nicht im Oracle SOA server" }
