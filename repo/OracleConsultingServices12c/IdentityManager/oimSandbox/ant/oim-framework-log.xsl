...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/changes">
    <html>
      <head>
        <title>Oracle<xsl:text disable-output-escaping="yes">&amp;</xsl:text>reg; Identity Manager Framework Change Log</title>
      ...
      <body>
        <div>
          ...
          <tr>
            <td align="left" valign="top"><b>Oracle<xsl:text disable-output-escaping="yes">&amp;</xsl:text>reg; Identity Manager Framework Change Log</b><br/></td>
          </tr>
          </table>
          <hr/>
          <a name="BEGIN" id="BEGIN"></a>
          <div>
            <h1>Oracle<xsl:text disable-output-escaping="yes">&amp;</xsl:text>reg; Identity Manager Framework</h1>
            <p>This document describes changes on top of Release 1.0.0.0 of Oracle Identity Manager Framework. It contains the following sections:</p>
