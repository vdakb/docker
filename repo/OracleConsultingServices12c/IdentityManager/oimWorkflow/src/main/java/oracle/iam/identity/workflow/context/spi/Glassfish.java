...
public class Glassfish extends ServiceProvider {
  ...
  public static final String CONTEXT_FACTORY  = "com.sun.appserv.naming.S1ASCtxFactory";
   ...
   */
  public static final String DEFAULT_PREFIX   = "com.sun.enterprise.naming";

  public static final String DEFAULT_PORT     = "3700";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Glassfish</code> {@link ServiceProvider} that allows
   ** use as a JavaBean.
   ** <br>
