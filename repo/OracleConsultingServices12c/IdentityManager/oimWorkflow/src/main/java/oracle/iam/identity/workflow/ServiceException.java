...
import oracle.iam.identity.workflow.resource.ServiceResourceBundle;
...
public class ServiceException extends TaskException {
  ...
  public ServiceException(final String code, final Throwable causing) {
    // ensure inheritance
    super(ServiceResourceBundle.RESOURCE, code, causing);
  }
  ...
  public ServiceException(final String code, final String[] parameter, final Throwable causing) {
    // ensure inheritance
    super(ServiceResourceBundle.RESOURCE, code, parameter, causing);
  }
}