...
public class JBoss extends ServiceProvider {
  ...
  public static final String CONTEXT_FACTORY  = "org.jnp.interfaces.NamingContextFactory";

  public static final String DEFAULT_PROTOCOL = "jnp";

  /**
   ** Constant that holds the value of the environment property to specify the
   ** package prefixes to use when loading in URL context factories.
   */
  public static final String DEFAULT_PREFIX   = "org.jboss.naming:org.jnp.interface";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>JBoss</code> {@link ServiceProvider} that allows use as
   ** a JavaBean.
   ** <br>
