...
public class WebLogic extends ServiceProvider {
  ...
  public static final String DEFAULT_PORT     = "8005";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>WebLogic</code> {@link ServiceProvider} that allows use
   ** as a JavaBean.
   ** <br>
