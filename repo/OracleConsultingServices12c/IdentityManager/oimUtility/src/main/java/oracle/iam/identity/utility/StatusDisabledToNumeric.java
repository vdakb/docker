/*
    ...
    File        :   StatusDisabledToNumeric.java
...
////////////////////////////////////////////////////////////////////////////////
// class StatusDisabledToNumeric
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>StatusDisabledToNumeric</code> transform a Oracle Identity Manager
 ** Status <code>Disabled</code> to the numerical value <code>1</code>.
 ** <p>
 ...
 ** @since   3.0.0.0
 */
public class StatusDisabledToNumeric extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>StatusDisabledToNumeric</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public StatusDisabledToNumeric(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    subject.put(attributeName, STATUS_DISABLED.equalsIgnoreCase(value.toString()) ? 1 : 0);
  }
}