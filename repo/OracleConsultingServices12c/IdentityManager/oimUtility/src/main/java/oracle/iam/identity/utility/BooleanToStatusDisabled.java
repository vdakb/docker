/*
    ...
    File        :   BooleanToStatusDisabled.java
...
////////////////////////////////////////////////////////////////////////////////
// class BooleanToStatusDisabled
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>BooleanToStatusDisabled</code> transform a boolean value coming
 ...
 ** @since   3.0.0.0
 */
public class BooleanToStatusDisabled extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>BooleanToStatusDisabled</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public BooleanToStatusDisabled(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    if (value == null)
      ...
      value = ((Boolean)value).booleanValue() ? STATUS_DISABLED : STATUS_ENABLED;
      ...
      if (expression.length() == 0)
        ...
        value = Boolean.parseBoolean(expression) ? STATUS_DISABLED : STATUS_ENABLED;
    }
    else
      value = STATUS_DISABLED;
