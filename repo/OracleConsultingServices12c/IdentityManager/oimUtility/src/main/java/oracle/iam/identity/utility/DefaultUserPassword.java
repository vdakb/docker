/*
    ...
    Purpose     :   This file implements the class
                    DefaultUserPasswordTransformer.
...
// ~~~~~ ~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>DefaultUserPassword</code> applies a default password to a
 ** Xellerate User or Target Account during reconciliation if the Object to
 ...
 ** @since   1.0.0.0
 */
public class DefaultUserPassword extends AbstractAttributeTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>DefaultUserPassword</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public DefaultUserPassword(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    subject.put(attributeName, (StringUtility.isEmpty((String)value)) ? DEFAULT_PASSWORD : value);
  }
}