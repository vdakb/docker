/*
    ...
    File        :   StatusActiveToBoolean.java
...
////////////////////////////////////////////////////////////////////////////////
// class StatusActiveToBoolean
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>StatusActiveToBoolean</code> transform a Oracle Identity Manager
 ** Status <code>Active</code> to the boolean value <code>true</code>.
 ** <p>
 ...
 ** @since   3.0.0.0
 */
public class StatusActiveToBoolean extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>StatusActiveToBoolean</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public StatusActiveToBoolean(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    subject.put(attributeName, STATUS_ACTIVE.equalsIgnoreCase(value.toString()) ? Boolean.TRUE : Boolean.FALSE);
  }
}