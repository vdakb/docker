 ...
 */
public class CSVReference extends TaskDescriptor {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>CSVReference</code> which is associated
   ...
   **                            belongs to.
   */
  public CSVReference(final Loggable loggable) {
    // ensure inheritance
    super(loggable);
  }
   ...
   */
  public CSVReference(final Loggable loggable, final AttributeMapping mapping, final AttributeMapping constant, final AttributeTransformation transformation) {
    // ensure inheritance
