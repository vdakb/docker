...
////////////////////////////////////////////////////////////////////////////////
// class StatusYesToBoolean
// ~~~~~ ~~~~~~~~~~~~~~~~~~
/**
 ** The <code>StatusYesToBoolean</code> transform a Oracle Identity Manager
 ** Status <code>Y</code> or <code>YES</code> to the boolean value
 ** <code>true</code>.
 ** <br>
 ...
 ** @since   3.0.0.0
 */
public class StatusYesToBoolean extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>StatusYesToBoolean</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public StatusYesToBoolean(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    subject.put(attributeName, (STATUS_Y.equalsIgnoreCase(value.toString()) || STATUS_YES.equalsIgnoreCase(value.toString())) ? Boolean.TRUE : Boolean.FALSE);
  }
}