...
////////////////////////////////////////////////////////////////////////////////
// abstract class UTCDateEncoder
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The <code>UTCDateDecoder</code> transform an internal Oracle Identity
 ** Manager Date Format '<code>yyyy/MM/dd hh:mm:ss z</code>' representation to a
 ** Coordinated Universal Time (UTC) '<code>'yyyymmddhhmissZ'</code>' Date
 ...
 ** @since   1.0.0.0
 */
public abstract class UTCDateEncoder extends AbstractDateTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>UTCDateEncoder</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  protected UTCDateEncoder(final Logger logger) {
    // ensure inheritance
    super(logger, DateUtility.ISO8601_ZULU_NANO);
  }
   ...
   */
  protected UTCDateEncoder(final Logger logger, final Date defaultDate) {
    // ensure inheritance
   ...
   */
  protected UTCDateEncoder(final Logger logger, final int year, int month, int date, int hourOfDay, int minute, int second) {
    // ensure inheritance
  ...
  /**
   ** Returns the specified <code>origin</code> as an appropriate transformation.
   ** <p>
   ...
   ** UTC Timestamp as "20010730174200Z".
   ** <p>
