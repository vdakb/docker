...
////////////////////////////////////////////////////////////////////////////////
// abstract class ISODateDecoder
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The <code>ISODateDecoder</code> transform a Date String formatted as an ISO
 ** Date and Time '<code>'yyyy-mm-dd hh:mm:ss zz'</code>' to the internal Oracle
 ...
 ** @since   1.0.0.0
 */
abstract class ISODateDecoder extends AbstractDateTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>ISODateDecoder</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  protected ISODateDecoder(final Logger logger) {
    // ensure inheritance
    super(logger, DateUtility.ISO8601_ZULU);
  }
   ...
   */
  protected ISODateDecoder(final Logger logger, final Date defaultDate) {
    // ensure inheritance
    super(logger, DateUtility.ISO8601_ZULU, defaultDate);
  }
   ...
   */
  protected ISODateDecoder(final Logger logger, final int year, int month, int date, int hourOfDay, int minute, int second) {
    // ensure inheritance
    super(logger, DateUtility.ISO8601_ZULU, year, month, date, hourOfDay, minute, second);
  }
