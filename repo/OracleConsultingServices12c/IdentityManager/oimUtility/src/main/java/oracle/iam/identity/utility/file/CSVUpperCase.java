...
// ~~~~~ ~~~~~~~~~~~~
/**
 ** The <code>CSVUpperCase</code> transforms all characters of a String to
 ** upper case letters.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 */
public class CSVUpperCase implements Transformer<String> {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>CSVUpperCase</code> attribute transformer that
