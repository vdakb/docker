...
////////////////////////////////////////////////////////////////////////////////
// class ISOEndDateDecoder
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** The <code>ISOEndDateDecoder</code> transform a Date String formatted as an
 ...
 ** @since   1.0.0.0
 */
public final class ISOEndDateDecoder extends ISODateDecoder {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>ISOEndDateDecoder</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public ISOEndDateDecoder(final Logger logger) {
    // ensure inheritance
