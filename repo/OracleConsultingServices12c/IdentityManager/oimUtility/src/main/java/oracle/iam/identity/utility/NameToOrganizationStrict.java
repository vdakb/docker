/*
    ...
    File        :   NameToOrganizationStrict.java
...
////////////////////////////////////////////////////////////////////////////////
// class NameToOrganizationStrict
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>NameToOrganizationStrict</code> transforms a given name to the
 ...
 ** @since   3.0.0.0
 */
public class NameToOrganizationStrict extends AbstractStatusTransformer {
  ...
  /**
   ** The SQL statement string to lookup an <code>Organization</code> key using
   ** the name of an <code>Organization</code>.
   */
  private static final String LOOKUP_ORGANIZATION = "select act_key from act where act_name = ?";
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>NameToOrganizationStrict</code> which use the
   ** specified {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose.
   */
  public NameToOrganizationStrict(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  /**
   ** Lookups the internal system identifier of a <code>Organization</code> from
   ** Oracle Identity Manager.
   **
   ** @param  identifier         the name of a <code>Organization</code> to
   **                            lookup.
   **
   ** @return                    the internal system identifier of a
   **                            <code>Organization</code> which name match the
   **                            specified parameter <code>identifier</code> or
   **                            <code>null</code> if no
   **                            <code>Organization</code> match the specified
   **                            name.
   */
