...
// ~~~~~ ~~~~~~~~~~~~~
/**
 ** The <code>CSVCapitalize</code> transform a String to a capitalized version.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 */
public class CSVCapitalize implements Transformer<String> {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>CSVCapitalize</code> attribute transformer that
  ...
  public Object transform(final Object origin) {
    return StringUtility.capitalize(origin.toString());
  }
}