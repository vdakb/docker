/*
    ...
    File        :   BooleanToNumericDefaultFalse.java
...
////////////////////////////////////////////////////////////////////////////////
// class BooleanToNumericDefaultFalse
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>BooleanToNumericDefaultFalse</code> transform a boolean value
 ** coming from a source to the Oracle Identity Manager Status <code>1</code> if
 ** the value is <code>true</code> otherwise the value is transformed to
 ** <code>0</code>.
 ** <br>
 ...
 ** @since   3.0.0.0
 */
public class BooleanToNumericDefaultFalse extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>BooleanToNumericDefaultFalse</code> which use the
   ** specified {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public BooleanToNumericDefaultFalse(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    if (origin.containsKey(attributeName)) {
      ...
      if (value == null)
        ...
        value = ((Boolean)value).booleanValue() ? NUMERIC_TRUE : NUMERIC_FALSE;
        ...
        if (expression.length() == 0)
          ...
          value = Boolean.parseBoolean(expression) ? NUMERIC_TRUE : NUMERIC_FALSE;
      }
      else
        value = NUMERIC_FALSE;
