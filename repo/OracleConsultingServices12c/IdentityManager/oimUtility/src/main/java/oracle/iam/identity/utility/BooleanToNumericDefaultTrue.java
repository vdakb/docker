/*
    ...
    File        :   BooleanToNumericDefaultTrue.java
...
////////////////////////////////////////////////////////////////////////////////
// class BooleanToNumericDefaultTrue
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>BooleanToNumericDefaultTrue</code> transform a boolean value
 ...
 ** @since   3.0.0.0
 */
public class BooleanToNumericDefaultTrue extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>BooleanToNumericDefaultTrue</code> which use the
   ** specified {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public BooleanToNumericDefaultTrue(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
