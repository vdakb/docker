 ...
 ** @version 1.0.0.0
 */
public class CSVBundle_de extends ListResourceBundle {
  ...
  , { CSVError.NOTAFOLDER,                           "Verwendung von %2$s als %1$s ist unzlässige, es ist kein Verzeichnis" }
  , { CSVError.NOTAFILE,                             "Verwendung von %2$s als %1$s ist unzlässige, es ist keine Datei" }
  , { CSVError.NOTREADABLE,                          "%2$s kann nicht als %1$s verwendet werden, es kann nicht gelesen werden" }
  , { CSVError.NOTWRITABLE,                          "%2$s kann nicht als %1$s verwendet werden, es kann nicht geschrieben werden" }
  , { CSVError.NOTCREATABLE,                         "%1$s kann nicht erzeugt werden. Grund: %2$s" }
