/*
    ...
    File        :   StatusActiveToNumeric.java
...
////////////////////////////////////////////////////////////////////////////////
// class StatusActiveToNumeric
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>StatusActiveToNumeric</code> transform a Oracle Identity Manager
 ** Status <code>Active</code> to the numerical value <code>1</code>.
 ** <p>
 ...
 ** @since   3.0.0.0
 */
public class StatusActiveToNumeric extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>StatusActiveToNumeric</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public StatusActiveToNumeric(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    subject.put(attributeName, STATUS_ACTIVE.equalsIgnoreCase(value.toString()) ? 1 : 0);
  }
}