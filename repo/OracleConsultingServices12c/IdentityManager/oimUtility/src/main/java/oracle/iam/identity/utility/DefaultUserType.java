...
// ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** The <code>DefaultUserType</code> transform an Object to the Oracle Identity
 ** Manager default User Xellerate Type <code>End-User</code> if the Object to
 ** transform is not a valid String.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class DefaultUserType extends AbstractAttributeTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>DefaultUserType</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public DefaultUserType(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
