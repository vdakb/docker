...
////////////////////////////////////////////////////////////////////////////////
// class ToLongTransformer
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** The <code>ToLongTransformer</code> transform a string value to a
 ** {@link Long} value is <code>1</code>. If the string value isn't convertable
 ** to <code>Long</code> the value is transformed to <code>null</code>.
 ** <br>
 ...
 ** @since   3.0.0.0
 */
public class ToLongTransformer extends AbstractAttributeTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>ToLongTransformer</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public ToLongTransformer(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    if (origin.containsKey(attributeName)) {
      ...
      if (value == null)
        ...
        try {
          subject.put(attributeName, Long.valueOf(value.toString()));
        }
