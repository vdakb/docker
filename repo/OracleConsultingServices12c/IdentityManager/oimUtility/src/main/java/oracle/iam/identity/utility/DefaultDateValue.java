...
////////////////////////////////////////////////////////////////////////////////
// abstract class DefaultDateValue
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** The <code>DefaultDateValue</code> applies a default date to a profile
 ...
 ** @since   1.0.0.0
 */
public abstract class DefaultDateValue extends AbstractAttributeTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>DefaultDateValue</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   ** @param  defaultValue       the {@link Date} value to be assigned to each
   **                            attribute in the reconcliation dataset where a
   **                            subclass of this transformer is assined to.
   */
  protected DefaultDateValue(final Logger logger, final Date defaultValue) {
    // ensure inheritance
    super(logger);
