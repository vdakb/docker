...
////////////////////////////////////////////////////////////////////////////////
// class NameToRoleWeak
// ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The <code>NameToRoleWeak</code> transforms a given name to the system
 ...
 ** @since   3.0.0.0
 */
public class NameToRoleWeak extends NameToRoleStrict {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>NameToRoleWeak</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose.
   */
  public NameToRoleWeak(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
   ...
   ** {@link Map} <code>subject</code> us the {@link NameToRoleStrict}
