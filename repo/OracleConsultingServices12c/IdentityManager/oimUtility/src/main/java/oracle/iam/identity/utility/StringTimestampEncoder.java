/*
    ...
    File        :   StringTimestampEncoder.java
...
////////////////////////////////////////////////////////////////////////////////
// abstract class StringTimestampEncoder
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~
/**
 ...
 ** @since   3.0.0.0
 */
public abstract class StringTimestampEncoder extends AbstractDateTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>StringTimestampEncoder</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  protected StringTimestampEncoder(final Logger logger) {
    // ensure inheritance
   ...
   */
  protected StringTimestampEncoder(final Logger logger, final String targetFormat) {
    // ensure inheritance
   ...
   */
  protected StringTimestampEncoder(final Logger logger, final Date defaultTimestamp) {
    // ensure inheritance
   ...
   **                            transformation method.
   */
  protected StringTimestampEncoder(final Logger logger, final String targetFormat, final Date defaultTimestamp) {
    // ensure inheritance
   ...
   */
  protected StringTimestampEncoder(final Logger logger, final int year, int month, int day, int hourOfDay, int minute, int second) {
    // ensure inheritance
    super(logger, DateUtility.RFC4517, year, month, day, hourOfDay, minute, second);
  }
   ...
   ** @param  second             the value used to set the SECOND calendar field.
   */
  protected StringTimestampEncoder(final Logger logger, final String targetFormat, final int year, int month, int day, int hourOfDay, int minute, int second) {
    // ensure inheritance
