...
////////////////////////////////////////////////////////////////////////////////
// class EndDateDecoder
// ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The <code>EndDateDecoder</code> transform a Date String formatted as an
 ...
 ** @since   1.0.0.0
 */
public class EndDateDecoder extends StringDateDecoder {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>EndDateDecoder</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public EndDateDecoder(final Logger logger) {
    // ensure inheritance
