...
////////////////////////////////////////////////////////////////////////////////
// class DefaultUserStatus
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** The <code>DefaultUserStatus</code> transform an Object to the Oracle
 ** Identity Manager default User Status <code>Active</code> if the Object to
 ...
 ** @since   1.0.0.0
 */
public class DefaultUserStatus extends AbstractAttributeTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>DefaultUserStatus</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public DefaultUserStatus(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    subject.put(attributeName, (StringUtility.isEmpty((String)value)) ? User.STATUS_ACTIVE : value);
  }
}