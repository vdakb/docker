/*
    ...
    File        :   DefaultOrganizationType.java
...
////////////////////////////////////////////////////////////////////////////////
// class DefaultOrganizationType
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>DefaultOrganizationType</code> transform an Object to the
 ** Oracle Identity Manager default Organization Type <code>Company</code> if
 ** the Object to transform is not a valid String.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class DefaultOrganizationType extends AbstractAttributeTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>DefaultOrganizationType</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public DefaultOrganizationType(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    // if we not got a String return the Oracle Identity Manager default type
    // 'End-User' for identities
    if (value == null || !(value instanceof String))
      value = Organization.DEFAULT_TYPE;

    // if we not got an empty String return the Oracle Identity Manager default
    // type; otherwise return the converted value as is
    subject.put(attributeName, (StringUtility.isEmpty((String)value)) ? Organization.DEFAULT_TYPE : value);
  }
}