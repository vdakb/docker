/*
    ...
    File        :   GroupFormQueryBuilder.java
...
////////////////////////////////////////////////////////////////////////////////
// class GroupFormQueryBuilder
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>GroupFormQueryBuilder</code> implements the base functionality to
 ** access the Oracle Identity Manager Group form directly.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 */
public class GroupFormQueryBuilder extends StandardFormQueryBuilder {
  ...
  private static final long   OBJECTKEY         = 4L;
  private static final long   FORMDEFINITIONKEY = 4L;
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>GroupFormQueryBuilder</code> which use the specified
   ** Service Locator.
   **
   ...
   **                            name could be found.
   */
  public GroupFormQueryBuilder(final tcDataProvider provider, final String loggerCategory)
  ...
  protected String statusField() {
    return AccessDescriptor.qualifiedColumnName(AccessDescriptor.UGP, AccessDescriptor.STATUS);
  }
}