...
////////////////////////////////////////////////////////////////////////////////
// abstract class DefaultLongValue
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** The <code>DefaultLongValue</code> applies a default long to a profile
 ...
 ** @since   1.0.0.0
 */
public abstract class DefaultLongValue extends AbstractAttributeTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>DefaultLongValue</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   ** @param  defaultValue       the {@link Long} value to be assigned to each
   **                            attribute in the reconcliation dataset where a
   **                            subclass of this transformer is assined to.
   */
  protected DefaultLongValue(final Logger logger, final Long defaultValue) {
    // ensure inheritance
    super(logger);
