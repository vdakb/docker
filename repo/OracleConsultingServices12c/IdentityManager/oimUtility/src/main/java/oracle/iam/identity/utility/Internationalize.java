...
// ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** The <code>Internationalize</code> transform a String to an internationalized
 ** version.
 ** <p>
 ...
 ** @since   1.0.0.0
 */
public class Internationalize extends AbstractAttributeTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>Internationalize</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public Internationalize(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    subject.put(attributeName, StringUtility.replaceAccents((String)origin.get(attributeName)));
  }
}
