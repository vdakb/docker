/*
    ...
    File        :   BooleanToStatusDeleted.java
...
////////////////////////////////////////////////////////////////////////////////
// class BooleanToStatusDeleted
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>BooleanToStatusDeleted</code> transform a boolean value coming
 ...
 ** @since   3.0.0.0
 */
public class BooleanToStatusDeleted extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>BooleanToStatusDeleted</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public BooleanToStatusDeleted(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    if (value == null)
      ...
      value = ((Boolean)value).booleanValue() ? STATUS_DELETED : STATUS_DISABLED;
      ...
      if (expression.length() == 0)
        ...
        value = Boolean.parseBoolean(expression) ? STATUS_DELETED : STATUS_DISABLED;
    }
    else
      value = STATUS_DELETED;
