...
////////////////////////////////////////////////////////////////////////////////
// class NameToUserWeak
// ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The <code>NameToUserWeak</code> transforms a given name to the system
 ...
 ** @since   3.0.0.0
 */
public class NameToUserWeak extends NameToUserStrict {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>NameToUserWeak</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose.
   */
  public NameToUserWeak(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
   ...
   ** {@link Map} <code>subject</code> us the {@link NameToUserStrict}
