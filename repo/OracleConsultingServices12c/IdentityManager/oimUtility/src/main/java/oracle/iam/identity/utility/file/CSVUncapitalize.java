...
// ~~~~~ ~~~~~~~~~~~~
/**
 ** The <code>CSVUncapitalize</code> transform a String to a uncapitalized
 ** version.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 */
public class CSVUncapitalize implements Transformer<String> {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>CSVUncapitalize</code> attribute transformer that
  ...
  public Object transform(final Object origin) {
    return StringUtility.uncapitalize(origin.toString());
  }
}