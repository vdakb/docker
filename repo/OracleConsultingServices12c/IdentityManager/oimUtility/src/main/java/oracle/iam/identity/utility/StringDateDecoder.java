...
////////////////////////////////////////////////////////////////////////////////
// abstract class StringDateDecoder
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** The <code>StringDateDecoder</code> transforms string representation of a
 ** date value provided by Oracle Identity Manager to a target in a specific
 ...
 ** @since   3.0.0.0
 */
abstract class StringDateDecoder extends AbstractDateTransformer {
   ...
   */
  protected StringDateDecoder(final Logger logger) {
    // ensure inheritance
   ...
   */
  protected StringDateDecoder(final Logger logger, final String targetFormat) {
    // ensure inheritance
   ...
   */
  protected StringDateDecoder(final Logger logger, final Date defaultDate) {
    // ensure inheritance
   ...
   **                            transformation method.
   */
  protected StringDateDecoder(final Logger logger, final String targetFormat, final Date defaultDate) {
    // ensure inheritance
   ...
   */
  protected StringDateDecoder(final Logger logger, final int year, int month, int day, int hourOfDay, int minute, int second) {
    // ensure inheritance
   ...
   ** @param  second             the value used to set the SECOND calendar field.
   */
  protected StringDateDecoder(final Logger logger, final String targetFormat, final int year, int month, int day, int hourOfDay, int minute, int second) {
    // ensure inheritance
