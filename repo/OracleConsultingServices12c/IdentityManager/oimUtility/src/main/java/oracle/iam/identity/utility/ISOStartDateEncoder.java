...
////////////////////////////////////////////////////////////////////////////////
// class ISOStartDateEncoder
// ~~~~~ ~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>ISOStartDateEncoder</code> transform a Data String formatted as a
 ...
 ** @since   1.0.0.0
 */
public class ISOStartDateEncoder extends ISODateEncoder {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>ISOStartDateEncoder</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public ISOStartDateEncoder(final Logger logger) {
    // ensure inheritance
