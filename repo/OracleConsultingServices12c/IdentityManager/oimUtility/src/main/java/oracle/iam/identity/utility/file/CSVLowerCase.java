...
// ~~~~~ ~~~~~~~~~~~~
/**
 ** The <code>CSVLowerCase</code> transforms all characters of a String to
 ** lower case letters.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 */
public class CSVLowerCase implements Transformer<String> {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>CSVLowerCase</code> attribute transformer that
  ...
  public Object transform(final Object origin) {
    return origin.toString().toLowerCase();
  }
}