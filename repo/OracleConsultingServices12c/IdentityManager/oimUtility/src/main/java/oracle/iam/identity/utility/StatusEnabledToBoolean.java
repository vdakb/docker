/*
    ...
    File        :   StatusEnabledToBoolean.java
...
////////////////////////////////////////////////////////////////////////////////
// class StatusEnabledToBoolean
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>StatusEnabledToBoolean</code> transform a Oracle Identity Manager
 ** Status <code>Enabled</code> to the boolean value <code>true</code>.
 ** <p>
 ...
 ** @since   3.0.0.0
 */
public class StatusEnabledToBoolean extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>StatusEnabledToBoolean</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public StatusEnabledToBoolean(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    subject.put(attributeName, STATUS_ENABLED.equalsIgnoreCase(value.toString()) ? Boolean.TRUE : Boolean.FALSE);
  }
}