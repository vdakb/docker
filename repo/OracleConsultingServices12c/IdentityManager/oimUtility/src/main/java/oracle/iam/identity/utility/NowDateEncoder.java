...
////////////////////////////////////////////////////////////////////////////////
// class NowDateEncoder
// ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The <code>NowDateEncoder</code> transform an internal Oracle Identity
 ...
 ** @since   1.0.0.0
 */
public final class NowDateEncoder extends DateEncoder {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>NowDateEncoder</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public NowDateEncoder(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
