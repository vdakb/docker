...
////////////////////////////////////////////////////////////////////////////////
// class StatusNoToBoolean
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** The <code>StatusNoToBoolean</code> transform a Oracle Identity Manager
 ** Status <code>N</code> or <code>NO</code> to the boolean value
 ** <code>false</code>.
 ** <br>
 ...
 ** @since   3.0.0.0
 */
public class StatusNoToBoolean extends AbstractStatusTransformer {
   ...
   */
  public StatusNoToBoolean(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    subject.put(attributeName, (STATUS_N.equalsIgnoreCase(value.toString()) || STATUS_NO.equalsIgnoreCase(value.toString())) ? Boolean.FALSE : Boolean.TRUE);
  }
}