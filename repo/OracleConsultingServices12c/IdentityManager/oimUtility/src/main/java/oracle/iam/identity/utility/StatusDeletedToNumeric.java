/*
    ...
    File        :   StatusDeletedToNumeric.java
...
////////////////////////////////////////////////////////////////////////////////
// class StatusDeletedToNumeric
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>StatusDeletedToNumeric</code> transform a Oracle Identity Manager
 ** Status <code>Deleted</code> to the numerical value <code>1</code>.
 ** <p>
 ...
 ** @since   3.0.0.0
 */
public class StatusDeletedToNumeric extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>StatusDeletedToNumeric</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public StatusDeletedToNumeric(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    subject.put(attributeName, STATUS_DELETED.equalsIgnoreCase(value.toString()) ? 1 : 0);
  }
}