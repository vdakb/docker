...
////////////////////////////////////////////////////////////////////////////////
// abstract class DefaultIntegerValue
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>DefaultIntegerValue</code> applies a default integer to a profile
 ...
 ** @since   1.0.0.0
 */
public abstract class DefaultIntegerValue extends AbstractAttributeTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>DefaultIntegerValue</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   ** @param  defaultValue       the {@link Integer} value to be assigned to each
   **                            attribute in the reconcliation dataset where a
   **                            subclass of this transformer is assined to.
   */
  protected DefaultIntegerValue(final Logger logger, final Integer defaultValue) {
    // ensure inheritance
    super(logger);
