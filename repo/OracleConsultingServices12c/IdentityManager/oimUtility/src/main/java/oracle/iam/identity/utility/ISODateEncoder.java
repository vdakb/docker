...
////////////////////////////////////////////////////////////////////////////////
// abstract class ISODateEncoder
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The <code>ISODateEncoder</code> transform an internal Oracle Identity
 ** Manager Date Format '<code>yyyy/MM/dd hh:mm:ss z</code>' representation to
 ** an ISO Date and Time '<code>'yyyy-mm-dd hh:mm:ss zz'</code>' Date String
 ** representation.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
abstract class ISODateEncoder extends AbstractDateTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>ISODateEncoder</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  protected ISODateEncoder(final Logger logger) {
    // ensure inheritance
   ...
   */
  protected ISODateEncoder(final Logger logger, final Date defaultDate) {
    // ensure inheritance
   ...
   */
  protected ISODateEncoder(final Logger logger, final int year, int month, int date, int hourOfDay, int minute, int second) {
    // ensure inheritance
