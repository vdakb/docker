/*
    ...
    File        :   StatusDisabledToBoolean.java
...
////////////////////////////////////////////////////////////////////////////////
// class StatusDisabledToBoolean
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>StatusDisabledToBoolean</code> transform a Oracle Identity Manager
 ** Status <code>Disabled</code> to the boolean value <code>true</code>.
 ** <p>
 ...
 ** @since   3.0.0.0
 */
public class StatusDisabledToBoolean extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>StatusDisabledToBoolean</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public StatusDisabledToBoolean(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    subject.put(attributeName, STATUS_DISABLED.equalsIgnoreCase(value.toString()) ? Boolean.TRUE : Boolean.FALSE);
  }
}