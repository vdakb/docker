...
////////////////////////////////////////////////////////////////////////////////
// class EndDateEncoder
// ~~~~~ ~~~~~~~~~~~~~~
/**
 ** The <code>EndDateEncoder</code> transform an internal Oracle Identity
 ** Manager Date Format '<code>yyyy/MM/dd hh:mm:ss z</code>' representation to a
 ** simple '<code>'yyyymmdd'</code>' Date String representation.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class EndDateEncoder extends StringDateEncoder {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>EndDateEncoder</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public EndDateEncoder(final Logger logger) {
    // ensure inheritance
