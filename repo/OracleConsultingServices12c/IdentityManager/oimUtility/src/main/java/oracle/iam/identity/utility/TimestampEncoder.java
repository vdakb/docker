 ...
 ** a <code>'yyyyMMddHHmmSS'</code> Date String representation.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class TimestampEncoder extends StringTimestampEncoder {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>TimestampEncoder</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public TimestampEncoder(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
}