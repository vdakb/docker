...
// ~~~~~ ~~~~~~
/**
 ** The <code>DN2RDN</code> transform a String that must be a DN to a RDN by
 ...
 ** @since   1.0.0.0
 */
public class DN2RDN extends AbstractAttributeTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>DN2RDN</code> which use the specified
   ** {@link Logger} for logging purpose.
   **
   ** @param  logger             the {@link Logger} for logging purpose.
   */
  public DN2RDN(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
