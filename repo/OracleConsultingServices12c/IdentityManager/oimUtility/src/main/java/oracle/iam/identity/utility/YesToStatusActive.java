...
////////////////////////////////////////////////////////////////////////////////
// class YesToStatusActive
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** The <code>YesToStatusActive</code> transform a Status <code>Y</code> or
 ** <code>YES</code> to the Oracle Identity Manager <code>Active</code>.
 ** <br>
 ** The vlaue comparision is ignoring case sensitivity.
 ** <p>
 ...
 ** @since   3.0.0.0
 */
public class YesToStatusActive extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>YesToStatusActive</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public YesToStatusActive(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    subject.put(attributeName, (STATUS_Y.equalsIgnoreCase(value.toString()) || STATUS_YES.equalsIgnoreCase(value.toString())) ? STATUS_ACTIVE : STATUS_DISABLED);
  }
}