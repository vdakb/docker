/*
    ...
    File        :   StatusEnabledToNumeric.java
...
////////////////////////////////////////////////////////////////////////////////
// class StatusEnabledToNumeric
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>StatusEnabledToNumeric</code> transform a Oracle Identity Manager
 ** Status <code>Enabled</code> to the numerical value <code>1</code>.
 ** <p>
 ...
 ** @since   3.0.0.0
 */
public class StatusEnabledToNumeric extends AbstractStatusTransformer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>StatusEnabledToNumeric</code> which use the specified
   ** {@link Logger} for debugging purpose.
   **
   ** @param  logger             the {@link Logger} for debugging purpose
   */
  public StatusEnabledToNumeric(final Logger logger) {
    // ensure inheritance
    super(logger);
  }
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    subject.put(attributeName, STATUS_ENABLED.equalsIgnoreCase(value.toString()) ? 1 : 0);
  }
}