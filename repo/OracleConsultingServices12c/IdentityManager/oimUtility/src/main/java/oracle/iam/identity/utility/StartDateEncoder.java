...
////////////////////////////////////////////////////////////////////////////////
// class StartDateEncoder
// ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** The <code>StartDateEncoder</code> transform an internal Oracle Identity
 ** Manager Date Format '<code>yyyy/MM/dd hh:mm:ss z</code>' representation to a
 ** Coordinated Universal Time (UTC) '<code>'yyyymmddhh'</code>' Date String
 ** representation.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class StartDateEncoder extends StringDateEncoder {
   ...
   */
  public StartDateEncoder(final Logger logger) {
    // ensure inheritance
   ...
   */
  public StartDateEncoder(final Logger logger, final String targetFormat) {
    // ensure inheritance
  ...
  public void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject) {
    ...
    if (subject.get(attributeName) == null)
      subject.put(attributeName, formatExternal(this.defaultDate()));
  }
}