...
public final class DescriptorFactory extends TaskDescriptorFactory {
  ...
  enum Grammar {
    ...
    // compatible with
    @SuppressWarnings("compatibility:3599276747449370639")
    ...
    public void startElement(final String uri, final String localName, final String qualifiedName, final Attributes attributes)
      ...
      switch (this.cursor) {
        ...
        case CONSTANT    : // there must be a task descriptor on the value
                           ...
                           // to an FileEntityReference is a subclass of
                           // TaskDescriptor
        ...
        case REFERENCE   : // if we have a reference there must be an attribute
                           ...
                           final DatabaseReference reference = new DatabaseReference(DescriptorFactory.this.descriptor);
