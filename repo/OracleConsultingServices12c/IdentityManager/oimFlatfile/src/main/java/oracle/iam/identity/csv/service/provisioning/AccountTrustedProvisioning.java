/*
    ...
    File        :   AccountTrustedProvisioning.java
...
////////////////////////////////////////////////////////////////////////////////
// class AccountTrustedProvisioning
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>AccountTrustedProvisioning</code> implements the base
 ** functionality of a service end point for the Oracle Identity Manager
 ** Scheduler which handles data that has to be dumped to a CSV flatfile.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class AccountTrustedProvisioning extends EntityProvisioning {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>AccountTrustedProvisioning</code> task adapter
   ...
   ** Default Constructor
   */
  public AccountTrustedProvisioning() {
    // ensure inheritance
    super();
  }
  ...
  protected void processSubject(final String transaction, final Map<String, Object> subject)
    ...
    final String[] identifier = this.dataDescriptor().identifier(subject);
    String[] parameter = {TaskBundle.string(TaskMessage.ENTITY_IDENTITY), identifier[0] };
