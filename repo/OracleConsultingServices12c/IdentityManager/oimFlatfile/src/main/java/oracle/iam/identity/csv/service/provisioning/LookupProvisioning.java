 ...
 ** data provided by CSV flatfile.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class LookupProvisioning extends Provisioning {
  ...
  , TaskAttribute.build(ENCLOSING_CHARACTER,     TaskAttribute.MANDATORY)
  };
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>LookupProvisioning</code> task adapter that
   ...
   **                            was last executed.
   */
  protected void prepareStatement(PreparedStatement statement, String lastExecution)
  ...
  protected void processSubject(final String transaction, final Map<String, Object> subject)
    ...
    String[] parameter = {TaskBundle.string(TaskMessage.ENTITY_LOOKUP), identifier[0] };
