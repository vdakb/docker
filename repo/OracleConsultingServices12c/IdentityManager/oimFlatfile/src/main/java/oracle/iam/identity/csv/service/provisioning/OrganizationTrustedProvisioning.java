/*
    ...
    File        :   OrganizationTrustedProvisioning.java
    ...
    Purpose     :   This file implements the class
                    OrganizationTrustedProvisioning.
...
////////////////////////////////////////////////////////////////////////////////
// class OrganizationTrustedProvisioning
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>OrganizationTrustedProvisioning</code> implements the base
 ** functionality of a service end point for the Oracle Identity Manager
 ** Scheduler which handles data provided by CSV flatfile.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 3.1.0.0
 ** @since   1.0.0.0
 */
public class OrganizationTrustedProvisioning extends EntityProvisioning {
  ...
  /** the criteria to search for organizations */
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>OrganizationTrustedProvisioning</code> task
   ** adapter that allows use as a JavaBean.
   ** <br>
   ** Zero argument constructor required by the framework.
   ** <br>
   ** Default Constructor
   */
  public OrganizationTrustedProvisioning() {
    // ensure inheritance
    super();
  }
  ...
  protected void prepareStatement(final PreparedStatement statement, final String lastExecution)
    ...
    try {
      statement.setString(1, lastExecution);
  ...
  protected void processSubject(final String transaction, final Map<String, Object> subject)
    ...
    String[] parameter = {TaskBundle.string(TaskMessage.ENTITY_ORGANIZATION), identifier[0] };
    debug(method, TaskBundle.format(TaskMessage.ENTITY_RECONCILE, parameter));

    try {
      final CSVWriter writer = writer();
