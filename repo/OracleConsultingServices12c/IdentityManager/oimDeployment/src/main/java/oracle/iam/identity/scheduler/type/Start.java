...
// ~~~~~ ~~~~~ ~~~~~
/**
 ** <code>Start</code> defines the attribute restriction on values that can
 ** be passed as the nested element start of a scheduled job instance.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public final class Start extends Command {
  ...
  private static final String[] registry = { ServiceCommand.start.id() };
