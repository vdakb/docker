...
import oracle.iam.identity.deployment.type.Resource;

import oracle.iam.identity.common.spi.ResourceHandler;

////////////////////////////////////////////////////////////////////////////////
// class ResourceOperation
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** Basic task operations on <code>Resource Object</code> instances of Oracle
 ** Identity Manager.
 ** <p>
...
public class ResourceOperation extends AbstractOperation {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>ResourceOperation</code> task that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public void setName(final String name) {
    final ResourceHandler handler = (ResourceHandler)this.handler;
    handler.name(name);
  }
  ...
  public void onExecution()
    ...
    switch (handler.operation()) {
      ...
      case modify: handler.modify(this);
        break;
      default: error(ServiceResourceBundle.format(ServiceError.OBJECT_OPERATION_INVALID, handler.operation().id(), ResourceHandler.PREFIX));
    }
  }
   ...
   **
   ** @throws BuildException     if the specified {@link Resource} object is
