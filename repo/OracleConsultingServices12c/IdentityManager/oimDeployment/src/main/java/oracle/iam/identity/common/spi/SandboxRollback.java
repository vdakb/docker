 ...
 ** @since   1.0.0.0
 */
public class SandboxRollback extends SandboxTransaction {
  ...
  // Method:   Ctor
  /**
   ** Create a new <code>SandboxRollback</code> to initialize the instance.
   **
   ** @param  frontend           the {link ServiceFrontend} that instantiated
   **                            this service.
   */
  public SandboxRollback(final ServiceFrontend frontend) {
    // ensure inheritance
    super(frontend);
  }
  ...
  public void execute(final MDSInstance instance)
    ...
    for (String name : this.sandbox)
      rollback(instance, namespace, name, this.force);
  }
}