 ...
 ** deleted from the Metadata Store.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class SandboxDelete extends SandboxTransaction {
  ...
  // Method:   Ctor
  /**
   ** Create a new <code>SandboxDelete</code> to initialize the instance.
   **
   ** @param  frontend           the {link ServiceFrontend} that instantiated
   **                            this service.
   */
  public SandboxDelete(final ServiceFrontend frontend) {
    // ensure inheritance
    super(frontend);
  }
  ...
  public void execute(final MDSInstance instance)
    ...
    for (String name : this.sandbox)
      delete(instance, namespace, name);
  }
}