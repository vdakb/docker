...
// ~~~~~ ~~~~~~~~~
/**
 ** <code>ImportSet</code> is a special {@link FileSet} that will be imported
 ** to Oracle Metadata Store.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class ImportSet extends FileSet {
   ...
   ** {@link ImportFile}.
   **
   ** @param  importFile         the subject of substitution.
   **
