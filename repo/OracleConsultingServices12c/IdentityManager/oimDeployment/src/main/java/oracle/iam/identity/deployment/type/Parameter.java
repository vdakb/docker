...
// ~~~~~ ~~~~~~~~~
/**
 ** <code>Parameter</code> defines the value holder of named value pairs to be
 ** applied on object definitions of Oracle Identity Manager after an import
 ** operation
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
...
public class Parameter extends DataType {
  ...
  // Method:   name
  /**
   ** Returns the name of the parameter of the Identity Manager object.
   **
  ...
  // Method:   value
  /**
   ** Returns the value for <code>name</code> to set on the Identity Manager
   ** object.
   **
