...
// ~~~~~ ~~~~~~~
/**
 ** Disables an existing workflow within within the repository of Oracle
 ** Identity Manager.
 ** <p>
 ...
 ** @since   1.0.0.0
 */
public class Disable extends Repository {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Disable</code> task that allows use as a JavaBean.
   ** <br>
  ...
  public Disable() {
    ...
    this.handler.operation(ServiceOperation.disable);
  }
}