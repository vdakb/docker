...
import oracle.iam.identity.common.spi.AdminRoleHandler;

////////////////////////////////////////////////////////////////////////////////
// class AdminRoleOperation
// ~~~~~ ~~~~~~~~~~~~~~~~~~
/**
 ** Basic task operations on <code>Admin Role</code>s in Identity Manager.
 ** <p>
 ** Works with Oracle Identity Manager 11.1.1 and later
 */
public class AdminRoleOperation extends AbstractOperation {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>AdminRoleOperation</code> task that allows use as a
   ** JavaBean.
   ** <br>
   ...
   ** Default Constructor
   */
  public AdminRoleOperation() {
    // ensure inheritance
    super();

    // initialize attribute instances
    this.handler = new AdminRoleHandler(this);
  }
   ...
   ** <code>name</code>.
   **
   ** @param  name               the name of the <code>Admin Role</code> in
   **                            Identity Manager to handle.
   */
  public void setName(final String name) {
    final AdminRoleHandler handler = (AdminRoleHandler)this.handler;
    handler.name(name);
  }
   ...
   **
   ** @param  role               the {@link AdminRole} to add.
   **
   ** @throws BuildException     if the specified {@link AdminRole} object is
   **                            already part of this operation.
   */
  public void addConfiguredAdminRole(final AdminRole role)
    throws BuildException {
