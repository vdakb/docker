...
import oracle.iam.identity.common.spi.SandboxCommit;
...
// ~~~~~ ~~~~~~
/**
 ** Commits changes done by a published sandbox in Oracle Metadata Store.
 ** <p>
 ...
 ** @since   1.0.0.0
 */
public class Commit extends FeatureSandboxTask {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Commit</code> task that allows use as a JavaBean.
   ** <br>
