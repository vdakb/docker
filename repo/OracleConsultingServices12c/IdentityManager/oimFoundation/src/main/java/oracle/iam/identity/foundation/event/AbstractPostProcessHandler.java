/*
    ...
    File        :   AbstractPostProcessHandler.java
...
////////////////////////////////////////////////////////////////////////////////
// abstract class AbstractPostProcessHandler
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>AbstractPreProcessHandler</code> provide the basic implementation
 ** of common tasks a pre-process handler needs.
 ** <p>
 ** This class implements the interface {@link PostProcessHandler}
 **
 ** @author  Dieter.Steding@oracle.com
 ** @version 1.0.0.0
 */
public abstract class AbstractPostProcessHandler extends    AbstractProcessHandler
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>AbstractPostProcessHandler</code> which use the
   ...
   ** Default Constructor
   */
  protected AbstractPostProcessHandler() {
    // ensure inheritance
   ...
   */
  protected AbstractPostProcessHandler(final String loggerCategory) {
    // ensure inheritance
