 ...
 ** @since   0.0.0.2
 */
public class DatabaseException extends TaskException {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-1681240419223554392")
  private static final long  serialVersionUID = 4243441062839092058L;
