...
public interface DirectoryMessage {
  ...
  static final String ATTRIBUTE_ADDED        = PREFIX + "01002";
  static final String ATTRIBUTE_DELETED      = PREFIX + "01003";
  static final String ATTRIBUTE_TOMODIFY     = PREFIX + "01004";
  static final String ATTRIBUTE_MODIFIED     = PREFIX + "01005";
}