...
public class DatabaseSelect extends DatabaseStatement {
   ...
   **                            returned result set.
   */
  protected DatabaseSelect(final Loggable loggable, final DatabaseEntity entity, final DatabaseFilter filter, final List<Pair<String, String>> returning) {
    // ensure inheritance
   ...
   */
  public static DatabaseSelect build(final Loggable loggable, final DatabaseEntity entity, final DatabaseFilter filter, final List<Pair<String, String>> returning) {
   ...
   */
  public List<Map<String, Object>> execute(final Connection connection)
   ...
   **                            performed.
   */
  public List<Map<String, Object>> execute(final List<DatabaseParameter> parameter)
    throws DatabaseException {
