 ...
 ** @since   3.0.0.0
 */
public class WebServiceBundle_en extends ListResourceBundle  {
  ...
  , { WebServiceError.NOTIMPLEMENTED,                   "Feature is not yet implemented"}
     ...
     // SOA-00010 - 00020 method argument related errors
