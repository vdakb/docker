/*
    ...
    File        :   AttributeTransformer.java
...
// ~~~~~~~~~ ~~~~~~~~~~~~~~~~~~~~
public interface AttributeTransformer extends AbstractTask {
   ...
   */
  void transform(final String attributeName, final Map<String, Object> origin, final Map<String, Object> subject);
}