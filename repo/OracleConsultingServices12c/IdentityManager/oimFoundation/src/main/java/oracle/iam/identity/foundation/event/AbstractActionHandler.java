/*
    ...
    File        :   AbstractActionHandler.java
...
import oracle.iam.platform.kernel.spi.ActionHandler;
...
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>AbstractActionHandler</code> provide the basic implementation
 ** of common tasks a action handler needs.
 ** <p>
 ** This class implements the interface {@link ActionHandler}
 **
 ** @author  Dieter.Steding@oracle.com
 ** @version 1.0.0.0
 */
public abstract class AbstractActionHandler extends    AbstractEventHandler
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>AbstractActionHandler</code> which use the default
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>AbstractActionHandler</code> which use the specified
   ** category for logging purpose.
   **
   ** @param  loggerCategory     the category for the Logger.
   */
  protected AbstractActionHandler(final String loggerCategory) {
    // ensure inheritance
   ...
   **                            {@link AbstractEventHandler} obtained from the
