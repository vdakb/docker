...
public interface ProvisioningError {
  ...
  // 00021 - 00040 identity related errors
  static final String INSUFFICIENT_INFORMATION   = PREFIX + "00021";

  // 00101 - 00110 permission assignment errors
  static final String PERMISSION_ALREADY_GRANTED = PREFIX + "00101";
  static final String PERMISSION_ALREADY_REVOKED = PREFIX + "00102";
}