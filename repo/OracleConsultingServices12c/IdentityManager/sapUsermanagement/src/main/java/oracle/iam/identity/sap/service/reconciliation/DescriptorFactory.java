...
public final class DescriptorFactory extends TaskDescriptorFactory {
  ...
  enum Grammar {
    ...
    // compatible with
    @SuppressWarnings("compatibility:4055648183442416703")
    ...
    public void startElement(final String uri, final String localName, final String qualifiedName, final Attributes attributes)
      ...
      switch (this.cursor) {
        ...
        case LOOKUP      : // put the name of the attribute on the value stack
                           ...
                           break;
        case REFERENCE   : final AccountReference reference = new AccountReference(DescriptorFactory.this.descriptor);
  ...
  private DescriptorFactory(final Descriptor descriptor)
    ...
    // prevent bogus input
    if (descriptor == null)
      throw new TaskException(TaskError.ARGUMENT_IS_NULL, "descriptor");
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   processDescriptor (overridden)
  /**
   ...
   */
  @Override
  protected final void processDescriptor(final TaskDescriptor descriptor, final Attributes attributes)
    throws SAXException {
    ...
    // get the name of the entity identifier
    ((Descriptor)descriptor).changeLog(Descriptor.ChangeLog.fromValue(attributes.getValue(Descriptor.CHANGELOG)));
  ...
  public static void main(String[] args) {
    SystemConsole console    = new SystemConsole("Test");
