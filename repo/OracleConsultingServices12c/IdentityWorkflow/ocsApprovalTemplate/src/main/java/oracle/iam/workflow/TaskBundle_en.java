/*
    ...
    Subsystem   :   Catalog Default Approver Approval

    File        :   TaskBundle_en.java
    ...
    ------------+-----------+-----------+-----------------------------------
    1.0.0.0      2021-06-06  DSteding    First release version
*/
 ...
 ** @since   1.0.0.0
 */
public class TaskBundle_en extends ListResourceBundle  {
  ...
  , {"challenge.title",                "Challenge for Request ID "}
