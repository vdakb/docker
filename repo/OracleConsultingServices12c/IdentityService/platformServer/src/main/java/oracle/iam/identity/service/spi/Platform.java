...
package oracle.iam.identity.service.spi;
...
import Thor.API.Security.LoginHandler.AssertionLoginSession;
...
// ~~~~~ ~~~~~~~~
/**
 ** Provides components a way to interact with elements in the Identity Manager
 ** runtime environment. The elements include
 ** <ul>
...
public class Platform {
  ...
  private static final String THIS          = Platform.class.getName();
  ...
  // ~~~~~ ~~~~~~~~
  /**
   ** The internal client holding the connection to Identoty Manager.
   */
  private static class Internal extends OIMClient {

    ////////////////////////////////////////////////////////////////////////////
    // Method:   Ctor
    /**
     ** Creates an instance of <code>Platform</code> to communicate with the
     ...
     */
    private Internal(final Hashtable environment) {
     ...
     ** <p>
     ** The caller is responsible for invoking this method prior to executing
     ** any other method.
     **
     ** @param  username         the login name of the user to autehnticate.
     **                          <br>
     ...
     **                          connection.
     */
    private Internal login(final String user)
      throws LoginException {

      // OPSS API
      // SubjectSecurity.getInstance().getActionExecutor(this.username) is
      // protected by code permission oracle.security.jps.JpsPermission with
      // name "IdentityAssertion" and action "execute"
      // the application code sources need to be granted the above permission
      // when invoking this method.
      this.loginSession = new AssertionLoginSession(user);

      // this call sets user in the Identty Managec context via a EJB call, and
      // MUST DO NOT REMOVE, as it would break Provisioning
      loginSessionCreated(user);
      return this;
    }
     ...
     ** <br>
     ** The roles returned here are not users enterprise roles.
     ** <br>
     ** Don't use these roles
     **
     ** @return                  the roles of the logged in user.
     **                          <br>
     **                          Possible object is {@link List} where each
     **                          element is of type {@link Role}.
     */
    private List<Role> role() {
      return this.loginSession.getRole();
    }
     ...
     **
     ** @return                  tthe Login Context.
     **                          <br>
     **                          Possible object is {@link LoginContext}.
     */
  ...
  /**
   ** Creates an instance of <code>Platform</code> to communicate with the
   ** Identity Manager application with a server environment.
   */
  public Platform() {
    // ensure inheritance
    super();
  ...
  public void startup() {
    ...
    // intialize context
    final String url = System.getProperty(PROVIDER_URL);
    ...
    environment.put("APPSERVER_TYPE", OIMClient.APPSERVER_TYPE_WEBLOGIC);
    // hard-coded due to I'll never run this piece of code on WebSphere
    environment.put(OIMClient.JAVA_NAMING_FACTORY_INITIAL, "weblogic.jndi.WLInitialContextFactory");
    if (url != null) {
      environment.put(OIMClient.JAVA_NAMING_PROVIDER_URL, url);
    }
    ...
    // in any case, we can always enforce manual environment settings by
    // OIMClient.setLookupEnv(configEnv) method.
    this.internal = new Internal(environment);
   ...
   ** Creates a initial connection as Identity Manager administrator.
   ** <br>
   ** The user <code>OIMInternal</code> is used for that purpose.
   **
   ** @throws LoginException     if an error occurs attempting to establish a
   **                            connection.
   */
  public void loginInternal()
    ...
    final String method = "loginInternal";
    LOGGER.entering(THIS, method);
    login(INTERNAL_USER);
    LOGGER.exiting(THIS, method);
  }
  ...
  // Method:   login
  /**
   ** Creates a initial connection as Identity Manager.
   ** <br>
   ** The given <code>username</code> is used for that purpose.
   **
   ** @param  username           the name of the user that requests to login.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ** @throws LoginException     if an error occurs attempting to establish a
   ...
   ** The roles returned here are not users enterprise roles.
   ** <br>
   ** Don't use these roles like roles in Identity Manager.
   **
   ** @return                  the roles of the logged in user.
   **                          <br>
   **                          Possible object is {@link List} where each
  ...
  public List<Role> role() {
    return this.internal == null ? Collections.emptyList() : this.internal.role();
  }
  ...
  public LoginContext context() {
    return this.internal == null ? null: this.internal.context();
  }
   ...
   */
  public UnauthenticatedSelfService unauthenticatedSelfService() {
   ...
   */
  public UnauthenticatedRequestService unauthenticatedRequestService() {
   ...
   */
  public AuthenticatedSelfService authenticatedSelfService() {
   ...
   */
  public AuthorizationOPSSService authorizationOPSSService() {
   ...
   */
  public PasswordMgmtService passwordManagementService() {
   ...
   */
  public ApplicationInstanceInternalService applicationInstanceInternalService() {
   ...
   */
  public EntityPublicationService entityPublicationService() {
   ...
   */
  public MetaDataDefinitionManager metadataDefinitionManager() {
   ...
   */
  public RequestProfileService requestProfileService() {
   ...
   **                            Possible object is {@link EntitlementService}.
   */
  public RequestDataSetService requestDataSetService() {
   ...
   */
  public ProvisioningServiceInternal provisioningInternalService() {
   ...
   */
  public ReconConfigService reconConfigService() {
   ...
   */
  public ConnectorServerService connectorServerService() {
   ...
   **                            {@link ConnectorBundleService}.
   */
  public ConnectorBundleService connectorBundleService() {
   ...
   */
  public ConnectorInfoService connectorInfoService() {
   ...
   */
  public ConnectorInfoManager connectorInfoManager() {
   ...
   */
  public SODCheckService sodCheckService() {
   ...
   */
  public CertificationAdministrationService certificationAdministrationService() {
   ...
   **                            Possible object is {@link PolicyManager}.
   */
  public PolicyTypeManager policyTypeManager() {
   ...
   */
  public PolicyViolationManager policyViolationManager() {
   ...
   **                            {@link PolicyViolationManager}.
   */
  public PolicyViolationCauseManager policyViolationCauseManager() {
   ...
   */
  public ScanDefinitionManager scanDefinitionManagerService() {
   ...
   */
  public ScanRunManager scanRunManager() {
   ...
   */
  public IDAConfigurationManager idaConfigurationManager() {
   ...
   */
  public tcLookupOperationsIntf lookupFacade() {
   ...
   */
  public tcITResourceDefinitionOperationsIntf endpointDefinitionFacade() {
   ...
   */
  public tcITResourceInstanceOperationsIntf endpointInstanceFacade() {
   ...
   */
  public tcOrganizationOperationsIntf organizationFacade() {
   ...
   */
  public tcGroupOperationsIntf groupFacade() {
   ...
   */
  public tcUserOperationsIntf userFacade() {
   ...
   */
  public tcObjectOperationsIntf objectFacade() {
   ...
   */
  public tcAccessPolicyOperationsIntf accessPolicyFacade() {
   ...
   */
  public tcFormDefinitionOperationsIntf formDefinitionFacade() {
   ...
   */
  public tcFormInstanceOperationsIntf formInstanceFacade() {
   ...
   */
  public tcProvisioningOperationsIntf provisioningFacade() {
   ...
   */
  public AttestationOperationsIntf attestationFacade() {
  ...
  public <T> T service(final Class<T> clazz)
    ...
    return this.internal.getService(clazz);
  }
}