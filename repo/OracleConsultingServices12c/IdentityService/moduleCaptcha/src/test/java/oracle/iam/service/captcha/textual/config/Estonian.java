...
// ~~~~~ ~~~~~~~~
/**
 ** The <code>Estonian</code> {@link Alphabet} dictionary generator for textual
 ** <code>CAPTCHA</code>s.
 ** <br>
 ** Used for translation resources to
 ** <ul>
 **   <li>country  code estonian (et)
 ...
 ** @since   1.0.0.0
 */
public class Estonian extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Estonian</code> {@link Alphabet}.
   **
   ...
   */
  private Estonian(final File path) {
    // ensure inheritance
    super(path, "et");
  }
  ...
  protected void initializeLetter() {
    ...
    // extend the dictionary with the estonian special characters
    this.letter.add(entry('\u00C4', '\u00C4')); // Ä
    this.letter.add(entry('\u00D5', '\u00D5')); // Õ
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>Estonian</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>Estonian</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>Estonian</code>.
   */
  public static Estonian build(final File path) {
    return new Estonian(path);
  }
}