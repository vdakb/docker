...
// ~~~~~ ~~~~~~
/**
 ** The <code>Spanish</code> {@link Alphabet} dictionary generator for textual
 ** <code>CAPTCHA</code>s.
 ** <br>
 ** Used for translation resources to
 ** <ul>
 **   <li>country  code spanish (es)
 ...
 ** @since   1.0.0.0
 */
public class Spanish extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Spanish</code> {@link Alphabet}.
   **
   ...
   */
  private Spanish(final File path) {
    // ensure inheritance
    super(path, "es");
  }
  ...
  protected void initializeLetter() {
    ...
    // extend the dictionary with the spanish special characters
    this.letter.add(entry('\u00D1', '\u00D1')); // Ñ
    this.letter.add(entry('\u00F1', '\u00D1')); // ñ
  }
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>Spanish</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>Spanish</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>Spanish</code>.
   */
  public static Spanish build(final File path) {
    return new Spanish(path);
  }
}