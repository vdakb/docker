...
// ~~~~~ ~~~~~~~~~
/**
 ** The <code>Slovenian</code> {@link Alphabet} dictionary generator for
 ** textual <code>CAPTCHA</code>s.
 ** <br>
 ** Used for translation resources to
 ** <ul>
 **   <li>language code slovenian (sl)
 ...
 ** @since   1.0.0.0
 */
public class Slovenian extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Slovenian</code> {@link Alphabet}.
   **
   ...
   */
  private Slovenian(final File path) {
    // ensure inheritance
    super(path, "sl");
  }
  ...
  protected void initializeLetter() {
    ...
    // extend the dictionary with the slovenian special characters
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>Slovenian</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>Slovenian</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>Slovenian</code>.
   */
  public static Slovenian build(final File path) {
    return new Slovenian(path);
  }
}