...
// ~~~~~ ~~~~~~~
/**
 ** The <code>Finish</code> {@link Alphabet} dictionary generator for
 ** textual <code>CAPTCHA</code>s.
 ** <br>
 ** Used for translation resources to
 ** <ul>
 **   <li>language code finish (fi)
 ...
 ** @since   1.0.0.0
 */
public class Finish extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Finish</code> {@link Alphabet}.
   **
   ...
   */
  private Finish(final File path) {
    // ensure inheritance
    super(path, "fi");
  }
  ...
  protected void initializeLetter() {
    ...
    // extend the dictionary with the finish special characters
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>Finish</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>Finish</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>Finish</code>.
   */
  public static Finish build(final File path) {
    return new Finish(path);
  }
}