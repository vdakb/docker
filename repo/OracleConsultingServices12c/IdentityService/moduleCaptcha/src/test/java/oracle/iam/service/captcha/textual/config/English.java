...
// ~~~~~ ~~~~~~~
/**
 ** The <code>English</code> {@link Alphabet} dictionary generator for textual
 ** <code>CAPTCHA</code>s.
 ** <br>
...
public class English extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>English</code> {@link Alphabet}.
   **
   ...
   */
  private English(final File path) {
    // ensure inheritance
    super(path, "en");
  }
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>English</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>English</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>English</code>.
   */
  public static English build(final File path) {
    return new English(path);
  }
}