...
// ~~~~~ ~~~~~~~~~~
/**
 ** The <code>Portuguese</code> {@link Alphabet} dictionary generator for
 ** textual <code>CAPTCHA</code>s.
 ** <br>
 ** Used for translation resources to
 ** <ul>
 **   <li>language code portuguese (pt)
 ...
 ** @since   1.0.0.0
 */
public class Portuguese extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Portuguese</code> {@link Alphabet}.
   **
   ...
   */
  private Portuguese(final File path) {
    // ensure inheritance
    super(path, "pt");
  }
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>Portuguese</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>Portuguese</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>Portuguese</code>.
   */
  public static Portuguese build(final File path) {
    return new Portuguese(path);
  }
}