...
// ~~~~~ ~~~~~~~
/**
 ** The <code>Italian</code> {@link Alphabet} dictionary generator for textual
 ** <code>CAPTCHA</code>s.
 ** <br>
 ** Used for translation resources to
 ** <ul>
 **   <li>language code italian (it)
 ...
 ** @since   1.0.0.0
 */
public class Italian extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Italian</code> {@link Alphabet}.
   **
   ...
   */
  private Italian(final File path) {
    // ensure inheritance
    super(path, "it");
  }
  ...
  protected void initializeLetter() {
    ...
    // uppercase letter 'J' is not applicable
    // uppercase letter 'K' is not applicable
    ...
    this.letter.add(entry('\u0068', '\u0048')); // h
    this.letter.add(entry('\u0069', '\u0049')); // i
    // lowercase letter 'j' is not applicable
    // lowercase letter 'k' is not applicable
    this.letter.add(entry('\u006C', '\u004C')); // l
    this.letter.add(entry('\u006D', '\u004D')); // m
    this.letter.add(entry('\u006E', '\u004E')); // n
    this.letter.add(entry('\u006F', '\u004F')); // o
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>Italian</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>Italian</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>Italian</code>.
   */
  public static Italian build(final File path) {
    return new Italian(path);
  }
}