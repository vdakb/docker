...
// ~~~~~ ~~~~~
/**
 ** The <code>Irish</code> {@link Alphabet} dictionary generator for textual
 ** <code>CAPTCHA</code>s.
 ** <br>
 ** Used for translation resources to
 ** <ul>
 **   <li>language code irish (ga)
 ...
 ** @since   1.0.0.0
 */
public class Irish extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Irish</code> {@link Alphabet}.
   **
  ...
  protected void initializeLetter() {
    ...
    // extend the dictionary with the irish special characters
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>Irish</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>Irish</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>Irish</code>.
   */
  public static Irish build(final File path) {
    return new Irish(path);
  }
}