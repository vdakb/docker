...
// ~~~~~ ~~~~~~
/**
 ** The <code>Slovak</code> {@link Alphabet} dictionary generator for
 ** textual <code>CAPTCHA</code>s.
 ** <br>
 ** Used for translation resources to
 ** <ul>
 **   <li>language code slovak (sk)
 ...
 ** @since   1.0.0.0
 */
public class Slovak extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Slovak</code> {@link Alphabet}.
   **
   ...
   */
  private Slovak(final File path) {
    // ensure inheritance
    super(path, "sk");
  }
  ...
  protected void initializeLetter() {
    ...
    // extend the dictionary with the slovak special characters
    this.letter.add(entry('\u00C4', '\u00C4')); // Ä
    this.letter.add(entry('\u00CD', '\u00CD')); // Í
    this.letter.add(entry('\u00D4', '\u00D4')); // Ô
    this.letter.add(entry('\u00E4', '\u00C4')); // ä
    this.letter.add(entry('\u00ED', '\u00CD')); // í
    this.letter.add(entry('\u00F4', '\u00D4')); // ô
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>Slovak</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>Slovak</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>Slovak</code>.
   */
  public static Slovak build(final File path) {
    return new Slovak(path);
  }
}