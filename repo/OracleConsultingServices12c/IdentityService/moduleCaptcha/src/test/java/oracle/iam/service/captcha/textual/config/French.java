...
// ~~~~~ ~~~~~~
/**
 ** The <code>French</code> {@link Alphabet} dictionary generator for textual
 ** <code>CAPTCHA</code>s.
 ** <br>
 ** Used for translation resources to
 ** <ul>
 **   <li>country  code french (fr)
 ...
 ** @since   1.0.0.0
 */
public class French extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>French</code> {@link Alphabet}.
   **
   ...
   */
  private French(final File path) {
    // ensure inheritance
    super(path, "fr");
  }
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>French</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>French</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>French</code>.
   */
  public static French build(final File path) {
    return new French(path);
  }
}