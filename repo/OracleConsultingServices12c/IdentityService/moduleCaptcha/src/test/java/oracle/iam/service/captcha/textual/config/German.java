...
// ~~~~~ ~~~~~~
/**
 ** The <code>German</code> {@link Alphabet} dictionary generator for textual
 ** <code>CAPTCHA</code>s.
 ** <br>
 ** Used for translation resources to
 ** <ul>
 **   <li>country  code german (de)
...
public class German extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>German</code> {@link Alphabet}.
   **
   ...
   */
  private German(final File path) {
    // ensure inheritance
    super(path, "de");
  }
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>German</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>German</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>German</code>.
   */
  public static German build(final File path) {
    return new German(path);
  }
}