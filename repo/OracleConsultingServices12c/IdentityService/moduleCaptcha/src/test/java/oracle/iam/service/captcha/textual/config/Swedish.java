...
// ~~~~~ ~~~~~~~
/**
 ** The <code>Swedish</code> {@link Alphabet} dictionary generator for
 ** textual <code>CAPTCHA</code>s.
 ** <br>
 ** Used for translation resources to
 ** <ul>
 **   <li>language code swedish (sv)
 ...
 ** @since   1.0.0.0
 */
public class Swedish extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Swedish</code> {@link Alphabet}.
   **
   ...
   */
  private Swedish(final File path) {
    // ensure inheritance
    super(path, "sv");
  }
  ...
  protected void initializeLetter() {
    ...
    // extend the dictionary with the swedish special characters
    this.letter.add(entry('\u00C4', '\u00C4')); // Ä
    this.letter.add(entry('\u00C5', '\u00C5')); // Å
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>Swedish</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>Swedish</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>Swedish</code>.
   */
  public static Swedish build(final File path) {
    return new Swedish(path);
  }
}