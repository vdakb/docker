...
// ~~~~~ ~~~~~~~~
/**
 ** The <code>Croatian</code> {@link Alphabet} dictionary generator for textual
 ** <code>CAPTCHA</code>s.
 ** <br>
 ** Used for translation resources to
 ** <ul>
 **   <li>language code croatian (hr)
 ...
 ** @since   1.0.0.0
 */
public class Croatian extends Alphabet {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Croatian</code> {@link Alphabet}.
   **
   ...
   */
  private Croatian(final File path) {
    // ensure inheritance
    super(path, "hr");
  }
  ...
  protected void initializeLetter() {
    ...
    this.letter.add(entry('\u0072', '\u0052')); // r
    this.letter.add(entry('\u0073', '\u0053')); // t
    this.letter.add(entry('\u0074', '\u0054')); // z
    this.letter.add(entry('\u0075', '\u0055')); // u
    this.letter.add(entry('\u0076', '\u0056')); // v
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>Croatian</code> {@link Alphabet}.
   ** properties.
   **
   ** @param  path               the abstract path to spool the configuration
   **                            file.
   ...
   **                            Allowed object is {@link File}.
   **
   ** @return                    <code>Croatian</code> {@link Alphabet}
   **                            <br>
   **                            Possible object is <code>Croatian</code>.
   */
  public static Croatian build(final File path) {
    return new Croatian(path);
  }
}