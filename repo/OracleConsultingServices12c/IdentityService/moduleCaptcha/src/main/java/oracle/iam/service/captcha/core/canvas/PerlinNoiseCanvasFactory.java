/*
    ...
    File        :   PerlinNoiseCanvasFactory.java
...
////////////////////////////////////////////////////////////////////////////////
// class PerlinNoiseCanvasFactory
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** <code>PerlinNoiseCanvasFactory</code> fills the background of an image with
 ...
 ** @since   1.0.0.0
 */
public class PerlinNoiseCanvasFactory implements CanvasFactory {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>PerlinNoiseCanvasFactory</code> that fills the
   ...
   */
  public PerlinNoiseCanvasFactory(final ColorFactory color) {
    // ensure inheritance
    super();
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>PerlinNoiseCanvasFactory</code> that
   ** fills the background noise of {@link Color#BLACK} and {@link Color#WHITE}.
   **
   ** @return                    the created
   **                            <code>PerlinNoiseCanvasFactory</code>.
   **                            <br>
   **                            Possible object is
   **                            <code>PerlinNoiseCanvasFactory</code>.
   */
  public static PerlinNoiseCanvasFactory build() {
  ...
  // Method:   build
  /**
   ** Factory method to create an <code>PerlinNoiseCanvasFactory</code> that use
   ...
   **                            <code>PerlinNoiseCanvasFactory</code>.
   */
  public static PerlinNoiseCanvasFactory build(final ColorFactory color) {
    return new PerlinNoiseCanvasFactory(color);
  }
}