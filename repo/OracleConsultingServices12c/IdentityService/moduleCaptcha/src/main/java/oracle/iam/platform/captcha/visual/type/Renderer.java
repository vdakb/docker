...
public class Renderer implements Serializable {
  ...
  // compatible with
  @SuppressWarnings("compatibility:4885524743339993161")
  private static final long serialVersionUID = 9043681255740003103L;
   ...
   ** Default Value: 8...8
   */
  private Limit length   = new Limit(8, 8);
   ...
   ** Default Value: 8...8
   */
  private Limit color    = new Limit(8, 8);
   ...
   ** Default Value: 28...32
   */
  private Limit fontSize = new Limit(28, 32);
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Renderer</code> that allows use as a JavaBean.
   ** <br>
