...
////////////////////////////////////////////////////////////////////////////////
// abstract class AbstractConvolveImageOp
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** <code>AbstractConvolveImageOp</code> describes and implements
 ** single-input/single-output convolve operation performed on
 ...
 ** @since   1.0.0.0
 */
public abstract class AbstractConvolveImageOp<T extends AbstractConvolveImageOp> extends AbstractImageOp<T> {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>AbstractConvolveImageOp</code> that allows use as a
   ** JavaBean.
   ** <br>
