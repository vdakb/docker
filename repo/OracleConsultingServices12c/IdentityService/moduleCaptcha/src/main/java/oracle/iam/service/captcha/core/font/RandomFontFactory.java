...
public class RandomFontFactory implements FontFactory {
  ...
  protected Limit        limit  = new Limit(45, 45);
  ...
  public Font get(final int index) {
    ...
    int           size   = this.limit.lower();
    if (this.limit.upper() - this.limit.lower() > 0) {
      size += Digester.instance.nextInt(this.limit.upper()  - this.limit.lower());
    }
