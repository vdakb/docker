...
public class Margin implements Serializable {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-3997688312895284792")
  private static final long serialVersionUID = 8496475679491772432L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Margin</code> that allows use as a JavaBean.
   ** <br>
   ...
   **                            Allowed object is {@link Integer}.
   */
  public Margin(final Integer top, final Integer left, final Integer bottom, final Integer right) {
    // ensure inheritance
    super();
