...
public class Limit implements Serializable {
  ...
  // compatible with
  @SuppressWarnings("compatibility:3148405205388355340")
  private static final long serialVersionUID = -2513389965228865072L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Limit</code> bean that allows use as a JavaBean.
   ** <br>
   ...
   **                            Allowed object is {@link Integer}.
   */
  public Limit(final Integer lower, final Integer upper) {
    // ensure inheritance
    super();
