...
public class BadRequestException extends ProcessingException {
  ...
  /**
   ** The error keyword that indicates the the path attribute was missing.
   */
  public static final String NO_TARGET        = "noTraget";
  ...
  // compatible with
  @SuppressWarnings("compatibility:7435528862383219123")
  private static final long  serialVersionUID = -516949832850098611L;
  ...
  /**
   ** Factory method to create a new <code>BadRequestException</code> with the
   ** noTraget error keyword.
   ** <p>
   ** The path attribute was missing.
   ** <br>
   ...
   **                            <code>BadRequestException</code>.
   */
  public static BadRequestException noTarget(final String message) {
    return new BadRequestException(NO_TARGET, message);
  }
