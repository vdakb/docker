...
public class EnterpriseUser<T extends EnterpriseUser> implements Discoverable {
  ...
  @Attribute(description="Numeric or alphanumeric identifier assigned to a person, typically based on order of hire or association with an organization.", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String  employeeNumber;

  @JsonProperty("costCenter")
  @Attribute(description="Identifies the name of a cost center.", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String  costCenter;

  @JsonProperty("organization")
  @Attribute(description="Identifies the name of an organization.", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String  organization;

  @JsonProperty("division")
  @Attribute(description="Identifies the name of a division.", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String  division;

  @JsonProperty("department")
  @Attribute(description="Identifies the name of a department.", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String  department;

  @JsonProperty("manager")
  @Attribute(description="The User's manager.", required=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.organization, this.division, this.department, this.costCenter, this.employeeNumber, this.manager);
  }
   ...
   ** <p>
   ** Two <code>EnterpriseUser</code>s are considered equal if and only if they
   ** represent the same properties. As a consequence, two given
   ** <code>EnterpriseUser</code>s may be different even though they contain the
