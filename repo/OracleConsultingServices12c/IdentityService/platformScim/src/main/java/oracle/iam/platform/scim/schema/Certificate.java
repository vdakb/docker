...
public final class Certificate {
  ...
  @JsonProperty("value")
  @Attribute(description="The value of a X509 certificate.", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private byte[]  value;
