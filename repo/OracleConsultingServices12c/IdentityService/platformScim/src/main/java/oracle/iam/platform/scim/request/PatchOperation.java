...
public abstract class PatchOperation {
  ...
  public static final class AddOperation extends PatchOperation {
    ...
    private AddOperation(final @JsonProperty(value="path") Path path, final @JsonProperty(value="value", required=true) JsonNode value)
      ...
      // The operation MUST contain a "value" member whose content specifies the
      // value to be added.  The value MAY be a quoted value, or it may be a
      // JSON object containing the sub-attributes of the complex attribute
      // specified in the operation's "path".
      if (value == null || value.isNull() || ((value.isArray() || value.isObject()) && value.size() == 0))
        throw BadRequestException.invalidSyntax(ServiceBundle.string(ServiceError.PATCH_OPERATION_VALUE_NOTNULL));
      ...
      if(path == null && !value.isObject())
        throw BadRequestException.noTarget(ServiceBundle.string(ServiceError.PATCH_OPERATION_ADD_ARRAY));

      if(path != null) {
        for (Path.Element element : path) {
          if(element.filter() != null)
            throw BadRequestException.invalidPath(ServiceBundle.string(ServiceError.PATCH_OPERATION_ADD_PATH));
        }
      }
      this.value = value;
    }
     ...
     ** <p>
     ** Two <code>AddOperation</code>s filter are considered equal if and only
     ** if they represent the same properties. As a consequence, two given
     ** <code>AddOperation</code>s filter may be different even though they
  ...
  public static final class ReplaceOperation extends PatchOperation {
     ...
     */
    @JsonCreator
    private ReplaceOperation(final @JsonProperty(value="path") Path path, final @JsonProperty(value="value", required=true) JsonNode value)
      throws ProcessingException {
      ...
      // and a "scimType" error code of "noTarget".
      if (path == null && !value.isObject())
        throw BadRequestException.noTarget(ServiceBundle.string(ServiceError.PATCH_OPERATION_REPLACE_VALUE));
     ...
     ** the contract specified in {@link Object#equals(Object)}.
     ** <p>
     ** Two <code>ReplaceOperation</code>s filter are considered equal if and
     ** only if they represent the same properties. As a consequence, two given
     ** <code>ReplaceOperation</code>s filter may be different even though they
     ** contain the same set of names with the same values, but in a different
     ** order.
     **
     ** @param  other            the reference object with which to compare.
  ...
  public static final class RemoveOperation extends PatchOperation {
     ...
     ** the contract specified in {@link Object#equals(Object)}.
     ** <p>
     ** Two <code>RemoveOperation</code>s filter are considered equal if and
     ** only if they represent the same properties. As a consequence, two given
     ** <code>RemoveOperation</code>s filter may be different even though they
     ** contain the same set of names with the same values, but in a different
     ** order.
     **
     ** @param  other            the reference object with which to compare.
   ...
   **                            <br>
   **                            Possibe object is <code>PatchOperation</code>.
   **
   ** @throws ProcessingException if the path is invalid.
   */
   ...
   **                            Allowed object is {@link ObjectNode}.
   **
   ** @throws ProcessingException if the patch operation is invalid.
   */
