...
public final class Photo {
  ...
  @JsonProperty("type")
  @Attribute(description="A label indicating the attribute's function; e.g., 'photo' or 'thumbnail'.", required=false, caseExact=false, canonical={PHOTO, THUMBNAIL}, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String  type;

  @JsonProperty("value")
  @Attribute(description="URI of a photo of the User.", required=false, reference={Resource.EXTERNAL}, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private URI     value;
