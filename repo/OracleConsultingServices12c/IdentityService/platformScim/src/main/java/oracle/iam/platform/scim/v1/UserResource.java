...
import oracle.iam.platform.scim.schema.User;
 ...
 ** @since   1.0.0.0
 */
@Schema(id=UserResource.ID, name=ResourceContext.RESOURCE_TYPE_USER, description="User Account")
public final class UserResource extends User<UserResource> {
