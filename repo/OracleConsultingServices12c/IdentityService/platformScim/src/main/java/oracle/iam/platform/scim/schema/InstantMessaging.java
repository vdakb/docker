 ...
 ** @since   1.0.0.0
 */
public final class InstantMessaging {
  ...
  @Attribute(description="A Boolean value indicating the 'primary' or preferred attribute value for this attribute, e.g., the preferred messenger or primary messenger. The primary attribute value 'true' MUST appear no more than once.", required=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT)
  private Boolean primary;

  @JsonProperty("type")
  @Attribute(description="A label indicating the attribute's function; e.g., 'aim', 'gtalk', 'mobile' etc.", required=false, caseExact=false, canonical={AIM, GTALK, ICQ, XMPP, MSN, SKYPE, QQ, YAHOO}, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String  type;

  @JsonProperty("value")
  @Attribute(description="Instant messaging address for the User.", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
