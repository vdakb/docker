...
public final class Name {
  ...
  @Attribute(description="The full name, including all middle names, titles, and suffixes as appropriate, formatted for display (for example, Ms. Barbara J Jensen, III.).", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String formatted;

  @JsonProperty("familyName")
  @Attribute(description="The family name of the User, or Last Name in most Western languages (for example, Jensen given the full name Ms. Barbara J Jensen, III.).", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String familyName;

  @JsonProperty("givenName")
  @Attribute(description="The given name of the User, or First Name in most Western languages (for example, Barbara given the full name Ms. Barbara J Jensen, III.).", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String givenName;

  @JsonProperty("middleName")
  @Attribute(description="The middle name(s) of the User (for example, Robert given the full name Ms. Barbara J Jensen, III.).", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String middleName;

  @JsonProperty("honorificPrefix")
  @Attribute(description="The honorific prefix(es) of the User, or Title in most Western languages (for example, Ms. given the full name Ms. Barbara J Jensen, III.).", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String honorificPrefix;

  @JsonProperty("honorificSuffix")
  @Attribute(description="The honorific suffix(es) of the User, or Suffix in most Western languages (for example, III. given the full name Ms. Barbara J Jensen, III.)", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  ...
  public boolean equals(final Object other) {
    ...
    return Objects.equals(this.formatted,       that.formatted)
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   computeFormatted
  /**
   ** From this <code>Name</code> instance, it builds a string depicting a full
   ** name including all middle names, titles, and suffixes as appropriate for
   ** display if the {@link #formatted() formatted} field of this object is
   ** <code>null</code> or empty.
   **
   ** @return                    a string representing a full name.
   **                            <br>
   **                            The formatted field will be set to this value.
   */
  public String computeFormatted() {
    if (StringUtility.empty(this.formatted)) {
      final StringBuilder builder = new StringBuilder();
      if (!StringUtility.empty(this.honorificPrefix)) {
        builder.append(this.honorificPrefix).append(' ');
      }
      if (!StringUtility.empty(this.givenName)) {
        builder.append(this.givenName).append(' ');
      }
      if (!StringUtility.empty(this.middleName)) {
        builder.append(this.middleName).append(' ');
      }
      if (!StringUtility.empty(this.familyName)) {
        builder.append(this.familyName).append(' ');
      }
      if (!StringUtility.empty(this.honorificSuffix)) {
        builder.append(this.honorificSuffix);
      }
      this.formatted = builder.length() == 0 ? null : builder.toString().trim();
    }
    return this.formatted;
  }
}