 ...
 ** of a SCIM PATCH operation.
 ** <br>
 ** A path may also be used to describe which JSON values to get or set when
 ** manipulating SCIM resources using the
 ** {@link oracle.iam.platform.scim.schema.Generic Generic}
 ** class.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
...
public class Path implements Iterable<Path.Element> {
  ...
  public static final class Element {
    ...
    public boolean equals(final Object other) {
      ...
      if (!StringUtility.equalIgnoreCase(this.attribute, that.attribute)) {
        return false;
      }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.namespace == null ? null : this.namespace.toLowerCase(), this.element);
  }
  ...
  public boolean equals(final Object other) {
    ...
    return Objects.equals(this.namespace, that.namespace) && Objects.equals(this.element, that.element);
  }
  ...
  // Method:   normalized
  /**
   ** Returns a string representation of this <code>Path</code> without any
   ** filter expression of the elements.
   **
   ** @return                    a string representation of this
   **                            <code>Path</code>.
   **                            <br>
  ...
  public String normalized() {
    ...
    final Iterator<Element> i = this.element.iterator();
    while(i.hasNext()) {
      builder.append(i.next().attribute);
      if(i.hasNext()) {
        builder.append(".");
      }
    }
  ...
  public Path withoutFilters() {
    return new Path(this.namespace, this.element.stream().map(e -> new Element(e.attribute(), null)).collect(Collectors.toList()));
  }
}