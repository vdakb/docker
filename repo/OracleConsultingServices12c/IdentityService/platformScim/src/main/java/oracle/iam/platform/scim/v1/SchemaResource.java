 ...
 ** @since   1.0.0.0
 */
@Schema(id="urn:scim:schemas:core:1.0", name=ResourceContext.RESOURCE_TYPE_SCHEMA, description="SCIM 1.0 Schema Resource")
public class SchemaResource extends Entity<SchemaResource> {
  ...
  @JsonProperty("name")
  @Attribute(description="The schema's human readable name.", mutability=Mutability.READ_ONLY)
  private final String                          name;

  @JsonProperty("description")
  @Attribute(description="The schema's human readable description.", mutability=Mutability.READ_ONLY)
  private final String                          description;

  @JsonProperty("attributes")
  @Attribute(description="Attributes of the object described by this schema.", mutability=Mutability.READ_ONLY, multiValueClass=AttributeDefinition.class)
