...
public abstract class SchemaFactory {
   ...
   **                            {@link AttributeDefinition}.
   */
  public static Collection<AttributeDefinition> attributes(final Stack<String> visited, final Class<?> clazz) {
    ...
    for (Field cursor : properties) {
      ...
      Attribute.Type type = attributeType(property);
      factory.type(type);
      if (type == Attribute.Type.COMPLEX) {
        // add this class to the list to allow cycle detection
        visited.push(clazz.getCanonicalName());
        final Collection<AttributeDefinition> sub = attributes(visited, property);
   ...
   */
  public static AttributeDefinition.Factory addCaseExact(final AttributeDefinition.Factory factory, final Attribute property) {
    if (property != null) {
   ...
   **                            Possible object is {@link AttributeDefinition.Factory}.
   */
  private static AttributeDefinition.Factory addReturned(final AttributeDefinition.Factory factory, final Attribute property) {
    if (property != null) {
   ...
   **                            {@link AttributeDefinition.Factory}.
   */
  private static AttributeDefinition.Factory addUniqueness(final AttributeDefinition.Factory factory, final Attribute property) {
    if (property != null) {
  ...
  private static AttributeDefinition.Factory addMutability(final AttributeDefinition.Factory factory, final Attribute property) {
    if (property != null) {
      ...
      factory.mutability(Attribute.Mutability.READ_WRITE);
    }
    return factory;
  }
