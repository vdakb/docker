 ...
 ** <br>
 ** The core schema for <code>EnterpriseUser</code> is identified using the URI
...
public final class EnterpriseUserResource extends EnterpriseUser<EnterpriseUserResource>  {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>EnterpriseUserResource</code> SCIM Resource
