...
public interface ResponseHandler<T> {
   ...
   **
   ** @return                    the <code>ResponseHandler</code> to allow
   **                            method chaining.
   **                            <br>
   **                            Possible object is
   **                            <code>ResponseHandler</code>.
   */
  ResponseHandler start(final int value);
   ...
   **                            <code>ResponseHandler</code>.
   */
  ResponseHandler items(final int value);
   ...
   **                            <code>ResponseHandler</code>.
   */
  ResponseHandler total(final int value);
   ...
   **                            <code>ResponseHandler</code>.
   */
  ResponseHandler extension(final String namespace, final ObjectNode extension);
