...
// ~~~~~ ~~~~~~~~~~
/**
 ** A complex type that specifies etag configuration properties.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public class ETagConfig {
   ...
   ** <p>
   ** Two <code>ETagConfig</code>s are considered equal if and only if they
   ** represent the same properties. As a consequence, two given
   ** <code>ETagConfig</code>s may be different even though they contain the
  ...
  public boolean equals(final Object other) {
    ...
    final ETagConfig that = (ETagConfig)other;
