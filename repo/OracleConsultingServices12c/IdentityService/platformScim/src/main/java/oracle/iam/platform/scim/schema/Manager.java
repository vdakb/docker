...
public final class Manager {
  ...
  @JsonProperty("value")
  @Attribute(description="The id of the SCIM resource representing the User's manager.", required=true, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String value;

  @JsonProperty("displayName")
  @Attribute(description="The displayName of the User's manager.", required=false, caseExact=false, mutability=Mutability.READ_ONLY, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
  private String displayName;

  @JsonProperty("$ref")
  @Attribute(description="The URI of the SCIM resource representing the User's manager.", required=true, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE, reference={"User"} )
  private URI    ref;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.value, this.displayName, this.ref);
  }
