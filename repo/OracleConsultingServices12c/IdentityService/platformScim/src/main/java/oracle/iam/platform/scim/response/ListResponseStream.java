...
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~
/**
 ** Interface for streaming list/query results using the SCIM
...
public abstract class ListResponseStream<T extends Resource> implements StreamingOutput {
  ...
  public final void write(final OutputStream stream)
    ...
    final ListResponseWriter<T> handler = new ListResponseWriter<T>(stream).startResponse();
    write(handler);
    handler.endResponse();
  }
