 ...
 ** @since   1.0.0.0
 */
@JsonPropertyOrder({"supported","maxResults"})
public class FilterConfig {
  ...
  @Attribute(description="Integer value specifying the maximum number of resources returned in a response.", mutability=Mutability.READ_ONLY, required=true)
