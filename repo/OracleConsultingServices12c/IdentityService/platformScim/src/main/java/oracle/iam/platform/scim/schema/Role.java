...
// ~~~~~ ~~~~~ ~~~~
/**
 ** Stores role membership for the user.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public final class Role {
  ...
  @JsonProperty("value")
  @Attribute(description="The value of a role.", required=false, caseExact=false, mutability=Mutability.READ_WRITE, returned=Returned.DEFAULT, uniqueness=Uniqueness.NONE)
