/*
    ...
    File        :   ChangePasswordConfig.java
...
public class ChangePasswordConfig {
  ...
  // Method:   Ctor
  /**
   ** Constructs a new complex type that specifies Change Password configuration
   ** options.
   **
   ...
   ** <p>
   ** Two <code>ChangePasswordConfig</code>s are considered equal if and only if
   ** they represent the same properties. As a consequence, two given
   ** <code>ChangePasswordConfig</code>s may be different even though they
  ...
  public boolean equals(final Object other) {
    ...
    final ChangePasswordConfig that = (ChangePasswordConfig)other;
