/*
    ...
    File        :   MarshallingExceptionMapper.java
...
////////////////////////////////////////////////////////////////////////////////
// class MarshallingExceptionMapper
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** A JAX-RS {@link ExceptionMapper ExceptionMapper} converting
 ** {@link JsonProcessingException} to SCIM Error Responses.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
@Provider
public class MarshallingExceptionMapper implements ExceptionMapper<JsonProcessingException> {
   ...
   ** Default Constructor
   */
  public MarshallingExceptionMapper() {
    // ensure inheritance
    super();
  }
   ...
   */
  @Override
  public Response toResponse(final JsonProcessingException cause) {
    final ErrorResponse response = ErrorResponse.of(Response.Status.BAD_REQUEST.getStatusCode(), cause.getMessage());
    try {
