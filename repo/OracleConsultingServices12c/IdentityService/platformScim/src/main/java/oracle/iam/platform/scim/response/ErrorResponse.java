...
import oracle.hst.platform.rest.marshal.StatusSerializer;
import oracle.hst.platform.rest.marshal.StatusDeserializer;
...
public class ErrorResponse extends    Entity<ErrorResponse>
  ...
  // compatible with
  @SuppressWarnings("compatibility:461244967164181319")
  private static final long serialVersionUID = 75630667496697476L;
  ...
  @Attribute(description = "The HTTP status code.", mutability=Attribute.Mutability.READ_ONLY, required=true)
  private final int status;

  @JsonProperty("scimType")
  @Attribute(description="A SCIM detailed error keyword", mutability=Attribute.Mutability.READ_ONLY)
  private String    type;

  @JsonProperty("detail")
  @Attribute(description="A detailed, human readable message", mutability=Attribute.Mutability.READ_ONLY)
