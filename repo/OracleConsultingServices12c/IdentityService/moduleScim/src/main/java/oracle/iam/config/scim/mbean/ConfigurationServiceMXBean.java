...
package oracle.iam.config.scim.mbean;
...
// ~~~~~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** MXBean declaration for managing Identity Provider Discovery configuration.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public interface ConfigurationServiceMXBean {
  ...
  public static final String          BUNDLE = "oracle.iam.confi.scim.resources.ConfigurationBundle";
}