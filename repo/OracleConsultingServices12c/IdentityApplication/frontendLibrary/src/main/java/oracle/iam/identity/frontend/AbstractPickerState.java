...
////////////////////////////////////////////////////////////////////////////////
// abstract class AbstractPickerState
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~
/**
 ...
 ** @since   2.0.0.0
 */
public abstract class AbstractPickerState extends AbstractSearchState {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-5946166988516811210")
  private static final long            serialVersionUID = 6838031223428499301L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>AbstractPickerState</code> backing bean that allows use
   ** as a JavaBean.
   ** <br>
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Methode:   isAddAllDisabled
  /**
   ** Whether at least one row (aka Resource Object) is available.
   **
   ** @return                    <code>true</code> if at least on row is
   **                            available.
   */
  public boolean isAddAllDisabled() {
    return !iteratorHasRows("ResourceObjectVOIterator");
  }
