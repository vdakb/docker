...
////////////////////////////////////////////////////////////////////////////////
// abstract class AbstractSearchState
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~~~~
/**
 ...
 ** @since   2.0.0.0
 */
public abstract class AbstractSearchState extends AbstractStateBean {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-4459020566724220949")
  private static final long            serialVersionUID = 1744659797122778014L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>AbstractSearchState</code> managed bean that allows use
   ** as a JavaBean.
   ** <br>
   ...
   */
  protected AbstractSearchState(final String id, final String name) {
    // ensure inheritance
    super(id, name);
  }
   ...
   */
  protected AbstractSearchState(final String id, final String name, final String status) {
    // ensure inheritance
