 ...
 ** @since   2.0.0.0
 */
public class AbstractStateBean extends AbstractManagedBean {
  ...
  protected static final String BUNDLE                 = "oracle.iam.identity.bundle.Foundation";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:8619333190050104511")
  private static final long     serialVersionUID       = 3665841037316580754L;
   ...
   */
  protected AbstractStateBean(final String id, final String name) {
    // ensure inheritance
    this(id, name, null);
  }
   ...
   */
  protected AbstractStateBean(final String id, final String name, final String status) {
    // ensure inheritance
    super();
