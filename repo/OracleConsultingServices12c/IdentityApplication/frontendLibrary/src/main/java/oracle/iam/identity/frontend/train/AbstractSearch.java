 ...
 ** @since   2.0.0.0
 */
public abstract class AbstractSearch extends AbstractSearchState {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-1775789921434877938")
  private static final long            serialVersionUID = -2576537878240360397L;
  ...
  // Method:   revert
  /**
   ** Reverts all changes belonging to the search region of the
   ** <code>Entity</code>.
   */
  public void revert() {
    refreshRegion();
  ...
  /**
   ** Refresh the account relationships belonging to a certain
   ** <code>Entity</code>.
   **
