 ...
 ** @since   2.0.0.0
 */
public abstract class AbstractFlow extends AbstractStateBean {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-1365213204622626413")
  private static final long            serialVersionUID = -2928720949885195914L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>AbstractFlow</code> backing bean that allows
   ** use as a JavaBean.
   ** <br>
