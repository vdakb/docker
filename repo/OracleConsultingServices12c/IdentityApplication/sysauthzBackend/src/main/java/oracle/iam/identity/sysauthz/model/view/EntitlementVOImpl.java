...
////////////////////////////////////////////////////////////////////////////////
// class EntitlementVOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** The <code>View Object</code> to coordinate database queries and the view
 ** rows that result from executing queries belonging to Entitlements.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class EntitlementVOImpl extends OIMProgrammaticVO {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>EntitlementVOImpl</code> view object that allows use as
   ** a JavaBean.
   ** <br>
  ...
  /**
   * Returns the bind variable value for bindObjectKey.
   * @return bind variable value for bindObjectKey
   */
  public Long getbindObjectKey() {
    return (Long)getNamedWhereClauseParam("bindObjectKey");
  }

  /**
   * Sets <code>value</code> for bind variable bindObjectKey.
   * @param value value to bind as bindObjectKey
   */
  public void setbindObjectKey(Long value) {
    setNamedWhereClauseParam("bindObjectKey", value);
  }

  /**
   * Returns the bind variable value for bindItResourceKey.
   * @return bind variable value for bindItResourceKey
   */
  public Long getbindItResourceKey() {
    return (Long)getNamedWhereClauseParam("bindItResourceKey");
  }

  /**
   * Sets <code>value</code> for bind variable bindItResourceKey.
   * @param value value to bind as bindItResourceKey
   */
  public void setbindItResourceKey(Long value) {
    setNamedWhereClauseParam("bindItResourceKey", value);
  }
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createEntitlementDataProvider();
  }
}