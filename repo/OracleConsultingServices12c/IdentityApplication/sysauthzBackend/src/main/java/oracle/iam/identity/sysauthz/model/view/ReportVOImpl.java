 ...
 ** rows that result from executing queries belonging to Reports.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class ReportVOImpl extends OIMProgrammaticVO {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>ReportVOImpl</code> view object that allows use as
   ** a JavaBean.
   ** <br>
