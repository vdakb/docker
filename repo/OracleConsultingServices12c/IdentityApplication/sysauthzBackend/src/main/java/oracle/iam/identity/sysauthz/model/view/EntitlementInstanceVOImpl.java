/*
    ...
    File        :   EntitlementInstanceVOImpl.java
...
////////////////////////////////////////////////////////////////////////////////
// class EntitlementInstanceVOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>View Object</code> to coordinate database queries and the view
 ** rows that result from executing queries belonging to Entitlement Instances.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class EntitlementInstanceVOImpl extends OIMProgrammaticVO {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>EntitlementInstanceVOImpl</code> view object that allows use as
   ** a JavaBean.
   ** <br>
   ...
   ** Default Constructor
   */
  public EntitlementInstanceVOImpl() {
    // ensure inheritance
    super();
  }
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createEntitlementInstanceDataProvider();
  }
}