...
public class QueryProviderFactory {
  ...
  /** the location of the repository to load the SQL statements from */
  private static final String              REPOSITORY      = "META-INF/sql/sysauthz.sql";
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   preparedStatement
 public PreparedStatement preparedStatement(final String property, final Connection connection, final DatabaseFilter criteria) {
    try {
      final List<DatabaseParameter> arguments = new ArrayList<DatabaseParameter>();
      final String                  filter    = DatabaseStatement.prepareFilter(criteria, arguments);
