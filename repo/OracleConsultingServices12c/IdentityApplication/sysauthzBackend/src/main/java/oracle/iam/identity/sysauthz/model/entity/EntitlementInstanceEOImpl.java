/*
    ...
    File        :   EntitlementInstanceEOImpl.java
...
import oracle.iam.identity.sysauthz.schema.EntitlementInstanceAdapter;

////////////////////////////////////////////////////////////////////////////////
// class EntitlementInstanceEOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>Entity Object</code> to coordinate representations of database
 ** rows belonging to <code>Entitlement Instance</code>s.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class EntitlementInstanceEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>EntitlementInstanceEOImpl</code> values object
   ...
   ** Default Constructor
   */
  public EntitlementInstanceEOImpl() {
    // ensure inheritance
    super();
  }
   ...
   ** {@link EntitlementInstanceAdapter} which populates its attribute values
  ...
  public ModelAdapterBean toAdapterBean(final Row row) {
    return new EntitlementInstanceAdapter(row);
  }
   ...
   ** <code>oracle.iam.identity.sysauthz.model.entity.ApplicationInstanceEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysauthz.model.entity.EntitlementInstanceEO");
