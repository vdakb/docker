/*
    ...
    File        :   ApplicationInstanceEOImpl.java
...
////////////////////////////////////////////////////////////////////////////////
// class ApplicationInstanceEOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>Entity Object</code> to coordinate representations of database
 ** rows belonging to Application Instances.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class ApplicationInstanceEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>ApplicationInstanceEOImpl</code> values object
   ...
   ** Default Constructor
   */
  public ApplicationInstanceEOImpl() {
    // ensure inheritance
    super();
  }
  ...
  /**
   ** Factory method to create an instance of {@link ApplicationInstanceAdapter}
   ** which populates its attribute values from the specified {@link Row}.
   **
   ** @param  row                the record providing the raw data.
   **
   ** @return                    an instance of {@link ApplicationInstanceAdapter}.
   */
  @Override
  public ModelAdapterBean toAdapterBean(final Row row) {
    return new ApplicationInstanceAdapter(row);
  }
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createApplicationInstanceDataProvider();
  }
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysauthz.model.entity.ApplicationInstanceEO");
