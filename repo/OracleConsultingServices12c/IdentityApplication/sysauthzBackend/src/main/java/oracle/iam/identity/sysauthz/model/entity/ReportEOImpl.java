 ...
 ** @since   2.0.0.0
 */
public class ReportEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>ReportEOImpl</code> values object that allows
   ** use as a JavaBean.
   ** <br>
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createReportDataProvider();
  }
   ...
   **                            constituents.
   */
  public static Key createPrimaryKey(final String path) {
    return new Key(new Object[] {path});
  }
   ...
   ** <code>oracle.iam.identity.sysauthz.model.entity.ReportEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysauthz.model.entity.ReportEO");
