/*
    ...
    File        :   EndpointTypeAMClient.java
 ...
 ** @since   2.0.0.0
 */
public class EndpointTypeAMClient extends    ApplicationModuleImpl
  ...
  // compatible with
  @SuppressWarnings("compatibility:1887939758173807403")
  private static final long serialVersionUID = 8742229247006872538L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>EndpointTypeAMClient</code> application module that
  ...
  public void refreshEndpoint(final String identifier) {
    riInvokeExportedMethod(this, "refreshEndpoint", new String [] {"java.lang.String"}, new Object[] {identifier});
  }
}