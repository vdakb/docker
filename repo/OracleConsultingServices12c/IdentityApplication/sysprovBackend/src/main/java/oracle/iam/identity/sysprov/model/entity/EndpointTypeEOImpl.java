 ...
 ** @since   2.0.0.0
 */
public class EndpointTypeEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>EndpointTypeEOImpl</code> values object that
  ...
  /**
   ** Factory method to create an instance of {@link EndpointTypeAdapter} which
   ** populates its attribute values from the specified {@link Row}.
   **
   ** @param  row                the record providing the raw data.
   **                            <br>
   **                            Allowed object is {@link Row}.
   **
   ** @return                    an instance of {@link EndpointTypeAdapter}.
   **                            <br>
   **                            Possible object is {@link ModelAdapterBean}.
   */
  @Override
  public ModelAdapterBean toAdapterBean(final Row row) {
    return new EndpointTypeAdapter(row);
  }
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createEndpointTypeDataProvider();
  }
   ...
   ** <code>oracle.iam.identity.sysprov.model.entity.EndpointTypeEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysprov.model.entity.EndpointTypeEO");
