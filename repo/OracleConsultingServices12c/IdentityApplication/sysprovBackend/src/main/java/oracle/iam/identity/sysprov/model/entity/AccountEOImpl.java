...
import oracle.iam.identity.sysprov.schema.AccountAdapter;
 ...
 ** @since   2.0.0.0
 */
public class AccountEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>AccountEOImpl</code> values object that allows
   ** use as a JavaBean.
   ** <br>
  ...
  /**
   ** Factory method to create an instance of {@link AccountAdapter}
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createAccountDataProvider();
  }
   ...
   ** <code>oracle.iam.identity.sysprov.model.entity.AccountEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysprov.model.entity.AccountEO");
