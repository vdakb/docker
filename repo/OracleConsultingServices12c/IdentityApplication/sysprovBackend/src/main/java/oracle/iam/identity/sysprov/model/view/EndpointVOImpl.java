 ...
 ** @since   2.0.0.0
 */
public class EndpointVOImpl extends OIMProgrammaticVO {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>EndpointVOImpl</code> view object that allows use as
   ** a JavaBean.
   ** <br>
