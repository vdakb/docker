/*
    ...
    File        :   EndpointTypeParameterAdapter.java
...
////////////////////////////////////////////////////////////////////////////////
// class EndpointTypeParameterAdapter
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** Data Access Object used by by <code>IT Resource Type</code> customization.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class EndpointTypeParameterAdapter extends StaticModelAdapterBean {
  ...
  public static final String FK               = "Bind_endpointTypeKey";
  ...
  // compatible with
  @SuppressWarnings("compatibility:-2301249976972137766")
  private static final long  serialVersionUID = 5499023009084475133L;
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>EndpointTypeParameterAdapter</code> values
   ...
   ** Default Constructor
   */
  public EndpointTypeParameterAdapter() {
    // ensure inheritance
    super();
  }
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>EndpointTypeParameterAdapter</code> values object which
   ...
   */
  public EndpointTypeParameterAdapter(final Row row) {
    // ensure inheritance
    super(row);
  }
   ...
   */
  public EndpointTypeParameterAdapter(final Row row, final boolean deferChildren) {
    // ensure inheritance
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>EndpointTypeParameterAdapter</code> values object that
   ** belongs to the specified {@link EndpointTypeAdapter} identifier.
   **
   ...
   */
  private EndpointTypeParameterAdapter(final Long endpointTypeKey) {
    // ensure inheritance
    super();

    // initialize instance attributes
    this.endpointTypeKey = endpointTypeKey;
  }
  ...
  // Methode:   build
  /**
   ** Factory method to create a <code>EndpointTypeParameterAdapter</code> with
   ** an identifier.
   **
   ** @param  endpointTypeKey    the {@link EndpointTypeAdapter} identifier the
   **                            parameter to build belongs to.
   ...
   */
  public static EndpointTypeParameterAdapter build(final Long endpointTypeKey) {
    return new EndpointTypeParameterAdapter(endpointTypeKey);
  }
   ...
   ** <p>
   ** Two <code>EndpointTypeParameterAdapter</code>s are considered equal if and
   ** only if they represent the same scope. As a consequence, two given
   ** <code>EndpointTypeParameterAdapter</code>s may be different even though
  ...
  public boolean equals(final Object other) {
    ...
    final EndpointTypeParameterAdapter that = (EndpointTypeParameterAdapter)other;
