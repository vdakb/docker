...
// ~~~~~ ~~~~~~~~~~~~~
/**
 ** Data Access Object used by System Provisioning customization to access
...
public class LegacyAdapter extends ResultSetModelAdapterBean {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-6945680218043124565")
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>LegacyAdapter</code> values object that
  ...
  protected void processRow(final Row row, final boolean deferChildren) {
    ...
    for (String cursor : attributes) {
      ...
      String name = (String)row.getStructureDef().findAttributeDef(cursor).getProperty("OIM_ATTRIBUTE");
      if (name == null) {
        name = cursor;
      }
