/*
    ...
    File        :   EndpointAdministratorEOImpl.java
...
////////////////////////////////////////////////////////////////////////////////
// class EndpointAdministratorEOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ...
 ** @since   2.0.0.0
 */
public class EndpointAdministratorEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>EndpointAdministratorEOImpl</code> values object that
   ...
   ** Default Constructor
   */
  public EndpointAdministratorEOImpl() {
    // ensure inheritance
    super();
  }
  ...
  /**
   ** Factory method to create an instance of {@link EndpointAdministratorAdapter}
  ...
  public ModelAdapterBean toAdapterBean(final Row row) {
    return new EndpointAdministratorAdapter(row);
  }
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createEndpointAdministratorDataProvider();
  }
   ...
   **
   ** @param  endpointKey        the value to embed in the primary key.
   **                            <br>
   ...
   */
  public static Key createPrimaryKey(final Long endpointKey, final Long groupKey) {
    return new Key(new Object[] {endpointKey, groupKey});
  }
   ...
   ** <code>oracle.iam.identity.sysprov.model.entity.EndpointAdministratorEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysprov.model.entity.EndpointAdministratorEO");
