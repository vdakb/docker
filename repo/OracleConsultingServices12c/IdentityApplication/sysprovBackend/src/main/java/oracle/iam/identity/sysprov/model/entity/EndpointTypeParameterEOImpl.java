/*
    ...
    File        :   EndpointTypeParameterEOImpl.java
...
////////////////////////////////////////////////////////////////////////////////
// class EndpointTypeParameterEOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>Entity Object</code> to coordinate representations of database
 ** rows belonging to <code>IT Resource Type Parameter</code>s.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class EndpointTypeParameterEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>EndpointTypeParameterEOImpl</code> values object
   ...
   ** Default Constructor
   */
  public EndpointTypeParameterEOImpl() {
    // ensure inheritance
    super();
  }
   ...
   ** {@link EndpointTypeParameterAdapter} which populates its attribute values
  ...
  public ModelAdapterBean toAdapterBean(final Row row) {
    return new EndpointTypeParameterAdapter(row);
  }
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createEndpointTypeParameterDataProvider();
  }
   ...
   ** <code>oracle.iam.identity.sysprov.model.entity.EndpointTypeParameterEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysprov.model.entity.EndpointTypeParameterEO");
