/*
    ...
    File        :   ReconciliationEventHistoryEOImpl.java
    ...
    Purpose     :   This file implements the class
                    ReconciliationEventHistoryEOImpl.
...
import oracle.iam.identity.sysprov.schema.ReconciliationEventHistoryAdapter;

////////////////////////////////////////////////////////////////////////////////
// class ReconciliationEventHistoryEOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>Entity Object</code> to coordinate representations of database
 ** rows belonging to Reconciliation Event Histories.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class ReconciliationEventHistoryEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>ReconciliationEventHistoryEOImpl</code> values
   ...
   ** Default Constructor
   */
  public ReconciliationEventHistoryEOImpl() {
    // ensure inheritance
    super();
  }
   ...
   ** {@link ReconciliationEventHistoryAdapter} which populates its attribute
   ** values from the specified {@link Row}.
   **
  ...
  public ModelAdapterBean toAdapterBean(final Row row) {
    return new ReconciliationEventHistoryAdapter(row);
  }
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createReconciliationEventHistoryDataProvider();
  }
   ...
   **
   ** @param  value              the value to embed in the primary key.
   **                            <br>
   ...
   */
  public static Key createPrimaryKey(final Long value) {
   ...
   ** <code>oracle.iam.identity.sysprov.model.entity.ReconciliationEventHistoryEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysprov.model.entity.ReconciliationEventHistoryEO");
