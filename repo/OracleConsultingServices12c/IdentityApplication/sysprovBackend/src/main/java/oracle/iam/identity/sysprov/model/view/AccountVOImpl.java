 ...
 ** rows that result from executing queries belonging to Accounts.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class AccountVOImpl extends OIMProgrammaticVO {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>AccountVOImpl</code> view object that allows use as a
   ** JavaBean.
   ** <br>
