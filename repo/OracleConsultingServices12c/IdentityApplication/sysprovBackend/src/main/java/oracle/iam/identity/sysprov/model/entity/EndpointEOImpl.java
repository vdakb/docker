 ...
 ** @since   2.0.0.0
 */
public class EndpointEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>EndpointEOImpl</code> values object that allows
   ** use as a JavaBean.
   ** <br>
  ...
  /**
   ** Factory method to create an instance of {@link EndpointAdapter}
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createEndpointDataProvider();
  }
   ...
   ** <code>oracle.iam.identity.sysprov.model.entity.EndpointEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysprov.model.entity.EndpointEO");
