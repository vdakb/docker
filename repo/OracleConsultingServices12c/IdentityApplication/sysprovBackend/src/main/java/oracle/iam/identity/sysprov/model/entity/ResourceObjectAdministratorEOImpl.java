/*
    ...
    File        :   ResourceObjectAdministratorEOImpl.java
    ...
    Purpose     :   This file implements the class
                    ResourceObjectAdministratorEOImpl.
...
package oracle.iam.identity.sysprov.model.entity;
...
import oracle.iam.identity.sysprov.schema.DataProviderFactory;
import oracle.iam.identity.sysprov.schema.ResourceObjectAdministratorAdapter;

////////////////////////////////////////////////////////////////////////////////
// class ResourceObjectAdministratorEOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>Entity Object</code> to coordinate representations of database
 ** rows belonging to <code>IT Resource</code> Administrators.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class ResourceObjectAdministratorEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>ResourceObjectAdministratorEOImpl</code> values
   ...
   ** Default Constructor
   */
  public ResourceObjectAdministratorEOImpl() {
    // ensure inheritance
    super();
  }
  ...
  /**
   ** Factory method to create an instance of {@link ResourceObjectAdministratorAdapter}
   ...
   **                            <br>
   **                            Possible object is {@link ModelAdapterBean}.
   */
  @Override
  public ModelAdapterBean toAdapterBean(final Row row) {
    return new ResourceObjectAdministratorAdapter(row);
  }
   ...
   **                            <br>
   **                            Possible object is {@link DataProvider} as of
   **                            type {@link ModelAdapterBean}.
   */
  @Override
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createResourceObjectAdministratorDataProvider();
  }
   ...
   **
   **
   ** @param  objectKey          the value to embed in the primary key.
   **                            <br>
   **                            Allowed object is {@link Long}.
   ** @param  groupKey           the value to embed in the primary key.
   **                            <br>
   **                            Allowed object is {@link Long}.
   **
   ...
   */
  public static Key createPrimaryKey(final Long objectKey, final Long groupKey) {
    return new Key(new Object[] {objectKey, groupKey});
  }
   ...
   ** <code>oracle.iam.identity.sysprov.model.entity.ResourceObjectAdministratorEO</code>
   ...
   **                            <code>oracle.iam.identity.sysprov.model.entity.ResourceObjectAdministratorEO</code>
   **                            <br>
   **                            Possible object is {@link EntityDefImpl}.
   */
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysprov.model.entity.ResourceObjectAdministratorEO");
