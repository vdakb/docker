/*
    ...
    File        :   ReconciliationProfileEOImpl.java
...
////////////////////////////////////////////////////////////////////////////////
// class ReconciliationProfileEOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>Entity Object</code> to coordinate representations of database
 ** rows belonging to <code>Reconciliation Profile</code>.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class ReconciliationProfileEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>ReconciliationProfileEOImpl</code> values object
   ...
   ** Default Constructor
   */
  public ReconciliationProfileEOImpl() {
    // ensure inheritance
    super();
  }
   ...
   ** {@link ReconciliationProfileAdapter} which populates its attribute values
   ** from the specified {@link Row}.
   **
  ...
  public ModelAdapterBean toAdapterBean(final Row row) {
    return new ReconciliationProfileAdapter(row);
  }
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createReconciliationProfileDataProvider();
  }
   ...
   **
   ** @param  object             the value to embed in the primary key.
   **                            <br>
   **                            Allowed object is {@link String}.
   ** @param  attribute          the value to embed in the primary key.
   **                            <br>
   **                            Allowed object is {@link String}.
   **
   ...
   */
  public static Key createPrimaryKey(final String object, final String attribute) {
    return new Key(new Object[] {object, attribute});
  }
   ...
   ** <code>oracle.iam.identity.sysprov.model.entity.ReconciliationProfileEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysprov.model.entity.ReconciliationProfileEO");
