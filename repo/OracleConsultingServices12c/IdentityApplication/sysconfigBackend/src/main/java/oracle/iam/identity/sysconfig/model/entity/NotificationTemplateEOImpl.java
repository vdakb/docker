/*
    ...
    File        :   NotificationTemplateEOImpl.java
...
package oracle.iam.identity.sysconfig.model.entity;
...
import oracle.iam.identity.sysconfig.schema.DataProviderFactory;
import oracle.iam.identity.sysconfig.schema.NotificationTemplateAdapter;

////////////////////////////////////////////////////////////////////////////////
// class NotificationTemplateEOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>Entity Object</code> to coordinate representations of database
 ** rows belonging to <code>Notification Template</code>s.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class NotificationTemplateEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>NotificationTemplateEOImpl</code> values object
   ...
   ** Default Constructor
   */
  public NotificationTemplateEOImpl() {
    // ensure inheritance
    super();
  }
   ...
   ** {@link NotificationTemplateAdapter} which populates its attribute values
  ...
  public ModelAdapterBean toAdapterBean(final Row row) {
    return new NotificationTemplateAdapter(row);
  }
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createNotificationTemplateDataProvider();
  }
   ...
   **
   ** @param  value              the value to embed in the unique key.
   **
   ...
   ** <code>oracle.iam.identity.sysconfig.model.entity.NotificationTemplateEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysconfig.model.entity.NotificationTemplateEO");
