 ...
 ** rows belonging to <code>Lookup Definition</code>s.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class LookupEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>LookupEOImpl</code> values object that allows
   ** use as a JavaBean.
   ** <br>
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createLookupDataProvider();
  }
   ...
   ** <code>oracle.iam.identity.sysconfig.model.entity.LookupEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysconfig.model.entity.LookupEO");
