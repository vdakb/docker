 ...
 ** rows belonging to <code>Lookup Value</code>s.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class LookupValueEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>LookupValueEOImpl</code> values object that
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createLookupValueDataProvider();
  }
   ...
   **
   ** @param  lku                the value to embed in the primary key.
   **                            Allowed object is {@link Long}.
   ** @param  lkv                the value to embed in the primary key.
   **                            Allowed object is {@link Long}.
   **
   ** @return                    a {@link Key} object based on given key
   **                            constituents.
   */
  public static Key createPrimaryKey(final Long lku, final Long lkv) {
    return new Key(new Object[] {lku, lkv});
  }
   ...
   ** <code>oracle.iam.identity.sysconfig.model.entity.LookupValueEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysconfig.model.entity.LookupValueEO");
