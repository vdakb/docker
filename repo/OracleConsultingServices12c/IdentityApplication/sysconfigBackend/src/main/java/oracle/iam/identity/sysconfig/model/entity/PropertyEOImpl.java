 ...
 ** @since   2.0.0.0
 */
public class PropertyEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>PropertyEOImpl</code> values object that allows
   ** use as a JavaBean.
   ** <br>
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createPropertyDataProvider();
  }
   ...
   ** <code>oracle.iam.identity.sysconfig.model.entity.PropertyEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysconfig.model.entity.PropertyEO");
