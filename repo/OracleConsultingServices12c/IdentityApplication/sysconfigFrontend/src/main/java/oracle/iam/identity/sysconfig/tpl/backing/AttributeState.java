...
package oracle.iam.identity.sysconfig.tpl.backing;
...
import oracle.iam.identity.sysconfig.tpl.state.Train;
 ...
 ** values of <code>Notification Template</code>s.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 2.0.0.0
 ** @since   2.0.0.0
...
public class AttributeState extends AbstractStep {
  ...
  public static final String           DETAIL_ITERATOR  = "TemplateIterator";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:2053821642713561070")
  private static final long serialVersionUID = -4960835593285279122L;
  ...
  private transient ComponentReference templateName;
   ...
   **                            component belonging to the template name.
   **                            Allowed object is {@link RichInputText}.
   */
  public void setTemplateName(final RichInputText component) {
    this.templateName = ComponentReference.newUIComponentReference(component);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Methode:   getTemplateName
  /**
   ...
   */
  public RichInputText getTemplateName() {
    return (this.templateName != null) ? (RichInputText)this.templateName.getComponent() : null;
  }
  ...
  public final void changed(final ValueChangeEvent event) {
    JSF.valueFromExpression("#{pageFlowScope.templateTrain}", Train.class).markDirty();
  ...
  // Method:   refresh
  /**
   ** Refreshs the attribute region of the <code>template</code>.
   */
  private void refresh() {
    // if Template name changed, update tab name and title
    final String name  = ADF.iteratorBindingValue(DETAIL_ITERATOR, NotificationTemplateAdapter.NAME, String.class);
