...
package oracle.iam.identity.sysconfig.pty.backing;
...
import oracle.iam.identity.sysconfig.pty.state.Train;
 ...
 ** values of <code>Properties</code>.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 2.0.0.0
 ** @since   2.0.0.0
...
public class AttributeState extends AbstractStep {
  ...
  public static final String           DETAIL_ITERATOR  = "PropertyIterator";

  private static final String          BUNDLE           = "oracle.iam.identity.bundle.Configuration";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:-5100377957538763816")
  private static final long            serialVersionUID = 4474030509196383872L;

  //////////////////////////////////////////////////////////////////////////////
  // instance attributes
  //////////////////////////////////////////////////////////////////////////////

  private transient ComponentReference propertyName;
   ...
   */
  public void setPropertyName(final RichInputText component) {
    this.propertyName = ComponentReference.newUIComponentReference(component);
  }
   ...
   */
  public RichInputText getPropertyName() {
    return (this.propertyName != null) ? (RichInputText)this.propertyName.getComponent() : null;
  }
  ...
  public final void changed(final ValueChangeEvent event) {
    JSF.valueFromExpression("#{pageFlowScope.propertyTrain}", Train.class).markDirty();
  ...
  // Method:   refresh
  /**
   ** Refreshs the attribute region of the <code>property</code>.
   */
  private void refresh() {
    // if Property name changed, update tab name and title
    final String name  = ADF.iteratorBindingValue(DETAIL_ITERATOR, PropertyAdapter.NAME, String.class);
