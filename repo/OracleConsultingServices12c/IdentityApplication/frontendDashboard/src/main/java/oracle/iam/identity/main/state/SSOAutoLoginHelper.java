...
public class SSOAutoLoginHelper extends oracle.iam.ui.platform.view.backing.SSOAutoLoginHelper {
  ...
  private final static String DEFAULT_REDIRECTION_URL       = "/sysauthz/faces/home";
  private static final String ADF_LOGOUT_SERVLET_URL_SUFFIX = "/sysauthz/adfAuthentication?logout=true&end_url=";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:4795235768197053991")
  private static final long   serialVersionUID              = -5175391431567980493L;
  ...
  private AutoLoginResponse doAutologin(HttpServletRequest request, String protectedUrl, String userLoginId, String userPasswd, Boolean passwordResetSuccessSSOFlow)
    ...
    String resourceHost = request.getServerName();
    int resourcePort = request.getServerPort();
