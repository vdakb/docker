 ...
 ** values of <code>Scheduler Task</code>.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 2.0.0.0
 ** @since   2.0.0.0
...
public class AttributeState extends AbstractStep {
  ...
  public static final String DETAIL_ITERATOR  = "TaskIterator";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:9100184942212264881")
  private static final long  serialVersionUID = 2612616449386861009L;
  ...
  public final void changed(final ValueChangeEvent event) {
    JSF.valueFromExpression("#{pageFlowScope.taskTrain}", Train.class).markDirty();
