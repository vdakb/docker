...
public class Picker extends AbstractPickerState {
  ...
  // compatible with
  @SuppressWarnings("compatibility:2123469303719600372")
  private static final long serialVersionUID = 377550461928260616L;

  //////////////////////////////////////////////////////////////////////////////
  // instance attributes
  //////////////////////////////////////////////////////////////////////////////

  private List<TaskAdapter> selectedItems    = new ArrayList<TaskAdapter>();
   ...
   */
  public List<TaskAdapter> getSelectedItems() {
  ...
  public void addAllActionListener(final ActionEvent event) {
    final List<Row> selection = iteratorAllRow("TaskVOIterator");
  ...
  public void removeSelectedActionListener(final ActionEvent event) {
    ...
    List<TaskAdapter> removeRows = new ArrayList<TaskAdapter>();
    for (Iterator<Object> i = keys.iterator(); i.hasNext(); ) {
      Object key = i.next();
      rtt.setRowKey(key);
      TaskAdapter rowData = (TaskAdapter)rtt.getRowData();
  ...
  protected void addSelection(final List<Row> selection) {
    for (Row row : selection) {
      final TaskAdapter obj = new TaskAdapter(row);
