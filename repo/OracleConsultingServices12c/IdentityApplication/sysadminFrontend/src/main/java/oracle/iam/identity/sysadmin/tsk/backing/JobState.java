 ...
 ** <code>Job</code>s of an <code>Scheduler Task</code>.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 2.0.0.0
 ** @since   2.0.0.0
 */
public class JobState extends AbstractSearch {
  ...
  // compatible with
  @SuppressWarnings("compatibility:2900968228692204815")
  private static final long serialVersionUID = 648501091063338171L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>JobState</code> backing bean that allows use as a
   ** JavaBean.
   ** <br>
   ...
   ** Job Detail taskflow which renders the details of the associated Scheduler
   ** Job for the selected job.
   **
  ...
  public String detail(final @SuppressWarnings("unused") ActionEvent event) {
    ...
    final String              jobName    = (String)row.getAttribute(JobAdapter.PK);
    ...
    raiseTaskFlowLaunchEvent(taskFlowId, "/WEB-INF/oracle/iam/identity/sysadmin/job/flow/train-tf.xml#train-tf", jobName, null, null, ConstantsDefinition.HELP_TOPIC_ID_ADM_SYSMAN_SCHED, false, parameter);
    return null;
  }
  ...
  private void refresh() {
    ...
    ADF.executeOperation("refreshJob", parameter);
  }
}