...
import oracle.iam.identity.sysadmin.orp.state.Train;
...
public class AttributeState extends AbstractStep {
  ...
  // compatible with
  @SuppressWarnings("compatibility:2360543330594783743")
  private static final long serialVersionUID = 2452202137313961811L;
  ...
  public final void changed(final ValueChangeEvent event) {
    JSF.valueFromExpression("#{pageFlowScope.orchestrationTrain}", Train.class).markDirty();
