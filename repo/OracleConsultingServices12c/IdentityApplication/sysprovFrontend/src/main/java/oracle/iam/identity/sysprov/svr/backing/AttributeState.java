...
public class AttributeState extends AbstractStep {
  ...
  public static final String DETAIL_ITERATOR  = "EndpointIterator";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:8118975101021042890")
  private static final long  serialVersionUID = 9052721203477390477L;
  ...
  public final void changed(final ValueChangeEvent event) {
    JSF.valueFromExpression("#{pageFlowScope.endpointTrain}", Train.class).markDirty();
