...
public class Picker extends AbstractPickerState {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-5456981835496979002")
  private static final long           serialVersionUID = -5966758158068140382L;

  //////////////////////////////////////////////////////////////////////////////
  // instance attributes
  //////////////////////////////////////////////////////////////////////////////

  private List<ResourceObjectAdapter> selectedItems    = new ArrayList<ResourceObjectAdapter>();
   ...
   */
  public List<ResourceObjectAdapter> getSelectedItems() {
  ...
  public void addAllActionListener(final ActionEvent event) {
    final List<Row> selection = iteratorAllRow("ResourceObjectIterator");
  ...
  public void removeSelectedActionListener(final ActionEvent event) {
    ...
    List<ResourceObjectAdapter> removeRows = new ArrayList<ResourceObjectAdapter>();
    for (Iterator<Object> i = keys.iterator(); i.hasNext(); ) {
      Object key = i.next();
      rtt.setRowKey(key);
      ResourceObjectAdapter rowData = (ResourceObjectAdapter)rtt.getRowData();
  ...
  protected void addSelection(final List<Row> selection) {
    for (Row row : selection) {
      final ResourceObjectAdapter obj = new ResourceObjectAdapter(row);
