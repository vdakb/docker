...
public class AttributeState extends AbstractStep {
  ...
  public static final String DETAIL_ITERATOR  = "EndpointTypeIterator";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:-5936280568109068577")
  private static final long  serialVersionUID = 8882249326881091429L;
  ...
  public final void changed(final ValueChangeEvent event) {
    JSF.valueFromExpression("#{pageFlowScope.endpointTypeTrain}", Train.class).markDirty();
