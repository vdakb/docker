/*
    ...
    File        :   OrchestrationEventEOImpl.java
...
package oracle.iam.identity.sysadmin.model.entity;
...
import oracle.iam.identity.sysadmin.schema.OrchestrationEventAdapter;

////////////////////////////////////////////////////////////////////////////////
// class OrchestrationEventEOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>Entity Object</code> to coordinate representations of database
 ** rows belonging to Orchestration Events.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class OrchestrationEventEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>OrchestrationEventEOImpl</code> values object
   ...
   ** Default Constructor
   */
  public OrchestrationEventEOImpl() {
    // ensure inheritance
    super();
  }
  ...
  /**
   ** Factory method to create an instance of {@link OrchestrationEventAdapter}
   ** which populates its attribute values from the specified {@link Row}.
   **
   ** @param  row                the record providing the raw data.
   **
   ** @return                    an instance of {@link OrchestrationEventAdapter}.
   */
  @Override
  public ModelAdapterBean toAdapterBean(final Row row) {
    return new OrchestrationEventAdapter(row);
  }
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createOrchestrationEventDataProvider();
  }
   ...
   **
   ** @param  processId          the value to embed in the primary key
   **                            constituent belonging to the process of the
   **                            orchestration event.
   **                            Allowed object is {@link Long}.
   ** @param  eventId            the value to embed in the primary key
   ...
   **                            constituents.
   */
  public static Key createPrimaryKey(final Long processId, final Long eventId) {
    return new Key(new Object[]{processId, eventId});
  }
   ...
   ** <code>oracle.iam.identity.sysadmin.model.entity.OrchestrationEventEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysadmin.model.entity.OrchestrationEventEO");
