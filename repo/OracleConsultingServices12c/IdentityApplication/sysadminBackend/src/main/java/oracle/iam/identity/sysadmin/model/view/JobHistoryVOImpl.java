 ...
 ** @since   2.0.0.0
 */
public class JobHistoryVOImpl extends OIMProgrammaticVO {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>JobHistoryVOImpl</code> view object that allows use as
   ** a JavaBean.
   ** <br>
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createJobHistoryDataProvider(this);
  }
}