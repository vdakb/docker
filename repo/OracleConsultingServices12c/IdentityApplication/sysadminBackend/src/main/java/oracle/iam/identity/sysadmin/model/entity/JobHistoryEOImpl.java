 ...
 ** @since   2.0.0.0
 */
public class JobHistoryEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>JobHistoryEOImpl</code> values object that allows
   ** use as a JavaBean.
   ** <br>
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createJobHistoryDataProvider();
  }
   ...
   **
   ** @param  historyId          the value to embed in the primary key
   ...
   **                            constituents.
   */
  public static Key createPrimaryKey(final Double historyId) {
   ...
   ** <code>oracle.iam.identity.sysadmin.model.entity.JobHistoryEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysadmin.model.entity.JobHistoryEO");
