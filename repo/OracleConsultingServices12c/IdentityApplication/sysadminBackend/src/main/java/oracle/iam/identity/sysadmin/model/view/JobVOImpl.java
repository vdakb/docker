 ...
 ** @since   2.0.0.0
 */
public class JobVOImpl extends OIMProgrammaticVO {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>JobVOImpl</code> view object that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createJobDataProvider(this);
  }
}