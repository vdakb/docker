 ...
 ** rows belonging to Scheduler Jobs.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class JobEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>JobEOImpl</code> values object that allows use
   ** as a JavaBean.
   ** <br>
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createJobDataProvider();
  }
   ...
   ** <code>oracle.iam.identity.sysadmin.model.entity.JobEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysadmin.model.entity.JobEO");
