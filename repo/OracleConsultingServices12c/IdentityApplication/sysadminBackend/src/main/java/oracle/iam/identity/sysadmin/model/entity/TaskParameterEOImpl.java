 ...
 ** @since   2.0.0.0
 */
public class TaskParameterEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>TaskParameterEOImpl</code> values object that
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createTaskParameterDataProvider();
  }
   ...
   **                            constituents.
   */
  public static Key createPrimaryKey(final String name) {
   ...
   ** <code>oracle.iam.identity.sysadmin.model.entity.TaskParameterEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysadmin.model.entity.TaskParameterEO");
