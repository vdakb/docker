 ...
 ** rows belonging to Scheduler Tasks.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class TaskEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>TaskEOImpl</code> values object
   ...
   ** <code>oracle.iam.identity.sysadmin.model.entity.TaskEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysadmin.model.entity.TaskEO");
