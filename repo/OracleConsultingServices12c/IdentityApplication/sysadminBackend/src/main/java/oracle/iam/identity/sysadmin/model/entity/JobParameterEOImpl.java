 ...
 ** @since   2.0.0.0
 */
public class JobParameterEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>JobParameterEOImpl</code> values object that
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createJobParameterDataProvider();
  }
   ...
   **
   ** @param  parameterKey       the value to embed in the primary key
   **                            constituent belonging to the history item.
   **                            Allowed object is {@link String}.
   **
   ** @return                    a {@link Key} object based on given key
   **                            constituents.
   */
  public static Key createPrimaryKey(final String parameterKey) {
    return new Key(new Object[]{parameterKey});
  }
   ...
   ** <code>oracle.iam.identity.sysadmin.model.entity.JobParameterEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysadmin.model.entity.JobParameterEO");
