/*
    ...
    File        :   OrchestrationProcessEOImpl.java
...
////////////////////////////////////////////////////////////////////////////////
// class OrchestrationProcessEOImpl
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The <code>Entity Object</code> to coordinate representations of database
 ** rows belonging to Orchestration Processes.
 ** <p>
 ...
 ** @since   2.0.0.0
 */
public class OrchestrationProcessEOImpl extends OIMProgrammaticEO {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>OrchestrationProcessEOImpl</code> values object
   ...
   ** Default Constructor
   */
  public OrchestrationProcessEOImpl() {
    // ensure inheritance
    super();
  }
  ...
  /**
   ** Factory method to create an instance of {@link OrchestrationProcessAdapter}
   ** which populates its attribute values from the specified {@link Row}.
   **
   ** @param  row                the record providing the raw data.
   **
   ** @return                    an instance of {@link OrchestrationProcessAdapter}.
   */
  @Override
  public ModelAdapterBean toAdapterBean(final Row row) {
    return new OrchestrationProcessAdapter(row);
  }
  ...
  public DataProvider<? extends ModelAdapterBean> getDataProvider() {
    return DataProviderFactory.createOrchestrationProcessDataProvider();
  }
   ...
   ** <code>oracle.iam.identity.sysadmin.model.entity.OrchestrationProcessEO</code>
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (definition == null || definition.isDirty())
      definition = EntityDefImpl.findDefObject("oracle.iam.identity.sysadmin.model.entity.OrchestrationProcessEO");
