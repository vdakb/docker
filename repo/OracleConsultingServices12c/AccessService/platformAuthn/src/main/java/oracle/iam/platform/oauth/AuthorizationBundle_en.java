/*
    ...
    File        :   AuthorizationBundle_en.java
 ...
 ** @since   1.0.0.0
 */
public class AuthorizationBundle_en extends ListResourceBundle  {
  ...
  , { AuthorizationError.SIGNING_SIGNER_METHOD,         "The [%1$s] signing method is not supported by the JWE signer" }
  , { AuthorizationError.SIGNING_ALGORITHM_EXCEPTION,   "The algorithm is not supported by the JWE signer:\n%1$s" }
  , { AuthorizationError.SIGNING_ALGORITHM_UNSUPPORTED, "The [%1$s] algorithm is not supported by the JWE signer" }
  , { AuthorizationError.SIGNING_ALGORITHM_NOTACCEPTED, "The [%1$s] algorithm is not accepted by the JWE signer" }
