...
public class AuthorizationFeature implements Feature {
   ...
   */
  public static final String PROPERTY_ACCESS_TOKEN = "ocs.oauth.access.token";
   ...
   */
  public static Feature build(final String token) {
    return new AuthorizationFeature(token);
  }
}