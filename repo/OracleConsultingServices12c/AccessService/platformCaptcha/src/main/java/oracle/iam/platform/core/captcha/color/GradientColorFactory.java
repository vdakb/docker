...
public class GradientColorFactory implements ColorFactory {
  ...
  public static GradientColorFactory build() {
    ...
    return build(Space.awt(186, 192, 14), Space.awt(227, 38, 54));
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   build
  /**
   ** Factory method to create an <code>GradientColorFactory</code> from a
   ...
   **                            <code>GradientColorFactory</code>.
   */
  public static GradientColorFactory build(final Palette palette) {
