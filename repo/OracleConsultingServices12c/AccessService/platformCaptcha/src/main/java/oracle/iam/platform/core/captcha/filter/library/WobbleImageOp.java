 ...
 ** @since   1.0.0.0
 */
public class WobbleImageOp extends TransformImageOp<WobbleImageOp> {

  //////////////////////////////////////////////////////////////////////////////
  // instance attributes
  //////////////////////////////////////////////////////////////////////////////

  protected Size wave      = Size.build(15, 15);
  protected Size scale     = Size.build(1,   1);
  protected Size amplitude = Size.build(4,   3);

  protected Size random    = Size.build(3 * Digester.instance.nextInt(), 10 * Digester.instance.nextInt());
   ...
   */
  public WobbleImageOp waveLength(final int value) {
   ...
   **                            Possible object is <code>WobbleImageOp</code>.
   */
  public WobbleImageOp waveHeight(final int value) {
   ...
   **                            Possible object is <code>WobbleImageOp</code>.
   */
  public WobbleImageOp amplitudeLength(final int value) {
   ...
   **                            Possible object is <code>WobbleImageOp</code>.
   */
  public WobbleImageOp amplitudeHeight(final int value) {
   ...
   **                            Possible object is <code>WobbleImageOp</code>.
   */
  public WobbleImageOp scaleLength(final int value) {
   ...
   **                            Possible object is <code>WobbleImageOp</code>.
   */
  public WobbleImageOp scaleHeight(final int value) {
   ...
   **                            <br>
   **                            Allowed object is array of <code>int</code>.
   ** @param  t                  the array of <code>int</code> in which to
   **                            store the result.
   **                            <br>
