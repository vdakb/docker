...
import oracle.iam.config.captcha.type.Marble;
 ...
 ** @since   1.0.0.0
 */
public class MarbleImageOp extends TransformImageOp<MarbleImageOp> {
  ...
  private Size             random     = Size.build(SIZE * Digester.instance.nextInt(), SIZE * Digester.instance.nextInt());
