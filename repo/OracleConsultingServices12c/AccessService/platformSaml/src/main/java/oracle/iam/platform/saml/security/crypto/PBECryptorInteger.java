...
////////////////////////////////////////////////////////////////////////////////
// class PBECryptorInteger
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** Default implementation of the {@link Cryptor.Integer} interface.
 ** <p>
 ...
 ** @since   1.0.0.0
 */
public class PBECryptorInteger extends    PBECryptorNumeric
                               implements Cryptor.Integer {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>PBEIntegerCryptor</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>PBECryptorInteger</code> with the specified password to
   ** use.
   ** <p>
   ...
   */
  public PBECryptorInteger(final char[] password) {
    // ensure inheritance
    super(password);
  }
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>PBECryptorInteger</code> using the specified
   ** byte cryptor (constructor used for cloning).
   **
   ** @param  cryptor            the byte encryptor to use.
   **                            <br>
   **                            Allowed object is {@link PBECryptorBinary}.
   */
  protected PBECryptorInteger(final PBECryptorBinary cryptor) {
    // ensure inheritance
    super(cryptor);
  }
  ...
  public BigInteger encrypt(final BigInteger message) {
    ...
    try {
      ...
      // signum).
      final byte[] length = intToBytes(bytes.length);
      // append the length bytes to the encrypted message
      final byte[] result = PBECryptorBinary.append(bytes, length);
