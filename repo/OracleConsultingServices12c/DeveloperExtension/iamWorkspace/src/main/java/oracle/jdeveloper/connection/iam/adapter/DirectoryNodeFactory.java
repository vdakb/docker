/*
    ...
    File        :   DirectoryNodeFactory.java
 ...
 */
public class DirectoryNodeFactory extends EndpointContextFactory {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>DirectoryNodeFactory</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public Context getInitialContext(final Hashtable environment)
    ...
    return new DirectoryNode(DirectoryService.build((DirectoryServer)connection), repository, catalog, environment);
  }
}