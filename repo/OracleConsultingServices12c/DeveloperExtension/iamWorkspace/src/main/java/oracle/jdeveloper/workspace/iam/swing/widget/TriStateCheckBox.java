...
// ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** An implementation of a check box that have an additional, third state.
 **
...
public class TriStateCheckBox extends    JCheckBox
  ...
  // compatible with
  @SuppressWarnings("compatibility:-1780244168714587917")
  private static final long serialVersionUID = -1847410789183390782L;
  ...
  // Method:   setModel
  /**
   ** Sets the model that this check box represents.
   **
   ** @param  model              the new {@link TriStateButton.Model}.
   **
   ** @see   #getModel
   */
  ...
  /**
   ** Returns the {@link TriStateButton.Model} that this check box represents.
   **
 ...
 /**
   ...
   ** <code>setModel(JToggleButtonModel)</code> calls a {@link #getModel()}
   ** where we returning a {@link Model}, but at this point we have a
