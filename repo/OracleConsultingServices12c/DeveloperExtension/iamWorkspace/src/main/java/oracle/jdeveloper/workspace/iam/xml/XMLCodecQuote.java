 ...
 ** as singleton.
 */
public class XMLCodecQuote extends MimeCodec {
   ...
   ** Singleton Pattern
   */
  private static final XMLCodecQuote instance         = new XMLCodecQuote();

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:-7017557097710282924")
  private static final long          serialVersionUID = 994725322421674320L;
  ...
  // Method:  Ctor
  /**
   ** Constructor for the <code>XMLCodecQuote</code> object.
   ** <p>
   ** This creates an object that can be used to write escaped XML.
   ** <br>
   ** This constructor is private to prevent other classes to use
   ** "new XMLCodecQuote()" and enforces use of the public factory method below.
   */
  private XMLCodecQuote() {
    // ensure inheritance
    super(DICTIONARY);
  }
   ...
   */
  public static XMLCodecQuote instance() {
    return instance;
  }
}