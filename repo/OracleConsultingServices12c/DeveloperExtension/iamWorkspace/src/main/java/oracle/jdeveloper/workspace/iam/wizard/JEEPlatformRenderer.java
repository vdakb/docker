...
////////////////////////////////////////////////////////////////////////////////
// class JEEPlatformRenderer
// ~~~~~ ~~~~~~~~~~~~~~~~~~~
/**
 ** The model to restrict the choice of supported JEE runtime platforms.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class JEEPlatformRenderer extends MappedListCellRenderer {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-4350675029452476551")
  private static final long serialVersionUID = 3385561297166937223L;
  ...
  // Method:   Ctor
  /**
   ** Constructs <code>JEEPlatformRenderer</code> that use the provided mapping
   ...
   **                          the values.
   */
  public JEEPlatformRenderer(final Map<String, String> model) {
    // ensure inheritance
    super(null, model);
  }
  ...
  public Component getListCellRendererComponent(final JList list, final Object value, int index, boolean selected, boolean focused) {
    return renderComponent(ComponentBundle.icon(JEEServerPage.SYMBOL.get(value.toString())),displayString(value), selected);
  }
}