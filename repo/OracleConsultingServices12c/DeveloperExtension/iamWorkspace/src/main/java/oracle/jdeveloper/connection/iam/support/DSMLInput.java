...
public class DSMLInput implements XMLStreamReader
                       ,          XMLStreamConstants {
   ...
   */
  public DSMLInput(final Reader reader)
   ...
   **                            create an appropriate {@link XMLStreamReader}.
   */
  public DSMLInput(final InputStream stream)
    throws XMLStreamException {
  ...
  // Method:  Ctor
  /**
   ** Constructor for <code>DSMLInput</code> from a {@link DOMSource}.
   ** <p>
   ** The {@link XMLStreamReader} interface allows forward, read-only access
   ** to XML. It is designed to be the lowest level and most efficient way to
   ** read XML data.
   ...
   **                            create an appropriate {@link XMLStreamReader}.
   */
  public DSMLInput(final Source source)
    throws XMLStreamException {

    // ensure inheritance
    this(streamReader(source));
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:  Ctor
  /**
   ** Constructor for <code>DSMLInput</code> with a specified
   ...
   */
  protected DSMLInput(final XMLStreamReader reader) {
    // ensure inheritance
    super();
