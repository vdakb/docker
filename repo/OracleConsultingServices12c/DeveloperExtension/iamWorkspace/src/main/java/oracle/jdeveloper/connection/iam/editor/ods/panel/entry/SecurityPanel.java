...
// ~~~~~ ~~~~~~~~~~~~~
/**
 ** A flat editor panel suitable to display Access Control Information of a
 ** Directory Service entry in a table layout.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.84
 ** @since   12.2.1.3.42.60.84
 */
public class SecurityPanel extends AbstractPanel {
  ...
  // compatible with
  @SuppressWarnings("compatibility:6538131700916381493")
  private static final long       serialVersionUID = 1481136599905952843L;
  ...
  public static class Table extends JTable {
    ...
    // the official serial version ID which says cryptically which version we're
    // compatible with
    @SuppressWarnings("compatibility:-2930657567166116361")
  ...
  private SecurityPanel(final String path, final Namespace data) {
    // ensure inheritance
    super(path, data);
  ...
  // Method:   build
  /**
   ** Factory method to create a <code>SecurityPanel</code> that populates its
   ...
   **                            Allowed object is {@link Namespace}.
   **
   ** @return                    the validated <code>SecurityPanel</code>.
   **                            <br>
   **                            Possible object <code>SecurityPanel</code>.
   */
  public static SecurityPanel build(final String path, final Namespace data) {
    return new SecurityPanel(path, data);
  }
