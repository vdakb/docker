...
import oracle.jdeveloper.workspace.iam.project.maven.ModelFile;
import oracle.jdeveloper.workspace.iam.project.maven.ModelBundle;
import oracle.jdeveloper.workspace.iam.project.maven.ModelGenerator;
...
class PreviewData extends DefaultTraversablePanel {
  ...
  // compatible with
  @SuppressWarnings("compatibility:7715242076594316584")
  private static final long           serialVersionUID = -5447138397104077907L;
...
//        this.view.setText(ModelGenerator.preview((ModelStream)data));
        ;
      else
//        this.view.setText(ModelGenerator.preview((ModelFile)data));
        ;
    }
    catch (Exception e) {
      e.printStackTrace();
