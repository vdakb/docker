 ...
 */
public class WKSPreference extends BuildPropertyAdapter {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "wks-preferences";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>WKSPreference</code>.
   ** <br>
   ** This constructor is private to prevent other classes to use
   ** "new WKSPreference()" and enforces use of the public factory method
   ** below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  private WKSPreference(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // the second parameter to string() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.WKS_PREFERENCE));
  }
   ...
   ** {@link BuildPropertyAdapter} using {@link Manifest#WKS_PREFERENCE} in the
   ...
   **
   ** @return                    the <code>WKSPreference</code> instance
   **                            obtained from the specifed
   **                            {@link TraversableContext}.
   */
  public static WKSPreference instance(final TraversableContext context) {
    WKSPreference instance = (WKSPreference)context.getDesignTimeObject(Manifest.WKS_PREFERENCE);
    if (instance == null) {
      instance = new WKSPreference(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.WKS_PREFERENCE, instance);
    }
    return instance;
  }
}