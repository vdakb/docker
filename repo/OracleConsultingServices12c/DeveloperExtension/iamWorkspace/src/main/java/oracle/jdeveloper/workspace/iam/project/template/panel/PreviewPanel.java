...
class PreviewPanel extends DefaultTraversablePanel {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-6716689712796410587")
  private static final long                 serialVersionUID = -1333340719668503403L;
  ...
  public void onEntry(final TraversableContext context) {
    ...
    if (visible && data instanceof TemplateData) {
