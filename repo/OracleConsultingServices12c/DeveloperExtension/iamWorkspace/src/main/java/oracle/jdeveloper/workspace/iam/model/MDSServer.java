/*
    ...
    11.1.1.3.37.60.15  2012-02-06  DSteding    The network protocol the JDBC
                                               driver will use to connect to the
                                               database is now supported.
                                               --
                                               Change setter/getter from name
                                               to file.
 ...
 ** stored in the <code>MDSServer</code> model.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class MDSServer extends PlatformConfig {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE             = "mds-server";
  ...
  private static final String DEFAULT_PROTOCOL = "thin";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>MDSServer</code>.
   ** <br>
   ** This constructor is private to prevent other classes to use
   ** "new MDSServer()" and enforces use of the public factory method
   ** below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  private MDSServer(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // the second parameter to string() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return  this.string(PROJECT, Manifest.string(Manifest.MDS_SERVER_PROJECT));
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   protocol
  /**
   ** Called to inject the argument for instance attribute <code>protocol</code>.
   **
   ** @param  protocol           the protocol the JDBC driver will use to
   **                            connect to the Metadata Store backend server.
   */
  public void protocol(final String protocol) {
    this._hash.putString(MDSServerHandler.PROTOCOL, protocol);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   protocol
  /**
   ** Returns the port the Metadata Store backend server is listening on.
   **
   ** @return                    the port the Metadata Store backend server is
   **                            listening on.
   */
  public String protocol() {
    // the second parameter to string() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(MDSServerHandler.PROTOCOL, DEFAULT_PROTOCOL);
  }
   ...
   **
   ** @param  port               the port the Metadata Store backend server is
   **                            listening on.
   */
  public void port(final String port) {
    this._hash.putString(MDSServerHandler.PORT, port);
  }
  ...
  public String port() {
    // the second parameter to string() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(MDSServerHandler.PORT, DEFAULT_PORT);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   service
  /**
   ** Called to inject the argument for instance attribute <code>service</code>.
   **
   ** @param  service            the service URL the Metadata Store is exposing.
   */
  public void service(final String service) {
    this._hash.putString(MDSServerHandler.SERVICE, service);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   service
  /**
   ** Returns the service URL the Metadata Store backend server is exposing.
   **
   ** @return                    the service URL the Metadata Store is exposing.
   */
  public String service() {
    // the second parameter to string() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(MDSServerHandler.SERVICE, StringUtility.EMPTY);
  }
  ...
  public final void platform(final String platform) {
    this._hash.putString(MDSServerHandler.PLATFORM, platform);
  }
  ...
  public final String platform() {
    // the second parameter to string() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(MDSServerHandler.PLATFORM, StringUtility.EMPTY);
  }
  ...
  public final void username(final String username) {
    this._hash.putString(MDSServerHandler.USERNAME, username);
  }
  ...
  public final String username() {
    // the second parameter to string() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(MDSServerHandler.USERNAME, StringUtility.EMPTY);
  }
  ...
  public final void password(final String password) {
    this._hash.putString(MDSServerHandler.PASSWORD, password);
  }
  ...
  public final String password() {
    return string(MDSServerHandler.PASSWORD, StringUtility.EMPTY);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   template (ANTFileHandler)
  /**
   ...
   ** using {@link Manifest#MDS_SERVER} in the design time objects of the
   ...
   **
   ** @return                    the <code>MDSServer</code> instance obtained
   **                            from the specifed {@link TraversableContext}.
   */
  public static MDSServer instance(final TraversableContext context) {
    MDSServer instance = (MDSServer)context.getDesignTimeObject(Manifest.MDS_SERVER);
    if (instance == null) {
      instance = new MDSServer(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.MDS_SERVER, instance);
  ...
  public void clone(final URL source) {
    MDSServerHandler handler = new MDSServerHandler(source);
    try {
      handler.load();
      platform(handler.propertyValue(MDSServerHandler.PLATFORM));
      host(handler.propertyValue(MDSServerHandler.HOST));
      port(handler.propertyValue(MDSServerHandler.PORT));
      protocol(handler.propertyValue(MDSServerHandler.PROTOCOL));
      username(handler.propertyValue(MDSServerHandler.USERNAME));
      password(handler.propertyValue(MDSServerHandler.PASSWORD));
      service(handler.propertyValue(MDSServerHandler.SERVICE));
    }
