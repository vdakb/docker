...
// ~~~~~ ~~~~~~~~~~~~~~~~~~
/**
 ** The <code>XMLOutputAttribute</code> object is used to represent a node added to the
 ** output node collection.
 ** <p>
...
public class XMLOutputAttribute implements XMLOutputNode {
  ...
  // compatible with
  @SuppressWarnings("compatibility:8014700019596846969")
