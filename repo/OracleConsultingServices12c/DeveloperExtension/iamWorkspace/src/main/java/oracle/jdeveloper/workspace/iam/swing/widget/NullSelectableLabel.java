 ...
 */
public class NullSelectableLabel extends SelectableLabel {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-4134158709536985665")
  private static final long serialVersionUID = -3402550172659588599L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>NullSelectableLabel</code> instance with no image and
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>NullSelectableLabel</code> instance with the specified
   ** text.
   ** <p>
   ...
   */
  public NullSelectableLabel(final String text) {
    // ensure inheritance
    super(text);
  }
   ...
   **                             </ul>.
   */
  public NullSelectableLabel(final String text, final int horizontalAlignment) {
    // ensure inheritance
   ...
   **                             </ul>.
   */
  public NullSelectableLabel(final String text, final Icon icon, final int horizontalAlignment) {
    // ensure inheritance
   ...
   ** @param  icon                the image to be displayed by the label.
   */
  public NullSelectableLabel(final Icon icon) {
    // ensure inheritance
    super(icon);
  }
   ...
   **                             </ul>.
   */
  public NullSelectableLabel(final Icon icon, final int horizontalAlignment) {
    // ensure inheritance
