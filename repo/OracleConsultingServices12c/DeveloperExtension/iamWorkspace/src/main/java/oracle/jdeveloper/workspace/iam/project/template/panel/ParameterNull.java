...
class ParameterNull extends DefaultTraversablePanel {
  ...
  // compatible with
  @SuppressWarnings("compatibility:2455186666378379401")
  private static final long             serialVersionUID = 6932069755538158485L;
   ...
   */
  protected OptionTreeNodeData template(final TraversableContext context) {
