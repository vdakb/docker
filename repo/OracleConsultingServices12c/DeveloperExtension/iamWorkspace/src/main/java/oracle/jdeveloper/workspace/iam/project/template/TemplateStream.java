 ...
 ** <p>
 ** The template handled by this instance is embeded in the java archive itself.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.60.15
 */
public class TemplateStream extends TemplateData {
  ...
  // compatible with
  @SuppressWarnings("compatibility:8404554484793528833")
  private static final long                   serialVersionUID = 6562398509938939981L;

  //////////////////////////////////////////////////////////////////////////////
  // instance attributes
  //////////////////////////////////////////////////////////////////////////////

  private transient Map<String, TemplateData> include          = new HashMap<String, TemplateData>();
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>TemplateStream</code> with the specified project name
   ** and base dir.
   **
   ...
   */
  public TemplateStream(final TemplateFolder folder, final String name) {
    // ensure inheritance
    super(folder, name);
  }
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>TemplateStream</code> with the specified file name and
   ...
   */
  public TemplateStream(final TemplateFolder folder, final String name, final String extension) {
    // ensure inheritance
  ...
  // Method:   property
  /**
   ** Sets the substitution of the ANT build file.
   **
   ** @param  property           the properties of the ANT build file.
   */
  ...
  // Method:   property
  /**
   ** Returns the substitution of the ANT build file.
   **
   ** @return                    the properties of the ANT build file.
   */
  ...
  // Method:   include
  /**
   ** Returns the included nodes of the ANT build file.
   **
   ** @return                    the included nodes of the ANT build file.
   */
  public final Map<String, TemplateData> include() {
    return this.include;
  }
   ...
   **
   ** @return                    this <code>TemplateData</code> to enable
   **                            method concatanation.
   */
  public final TemplateData include(final String key, final TemplateData node) {
  ...
  public void evaluateIncludes() {
    for (String key : this.include.keySet()) {
      final TemplateData node     = this.include.get(key);
  ...
  public final Icon icon() {
    return TemplateBundle.icon(TemplateBundle.NODE_BUILDFILE_ICON);
  }
}