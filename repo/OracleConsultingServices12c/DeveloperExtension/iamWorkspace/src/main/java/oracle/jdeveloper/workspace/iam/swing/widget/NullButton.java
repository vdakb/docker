...
public class NullButton extends JButton {
  ...
  // compatible with
  @SuppressWarnings("compatibility:7266090579680828821")
  private static final long serialVersionUID = 3923992362908103215L;
  ...
  // Method:   Ctor
  /**
   ** Constructs a button with no text, no icon.
   */
  public NullButton() {
    // ensure inheritance
    super();
   ...
   **
   ** @param  icon               the {@link Icon} image to display on the
   **                            button.
   */
  public NullButton(final Icon icon) {
    // ensure inheritance
    super(icon);
  }
   ...
   */
  public NullButton(final String text) {
    // ensure inheritance
    super(text);
  }
  ...
  // Method:   Ctor
  /**
   ** Constructs a button with the specified text and icon.
   **
   ** @param  text               the text of the button.
   ** @param  icon               the {@link Icon} image to display on the
   **                            button.
   */
  public NullButton(final String text, final Icon icon) {
    // ensure inheritance
    super(text, icon);
  }
   ...
   */
  public NullButton(final Action action) {
    // ensure inheritance
    super(action);
  }
