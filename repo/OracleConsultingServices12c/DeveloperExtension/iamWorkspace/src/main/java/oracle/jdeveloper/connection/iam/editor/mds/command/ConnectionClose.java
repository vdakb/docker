 ...
 ** close an opened the connection to a Meatadat Service.
 **
...
public class ConnectionClose {
  ...
  /**
   ** The id of the command to close an opened the connection to a Meatadat
   ** Service.
   ** This matches the id defined for this action in extension.xml.
   */
  static final String COMMAND = "mds.action.close";
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>ConnectionClose</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  // Method:   action
  /**
   ** Returns the id of the action that is responsible for create a new folder
   ** in a Metadata Service.
   **
   ** @return                    the id of the action that is responsible for
   **                            create a new folder in a Metadata Service.
   **
   ...
   ** <br>
   ** Creates a new metadata folder as a subordinated element of the specified
