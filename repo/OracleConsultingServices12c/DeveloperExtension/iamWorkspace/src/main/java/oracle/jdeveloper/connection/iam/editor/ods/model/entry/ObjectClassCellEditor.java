/*
    ...
    File        :   ObjectClassCellEditor.java
...
////////////////////////////////////////////////////////////////////////////////
// class ObjectClassCellEditor
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~
/**
 ** A minimal extension of {@link DefaultCellEditor} allowing us to an object
 ** class prefix.
 **
 ...
 */
public class ObjectClassCellEditor extends DefaultCellEditor {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-7355646749765326817")
  private static final long serialVersionUID = 5901511031112029171L;
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>ObjectClassCellEditor</code> that displays a
   ...
   */
  private ObjectClassCellEditor(final JTextField editor, final Set<String> inventory) {
    // ensure inheritance
    super(editor);
  ...
  // Method:   build
  /**
   ** Factory method to create a <code>ObjectClassCellEditor</code> table cell
   ** editor responsible to visualize the object class of a Directory Service
   ** schema.
   **
   ...
   */
  public static ObjectClassCellEditor build(final Set<String> inventory) {
    return new ObjectClassCellEditor(new JTextField(), inventory);
  }
