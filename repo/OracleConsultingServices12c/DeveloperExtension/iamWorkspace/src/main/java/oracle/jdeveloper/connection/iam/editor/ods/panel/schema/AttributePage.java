...
// ~~~~~ ~~~~~~~~~~~~~
/**
 ** A flat editor panel suitable to display all attrbutes of a directory
...
public class AttributePage extends AbstractPage {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-2667701884094608158")
  private static final long serialVersionUID = 7516519585246748256L;
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>AttributePage</code> responsible to visualize
   ** the table UI of all attribute types that populates its data from the
  ...
  protected final void initializeView() {
    this.panel = AttributePanel.build(SchemaEditor.ATTRIBUTE, this.data);
    initializeHeaderPanel(Bundle.string(Bundle.SCHEMA_ATTRIBUTE_PANEL_TITLE), this.panel);
  }
   ...
   ** data object from the specified {@link Namespace}.
   ** <p>
