/*
    ...
    File        :   DirectoryServerFactory.java
 ...
 */
public class DirectoryServerFactory extends EndpointFactory {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>DirectoryServerFactory</code> that allows use as a
   ** JavaBean.
   ** <br>
