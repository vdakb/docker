/*
    ...
    File        :   DirectoryContextRename.java
...
////////////////////////////////////////////////////////////////////////////////
// class DirectoryContextRename
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~
/**
 ** Implementation of the dialog to obtain the information about to rename an
 ...
 */
class DirectoryContextRename extends DirectoryContextPanel {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-1951141922700997625")
  private static final long serialVersionUID = 6725727331144054367L;
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>DirectoryContextRename</code> panel that allows
   ** use as a JavaBean.
   ** <br>
  ...
  public void vetoableChange(final PropertyChangeEvent event)
    ...
    if (StringUtility.empty(this.entryPrefix.getText())) {
      ...
      MessageDialog.error(this, Bundle.string(Bundle.ENTRY_RENAME_PREFIX_REQUIRED), Bundle.string(Bundle.ENTRY_RENAME_TITLE), null);
  ...
  public void onEntry(final TraversableContext context) {
    ...
    // make the suffix non-editable due to allow only chnages on RDN
    this.entrySuffix.setEditable(false);

    // initialize layout
    final GridBagBuilder layout = GridBagBuilder.build(this);
    layout.append(Bundle.string(Bundle.ENTRY_PREFIX_LABEL), this.entryPrefix);
    layout.append(Bundle.string(Bundle.ENTRY_ORIGIN_LABEL), this.entrySuffix);
  }
}