 ...
 */
public class ModelBundle extends ArrayResourceBundle {
  ...
  private static final String CONTENT[] = {
    /*  0 */ "Generate Maven Project Object Model File"
  ...
  , /*  3 */ "images/mvn-node-folder.png"
  , /*  4 */ "images/mvn-node-file.png"
  , /*  5 */ "images/xml-node-file.png"

  , /*  6 */ "Properties"
  , /*  7 */ "images/mvn-property.png"
  , /*  8 */ "images/mvn-target.png"
  , /*  9 */ "images/mvn-parameter.png"
  , /* 10 */ "images/mvn-java-duke.png"
  , /* 11 */ "images/mvn-folder.png"
  ...
  public static final ArrayResourceBundle RESOURCE = (ArrayResourceBundle)ResourceBundle.getBundle(
    ModelBundle.class.getName()
  , Locale.getDefault()
  , ModelBundle.class.getClassLoader()
  );
  ...
  public static Icon icon(final int key) {
    return IconFactory.create(ModelBundle.class, string(key));
  }
  ...
  public static Image image(final int key) {
    return IconFactory.create(ModelBundle.class, string(key)).getImage();
  }
}
