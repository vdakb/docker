/*
    ...
    File        :   CheckBoxListCellRenderer.java
...
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** Displays an option entry (CheckBox) in a list.
 ** <p>
 ** <code>CheckBoxListCellRenderer</code> is not opaque and unless you subclass
 ...
 */
public class CheckBoxListCellRenderer extends OptionListCellRenderer {
  ...
  // compatible with
  @SuppressWarnings("compatibility:6864545959875609057")
  private static final long      serialVersionUID = -7656847929977033102L;

  private static final JCheckBox prototype        = new TriStateCheckBox();
  ...
  // Method: Ctor
  /**
   ** Constructs a <code>CheckBoxListCellRenderer</code> that has a check box
   ** and a label.
   */
   ...
   */
  public CheckBoxListCellRenderer(final ContentListCellRenderer renderer) {
    // ensure inheritance
    super(renderer);
  ...
  public Component getListCellRendererComponent(final JList list, final Object value, final int index, final boolean selected, final boolean focused) {
    ((TriStateCheckBox)this.hotspot).setPreferredSize(CheckBoxListCellRenderer.prototype.getPreferredSize());
    this.empty.setPreferredSize(CheckBoxListCellRenderer.prototype.getPreferredSize());
    ...
    if (list instanceof OptionList) {
      ...
      if (selectionModel != null) {
        ...
        if ((data != null && data.hotspotVisible())) {
         ...
         ((TriStateCheckBox)this.hotspot).setEnabled(list.isEnabled() ? data.hotspotEnabled() : false);
        }
    ...
    if (!(list instanceof OptionList) || (data == null) || (data != null && !data.hotspotVisible())) {
      ...
      // and place the placeholder in front of the element to get a left
      // or right aligned list
