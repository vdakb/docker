 ...
 ** Manager workflow deployment context.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class SOAContext extends BuildPropertyAdapter {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "soa-context";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>SOAContext</code>.
   ** <br>
   ** This constructor is protected to prevent other classes to use
   ** "new Context()" and enforces use of the public factory method below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  protected SOAContext(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.SOA_CONTEXT_PROJECT));
  }
  ...
  public String description() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(DESCRIPTION, Manifest.string(Manifest.SOA_CONTEXT_DESCRIPTION));
  }
   ...
   ** {@link BuildPropertyAdapter} using {@link Manifest#SOA_CONTEXT} in the
   ...
   */
  public static SOAContext instance(final TraversableContext context) {
    SOAContext instance = (SOAContext)context.getDesignTimeObject(Manifest.SOA_CONTEXT);
    if (instance == null) {
      instance = new SOAContext(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.SOA_CONTEXT, instance);
    }
    return instance;
  }
}