 ...
 */
public class ADFTarget extends Target {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "adf-targets";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>ADFTarget</code>.
   ** <br>
   ** This constructor is private to prevent other classes to use
   ** "new ADFTarget()" and enforces use of the public factory method below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  public ADFTarget(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.ADF_TARGET_PROJECT));
  }
   ...
   */
  public static ADFTarget instance(final TraversableContext context) {
    ADFTarget instance = (ADFTarget)context.getDesignTimeObject(Manifest.ADF_TARGET);
    if (instance == null) {
      instance = new ADFTarget(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.ADF_TARGET, instance);
    }
    return instance;
  }
  ...
  public void clone(final URL source) {
    ADFTargetHandler handler = new ADFTargetHandler(source);
    try {
      handler.load();
      specificationVendor(handler.propertyValue(ADFTargetHandler.SPECIFICATION_VENDOR));
      implementationVendor(handler.propertyValue(ADFTargetHandler.IMPLEMENTATION_VENDOR));
    }
