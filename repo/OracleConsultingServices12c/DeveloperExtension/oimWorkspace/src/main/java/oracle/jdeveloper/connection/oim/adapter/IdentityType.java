 ...
 */
public class IdentityType implements ConnectionType {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  public static final Class<IdentityServer> CLASS = IdentityServer.class;
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>IdentityType</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public String getDescription(final Locale local) {
    return Manifest.string(Manifest.IDENTITY_SERVER_DESCRIPTION);
  }
  ...
  public boolean isInstanceOf(final Referenceable connection) {
    return connection instanceof IdentityServer;
  }
