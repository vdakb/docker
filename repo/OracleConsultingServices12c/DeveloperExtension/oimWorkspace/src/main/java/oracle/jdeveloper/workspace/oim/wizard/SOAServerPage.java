 ...
 ** preferences stored in the {@link SOAServer} model.
 ** <p>
 ...
 */
public class SOAServerPage extends TemplateFeaturePage {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-1202994902932090843")
  private static final long           serialVersionUID = 5824355306836585093L;
  ...
  private transient JTextField        serverPartition;

  private transient SOAServer         provider         = null;
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>SOAServerPage</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  protected void initializeComponent() {
    ...
    this.cloneBrowse.addActionListener(new FeatureClone(this, Manifest.SOA_SERVER));
    ...
    this.serverPartition  = new JTextField();
  ...
  protected void initializeLayout() {
    ...
    , "pref, pref, 6dlu, pref, 3dlu, pref, 3dlu, pref, 3dlu, pref, 6dlu, pref, 6dlu, pref, 3dlu, pref, 3dlu, pref, 6dlu, pref, 6dlu, pref"
    ...
    label.setLabelFor(this.serverPartition);
    builder.add(this.serverPartition, constraint.xyw(4, row, 7));
  }
  ...
  protected final void initializePage() {
    ...
    this.serverPartition.setText(this.provider.partition());
  }
  ...
  public void onEntry(final TraversableContext context) {
    ...
    this.provider = SOAServer.instance(context);
  ...
  private final void commitPartition(final boolean validate)
    ...
    // obtained the value from the UI to store.
    final String value = this.serverPartition.getText();
