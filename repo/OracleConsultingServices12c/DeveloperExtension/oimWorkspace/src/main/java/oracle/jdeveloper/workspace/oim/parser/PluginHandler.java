 ...
 */
public class PluginHandler extends ProjectHandler {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  public static final String PLUGIN           = "oim.plugin";
  public static final String PACKAGEPATH      = "oim.packagepath";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:2261785543468276957")
  private static final long  serialVersionUID = 1271557293315169747L;
  ...
  // Method:   Ctor
  /**
   ** Creates a new <code>PluginHandler</code> instance by converting the
   ...
   **                              <code>null</code>.
   */
  public PluginHandler(final URL file) {
    // ensure inheritance
    super(file);
  }
  ...
  protected void register() {
    ...
    registerProperty(PLUGIN,        "plugin");
    registerProperty(DESTINATION,   "destination.plugin");
    registerProperty(PACKAGEPATH,   "packagepath.plugin");
  }
}