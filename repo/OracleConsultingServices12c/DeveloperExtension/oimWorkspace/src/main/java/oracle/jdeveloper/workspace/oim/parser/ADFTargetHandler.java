 ...
 */
public class ADFTargetHandler extends TargetHandler {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-2489689927463529573")
  private static final long serialVersionUID = 5924077089245541988L;
  ...
  // Method:   Ctor
  /**
   ** Creates a new <code>ADFTargetHandler</code> instance by converting the
   ...
   **                              <code>null</code>.
   */
  public ADFTargetHandler(final URL file) {
    // ensure inheritance
    super(file);
  }
}