...
////////////////////////////////////////////////////////////////////////////////
// final class BackendWizard
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~
/**
 ** Implementation of the "Oracle Identity Manager Backend Project" gallery
 ** item.
 **
 ...
 */
public class BackendWizard extends ProjectWizard {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>BackendWizard</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public String getShortLabel() {
    return Manifest.string(Manifest.OIM_BACKEND);
  }
  ...
  public ProjectTemplate projectTemplate() {
    return Feature.lookupProjectTemplate(Manifest.OIM_BACKEND);
  }
}