 ...
 */
public class SOATargetHandler extends TargetHandler {
  ...
  // compatible with
  @SuppressWarnings("compatibility:5293741199887977742")
  private static final long serialVersionUID = 1108831900502226232L;
  ...
  // Method:   Ctor
  /**
   ** Creates a new <code>SOATargetHandler</code> instance by converting the
   ...
   **                              <code>null</code>.
   */
  public SOATargetHandler(final URL file) {
    // ensure inheritance
    super(file);
  }
}