...
public class PreferenceHandler extends ANTFileHandler {
  ...
  public static final String OIM_RELEASE      = "oim.release";
  public static final String OIM_PROJECT      = "oim.project";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:-2359187024838185050")
  private static final long  serialVersionUID = 497210563827715880L;
