 ...
 */
public class ExportHandler extends ANTFileHandler {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-8152763667666607410")
  private static final long serialVersionUID = 1245546415068124290L;
  ...
  // Method:   Ctor
  /**
   ** Creates a new <code>ExportHandler</code> instance by converting the
   ...
   **                              <code>null</code>.
   */
  public ExportHandler(final URL file) {
    // ensure inheritance
    super(file);
  }
}