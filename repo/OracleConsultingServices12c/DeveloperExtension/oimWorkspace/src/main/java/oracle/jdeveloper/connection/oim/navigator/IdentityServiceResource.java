/*
    ...
    File        :   IdentityServiceResource.java
...
////////////////////////////////////////////////////////////////////////////////
// class IdentityServiceResource
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The expandable navigator node that display <code>Resource</code>s of the
 ...
 */
public class IdentityServiceResource extends IdentityServiceBase {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>IdentityServiceResource</code> that allows use as a
   ** JavaBean.
   **
   ...
   */
  public IdentityServiceResource(final EndpointElement parent, final IdentityService service) {
    // ensure inheritance
    super(parent, service, Bundle.IDENTITY_RESOURCE_LABEL, Bundle.IDENTITY_RESOURCE_ICON);
  }
}