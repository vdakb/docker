...
public class PluginRegistryHandler extends XMLFileHandler {
  ...
  public static final String ELEMENT_ROOT     = "oimplugins";

  public static final String ROOT_PATH        = "//" + ELEMENT_ROOT;

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:-2534007739463679106")
  private static final long  serialVersionUID = -5160525337538692863L;
