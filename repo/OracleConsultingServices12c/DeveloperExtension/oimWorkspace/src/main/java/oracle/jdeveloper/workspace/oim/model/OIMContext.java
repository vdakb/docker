 ...
 ** Manager application deployment context.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class OIMContext extends BuildPropertyAdapter {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "oim-context";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>OIMContext</code>.
   ** <br>
   ** This constructor is protected to prevent other classes to use
   ** "new OIMContext()" and enforces use of the public factory method below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  protected OIMContext(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.OIM_CONTEXT_PROJECT));
  }
  ...
  public String description() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(DESCRIPTION, Manifest.string(Manifest.OIM_CONTEXT_DESCRIPTION));
  }
   ...
   ** {@link BuildPropertyAdapter} using {@link Manifest#OIM_CONTEXT} in the
   ...
   **
   ** @return                    the <code>Context</code> instance obtained from
   **                            the specifed {@link TraversableContext}.
   */
  public static OIMContext instance(final TraversableContext context) {
    OIMContext instance = (OIMContext)context.getDesignTimeObject(Manifest.OIM_CONTEXT);
    if (instance == null) {
      instance = new OIMContext(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.OIM_CONTEXT, instance);
    }
    return instance;
  }
}