...
public class AdapterHandler extends ProjectHandler {
  ...
  public static final String ADAPTER               = "oim.adapter";
  public static final String SCHEDULER             = "oim.scheduler";
  public static final String LIBRARY               = "oim.library";

  public static final String PACKAGEPATH_ADAPTER   = "oim.packagepath.adapter";
  public static final String PACKAGEPATH_SCHEDULER = "oim.packagepath.scheduler";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:1240474672374865648")
  private static final long  serialVersionUID      = 889016345509976286L;
  ...
  protected void register() {
    ...
    registerProperty(ADAPTER,               "adapter");
    registerProperty(SCHEDULER,             "scheduler");
    registerProperty(LIBRARY,               "library");
    registerProperty(DESTINATION,           "destination.base");
    registerProperty(PACKAGEPATH_ADAPTER,   "packagepath.adapter");
    registerProperty(PACKAGEPATH_SCHEDULER, "packagepath.scheduler");
  }
}