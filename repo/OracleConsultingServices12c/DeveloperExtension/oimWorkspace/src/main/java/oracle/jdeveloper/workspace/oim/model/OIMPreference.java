/*
    ...
    11.1.1.3.37.60.15  2012-02-06  DSteding    Change setter/getter from name
                                               to file.
    11.1.1.3.37.60.23  2012-02-06  DSteding    Separated SOA from OIM.
 ...
 ** Manager workflow preferences.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class OIMPreference extends BuildPropertyAdapter {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "oim-preferences";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>OIMPreference</code>.
   ** <br>
   ** This constructor is private to prevent other classes to use
   ** "new Preference()" and enforces use of the public factory method below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  public OIMPreference(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.OIM_PREFERENCE_PROJECT));
  }
  ...
  // Method:   instance
  /**
   ** Returns an instance of this {@link OIMPreference}.
   ** <p>
   ** This method tries to find an existing instance of a
   ** {@link OIMPreference} using {@link Manifest#OIM_PREFERENCE} in the
   ...
   **
   ** @return                    the <code>Preference</code> instance obtained
   **                            from the specifed {@link TraversableContext}.
   */
  public static OIMPreference instance(final TraversableContext context) {
    OIMPreference instance = (OIMPreference)context.getDesignTimeObject(Manifest.OIM_PREFERENCE);
    if (instance == null) {
      instance = new OIMPreference(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.OIM_PREFERENCE, instance);
    }
    return instance;
  }
}