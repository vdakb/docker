 ...
 */
public class SOAServerHandler extends ANTFileHandler {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  public static final String PLATFORM         = "soa.server.type";
  public static final String PROTOCOL         = "soa.server.protocol";
  public static final String HOST             = "soa.server.host";
  public static final String PORT             = "soa.server.port";
  public static final String NAME             = "soa.server.name";
  public static final String HOME             = "soa.server.home";
  public static final String USERNAME         = "soa.server.username";
  public static final String PASSWORD         = "soa.server.password";

  public static final String PARTITION        = "soa.metadata.partition";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:-7671123198358938591")
  private static final long  serialVersionUID = -5272519155945802889L;
  ...
  // Method:   Ctor
  /**
   ** Creates a new <code>SOAServerHandler</code> instance by converting the
   ...
   **                              <code>null</code>.
   */
  public SOAServerHandler(final URL file) {
    // ensure inheritance
    super(file);
  }
