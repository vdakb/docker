 ...
 */
public class ImportHandler extends ANTFileHandler {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-6417753877662872232")
  private static final long serialVersionUID = 9060754838598090866L;
  ...
  // Method:   Ctor
  /**
   ** Creates a new <code>ImportHandler</code> instance by converting the
   ...
   **                              <code>null</code>.
   */
  public ImportHandler(final URL file) {
    // ensure inheritance
    super(file);
  }
}