/*
    ...
    File        :   IdentityServiceAdapter.java
...
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~
/**
 ** The expandable navigator node that display <code>EventHandler</code>s of the
 ...
 */
public class IdentityServiceAdapter extends IdentityServiceBase {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>IdentityServiceAdapter</code> that allows use as a
   ** JavaBean.
   **
   ...
   */
  public IdentityServiceAdapter(final EndpointElement parent, final IdentityService service) {
    // ensure inheritance
    super(parent, service, Bundle.IDENTITY_ADAPTER_LABEL ,Bundle.IDENTITY_ADAPTER_ICON);
  }
}
