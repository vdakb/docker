 ...
 ** Manager Scheduler Project.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class Scheduler extends BuildArtifact {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE                = "oim-scheduler-ant";
  private static final String TEMPLATE            = Manifest.BUILDFILE_PACKAGE + "." + FILE;
  private static final String DEFAULT_APPLICATION = "ocs-scheduler";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Scheduler</code>.
   ** <br>
   ** This constructor is private to prevent other classes to use
   ** "new Scheduler()" and enforces use of the public factory method below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  private Scheduler(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
   ...
   ** using {@link Manifest#SCHEDULER} in the design time objects of the specified
   ...
   **
   ** @return                    the <code>Scheduler</code> instance obtained
   **                            from the specifed {@link TraversableContext}.
   */
  public static Scheduler instance(final TraversableContext context) {
    Scheduler instance = (Scheduler)context.getDesignTimeObject(Manifest.SCHEDULER);
    if (instance == null) {
      instance = new Scheduler(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.SCHEDULER, instance);
    }
    return instance;
  }
}