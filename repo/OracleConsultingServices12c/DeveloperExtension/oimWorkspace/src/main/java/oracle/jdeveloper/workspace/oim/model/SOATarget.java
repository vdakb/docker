/*
    ...
    ------------------+-----------+-----------+-------------------------------
    11.1.1.3.37.60.21  2012-06-16  DSteding    First release version
 ...
 ** @since   11.1.1.3.37.60.21
 */
public class SOATarget extends Target {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "soa-targets";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>SOATarget</code>.
   ** <br>
   ** This constructor is private to prevent other classes to use
   ** "new SOATarget()" and enforces use of the public factory method below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  private SOATarget(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.SOA_TARGET_PROJECT));
  }
   ...
   ** {@link BuildPropertyAdapter} using {@link Manifest#SOA_TARGET} in the
   ...
   */
  public static SOATarget instance(final TraversableContext context) {
    SOATarget instance = (SOATarget)context.getDesignTimeObject(Manifest.SOA_TARGET);
    if (instance == null) {
      instance = new SOATarget(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.SOA_TARGET, instance);
    }
    return instance;
  }
  ...
  public void clone(final URL source) {
    SOATargetHandler handler = new SOATargetHandler(source);
    try {
      handler.load();
      specificationVendor(handler.propertyValue(SOATargetHandler.SPECIFICATION_VENDOR));
      implementationVendor(handler.propertyValue(SOATargetHandler.IMPLEMENTATION_VENDOR));
    }
