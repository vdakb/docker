/*
    ...
    File        :   IdentityServiceLookup.java
...
////////////////////////////////////////////////////////////////////////////////
// class IdentityServiceLookup
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~
/**
 ** The expandable navigator node that display <code>Lookup</code>s of the
 ...
 */
public class IdentityServiceLookup extends IdentityServiceBase {
  ...
  // Method:   Ctor
  /**
   ** Constructs an <code>IdentityServiceLookup</code> that allows use as a
   ** JavaBean.
   **
   ...
   */
  public IdentityServiceLookup(final EndpointElement parent, final IdentityService service) {
    // ensure inheritance
    super(parent, service, Bundle.IDENTITY_LOOKUP_LABEL, Bundle.IDENTITY_LOOKUP_ICON);
  }
