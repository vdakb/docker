/*
    ...
    11.1.1.3.37.60.15  2012-02-06  DSteding    Change setter/getter from name
                                               to file.
    11.1.1.3.37.60.23  2012-06-14  DSteding    To distinct from OIM renamed.
 ...
 */
public class SOADeployment extends BuildArtifact {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE                = "soa-deployment";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>SOADeployment</code>.
   ** <br>
   ** This constructor is protected to prevent other classes to use
   ** "new Deployment()" and enforces use of the public factory method below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  protected SOADeployment(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.SOA_DEPLOYMENT_PROJECT));
  }
   ...
   ** using {@link Manifest#SOA_DEPLOYMENT} in the design time objects of the
   ...
   **
   ** @return                    the <code>Deployment</code> instance obtained
   **                            from the specifed {@link TraversableContext}.
   */
  public static SOADeployment instance(final TraversableContext context) {
    SOADeployment instance = (SOADeployment)context.getDesignTimeObject(Manifest.SOA_DEPLOYMENT);
    if (instance == null) {
      instance = new SOADeployment(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.SOA_DEPLOYMENT, instance);
    }
    return instance;
  }
}