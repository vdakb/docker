 ...
 */
public class LibraryHandler extends ProjectHandler {
  ...
  public static final String PACKAGEPATH_LIBRARY = "oim.packagepath.library";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:-6485140564202585069")
  private static final long  serialVersionUID    = 4792356713555040425L;
  ...
  // Method:   Ctor
  /**
   ** Creates a new <code>LibraryHandler</code> instance by converting the
   ...
   **                              <code>null</code>.
   */
  public LibraryHandler(final URL file) {
    // ensure inheritance
    super(file);
  }
  ...
  protected void register() {
    ...
    registerProperty(PACKAGEPATH_LIBRARY, "packagepath.library");
  }
}