...
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~
/**
 ** The model to support the configuration wizard in creating a Oracle Identity
 ** Manager Project.
 **
...
public abstract class BuildArtifact extends BuildPropertyAdapter {
  ...
  public static final String DEFAULT_PACKAGE = "oracle.iam.identity";
  ...
  /**
   ** Sets the configuration tag used by the component configuration.
   **
   ** @param  configuration      the configuration tag used by the component
   **                            configuration.
   */
  public void configuration(final boolean configuration) {
    this._hash.putBoolean(CONFIGURATION, configuration);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   configuration
  /**
   ** Returns the configuration tag for the project.
   **
   ** @return                    the configuration tag for the project.
   */
  public boolean configuration() {
    // the second parameter to getBoolean() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return this._hash.getBoolean(CONFIGURATION, false);
  }
