/*
    ...
    ------------------+-----------+-----------+-------------------------------
    11.1.1.3.37.60.34  2013-05-25  DSteding    First release version
 ...
 ** Manager application deployment import.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.60.34
 */
public class Request extends BuildPropertyAdapter {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "oim-request-ant";
   ...
   ** "new Request()" and enforces use of the public factory method below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  public Request(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.DEPLOYMENT_REQUEST_PROJECT));
  }
  ...
  public String description() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(DESCRIPTION, Manifest.string(Manifest.DEPLOYMENT_REQUEST_DESCRIPTION));
  }
  ...
  // Method:   instance
  /**
   ** Returns an instance of this {@link Request}.
   ** <p>
   ** This method tries to find an existing instance of a {@link Request} using
   ** {@link Manifest#DEPLOYMENT_REQUEST} in the design time objects of the
   ...
   **
   ** @return                    the <code>Request</code> instance obtained from
   **                            the specifed {@link TraversableContext}.
   */
  public static Request instance(final TraversableContext context) {
    Request instance = (Request)context.getDesignTimeObject(Manifest.DEPLOYMENT_REQUEST);
    if (instance == null) {
      instance = new Request(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.DEPLOYMENT_REQUEST, instance);
    }
    return instance;
  }
}