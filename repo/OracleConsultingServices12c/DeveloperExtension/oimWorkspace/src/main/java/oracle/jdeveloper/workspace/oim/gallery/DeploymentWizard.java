...
////////////////////////////////////////////////////////////////////////////////
// final class DeploymentWizard
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~~~~
/**
 ** Implementation of the "Oracle Identity Manager Deployment Project" gallery
 ** item.
 **
 ...
 */
public final class DeploymentWizard extends ProjectWizard {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>DeploymentWizard</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public String getShortLabel() {
    return Manifest.string(Manifest.OIM_DEPLOYMENT);
  }
  ...
  public ProjectTemplate projectTemplate() {
    return Feature.lookupProjectTemplate(Manifest.OIM_DEPLOYMENT);
  }
}