 ...
 */
public class SOAPreference extends BuildPropertyAdapter {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "soa-preferences";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>SOAPreference</code>.
   ** <br>
   ...
   */
  public SOAPreference(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.SOA_PREFERENCE_PROJECT));
  }
  ...
  // Method:   instance
  /**
   ** Returns an instance of this {@link SOAPreference}.
   ** <p>
   ** This method tries to find an existing instance of a
   ** {@link SOAPreference} using {@link Manifest#SOA_PREFERENCE} in the
   ...
   */
  public static SOAPreference instance(final TraversableContext context) {
    SOAPreference instance = (SOAPreference)context.getDesignTimeObject(Manifest.SOA_PREFERENCE);
    if (instance == null) {
      instance = new SOAPreference(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.SOA_PREFERENCE, instance);
    }
    return instance;
  }
}