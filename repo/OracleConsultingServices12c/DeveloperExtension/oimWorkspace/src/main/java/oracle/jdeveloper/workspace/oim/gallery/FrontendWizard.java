...
////////////////////////////////////////////////////////////////////////////////
// final class FrontendWizard
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~~
/**
 ** Implementation of the "Oracle Identity Manager Frontend Project" gallery
 ** item.
 **
 ...
 */
public final class FrontendWizard extends ProjectWizard {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>FrontendWizard</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public String getShortLabel() {
    return Manifest.string(Manifest.OIM_FRONTEND);
  }
  ...
  public ProjectTemplate projectTemplate() {
    return Feature.lookupProjectTemplate(Manifest.OIM_FRONTEND);
  }
}