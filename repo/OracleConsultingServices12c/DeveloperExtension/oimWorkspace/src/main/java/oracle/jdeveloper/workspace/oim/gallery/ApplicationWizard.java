...
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** Implementation of the "Oracle Identity Manager Application" gallery item.
 **
...
public class ApplicationWizard extends AbstractWizard {
  ...
  // ~~~~~ ~~~~
  /**
   ** Implementation of the "Oracle Identity Manager Application" dialog page
   ** flow.
   */
  private class Flow extends TemplateApplicationWizard {
    ...
    public final void update(final Object observed, final UpdateMessage change) {
      ...
      final PropertyChangeEvent event = (PropertyChangeEvent)change.getProperty(TechnologyScopeConfiguration.TECHNOLOGY_SCOPE_PROPERTY);
      if (event != null)
    ...
    protected TemplateObjectSequence createTechnologySequence(final TraversableContext context) {
      ...
      , registry.getTechId(oracle.jdeveloper.workspace.iam.Manifest.SOA_SERVER)
