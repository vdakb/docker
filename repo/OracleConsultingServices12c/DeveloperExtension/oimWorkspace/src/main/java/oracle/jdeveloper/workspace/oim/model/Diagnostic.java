 ...
 ** Manager Diagnostic Project.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class Diagnostic extends BuildArtifact {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE                = "oim-diagnostic-ant";
  private static final String TEMPLATE            = Manifest.BUILDFILE_PACKAGE + "." + FILE;
  private static final String DIAGNOSTIC          = "diagnostic";
  private static final String DEFAULT_APPLICATION = "ocs-diagnostic";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Diagnostic</code>.
   ** <br>
   ...
   */
  private Diagnostic(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
   ...
   ** using {@link #DIAGNOSTIC} in the design time objects of the specified
   ...
   */
  public static Diagnostic instance(final TraversableContext context) {
    Diagnostic instance = (Diagnostic)context.getDesignTimeObject(DIAGNOSTIC);
    if (instance == null) {
      instance = new Diagnostic(HashStructure.newInstance());
      context.putDesignTimeObject(DIAGNOSTIC, instance);
    }
    return instance;
  }
}