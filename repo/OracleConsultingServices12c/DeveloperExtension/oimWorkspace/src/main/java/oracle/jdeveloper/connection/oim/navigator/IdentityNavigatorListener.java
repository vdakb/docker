/*
    ...
    File        :   IdentityNavigatorListener.java
...
////////////////////////////////////////////////////////////////////////////////
// class IdentityNavigatorListener
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~
/**
 ...
 */
public class IdentityNavigatorListener implements ViewSelectionListener {
  ...
  /**
   ** The <code>IdentityNavigatorListener</code> implements the singleton
   ** pattern.
   ** <br>
   ** The static attribute {@link #instance} holds this single instance.
   */
  static IdentityNavigatorListener instance = new IdentityNavigatorListener();
  ...
  private final List<EndpointElement> opening = new ArrayList<EndpointElement>();
  ...
  public class Adapter extends MouseAdapter {
    ...
    public void mouseClicked(final MouseEvent event) {
      ...
      if (object instanceof CustomTree) {
        ...
        if (path != null) {
          element = IdentityNavigatorListener.this.lastObject(tree);
        }
      }
      else if (object instanceof JList) {
        element = IdentityNavigatorListener.this.lastObject(event.getPoint(), (JList)object);
      }
      if (element == null)
        return;

      IdentityNavigatorListener.this.openSelected(element);
    }
    ...
    public void mousePressed(final MouseEvent event) {
      IdentityNavigatorListener.this.rightClick = event.getModifiers() == 4 || event.getModifiers() == 8;
      IdentityNavigatorListener.this.cancelPendingChanges();
      IdentityNavigatorListener.this.mousePressed = true;
    }
    ...
    public void mouseReleased(final MouseEvent event) {
      ...
      if (object instanceof CustomTree) {
        ...
        element = IdentityNavigatorListener.this.lastObject(customTree);
        bl = customTree.getPathForLocation(event.getX(), event.getY()) != null;
      }
      else if (object instanceof JList) {
        element = IdentityNavigatorListener.this.lastObject(event.getPoint(), (JList)object);
        bl = element != null;
      ...
      if (element != null) {
        IdentityNavigatorListener.this.selectionChange = element;
      }
      if (IdentityNavigatorListener.this.selectionChanged && bl) {
        IdentityNavigatorListener.this.doPendingChanges();
        return;
      }
      IdentityNavigatorListener.this.mouseReleased = true;
    }
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>IdentityNavigatorListener</code> that allows
   ** use as a JavaBean.
   ** <br>
   ...
   ** Default Constructor
   */
  private IdentityNavigatorListener() {
    // ensure inheritance
    super();
  }
  ...
  // Method:   instance
  /**
   ** The <code>IdentityNavigatorListener</code> is a singleton class.
   ** This method gets this manager's single instance.
   **
   ** @return                    the <code>IdentityNavigatorListener</code>
   **                            single instance.
   */
  public static synchronized IdentityNavigatorListener instance() {
    return instance;
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   openEditor
  private Editor openEditor(final Context context, final boolean focus) {
    return openEditor(context, focus, null);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   openEditor
  private Editor openEditor(final Context context, final boolean focus, final Class<? extends Editor> editorClass) {
    final OpenEditorOptions option = new OpenEditorOptions(context, editorClass);
    option.setFlags(focus ? OpenEditorOptions.FOCUS : OpenEditorOptions.RAISE);
    final Editor editor = openEditor(option);
    if (!focus) {
      SwingUtilities.invokeLater(
        new Runnable() {
          ...
          public void run() {
            ...
            IdentityNavigatorListener.this.openEditor(option);
          }
        }
      );
    }
  ...
  private Editor openEditor(final OpenEditorOptions option) {
    ...
    try {
      waitCursor.show();
      return EditorManager.getEditorManager().openEditor(option);
    }
    finally {
      waitCursor.hide();
      this.opening.clear();
  ...
  private void doPendingChanges() {
    final EndpointElement element = this.selectionChange;
    cancelPendingChanges();
    openSelected(element);
  }

  //////////////////////////////////////////////////////////////////////////////
  // Method:   cancelPendingChanges
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   openSelected
  private void openSelected(final EndpointElement element) {
    if (this.rightClick || this.opening.contains(element))
      return;

    this.opening.add(element);
  }
