...
import oracle.jdeveloper.workspace.dip.Library;
import oracle.jdeveloper.workspace.dip.Manifest;

import oracle.jdeveloper.workspace.dip.model.Plugin;

import oracle.jdeveloper.workspace.dip.parser.PluginHandler;

////////////////////////////////////////////////////////////////////////////////
// class PluginConfigurator
// ~~~~~ ~~~~~~~~~~~~~~~~~~
/**
 ** The configurator to setup Oracle Integration Platform Plug-In projects.
 **
...
class PluginConfigurator extends TemplateProjectConfigurator {
  ...
  public final void templateFeaturePreview(final TemplateFolder workspaceFolder) {
    ...
    // we assume the template specifies the pattern #{dip.preferences} to
  ...
  protected final void configureClassPath() {
    ...
    settings.addLibrary(Library.DIP_SERVER_ID,     false);
    settings.addLibrary(Library.HST_FOUNDATION_ID, false);
    settings.addLibrary(Library.DIP_FOUNDATION_ID, false);
  }
   ...
   **                            configure Oracle Integration Platform Plug-In
   **                            {@link Project}s.
   */
