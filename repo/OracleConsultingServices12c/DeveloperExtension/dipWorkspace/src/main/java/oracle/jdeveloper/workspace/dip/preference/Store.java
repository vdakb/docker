...
// ~~~~~ ~~~~~
/**
 ** This is a preferences object, used as the data model for Integration
 ** Platform preferences.
 ** <p>
 ** It consists of the propertiy, DIP Foundation Framework Home, which you can
...
public final class Store extends FeaturePreference {
   ...
   **                            the Oracle Integration Platform development
   **                            will happens.
   */
  @Override
   ...
   **
   ** @return                    the release of Oracle Integration Platform used
   **                            for development.
   */
  @Override
