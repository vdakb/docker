...
public class Manifest extends ListResourceBundle {
   ...
   */
  public static final String FEATURE                     = "dip";

  public static final String FEATURE_RULE                = "dip-extension-state";
  public static final String GALLERY_RULE                = "dip-workspace";
  ...
  public static final String BUILDFILE_PACKAGE           = "template.dip";

  /** identifier to maintain the DIP Server properties */
  public static final String DIP_SERVER                  = FEATURE         + ".server";
  public static final String DIP_SERVER_PROJECT          = DIP_SERVER      + ".project";
  public static final String DIP_SERVER_DESCRIPTION      = DIP_SERVER      + ".description";
  /** identifier to maintain the DIP build preferences */
  ...
  /** identifier to maintain the DIP ANT build targets properties */
  public static final String TARGET                      = FEATURE         + ".targets";
  public static final String TARGET_PROJECT              = TARGET          + ".project";
  /** identifier to maintain the DIP ANT plugin extension */
  ...
  private static final String CONTENT[][] = {
    { FEATURE,                     "Oracle Integration Platform" }
  ...
  , { DESCRIPTION,                 "Support for development of Oracle Directory Integration Platform components" }

  , { TECHNOLOGY,                  "Integration Platform" }
  , { PROJECT_CONFIG,              "Refactor &Build Files" }
  , { PROJECT_CONFIG_ICON,         "res:/oracle/jdeveloper/workspace/dip/gallery/pathlib.png" }
  ...
  , { PROJECT_RUNTIME_ICON,        "res:/oracle/jdeveloper/workspace/dip/gallery/pathant.png" }
  , { PROJECT_RUNTIME_DESCRIPTION, "Regenerates the ANT classpath" }
  , { APPLICATION,                 "Integration Platform Application" }
  , { APPLICATION_ICON,            "/oracle/jdeveloper/workspace/dip/gallery/application.png" }
  , { APPLICATION_DESCRIPTION,     "Creates a Integration Platform application.\nThe application consists of one or more Integration Platform projects for the plugin components." }
  , { PREFERENCE,                  "Integration Platform Application Properties" }
  , { PREFERENCE_PROJECT,          "Integration Platform Application Properties" }
  , { TARGET,                      "Integration Platform Application Targets" }
  , { TARGET_PROJECT,              "Integration Platform Application Targets" }
  , { PLUGIN,                      "Integration Platform Plug-In" }
  , { PLUGIN_ICON,                 "/oracle/jdeveloper/workspace/dip/gallery/application.png" }
  , { PLUGIN_PROJECT,              "Integration Platform Application Targets" }
  , { PLUGIN_DESCRIPTION,          "Launches the Create Integration Platform Plug-In project wizard, with which you create an Integration Platform project using new or existing service components like Plug-Ins." }

  , { DIP_SERVER,                  "DIP Server Properties" }
  , { DIP_SERVER_PROJECT,          "DIP Server Properties" }
  , { DIP_SERVER_DESCRIPTION,      "The properties configured in an ANT property file describing the connection to an Integration PlatformIntegration Platform used during deployments.\n The connection properties usually used to export or import artifacts through the Deployment Manager" }
  , { CONNECTION,                  "Integration Platform Connection" }
  ...
  , { CONNECTION_ICON,             "/oracle/jdeveloper/connection/dip/gallery/connection-wizard.png" }
  , { CONNECTION_DESCRIPTION,      "Launches the Create Integration Platform Connection dialog, in which you create and edit connections.\nIf the new connection is created within the application, it will be listed in the Application Resources panel. If it is created as an IDE Connection, it will appear in the Resources window and be available for reuse." }

  , { Library.DIP_SERVER_ID,       Library.DIP_SERVER_NAME + " provides the base functionality to communicate with an Integration Platform 12c" }
  ...
  , { Library.DIP_FOUNDATION_ID,   Library.DIP_FOUNDATION_NAME + " is the abstraction layer to compose the functionality provided by " + Library.DIP_SERVER_NAME + " on a higher level" }
  };
