...
package oracle.jdeveloper.workspace.dip.gallery;
...
import oracle.jdeveloper.workspace.dip.project.Configurator;

////////////////////////////////////////////////////////////////////////////////
// class ApplicationWizard
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** Implementation of the "Oracle Integration Platform Application" gallery
 ** item.
 **
...
public class ApplicationWizard extends AbstractWizard {
  ...
  // ~~~~~ ~~~~
  /**
   ** Implementation of the "Integration Platform Application" dialog page
   ** flow.
   */
  private class Flow extends TemplateApplicationWizard {
    ...
    protected TemplateObjectSequence createTechnologySequence(final TraversableContext context) {
      ...
      return new TemplateApplicationSequence(context, new TechId[0]);
    }
