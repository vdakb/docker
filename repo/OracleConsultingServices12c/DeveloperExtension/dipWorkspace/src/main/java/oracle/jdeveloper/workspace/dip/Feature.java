...
import oracle.jdeveloper.workspace.dip.gallery.PluginWizard;
import oracle.jdeveloper.workspace.dip.gallery.ApplicationWizard;
 ...
 ** handle Directory Integration Platform artifacts.
 **
...
public class Feature extends AbstractAddin {
   ...
   ** technology related to Oracle Integration Platform.
   **
  ...
  /**
   ** Returns the {@link TechId} registered in Oracle JDeveloper as the
   ** technology related to Oracle Integration Platform Plug-Ins.
   **
   ** @return                    the {@link TechId} registered in Oracle
   **                            JDeveloper as the technology related to Oracle
   **                            Integration Platform Plug-Ins.
   */
   ...
   ** Integration Platform and registers the gallery items for each of them.
   */
  ...
  /**
   ** Creates the project template specific for Oracle Integration Platform
   ** Plug-In and registers a gallery item for it.
   **
   ** @return                    the created project template specific for
   **                            Oracle Integration Platform Plug-In development.
   */
  ...
  /**
   ** Creates the application template specific for Oracle Integration Platform
   ** development and registers a gallery item for it.
   **
   ** @return                    the created project template specific for
   **                            Oracle Integration Platform development.
   */
  private ApplicationTemplate createApplicationTemplate(final List<ProjectTemplate> project) {
    ...
    final TechnologyScope    scope    = new TechnologyScope();
    scope.add(registry.getTechId(oracle.jdeveloper.workspace.iam.Manifest.TECHNOLOGY));
    scope.add(registry.getTechId(oracle.jdeveloper.workspace.dip.Manifest.TECHNOLOGY));
