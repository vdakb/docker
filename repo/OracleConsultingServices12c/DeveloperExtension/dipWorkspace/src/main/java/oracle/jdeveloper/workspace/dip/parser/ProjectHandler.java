...
public class ProjectHandler extends ANTFileHandler {
  ...
  public static final String DESCRIPTION      = "dip.description";
  public static final String DESTINATION      = "dip.destination";
  public static final String APPLICATION      = "dip.application";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:3192163247075204079")
  private static final long  serialVersionUID = -5411213732992057026L;
