 ...
 ** using reflection, the IDE framework ddip not require that it is public (only
...
public class Panel extends FeatureProjectPanel {
  ...
  // compatible with
  @SuppressWarnings("compatibility:2779635617236720430")
  private static final long serialVersionUID = 8515438273962617940L;
