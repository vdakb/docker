...
public class Bundle extends ArrayResourceBundle {
  ...
  , /*  5 */ "Path to Integration Platform &Foundation Framework:"
  , /*  6 */ "Select to open the Choose Directory dialog, through which you can choose the location of Integration Platform Foundation Framework"
  , /*  7 */ "Path to Integration Platform Foundation Framework must be a valid directory"
  , /*  8 */ "Libraries"
  , /*  9 */ "&Release:"
  , /* 10 */ "&Generate"
  , /* 11 */ "&Manage..."
