...
// ~~~~~ ~~~~~
/**
 ** This is a preferences object, used as the data model for Unified Directory
 ** preferences.
 ** <p>
 ** It consists of the propertiy, OUD Foundation Framework Home, which you can
...
public final class Store extends FeaturePreference {
   ...
   **                            the Oracle Unified Directory development will
   **                            happens.
   */
  @Override
   ...
   **
   ** @return                    the release of Oracle Unified Directory used
   **                            for development.
   */
  @Override
