 ...
 ** using reflection, the IDE framework doud not require that it is public (only
...
public class Panel extends FeatureProjectPanel {
  ...
  // compatible with
  @SuppressWarnings("compatibility:4762978664008081982")
  private static final long serialVersionUID = -8574415454170629822L;
