...
public class ProjectHandler extends ANTFileHandler {
  ...
  public static final String DESCRIPTION      = "oud.description";
  public static final String DESTINATION      = "oud.destination";
  public static final String APPLICATION      = "oud.application";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:3262821046718578465")
