 ...
 ** Unified Directory in Oracle JDeveloper.
 **
...
public final class Library extends LibraryBuilder {
  ...
  public static final String              DEFAULT_VIEW        = "OUD Library Builder";
  public static final String              DEFAULT_FOLDER      = "UnifiedDirectory";
  public static final String              DEFAULT_RELEASE     = "12.2.1.4";
  public static final String              DEFAULT_DESCRIPTOR  = "oud-library";

  public static final String              OUD_SERVER_ID       = "oracle-oud-12c-platform";
  public static final String              OUD_SERVER_NAME     = "Unified Directory 12c Platform";
  ...
  public static final String              OUD_FOUNDATION_ID   = "oracle-oud-12c-foundation";
  public static final String              OUD_FOUNDATION_NAME = "Directory Server 12c Foundation";
  ...
  static {
    RELEASE.put("12.2.1.3", "Unified Directory 12.2.1.3");
    RELEASE.put("12.2.1.4", "Unified Directory 12.2.1.4");
  };
