...
import oracle.jdeveloper.workspace.oud.model.Plugin;

import oracle.jdeveloper.workspace.oud.parser.PluginHandler;

////////////////////////////////////////////////////////////////////////////////
// class PluginConfigurator
// ~~~~~ ~~~~~~~~~~~~~~~~~~
/**
 ** The configurator to setup Oracle Unified Directory Plug-In projects.
 **
...
class PluginConfigurator extends TemplateProjectConfigurator {
  ...
  public final void templateFeaturePreview(final TemplateFolder workspaceFolder) {
    ...
    // we assume the template specifies the pattern #{oud.preferences} to
  ...
  protected final void configureClassPath() {
    ...
    settings.addLibrary(Library.OUD_SERVER_ID,     false);
    settings.addLibrary(Library.HST_FOUNDATION_ID, false);
    settings.addLibrary(Library.OUD_FOUNDATION_ID, false);
  }
   ...
   **                            configure Oracle Unified Directory Agent
   **                            {@link Project}s.
   */
