...
import oracle.jdeveloper.workspace.oud.preference.Store;

import oracle.jdeveloper.workspace.oud.model.Target;
import oracle.jdeveloper.workspace.oud.model.Preference;

import oracle.jdeveloper.workspace.oud.parser.TargetHandler;
import oracle.jdeveloper.workspace.oud.parser.PreferenceHandler;

////////////////////////////////////////////////////////////////////////////////
// class WorkspaceConfigurator
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~
/**
 ** The configurator to setup Oracle Unified Directory application.
 **
...
class WorkspaceConfigurator extends TemplateApplicationConfigurator {
  ...
  /**
   ** Creates the ANT preferences build file for Oracle Unified Directory
   ** applications.
   **
   ...
   **                            preview.
   */
  protected static TemplateStream templatePreferencePreview(final TemplateFolder folder, final TraversableContext context) {
    ...
    item.add(PreferenceHandler.OUD_RELEASE, TemplateBundle.icon(TemplateBundle.NODE_PROPERTY_XML_ICON), store.release());
    ...
    item.include(oracle.jdeveloper.workspace.iam.Manifest.OUD_SERVER, folder.add(templateODSServerPreview(folder, context)));
    return item;
  }
  ...
  /**
   ** Creates the ANT target build file for Oracle Unified Directory
   ** applications.
   **
   ** @param  folder             the {@link TemplateFolder} where the file will
   **                            be created within.
   ...
   **                            preview.
   */
  protected static TemplateStream targetPreview(final TemplateFolder folder, final TraversableContext context) {
   ...
   **                            specific to configure Oracle Unified Directory
   **                            {@link Workspace}s.
   */
