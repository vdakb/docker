...
package oracle.jdeveloper.workspace.oud.model;
...
// ~~~~~ ~~~~~~~~~~
/**
 ** The model to support the configuration wizard in creating an Oracle Unified
 ** Directory application preferences.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class Preference extends BuildPropertyAdapter {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "ods-preferences";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Preference</code>.
   ** <br>
   ...
   */
  private Preference(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // the second parameter to string() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.PREFERENCE_PROJECT));
  }
   ...
   ** {@link BuildPropertyAdapter} using {@link Manifest#PREFERENCE} in the
   ...
   */
  public static Preference instance(final TraversableContext context) {
    Preference instance = (Preference)context.getDesignTimeObject(Manifest.PREFERENCE);
    if (instance == null) {
      instance = new Preference(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.PREFERENCE, instance);
    }
    return instance;
  }
}