...
import oracle.jdeveloper.workspace.oud.gallery.PluginWizard;
import oracle.jdeveloper.workspace.oud.gallery.ApplicationWizard;
 ...
 ** handle Unified Directory artifacts.
 **
...
public class Feature extends AbstractAddin {
   ...
   ** technology related to Oracle Unified Directory.
   **
  ...
  /**
   ** Returns the {@link TechId} registered in Oracle JDeveloper as the
   ** technology related to Oracle Unified Directory Plug-Ins.
   **
   ** @return                    the {@link TechId} registered in Oracle
   **                            JDeveloper as the technology related to Oracle
   **                            Unified Directory Plug-Ins.
   */
   ...
   ** Unified Directory and registers the gallery items for each of them.
   */
  ...
  /**
   ** Creates the project template specific for Oracle Unified Directory
   ** Plug-In and registers a gallery item for it.
   **
   ** @return                    the created project template specific for
   **                            Oracle Unified Directory Plug-In development.
   */
  ...
  /**
   ** Creates the application template specific for Oracle Unified Directory
   ** development and registers a gallery item for it.
   **
   ** @return                    the created project template specific for
   **                            Oracle Unified Directory development.
   */
  private ApplicationTemplate createApplicationTemplate(final List<ProjectTemplate> project) {
    ...
    final TechnologyScope    scope    = new TechnologyScope();
    scope.add(registry.getTechId(oracle.jdeveloper.workspace.iam.Manifest.TECHNOLOGY));
    scope.add(registry.getTechId(oracle.jdeveloper.workspace.oud.Manifest.TECHNOLOGY));
