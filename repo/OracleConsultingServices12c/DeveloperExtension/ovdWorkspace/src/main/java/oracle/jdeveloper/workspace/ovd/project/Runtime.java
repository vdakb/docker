/*
    ...
    12.2.1.3.42.60.100 2021-10-22  DSteding    Accomplished ANT runtime path
                                               with ods-deployment.jar.
*/
...
import oracle.jdeveloper.workspace.ovd.Bundle;
...
public class Runtime extends Command {
  ...
  public static final String COMMAND = "ovd.jpr.runtime";
 ...
 //////////////////////////////////////////////////////////////////////////////
  ...
  protected static void configure(final Project project) {
    ...
    final File     odsHome    = TemplateProjectConfigurator.toFolder(provider.foundation());
    ...
    classpath.add(TemplateProjectConfigurator.pathEntry(odsHome, "odsDeployment/lib/ods-deployment.jar"));
