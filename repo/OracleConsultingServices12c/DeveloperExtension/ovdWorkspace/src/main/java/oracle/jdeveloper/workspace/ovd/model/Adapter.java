...
package oracle.jdeveloper.workspace.ovd.model;
...
// ~~~~~ ~~~~~~~
/**
 ** The model to support the configuration wizard in creating an Oracle Virtual
 ** Directory Adapter Project.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class Adapter extends BuildArtifact {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE                = "ovd-targets";
  ...
  private static final String DEFAULT_APPLICATION = "ocs-adapter";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Adapter</code>.
   ** <br>
   ** This constructor is private to prevent other classes to use
   ** "new Adapter()" and enforces use of the public factory method below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  private Adapter(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.ADAPTER_PROJECT));
  }
   ...
   ** using {@link Manifest#ADAPTER} in the design time objects of the specified
   ...
   **
   ** @return                    the <code>Adapter</code> instance obtained from
   **                            the specifed {@link TraversableContext}.
   */
  public static Adapter instance(final TraversableContext context) {
    Adapter instance = (Adapter)context.getDesignTimeObject(Manifest.ADAPTER);
    if (instance == null) {
      instance = new Adapter(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.ADAPTER, instance);
    }
    return instance;
  }
}