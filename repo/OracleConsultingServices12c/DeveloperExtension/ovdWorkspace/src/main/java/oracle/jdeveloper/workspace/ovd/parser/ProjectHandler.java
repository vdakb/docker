...
public class ProjectHandler extends ANTFileHandler {
  ...
  public static final String DESCRIPTION      = "ovd.description";
  public static final String DESTINATION      = "ovd.destination";
  public static final String APPLICATION      = "ovd.application";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:349570414328190728")
  private static final long  serialVersionUID = 2613855135611235045L;
