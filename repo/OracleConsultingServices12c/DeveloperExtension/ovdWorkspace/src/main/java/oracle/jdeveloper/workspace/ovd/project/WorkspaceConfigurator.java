...
import oracle.jdeveloper.workspace.ovd.model.Target;
import oracle.jdeveloper.workspace.ovd.model.Preference;

import oracle.jdeveloper.workspace.ovd.parser.TargetHandler;
import oracle.jdeveloper.workspace.ovd.parser.PreferenceHandler;

////////////////////////////////////////////////////////////////////////////////
// class WorkspaceConfigurator
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~
/**
 ** The configurator to setup Oracle Virtual Directory application.
 **
...
class WorkspaceConfigurator extends TemplateApplicationConfigurator {
  ...
  public static TemplateStream templatePreferencePreview(final TemplateFolder folder, final TraversableContext context) {
    ...
    item.add(PreferenceHandler.OVD_RELEASE, TemplateBundle.icon(TemplateBundle.NODE_PROPERTY_XML_ICON), store.release());
    ...
    item.include(oracle.jdeveloper.workspace.iam.Manifest.OVD_SERVER, folder.add(templateODSServerPreview(folder, context)));
    return item;
  }
  ...
  /**
   ** Creates the ANT target build file for Oracle Virtual Directory
   ** applications.
   **
   ** @param  folder             the {@link TemplateFolder} where the file will
   **                            be created within.
   ...
   **                            specific to configure Oracle Virtual Directory
   **                            {@link Workspace}s.
   */
