...
// ~~~~~ ~~~~~~~~~~~~~
/**
 ** Implementation of the "Oracle Virtual Directory Adapter Project" gallery
 ** item.
 **
 ...
 */
public final class AdapterWizard extends AbstractWizard {
  ...
  // ~~~~~ ~~~~
  /**
   ** Implementation of the "Oracle Virtual Directory Adapter Project" dialog
   ** page
   ** flow.
   */
  ...
  public boolean invoke(final Context context) {
    ...
    final ProjectTemplate template = Feature.lookupProjectTemplate(Manifest.ADAPTER);
