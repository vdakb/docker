 ...
 ** Virtual Directory in Oracle JDeveloper.
 **
...
public final class Library extends LibraryBuilder {
  ...
  public static final String              DEFAULT_VIEW        = "OVD Library Builder";
  public static final String              DEFAULT_FOLDER      = "VirtualDirectory";
  public static final String              DEFAULT_RELEASE     = "12.2.1.4";
  public static final String              DEFAULT_DESCRIPTOR  = "ovd-library";

  public static final String              OVD_SERVER_ID       = "oracle-ovd-12c-platform";
  public static final String              OVD_SERVER_NAME     = "Virtual Directory 12c Server";
  ...
  public static final String              OVD_FOUNDATION_ID   = "oracle-ovd-12c-foundation";
  public static final String              OVD_FOUNDATION_NAME = "Directory Server 12c Foundation";
  ...
  static {
    RELEASE.put("12.2.1.3", "Virtual Directory 12.2.1.3");
    RELEASE.put("12.2.1.4", "Virtual Directory 12.2.1.4");
  };
