/*
    ...
    Subsystem   :   Virtual Directory Facilities
...
public class Manifest extends ListResourceBundle {
   ...
   */
  public static final String FEATURE                     = "ovd";

  public static final String FEATURE_RULE                = "ovd-extension-state";
  public static final String GALLERY_RULE                = "ovd-workspace";
  ...
  public static final String BUILDFILE_PACKAGE           = "template.ovd";

  /** identifier to maintain the OVD ANT build preference properties */
  ...
  /** identifier to maintain the OVD ANT build targets properties */
  public static final String TARGET                      = FEATURE         + ".targets";
  public static final String TARGET_PROJECT              = TARGET          + ".project";
  /** identifier to maintain the OVD ANT adapter extension */
  ...
  private static final String CONTENT[][] = {
    { FEATURE,                     "Oracle Virtual Directory" }
  ...
  , { DESCRIPTION,                 "Support for development of Oracle Virtual Directory components" }

  , { TECHNOLOGY,                  "Virtual Directory" }
  , { PROJECT_CONFIG,              "Regenerate &Build File" }
  , { PROJECT_CONFIG_ICON,         "res:/oracle/jdeveloper/workspace/ovd/gallery/pathlib.png" }
  ...
  , { PROJECT_RUNTIME_ICON,        "res:/oracle/jdeveloper/workspace/ovd/gallery/pathant.png" }
  , { PROJECT_RUNTIME_DESCRIPTION, "Regenerates the ANT classpath" }
  , { APPLICATION,                 "Virtual Directory Application" }
  , { APPLICATION_ICON,            "/oracle/jdeveloper/workspace/ovd/gallery/application.png" }
  , { APPLICATION_DESCRIPTION,     "Creates an Virtual Directory Application.\nThe application consists of one or more Virtual Directory projects for the adapter components." }
  , { PREFERENCE,                  "Virtual Directory Application Properties" }
  , { PREFERENCE_PROJECT,          "Virtual Directory Application Properties" }
  , { TARGET,                      "Virtual Directory Application Targets" }
  , { TARGET_PROJECT,              "Virtual Directory Application Targets" }
  , { ADAPTER,                     "Virtual Directory Adapter" }
  , { ADAPTER_ICON,                "/oracle/jdeveloper/workspace/ovd/gallery/application.png" }
  , { ADAPTER_PROJECT,             "Virtual Directory Application Targets" }
  , { ADAPTER_DESCRIPTION,         "Launches the Create Virtual Directory Adapter project wizard, with which you create a Virtual Directory project using new or existing service components like Adapters." }
  , { CONNECTION,                  "Virtual Directory Connection" }
  ...
  , { CONNECTION_DESCRIPTION,      "Launches the Create Virtual Directory Connection dialog, in which you create and edit connections.\nIf the new connection is created within the application, it will be listed in the Application Resources panel. If it is created as an IDE Connection, it will appear in the Resources window and be available for reuse." }

  , { Library.OVD_SERVER_ID,       Library.OVD_SERVER_ID + " provides the base functionality to communicate with an Virtual Directory Server 12c" }
  ...
  , { Library.OVD_FOUNDATION_ID,   Library.OVD_FOUNDATION_NAME + " is the abstraction layer to compose the functionality provided by " + Library.OVD_SERVER_NAME + " on a higher level" }
  };
