...
<xsl:stylesheet version   ="1.0"
  ...
  <xsl:template match="/changes">
    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
      <head>
        <title>Oracle<xsl:text disable-output-escaping="yes">&amp;</xsl:text>reg; Oracle JDeveloper Extension Release Notes</title>
      ...
      <body>
        <div>
          ...
          <tr>
            <td align="left" valign="top"><b>Oracle<xsl:text disable-output-escaping="yes">&amp;</xsl:text>reg; Identity Manager Framework Release Notes</b><br/></td>
          </tr>
          </table>
          <hr/>
          <a name="BEGIN" id="BEGIN"></a>
          <div>
            <h1>Oracle<xsl:text disable-output-escaping="yes">&amp;</xsl:text>reg; Oracle JDeveloper Extension</h1>
            <p>This document describes changes on top of Release 11.1.1.3.37 of Oracle JDeveloper Extension. It contains the following sections:</p>
            <p><xsl:text disable-output-escaping="yes">October 2014</xsl:text></p>
          </div>
        </div>
        <p>
        <ol>
