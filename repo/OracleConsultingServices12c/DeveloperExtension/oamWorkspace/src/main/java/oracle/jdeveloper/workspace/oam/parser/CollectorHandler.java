 ...
 */
public class CollectorHandler extends ProjectHandler {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  public static final String PACKAGEPATH       = "oam.packagepath.module";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:-689962786332850772")
  private static final long  serialVersionUID = -8816527636861160962L;
  ...
  // Method:   Ctor
  /**
   ** Creates a new <code>CollectorHandler</code> instance by converting the
   ...
   **                              <code>null</code>.
   */
  public CollectorHandler(final URL file) {
    // ensure inheritance
    super(file);
  }
  ...
  protected void register() {
    ...
    registerProperty(PACKAGEPATH, "packagepath");
  }
}