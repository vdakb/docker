/*
    ...
    11.1.1.3.37.60.71  2017-18-10  DSteding    Accomplished ANT runtime path
                                               configuration.
    12.2.1.3.42.60.74  2018-05-15  DSteding    Migration to JDeveloper 12c
    12.2.1.3.42.60.81  2018-05-15  DSteding    Accomplished ANT runtime path
                                               management API.
...
public class Runtime extends Command {
  ...
  public static final String COMMAND = "oam.jpr.runtime";
 ...
 //////////////////////////////////////////////////////////////////////////////
  ...
  protected static void configure(final Project project) {
    ...
    classpath.add(TemplateProjectConfigurator.pathEntry(fmwHome, "oracle.webservices_11.1.1/wsclient-rt.jar"));
    ...
    classpath.add(TemplateProjectConfigurator.pathEntry(fmwHome, "oracle.fabriccommon_11.1.1/fabric-common.jar"));
    ...
    classpath.add(TemplateProjectConfigurator.pathEntry(ocsHome, "CodeBaseServer/"   + provider.release() + "/lib/identitystore.jar"));
    classpath.add(TemplateProjectConfigurator.pathEntry(ocsHome, "CodeBaseServer/"   + provider.release() + "/lib/identitydirectory.jar"));
    classpath.add(TemplateProjectConfigurator.pathEntry(ocsHome, "CodeBaseServer/"   + provider.release() + "/lib/identity-provider.jar"));
    classpath.add(TemplateProjectConfigurator.pathEntry(ocsHome, "CodeBaseServer/"   + provider.release() + "/lib/config.jar"));
    classpath.add(TemplateProjectConfigurator.pathEntry(ocsHome, "CodeBaseServer/"   + provider.release() + "/lib/configmgmt.jar"));
    ...
    classpath.add(TemplateProjectConfigurator.pathEntry(ocsHome, "oamDeployment/lib/oam-deployment.jar"));
