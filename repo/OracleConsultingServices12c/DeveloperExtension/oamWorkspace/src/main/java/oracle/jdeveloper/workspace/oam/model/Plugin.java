...
// ~~~~~ ~~~~~~
/**
 ** The base class to support the configuration wizard in creating an Oracle
 ** Access Manager Plugin Project.
 **
...
public class Plugin extends BuildArtifact {
  ...
  private static final String FILE                = "oam-plugin-ant";
  ...
  private static final String DEFAULT_APPLICATION = "ocs-plugin";
   ...
   */
  public Plugin(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
   ...
   ** using {@link Manifest#PLUGIN} in the design time objects of the
   ...
   **
   ** @return                    the <code>Plugin</code> instance obtained
