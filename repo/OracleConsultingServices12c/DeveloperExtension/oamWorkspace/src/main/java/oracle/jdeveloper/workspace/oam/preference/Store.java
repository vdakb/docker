...
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** This is a preferences object, used as the data model for Access Manager
 ** preferences.
 ** <p>
 ** It consists of the propertiy, OAM Foundation Framework Home, which you can
...
public final class Store extends FeaturePreference {
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   release (Store)
  /**
   ** Returns the instance attribute <code>release</code>.
   **
   ** @return                    the release of Oracle Access Manager used for
   **                            development.
   */
  @Override
