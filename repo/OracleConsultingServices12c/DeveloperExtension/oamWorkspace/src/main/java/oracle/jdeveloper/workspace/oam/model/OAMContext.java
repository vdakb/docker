 ...
 ** Manager deployment context.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class OAMContext extends BuildPropertyAdapter {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "oam-context";
   ...
   */
  protected OAMContext(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.OAM_CONTEXT_PROJECT));
  }
  ...
  public String description() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(DESCRIPTION, Manifest.string(Manifest.OAM_CONTEXT_DESCRIPTION));
  }
   ...
   ** {@link BuildPropertyAdapter} using {@link Manifest#OAM_CONTEXT} in the
   ...
   */
  public static OAMContext instance(final TraversableContext context) {
    OAMContext instance = (OAMContext)context.getDesignTimeObject(Manifest.OAM_CONTEXT);
    if (instance == null) {
      instance = new OAMContext(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.OAM_CONTEXT, instance);
    }
    return instance;
  }
}