 ...
 */
public class AgentHandler extends ProjectHandler {
  ...
  // compatible with
  @SuppressWarnings("compatibility:1638034639165687547")
  private static final long  serialVersionUID = 8968468163285043934L;
  ...
  // Method:   Ctor
  /**
   ** Creates a new <code>AgentHandler</code> instance by converting the given
   ...
   **                              <code>null</code>.
   */
  public AgentHandler(final URL file) {
    // ensure inheritance
    super(file);
  }
}