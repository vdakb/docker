...
////////////////////////////////////////////////////////////////////////////////
// final class CollectorWizard
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~~~
/**
 ** Implementation of the "Oracle Access Manager Credential Collector Project"
 ** gallery item.
 **
 ...
 */
public final class CollectorWizard extends ProjectWizard {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>CollectorWizard</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public String getShortLabel() {
    return Manifest.string(Manifest.COLLECTOR);
  }
  ...
  public ProjectTemplate projectTemplate() {
    return Feature.lookupProjectTemplate(Manifest.COLLECTOR);
  }
}