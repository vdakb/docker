 ...
 ** using reflection, the IDE framework doam not require that it is public (only
...
public class Panel extends FeatureProjectPanel {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-7959558624148263316")
  private static final long serialVersionUID = 1378341655150675914L;
