...
////////////////////////////////////////////////////////////////////////////////
// final class LibraryWizard
// ~~~~~ ~~~~~ ~~~~~~~~~~~~~~
/**
 ** Implementation of the "Oracle Access Manager Library Project" gallery item.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.60.66
 */
public final class LibraryWizard extends ProjectWizard {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>LibraryWizard</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public String getShortLabel() {
    return Manifest.string(Manifest.LIBRARY);
  }
  ...
  public ProjectTemplate projectTemplate() {
    return Feature.lookupProjectTemplate(Manifest.LIBRARY);
  }
}