/*
    ...
    11.1.1.3.37.60.71  2017-10-27  DSteding    Deprecated Releases dropped.
 ...
 ** Access Manager in Oracle JDeveloper.
 **
...
public final class Library extends LibraryBuilder {
  ...
  public static final String              DEFAULT_VIEW        = "OAM Library Builder";
  public static final String              DEFAULT_FOLDER      = "AccessManager";
  public static final String              DEFAULT_RELEASE     = "12.2.1.3";
  public static final String              DEFAULT_DESCRIPTOR  = "oam-library";

  public static final String              OAM_SERVER_ID       = "oracle-oam-12c-server";
  public static final String              OAM_SERVER_NAME     = "Access Manager 12c Server";
  public static final String              OAM_PLUGIN_ID       = "oracle-oam-12c-plugin";
  public static final String              OAM_PLUGIN_NAME     = "Access Manager 12c Plugin";
  public static final String              OAM_AGENT_ID        = "oracle-oam-12c-agent";
  public static final String              OAM_AGENT_NAME      = "Access Manager 12c Agent";
  ...
  public static final String              OAM_FOUNDATION_ID   = "oracle-oam-12c-foundation";
  public static final String              OAM_FOUNDATION_NAME = "Oracle Access Manager 12c Foundation";

  public static final String              JSP_RUNTIME_ID      = "JSP Runtime";
  public static final String              JSP_RUNTIME_NAME    = JSP_RUNTIME_ID;
  ...
  static {
    RELEASE.put("12.2.1.3", "Access Manager 12.2.1.3");
    RELEASE.put("12.2.1.4", "Access Manager 12.2.1.4");
  };
