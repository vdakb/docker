...
public class ProjectHandler extends ANTFileHandler {
  ...
  public static final String DESCRIPTION      = "oam.description";
  public static final String DESTINATION      = "oam.destination";
  public static final String APPLICATION      = "oam.application";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:3950093609083717342")
  private static final long serialVersionUID = 2304246502168574172L;
