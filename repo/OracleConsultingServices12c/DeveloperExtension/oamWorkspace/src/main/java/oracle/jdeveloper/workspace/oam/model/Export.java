 ...
 ** Manager application deployment export.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class Export extends BuildPropertyAdapter {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "oam-export-ant";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Export</code>.
   ** <br>
   ** This constructor is private to prevent other classes to use
   ** "new Export()" and enforces use of the public factory method below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  private Export(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.DEPLOYMENT_EXPORT_PROJECT));
  }
  ...
  public String description() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(DESCRIPTION, Manifest.string(Manifest.DEPLOYMENT_EXPORT_DESCRIPTION));
  }
  ...
  // Method:   instance
  /**
   ** Returns an instance of this {@link Export}.
   ** <p>
   ** This method tries to find an existing instance of a {@link Export} using
   ** {@link Manifest#DEPLOYMENT_EXPORT} in the design time objects of the
   ...
   **
   ** @return                    the <code>Export</code> instance obtained from
   **                            the specifed {@link TraversableContext}.
   */
  public static Export instance(final TraversableContext context) {
    Export instance = (Export)context.getDesignTimeObject(Manifest.DEPLOYMENT_EXPORT);
    if (instance == null) {
      instance = new Export(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.DEPLOYMENT_EXPORT, instance);
    }
    return instance;
  }
}