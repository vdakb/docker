...
// ~~~~~~~~ ~~~~~ ~~~~~~~~~~~~~
/**
 ** Abstract implementation of any "Oracle Access Manager Project" gallery item.
 **
...
public abstract class ProjectWizard extends AbstractWizard {
  ...
  // ~~~~~ ~~~~
  /**
   ** Implementation of the "Access Manager Project" dialog page flow.
   */
  ...
  //////////////////////////////////////////////////////////////////////////////
  // Method:   workspaceTemplate (DefaultProjectWizard)
  /**
   ** Returns the application template id of the owning workspace this
   ** <code>TemplateProjectWizard</code> expects to get operational.
   **
   ** @return                    the application template id of the owning
   **                            workspace this
   ...
   **                            get operational.
   */
  public final String workspaceTemplate() {
