 ...
 ** preferences stored in the {@link OAMServer} model.
 ** <p>
 ...
 */
public class OAMServerPage extends TemplateFeaturePage {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-1102466653954311231")
  private static final long           serialVersionUID = -5229354927914273063L;
  ...
  private transient OAMServer         provider         = null;
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>OAMServerPage</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  protected void initializeComponent() {
    ...
    this.cloneBrowse.addActionListener(new FeatureClone(this, Manifest.OAM_SERVER));
  ...
  public void onEntry(final TraversableContext context) {
    ...
    this.provider = OAMServer.instance(context);
