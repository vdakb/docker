...
////////////////////////////////////////////////////////////////////////////////
// final class AgentWizard
// ~~~~~ ~~~~~ ~~~~~~~~~~~
/**
 ** Implementation of the "Oracle Access Manager Agent Project" gallery item.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public final class AgentWizard extends ProjectWizard {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>AgentWizard</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public String getShortLabel() {
    return Manifest.string(Manifest.AGENT);
  }
  ...
  public ProjectTemplate projectTemplate() {
    return Feature.lookupProjectTemplate(Manifest.AGENT);
  }
}