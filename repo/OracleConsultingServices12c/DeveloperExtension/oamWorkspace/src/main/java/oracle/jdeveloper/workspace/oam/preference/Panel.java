...
package oracle.jdeveloper.workspace.oam.preference;
 ...
 ** preferences stored in the {@link Store} model.
 ** <p>
...
public final class Panel extends FeaturePreferencePanel {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-216468387939093004")
  private static final long           serialVersionUID = -5867235301311746116L;
  ...
  protected boolean commit(final boolean destructive) {
    try {
      super.commitWorkspace(this.workspaceEdit.getText(),  Bundle.string(Bundle.WORKSPACE_FAILURE), destructive);
      super.commitFoundation(this.foundationEdit.getURL(), Bundle.string(Bundle.FRAMEWORK_FAILURE), destructive);
      super.commitRelease(((String)this.releaseList.getSelectedItem()).trim());
