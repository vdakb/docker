...
import oracle.jdeveloper.workspace.oam.project.Configurator;

////////////////////////////////////////////////////////////////////////////////
// class ApplicationWizard
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** Implementation of the "Oracle Access Manager Application" gallery item.
 **
...
public class ApplicationWizard extends AbstractWizard {
  ...
  // ~~~~~ ~~~~
  /**
   ** Implementation of the "Access Manager Application" dialog page flow.
   */
  private class Flow extends TemplateApplicationWizard {
    ...
    protected TemplateObjectSequence createTechnologySequence(final TraversableContext context) {
      ...
      , registry.getTechId(oracle.jdeveloper.workspace.iam.Manifest.OAM_SERVER)
      };
