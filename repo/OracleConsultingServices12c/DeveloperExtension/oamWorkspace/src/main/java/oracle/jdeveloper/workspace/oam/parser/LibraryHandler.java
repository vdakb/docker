...
public class LibraryHandler extends ProjectHandler {
  ...
  public static final String LIBRARY             = "oam.library";

  public static final String PACKAGEPATH_LIBRARY = "oam.packagepath.library";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:-6233855298726748559")
  private static final long  serialVersionUID    = -3922595367428419573L;
