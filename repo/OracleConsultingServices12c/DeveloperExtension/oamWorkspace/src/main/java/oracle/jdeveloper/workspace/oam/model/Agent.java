 ...
 ** Manager Agent Project.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class Agent extends BuildArtifact {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE                = "oam-agent-ant";
  ...
  private static final String DEFAULT_APPLICATION = "ocs-agent";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Agent</code>.
   ** <br>
   ** This constructor is private to prevent other classes to use
   ** "new Agent()" and enforces use of the public factory method below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  private Agent(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // the second parameter to string() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.AGENT_PROJECT));
  }
   ...
   ** using {@link Manifest#AGENT} in the design time objects of the specified
   ...
   **
   ** @return                    the <code>Agent</code> instance obtained from
   **                            the specifed {@link TraversableContext}.
   */
  public static Agent instance(final TraversableContext context) {
    Agent instance = (Agent)context.getDesignTimeObject(Manifest.AGENT);
    if (instance == null) {
      instance = new Agent(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.AGENT, instance);
    }
    return instance;
  }
}