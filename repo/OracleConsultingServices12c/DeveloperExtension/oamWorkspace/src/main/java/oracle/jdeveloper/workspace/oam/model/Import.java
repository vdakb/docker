 ...
 */
public class Import extends BuildPropertyAdapter {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "oam-import-ant";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Import</code>.
   ** <br>
   ** This constructor is private to prevent other classes to use
   ** "new Import()" and enforces use of the public factory method below.
   **
   ** @param  structure          the data provider to initialize the instance.
   */
  private Import(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.DEPLOYMENT_IMPORT_PROJECT));
  }
  ...
  public String description() {
    // The second parameter to getString() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(DESCRIPTION, Manifest.string(Manifest.DEPLOYMENT_IMPORT_DESCRIPTION));
  }
  ...
  // Method:   instance
  /**
   ** Returns an instance of this {@link Import}.
   ** <p>
   ** This method tries to find an existing instance of a {@link Import} using
   ** {@link Manifest#DEPLOYMENT_IMPORT} in the design time objects of the
   ...
   **
   ** @return                    the <code>Import</code> instance obtained from
   **                            the specifed {@link TraversableContext}.
   */
  public static Import instance(final TraversableContext context) {
    Import instance = (Import)context.getDesignTimeObject(Manifest.DEPLOYMENT_IMPORT);
    if (instance == null) {
      instance = new Import(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.DEPLOYMENT_IMPORT, instance);
    }
    return instance;
  }
}