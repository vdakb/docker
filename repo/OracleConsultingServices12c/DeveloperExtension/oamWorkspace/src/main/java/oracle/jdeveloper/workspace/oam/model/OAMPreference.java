 ...
 */
public class OAMPreference extends BuildPropertyAdapter {

  //////////////////////////////////////////////////////////////////////////////
  // static final attributes
  //////////////////////////////////////////////////////////////////////////////

  private static final String FILE         = "oam-preferences";
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>OAMPreference</code>.
   ** <br>
   ...
   */
  private OAMPreference(final HashStructure structure) {
    // ensure inheritance
    super(structure);
  }
  ...
  public String project() {
    // the second parameter to string() is a default value. Defaults are
    // stored in the persistent preferences file using a "placeholder".
    return string(PROJECT, Manifest.string(Manifest.OAM_PREFERENCE_PROJECT));
  }
   ...
   ** {@link BuildPropertyAdapter} using {@link Manifest#OAM_PREFERENCE} in the
   ...
   **
   ** @return                    the <code>OAMPreference</code> instance
   **                            obtained from the specifed
   **                            {@link TraversableContext}.
   */
  public static OAMPreference instance(final TraversableContext context) {
    OAMPreference instance = (OAMPreference)context.getDesignTimeObject(Manifest.OAM_PREFERENCE);
    if (instance == null) {
      instance = new OAMPreference(HashStructure.newInstance());
      context.putDesignTimeObject(Manifest.OAM_PREFERENCE, instance);
    }
    return instance;
  }
}