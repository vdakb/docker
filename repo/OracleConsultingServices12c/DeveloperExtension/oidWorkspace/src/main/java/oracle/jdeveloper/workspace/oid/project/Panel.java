 ...
 ** using reflection, the IDE framework doid not require that it is public (only
...
public class Panel extends FeatureProjectPanel {
  ...
  // compatible with
  @SuppressWarnings("compatibility:-7036280680732415699")
  private static final long serialVersionUID = 3737361462312008470L;
