/*
    ...
    Subsystem   :   Internet Directory Facilities
    ...
    @version 12.2.1.3.42.60.74  2015-12-27  DSteding    Removed Oracle from the product
...
public class Manifest extends ListResourceBundle {
   ...
   */
  public static final String FEATURE                     = "oid";

  public static final String FEATURE_RULE                = "oid-extension-state";
  public static final String GALLERY_RULE                = "oid-workspace";
  ...
  public static final String BUILDFILE_PACKAGE           = "template.oid";

  /** identifier to maintain the OID build preferences */
  ...
  /** identifier to maintain the OID ANT build targets properties */
  public static final String TARGET                      = FEATURE         + ".targets";
  public static final String TARGET_PROJECT              = TARGET          + ".project";
  /** identifier to maintain the OID ANT plugin extension */
  ...
  private static final String CONTENT[][] = {
    { FEATURE,                     "Oracle Internet Directory" }
  ...
  , { DESCRIPTION,                 "Support for development of Oracle Internet Directory components" }

  , { TECHNOLOGY,                  "Internet Directory" }
  , { PROJECT_CONFIG,              "Regenerate &Build File" }
  , { PROJECT_CONFIG_ICON,         "res:/oracle/jdeveloper/workspace/oid/gallery/pathlib.png" }
  ...
  , { PROJECT_RUNTIME_ICON,        "res:/oracle/jdeveloper/workspace/oid/gallery/pathant.png" }
  , { PROJECT_RUNTIME_DESCRIPTION, "Regenerates the ANT classpath" }
  , { APPLICATION,                 "Internet Directory Application" }
  , { APPLICATION_ICON,            "/oracle/jdeveloper/workspace/oid/gallery/application.png" }
  , { APPLICATION_DESCRIPTION,     "Creates a Internet Directory application.\nThe application consists of one or more Internet Directory projects for the plugin components." }
  , { PREFERENCE,                  "Internet Directory Application Properties" }
  , { PREFERENCE_PROJECT,          "Internet Directory Application Properties" }
  , { TARGET,                      "Internet Directory Application Targets" }
  , { TARGET_PROJECT,              "Internet Directory Application Targets" }
  , { PLUGIN,                      "Internet Directory Plug-In" }
  , { PLUGIN_ICON,                 "/oracle/jdeveloper/workspace/oid/gallery/application.png" }
  , { PLUGIN_PROJECT,              "Internet Directory Application Targets" }
  , { PLUGIN_DESCRIPTION,          "Launches the Create Internet Directory Plug-In project wizard, with which you create an Internet Directory project using new or existing service components like Plug-Ins." }
  , { CONNECTION,                  "Internet Directory Connection" }
  ...
  , { CONNECTION_ICON,             "/oracle/jdeveloper/connection/oid/gallery/connection-wizard.png" }
  , { CONNECTION_DESCRIPTION,      "Launches the Create Internet Directory Connection dialog, in which you create and edit connections.\nIf the new connection is created within the application, it will be listed in the Application Resources panel. If it is created as an IDE Connection, it will appear in the Resources window and be available for reuse." }

  , { Library.OID_SERVER_ID,        Library.OID_SERVER_NAME + " provides the base functionality to communicate with an Internet Directory Server 12c" }
  ...
  , { Library.OID_FOUNDATION_ID,    Library.OID_FOUNDATION_NAME + " is the abstraction layer to compose the functionality provided by " + Library.OID_SERVER_NAME + " on a higher level" }
  };
