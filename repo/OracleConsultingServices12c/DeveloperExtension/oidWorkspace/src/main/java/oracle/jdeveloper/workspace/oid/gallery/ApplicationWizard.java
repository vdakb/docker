...
package oracle.jdeveloper.workspace.oid.gallery;
...
import oracle.jdeveloper.workspace.oid.Feature;
import oracle.jdeveloper.workspace.oid.Library;
import oracle.jdeveloper.workspace.oid.Manifest;

import oracle.jdeveloper.workspace.oid.preference.Store;

import oracle.jdeveloper.workspace.oid.project.Configurator;

////////////////////////////////////////////////////////////////////////////////
// class ApplicationWizard
// ~~~~~ ~~~~~~~~~~~~~~~~~
/**
 ** Implementation of the "Oracle Internet Directory Application" gallery item.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 12.2.1.3.42.60.74
 ** @since   11.1.1.3.37.56.13
 */
public class ApplicationWizard extends AbstractWizard {
  ...
  // ~~~~~ ~~~~
  /**
   ** Implementation of the "Internet Directory Application" dialog page flow.
   */
  private class Flow extends TemplateApplicationWizard {
    ...
    ////////////////////////////////////////////////////////////////////////////
    // Method: TemplateObjectSequence (TemplateApplicationWizard)
    /**
    ...
    protected TemplateObjectSequence createTechnologySequence(final TraversableContext context) {
      ...
      , registry.getTechId(oracle.jdeveloper.workspace.iam.Manifest.ODS_SERVER)
      };
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>ApplicationWizard</code> that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public String getShortLabel() {
    return Manifest.string(Manifest.APPLICATION);
  }
  ...
  public boolean invoke(final Context context) {
    ...
    final ApplicationTemplate template = Feature.lookupApplicationTemplate(Manifest.APPLICATION);
