/*
    ...
    @version 12.2.1.3.42.60.74  2015-12-27  DSteding    Removed spaces in directory names
 ...
 ** Internet Directory in Oracle JDeveloper.
 **
...
public final class Library extends LibraryBuilder {
  ...
  public static final String              DEFAULT_VIEW        = "OID Library Builder";
  public static final String              DEFAULT_FOLDER      = "InternetDirectory";
  public static final String              DEFAULT_RELEASE     = "12.2.1.4";
  public static final String              DEFAULT_DESCRIPTOR  = "oid-library";

  public static final String              OID_SERVER_ID       = "oracle-oid-12c-platform";
  public static final String              OID_SERVER_NAME     = "Internet Directory 12c Platform";
  ...
  public static final String              OID_FOUNDATION_ID   = "oracle-oid-12c-foundation";
  public static final String              OID_FOUNDATION_NAME = "Directory Server 12c Foundation";
  ...
  static {
    RELEASE.put("12.2.1.3", "Internet Directory 12.2.1.3");
    RELEASE.put("12.2.1.4", "Internet Directory 12.2.1.4");
  };
