...
package oracle.jdeveloper.workspace.oid.preference;
...
// ~~~~~ ~~~~~
/**
 ** This is a preferences object, used as the data model for Internet Directory
 ** preferences.
 ** <p>
 ** It consists of the propertiy, OID Foundation Framework Home, which you can
...
public final class Store extends FeaturePreference {
   ...
   **                            the Oracle Internet Directory development will
   **                            happens.
   */
  @Override
   ...
   **
   ** @return                    the release of Oracle Internet Directory used
   **                            for development.
   */
  @Override
