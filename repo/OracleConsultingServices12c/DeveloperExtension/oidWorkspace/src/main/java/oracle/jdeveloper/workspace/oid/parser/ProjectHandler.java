...
public class ProjectHandler extends ANTFileHandler {
  ...
  public static final String DESCRIPTION      = "oid.description";
  public static final String DESTINATION      = "oid.destination";
  public static final String APPLICATION      = "oid.application";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:1877818948162842395")
  private static final long  serialVersionUID = 9083679829175960481L;
