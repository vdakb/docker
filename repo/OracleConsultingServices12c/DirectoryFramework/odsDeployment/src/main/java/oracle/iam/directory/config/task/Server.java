 ...
 ** @since   1.0.0.0
 */
public class Server extends FeaturePlatformTask {

  //////////////////////////////////////////////////////////////////////////////
  // instance attributes
  //////////////////////////////////////////////////////////////////////////////

  private final ConfigHandler.Server handler;
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Server</code> event handler that allows use as a
   ** JavaBean.
   ** <br>
  ...
  public Server() {
    ...
    // initialize instance
    this.handler = new ConfigHandler.Server(this);
  }
