...
// ~~~~~ ~~~~~~
/**
 ** Modifies an entry in the Directory Information Tree (DIT).
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
 */
public class Modify extends Transaction {
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Modify</code> event handler that allows use as a
   ** JavaBean.
   ** <br>
