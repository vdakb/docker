...
public class LDAPControl implements Cloneable
  ...
  // compatible with
  @SuppressWarnings("compatibility:178345725645001159")
   ...
   **                            associated with oid
   **
   ** @throws FeatureException   if the class parameter is not implementing
  ...
  public static void register(final String oid, final Class<Control> controlClass)
    ...
    if (!Control.class.isAssignableFrom(controlClass)) {
      ...
      throw new FeatureException(FeatureError.CLASSINVALID, arguments);
    }
    ...
    try {
      ...
      throw new FeatureException(FeatureError.CLASSCONSTRUCTOR, arguments);
    }
