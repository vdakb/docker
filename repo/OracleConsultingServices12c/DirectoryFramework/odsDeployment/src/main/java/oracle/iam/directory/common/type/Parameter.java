 ...
 ** applied on object definitions of Oracle Directory Service
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public class Parameter extends DataType {
  ...
  // Method:   name
  /**
   ** Returns the name of the parameter of the Directory Service object.
   **
  ...
  // Method:   value
  /**
   ** Returns the value for <code>name</code> to set on the Directory Service
   ** object.
   **
