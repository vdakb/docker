...
// ~~~~~ ~~~~~
/**
 ** <code>Format</code> defines the attribute restriction on values that can be
 ** passed to an {@link ExportSet} format.
 **
 ** @author  dieter.steding@oracle.com
 ** @version 1.0.0.0
 ** @since   1.0.0.0
...
public class Format extends EnumeratedAttribute {
  ...
  private static final String[] registry = {
    FeatureConstant.FORMAT_LDIF
  , FeatureConstant.FORMAT_DSML
  , FeatureConstant.FORMAT_JSON
  };
  ...
  // Method:   Ctor
  /**
   ** Constructs a <code>Format</code> task that allows use as a JavaBean.
   ** <br>
