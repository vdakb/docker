 ...
 ** rows belonging to <code>Vehicle Color</code>s.
 ** <p>
 ...
 ** @since   1.0.0.0
 */
public class ColorEOImpl extends EntityImpl {
  ...
  // Method:   Ctor
  /**
   ** Constructs an empty <code>ColorEOImpl</code> values object that allows use
   ** as a JavaBean.
   ** <br>
   ...
   ** <code>bka.employee.portal.vehicle.entity.ColorEO</code>
   ...
   **                            <code>oracle.hcm.model.entity.ColorEO</code>
   */
  public static synchronized EntityDefImpl getDefinitionObject() {
    return EntityDefImpl.findDefObject("bka.employee.portal.vehicle.entity.ColorEO");
  }
}