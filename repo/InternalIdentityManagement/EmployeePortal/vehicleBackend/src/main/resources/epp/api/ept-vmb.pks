-- D:\Project\Bundeskriminalamt12c\InternalIdentityManagement\EmployeePortal\portalBackend\..\vehicleBackend\src\main\resources\dbs\epp\api\ept-vmb.pks
--
-- Generated for Oracle Database 12c on Sun May 24 17:30:58 2020 by Server Generator 10.1.2.93.10

PROMPT Creating API Package Specification for Table 'ept_vehicle_brands'
--------------------------------------------------------------------------------
-- Name:        cg$ept_vehicle_brands
-- Description: cg$ept_vehicle_brands table API package declarations
--------------------------------------------------------------------------------
CREATE OR REPLACE PACKAGE cg$ept_vehicle_brands
IS

  called_from_package BOOLEAN := FALSE;

  -- Repository User-Defined Error Messages
  EPT_VMB_PK        CONSTANT VARCHAR2(10) := 'EPT-00106';

  -- Column default prompts. Format PSEQNO_COL
  P10ID             CONSTANT VARCHAR2(30) := 'Brand';
  ...
  P40NAME           CONSTANT VARCHAR2(30) := 'Name';
  P45ICON           CONSTANT VARCHAR2(30) := 'Symbol';

  cg$row ept_vehicle_brands%ROWTYPE;

  -- ept_vehicle_brands row type variable
  ...
  , icon            cg$row.icon%TYPE
  , the_rowid       ROWID
  );

  -- ept_vehicle_brands indicator type variable
  ...
  -- ept_vehicle_brands primary key type variable
  ...
  TYPE cg$table_type IS TABLE of ept_vehicle_brands%ROWTYPE
