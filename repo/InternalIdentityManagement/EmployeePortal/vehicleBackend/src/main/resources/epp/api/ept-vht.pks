-- D:\Project\Bundeskriminalamt12c\InternalIdentityManagement\EmployeePortal\portalBackend\..\vehicleBackend\src\main\resources\dbs\epp\api\ept-vht.pks
--
-- Generated for Oracle Database 12c on Sun May 24 17:30:58 2020 by Server Generator 10.1.2.93.10

PROMPT Creating API Package Specification for Table 'ept_vehicle_types'
--------------------------------------------------------------------------------
-- Name:        cg$ept_vehicle_types
-- Description: cg$ept_vehicle_types table API package declarations
--------------------------------------------------------------------------------
CREATE OR REPLACE PACKAGE cg$ept_vehicle_types
IS

  called_from_package BOOLEAN := FALSE;

  -- Repository User-Defined Error Messages
  EPT_VHT_PK        CONSTANT VARCHAR2(10) := 'EPT-00105';

  -- Column default prompts. Format PSEQNO_COL
  P10ID             CONSTANT VARCHAR2(30) := 'Type';
  ...
  cg$row ept_vehicle_types%ROWTYPE;

  -- ept_vehicle_types row type variable
  ...
  -- ept_vehicle_types indicator type variable
  ...
  -- ept_vehicle_types primary key type variable
  ...
  TYPE cg$table_type IS TABLE of ept_vehicle_types%ROWTYPE
