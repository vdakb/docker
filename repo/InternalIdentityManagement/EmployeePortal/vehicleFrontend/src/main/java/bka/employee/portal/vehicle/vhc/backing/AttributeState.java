...
*/
package bka.employee.portal.vehicle.vhc.backing;
...
public class AttributeState extends AbstractStep {
  ...
  public static final String  DETAIL_ITERATOR  = "ColorIterator";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:6830819497853779223")
  private static final long serialVersionUID = 4540740170138045384L;
