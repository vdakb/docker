...
public class AttributeState extends AbstractStep {
  ...
  public static final String           DETAIL_ITERATOR  = "BrandIterator";

  // the official serial version ID which says cryptically which version we're
  // compatible with
  @SuppressWarnings("compatibility:-7409670834181643608")
  private static final long            serialVersionUID = 6811360993895300366L;
