-- D:\Project\Bundeskriminalamt12c\InternalIdentityManagement\EmployeePortal\eppAplication\src\main\dbs\qms\api\qms-msp.pks
--
...
IS
  ...
  P20CODE             CONSTANT VARCHAR2(30) := 'Code';
  P30DESCRIPTION      CONSTANT VARCHAR2(30) := 'Description';
  P40SEVERITY         CONSTANT VARCHAR2(30) := 'Severity';
  P50LOGGING          CONSTANT VARCHAR2(30) := 'Logging Indicator';
  P60SUPPRESS_WARNING CONSTANT VARCHAR2(30) := 'Suppress Warning Indicator';
  P70SUPPRESS_ALWAYS  CONSTANT VARCHAR2(30) := 'Suppress Always Indicator';
  P100CONSTRAINT_NAME CONSTANT VARCHAR2(30) := 'Constraint Name';
  P105CREATED_BY      CONSTANT VARCHAR2(30) := 'Created By';
  P110CREATED_ON      CONSTANT VARCHAR2(30) := 'Created On';
  P115UPDATED_BY      CONSTANT VARCHAR2(30) := 'Updated By';
  P120UPDATED_ON      CONSTANT VARCHAR2(30) := 'Updated On';
