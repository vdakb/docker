-- D:\Project\Bundeskriminalamt12c\InternalIdentityManagement\EmployeePortal\portalBackend\src\main\resources\dbs\epp\api\ept-loc.pks
--
-- Generated for Oracle Database 12c on Sun May 24 17:02:48 2020 by Server Generator 10.1.2.93.10

PROMPT Creating API Package Specification for Table 'ept_locales'
--------------------------------------------------------------------------------
-- Name:        cg$ept_locales
-- Description: cg$ept_locales table API package declarations
--------------------------------------------------------------------------------
CREATE OR REPLACE PACKAGE cg$ept_locales
IS

  called_from_package BOOLEAN := FALSE;

  -- Repository User-Defined Error Messages
  EPT_LOC_PK        CONSTANT VARCHAR2(10) := 'EPT-00102';
  EPT_LOC_CK        CONSTANT VARCHAR2(10) := 'EPT-00301';

  -- Column default prompts. Format PSEQNO_COL
  P10ID             CONSTANT VARCHAR2(30) := 'Locale';
  ...
  cg$row ept_locales%ROWTYPE;

  -- ept_locales row type variable
  ...
  -- ept_locales indicator type variable
  ...
  -- ept_locales primary key type variable
  ...
  TYPE cg$table_type IS TABLE of ept_locales%ROWTYPE
