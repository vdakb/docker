-- D:\Project\Bundeskriminalamt12c\InternalIdentityManagement\EmployeePortal\eppAplication\src\main\dbs\qms\api\qms-msg.pks
--
-- Generated for Oracle Database 12c on Fri Apr 24 10:07:06 2020 by Server Generator 10.1.2.93.10

/*****************************************************************************************
Purpose  Server Side package used to access the database (return the error message
         information from the error handling tables.
         Keeps all user defined settings as package variables like end-user langauge,
         debug flag etc.
...
*****************************************************************************************/
PROMPT Creating Package 'qms$message'
