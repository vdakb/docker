-- D:\Project\Bundeskriminalamt12c\InternalIdentityManagement\EmployeePortal\eppAplication\src\main\dbs\qms\api\qms-msp.pkb
--
-- Generated for Oracle Database 12c on Fri Apr 24 10:07:06 2020 by Server Generator 10.1.2.93.10

PROMPT Creating API Package Body for Table 'qms$message_properties'
--------------------------------------------------------------------------------
...
BEGIN
  ...
  THEN
    cg$errors.push( cg$errors.get_text(cg$errors.API_MAND_COLUMN_ISNULL, cg$errors.VAL_MAND, P20CODE)
                  , 'E'
                  , 'API'
  ...
  THEN
    cg$errors.push( cg$errors.get_text(cg$errors.API_MAND_COLUMN_ISNULL, cg$errors.VAL_MAND, P30DESCRIPTION)
                  , 'E'
                  , 'API'
                  , cg$errors.API_MAND_COLUMN_ISNULL
                  , loc
  ...
  THEN
    cg$errors.push( cg$errors.get_text(cg$errors.API_MAND_COLUMN_ISNULL, cg$errors.VAL_MAND, P40SEVERITY)
                  , 'E'
                  , 'API'
                  , cg$errors.API_MAND_COLUMN_ISNULL
                  , loc
  ...
  THEN
    cg$errors.push( cg$errors.get_text(cg$errors.API_MAND_COLUMN_ISNULL, cg$errors.VAL_MAND, P50LOGGING)
                  , 'E'
                  , 'API'
                  , cg$errors.API_MAND_COLUMN_ISNULL
                  , loc
  ...
  THEN
    cg$errors.push(cg$errors.get_text(cg$errors.API_MAND_COLUMN_ISNULL, cg$errors.VAL_MAND, P60SUPPRESS_WARNING)
                  , 'E'
                  , 'API'
                  , cg$errors.API_MAND_COLUMN_ISNULL
                  , loc
  ...
  THEN
    cg$errors.push( cg$errors.get_text(cg$errors.API_MAND_COLUMN_ISNULL, cg$errors.VAL_MAND, P70SUPPRESS_ALWAYS)
                  , 'E'
                  , 'API'
                  , cg$errors.API_MAND_COLUMN_ISNULL
                  , loc
  ...
  THEN
    cg$errors.push( cg$errors.get_text(cg$errors.API_MAND_COLUMN_ISNULL, cg$errors.VAL_MAND, P105CREATED_BY)
                  , 'E'
                  , 'API'
                  , cg$errors.API_MAND_COLUMN_ISNULL
                  , loc
  ...
  THEN
    cg$errors.push( cg$errors.get_text(cg$errors.API_MAND_COLUMN_ISNULL, cg$errors.VAL_MAND, P110CREATED_ON)
                  , 'E'
                  , 'API'
                  , cg$errors.API_MAND_COLUMN_ISNULL
                  , loc
  ...
  THEN
    cg$errors.push( cg$errors.get_text(cg$errors.API_MAND_COLUMN_ISNULL, cg$errors.VAL_MAND, P115UPDATED_BY)
                  , 'E'
                  , 'API'
                  , cg$errors.API_MAND_COLUMN_ISNULL
                  , loc
  ...
  THEN
    cg$errors.push( cg$errors.get_text(cg$errors.API_MAND_COLUMN_ISNULL, cg$errors.VAL_MAND, P120UPDATED_ON)
                  , 'E'
                  , 'API'
                  , cg$errors.API_MAND_COLUMN_ISNULL
                  , loc
...
BEGIN
  ...
  THEN
    cg$errors.push( NVL(QMS_MSP_PK, cg$errors.get_text(cg$errors.API_PK_CON_VIOLATED ,cg$errors.APIMSG_PK_VIOLAT, 'QMS_MSP_PK', 'qms$message_properties'))
                  , 'E'
                  , 'API'
  ...
  THEN
    cg$errors.push( NVL(QMS_MSP_UK1, cg$errors.get_text(cg$errors.API_UQ_CON_VIOLATED, cg$errors.APIMSG_UK_VIOLAT, 'QMS_MSP_UK1', 'qms$message_properties'))
                  , 'E'
                  , 'API'
...
IS
  ...
  D50LOGGING          CONSTANT qms_message_properties.logging%TYPE          := 'N';
  D60SUPPRESS_WARNING CONSTANT qms_message_properties.suppress_warning%TYPE := 'N';
  D70SUPPRESS_ALWAYS  CONSTANT qms_message_properties.suppress_always%TYPE  := 'N';
...
BEGIN
  ...
  THEN
    cg$rec.logging := D50LOGGING;
  END IF;
  IF NOT (cg$ind.suppress_warning)
  THEN
    cg$rec.suppress_warning := D60SUPPRESS_WARNING;
  END IF;
  IF NOT (cg$ind.suppress_always)
  THEN
    cg$rec.suppress_always := D70SUPPRESS_ALWAYS;
  END IF;
...
--------------------------------------------------------------------------------
PROCEDURE upd(cg$rec IN OUT cg$row_type, cg$ind IN OUT cg$ind_type, do_upd IN BOOLEAN DEFAULT TRUE) IS
...
EXCEPTION
  ...
  WHEN no_data_found
  THEN
    cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_DEL, cg$errors.ROW_DEL), 'E', 'ORA', SQLCODE, 'qms$message_properties.del.no_data_found');
    called_from_package := FALSE;
    cg$errors.raise_failure;
  WHEN OTHERS
  THEN
...
EXCEPTION
  ...
  THEN
    cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_LCK, cg$errors.ROW_LCK), 'E', 'ORA', SQLCODE, 'qms$message_properties.lck.resource_busy');
    cg$errors.raise_failure;
  WHEN no_data_found
  THEN
    cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_DEL, cg$errors.ROW_DEL), 'E', 'ORA', SQLCODE, 'qms$message_properties.lck.no_data_found');
    cg$errors.raise_failure;
  WHEN OTHERS
  THEN
  ...
  THEN
    ...
    THEN
      ...
      THEN
        cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_MOD, cg$errors.ROW_MOD, P100CONSTRAINT_NAME),'E', 'API', CG$ERRORS.API_MODIFIED, 'qms$message_properties.lck');
         any_modified := TRUE;
      END IF;
  ...
  THEN
    ...
    THEN
      cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_MOD, cg$errors.ROW_MOD, P20CODE),'E', 'API', CG$ERRORS.API_MODIFIED, 'qms$message_properties.lck');
      any_modified := TRUE;
    END IF;
  END IF;
  ...
  THEN
    ...
    THEN
      cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_MOD, cg$errors.ROW_MOD, P30DESCRIPTION),'E', 'API', CG$ERRORS.API_MODIFIED, 'qms$message_properties.lck');
      any_modified := TRUE;
    END IF;
  END IF;
  ...
  THEN
    ...
    THEN
      cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_MOD, cg$errors.ROW_MOD, P40SEVERITY),'E', 'API', CG$ERRORS.API_MODIFIED, 'qms$message_properties.lck');
      any_modified := TRUE;
    END IF;
  END IF;
  ...
  THEN
    ...
    THEN
      cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_MOD, cg$errors.ROW_MOD, P50LOGGING),'E', 'API', CG$ERRORS.API_MODIFIED, 'qms$message_properties.lck');
      any_modified := TRUE;
    END IF;
  END IF;
  ...
  THEN
    ...
    THEN
      cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_MOD, cg$errors.ROW_MOD, P60SUPPRESS_WARNING),'E', 'API', CG$ERRORS.API_MODIFIED, 'qms$message_properties.lck');
      any_modified := TRUE;
    END IF;
  END IF;
  ...
  THEN
    ...
    THEN
      cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_MOD, cg$errors.ROW_MOD, P70SUPPRESS_ALWAYS),'E', 'API', CG$ERRORS.API_MODIFIED, 'qms$message_properties.lck');
      any_modified := TRUE;
    END IF;
  END IF;
  ...
  THEN
    ...
    THEN
      cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_MOD, cg$errors.ROW_MOD, P105CREATED_BY),'E', 'API', CG$ERRORS.API_MODIFIED, 'qms$message_properties.lck');
      any_modified := TRUE;
    END IF;
  END IF;
  ...
  THEN
    ...
    THEN
      cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_MOD, cg$errors.ROW_MOD, P110CREATED_ON),'E', 'API', CG$ERRORS.API_MODIFIED, 'qms$message_properties.lck');
      any_modified := TRUE;
    END IF;
  END IF;
  ...
  THEN
    ...
    THEN
      cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_MOD, cg$errors.ROW_MOD, P115UPDATED_BY),'E', 'API', CG$ERRORS.API_MODIFIED, 'qms$message_properties.lck');
      any_modified := TRUE;
    END IF;
  END IF;
  ...
  THEN
    ...
    THEN
      cg$errors.push(cg$errors.get_text(cg$errors.API_ROW_MOD, cg$errors.ROW_MOD, P120UPDATED_ON),'E', 'API', CG$ERRORS.API_MODIFIED, 'qms$message_properties.lck');
      any_modified := TRUE;
    END IF;
  END IF;
