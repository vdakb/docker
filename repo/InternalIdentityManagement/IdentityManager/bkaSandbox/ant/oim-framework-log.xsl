...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/changes">
    <html>
      <head>
        <title>Federated Identity Managegement Framework Change Log</title>
      ...
      <body>
        <div>
          ...
          <tr>
            <td align="left" valign="top"><b>Federated Identity Managegement Framework Change Log</b><br/></td>
          </tr>
          </table>
          <hr/>
          <a name="BEGIN" id="BEGIN"></a>
          <div>
            <h1>Federated Identity Managegement Framework</h1>
            <p>This document describes changes on top of Release 12.1.3.0 of Oracle Identity Manager Framework. It contains the following sections:</p>
            <p><xsl:text disable-output-escaping="yes">February 2019</xsl:text></p>
          </div>
        </div>
        <ol>
